...
@implementation ABI50_0_0RCTI18nUtil

+ (instancetype)sharedInstance
{
  static ABI50_0_0RCTI18nUtil *sharedInstance;
...
- (BOOL)isRTLAllowed
{
  NSNumber *value = [[NSUserDefaults standardUserDefaults] objectForKey:@"ABI50_0_0RCTI18nUtil_allowRTL"];
  if (value == nil) {
    return YES;
  }
...
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI50_0_0RCTI18nUtil_allowRTL"];
...
- (BOOL)isRTLForced
{
  BOOL rtlStatus = [[NSUserDefaults standardUserDefaults] boolForKey:@"ABI50_0_0RCTI18nUtil_forceRTL"];
  return rtlStatus;
}

- (void)forceRTL:(BOOL)rtlStatus
{
  [[NSUserDefaults standardUserDefaults] setBool:rtlStatus forKey:@"ABI50_0_0RCTI18nUtil_forceRTL"];
  [[NSUserDefaults standardUserDefaults] synchronize];
}

- (BOOL)doLeftAndRightSwapInRTL
{
  return [[NSUserDefaults standardUserDefaults] boolForKey:@"ABI50_0_0RCTI18nUtil_makeRTLFlipLeftAndRightStyles"];
}

- (void)swapLeftAndRightInRTL:(BOOL)value
{
  [[NSUserDefaults standardUserDefaults] setBool:value forKey:@"ABI50_0_0RCTI18nUtil_makeRTLFlipLeftAndRightStyles"];
  [[NSUserDefaults standardUserDefaults] synchronize];
}
