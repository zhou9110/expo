 ...
 */
@protocol ABI50_0_0RCTMountingManagerDelegate <NSObject>
 ...
 */
- (void)mountingManager:(ABI50_0_0RCTMountingManager *)mountingManager willMountComponentsWithRootTag:(ABI50_0_0ReactTag)MountingManager;
