...
// When building a cross-platform module for ABI50_0_0React Native, arguments passed
...
// they can be caught and reported to ABI50_0_0RN consistently.  The goal is to make the
...
#include <ABI50_0_0cxxreact/ABI50_0_0JsArgumentHelpers-inl.h>
