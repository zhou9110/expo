...
typedef NS_ENUM(NSInteger, ABI50_0_0EXTypedArrayKind) {
  Int8Array = 1,
  Int16Array = 2,
  Int32Array = 3,
  Uint8Array = 4,
...
@interface ABI50_0_0EXJavaScriptTypedArray : ABI50_0_0EXJavaScriptObject

@property (nonatomic) ABI50_0_0EXTypedArrayKind kind;
