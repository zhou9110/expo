...
#include "ABI50_0_0TurboModuleBinding.h"

#include <stdexcept>
#include <string>

#include <ABI50_0_0ReactCommon/ABI50_0_0LongLivedObject.h>
...
void TurboModuleBinding::install(
  ...
  if (runtime.global().hasProperty(runtime, "ABI50_0_0RN$Bridgeless")) {
    if (legacyModuleProvider != nullptr) {
      defineReadOnlyGlobal(runtime, "ABI50_0_0RN$TurboInterop", jsi::Value(true));
