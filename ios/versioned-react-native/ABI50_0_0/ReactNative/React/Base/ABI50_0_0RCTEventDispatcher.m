...
const NSInteger ABI50_0_0RCTTextUpdateLagWarningThreshold = 3;

NSString *ABI50_0_0RCTNormalizeInputEventName(NSString *eventName)
{
...
@implementation ABI50_0_0RCTBridge (ABI50_0_0RCTEventDispatcher)
...
@implementation ABI50_0_0RCTBridgeProxy (ABI50_0_0RCTEventDispatcher)
