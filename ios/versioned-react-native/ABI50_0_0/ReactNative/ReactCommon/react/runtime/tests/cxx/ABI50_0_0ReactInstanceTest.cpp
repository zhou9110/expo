...
class ABI50_0_0ReactInstanceTest : public ::testing::Test {
 protected:
  ABI50_0_0ReactInstanceTest() {}

  void SetUp() override {
    auto runtime = ABI50_0_0hermes::makeHermesRuntime();
    ...
    instance_ = std::make_unique<ABI50_0_0ReactInstance>(
        std::move(runtime),
        messageQueueThread_,
        timerManager_,
  ...
  void initializeRuntimeWithScript(
      ABI50_0_0ReactInstance::JSRuntimeFlags jsRuntimeFlags,
      std::string script) {
  ...
  void expectError() {
    ABI50_0_0EXPECT_NE(errorHandler_->size(), 0)
        << "Expected an error to have been thrown, but it wasn't.";
  }

  void expectNoError() {
    ABI50_0_0EXPECT_EQ(errorHandler_->size(), 0)
  ...
  std::unique_ptr<ABI50_0_0ReactInstance> instance_;
  std::shared_ptr<TimerManager> timerManager_;
  MockTimerRegistry* mockRegistry_;
  std::shared_ptr<ErrorUtils> errorHandler_;
};

TEST_F(ABI50_0_0ReactInstanceTest, testBridgelessFlagIsSet) {
  eval("ABI50_0_0RN$Bridgeless === true");
  expectError();
  initializeRuntimeWithScript("");
  auto val = eval("ABI50_0_0RN$Bridgeless === true");
  ABI50_0_0EXPECT_EQ(val.getBool(), true);
}

TEST_F(ABI50_0_0ReactInstanceTest, testProfilingFlag) {
  eval("__ABI50_0_0RCTProfileIsProfiling === true");
  expectError();
  initializeRuntimeWithScript({.isProfiling = true}, "");
  auto val = eval("__ABI50_0_0RCTProfileIsProfiling === true");
  ABI50_0_0EXPECT_EQ(val.getBool(), true);
}

TEST_F(ABI50_0_0ReactInstanceTest, testPromiseIntegration) {
  initializeRuntimeWithScript("");
...
Promise.resolve().then(() => {
  ...
  auto result = runtime_->global()
                    ...
                    .call(*runtime_);
  ABI50_0_0EXPECT_EQ(result.getNumber(), 2);
}

TEST_F(ABI50_0_0ReactInstanceTest, testSetImmediate) {
  initializeRuntimeWithScript("");
...
setImmediate(() => {
  ...
  auto result = runtime_->global()
                    .getPropertyAsFunction(*runtime_, "getResult")
                    .call(*runtime_);
  ABI50_0_0EXPECT_EQ(result.getBool(), true);
}

TEST_F(ABI50_0_0ReactInstanceTest, testNestedSetImmediate) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testSetImmediateWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testClearImmediate) {
  initializeRuntimeWithScript("");
...
clearImmediate(handle);
  ...
  ABI50_0_0EXPECT_EQ(val.getBool(), false);
}

TEST_F(ABI50_0_0ReactInstanceTest, testClearImmediateWithInvalidHandle) {
  initializeRuntimeWithScript("");
...
function clearInvalidHandle() {
  ...
  ABI50_0_0EXPECT_NO_THROW(clear.call((*runtime_)));
}

TEST_F(ABI50_0_0ReactInstanceTest, testClearImmediateWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testSetTimeout) {
  initializeRuntimeWithScript("");

  uint32_t timerID{0};
  ABI50_0_0EXPECT_CALL(*mockRegistry_, createTimer(_, 100))
...
function getResult() {
  ...
  auto called = runtime_->global()
                    .getPropertyAsFunction(*runtime_, "getResult")
                    .call(*runtime_);
  ABI50_0_0EXPECT_EQ(called.getBool(), true);
}

TEST_F(ABI50_0_0ReactInstanceTest, testSetTimeoutWithoutDelay) {
  initializeRuntimeWithScript("");

  ABI50_0_0EXPECT_CALL(
      *mockRegistry_,
      createTimer(_, 0)); // If delay is not provided, it should use 0
  eval("setTimeout(() => {});");
}

TEST_F(ABI50_0_0ReactInstanceTest, testSetTimeoutWithPassThroughArgs) {
  initializeRuntimeWithScript("");

  uint32_t timerID{0};
  ABI50_0_0EXPECT_CALL(*mockRegistry_, createTimer(_, 0)).WillOnce(SaveArg<0>(&timerID));
  eval(R"xyz123(
let result;
setTimeout(arg => {
  result = arg;
...
function getResult() {
  ...
  auto result = runtime_->global()
                    .getPropertyAsFunction(*runtime_, "getResult")
                    .call(*runtime_);
  ABI50_0_0EXPECT_EQ(result.asString(*runtime_).utf8(*runtime_), "foo");
}

TEST_F(ABI50_0_0ReactInstanceTest, testSetTimeoutWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testClearTimeout) {
  initializeRuntimeWithScript("");
...
function clear() {
  ...
  ABI50_0_0EXPECT_CALL(*mockRegistry_, deleteTimer(timerID));
  runtime_->global().getPropertyAsFunction(*runtime_, "clear").call(*runtime_);
}

TEST_F(ABI50_0_0ReactInstanceTest, testClearTimeoutWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testClearTimeoutForExpiredTimer) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testSetInterval) {
  initializeRuntimeWithScript("");

  uint32_t timerID{0};
  ABI50_0_0EXPECT_CALL(*mockRegistry_, createRecurringTimer(_, 100))
      .WillOnce(SaveArg<0>(&timerID));
  eval(R"xyz123(
let result = 0;
setInterval(() => {
...
function getResult() {
  ...
  ABI50_0_0EXPECT_EQ(getResult.call(*runtime_).asNumber(), 1.0);

  // Should be able to call the same callback again.
  timerManager_->callTimer(timerID);
  step();
  ABI50_0_0EXPECT_EQ(getResult.call(*runtime_).asNumber(), 2.0);
}

TEST_F(ABI50_0_0ReactInstanceTest, testSetIntervalWithPassThroughArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testSetIntervalWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testClearInterval) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testClearIntervalWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testRequestAnimationFrame) {
  initializeRuntimeWithScript("");
...
function getResult() {
  ...
  auto getResult =
      runtime_->global().getPropertyAsFunction(*runtime_, "getResult");
  ABI50_0_0EXPECT_EQ(getResult.call(*runtime_).getBool(), false);

  timerManager_->callTimer(timerID);
  step();
  ABI50_0_0EXPECT_EQ(getResult.call(*runtime_).getBool(), true);
}
...
function getResult() {
  ...
  auto getResult =
      runtime_->global().getPropertyAsFunction(*runtime_, "getResult");
  ABI50_0_0EXPECT_EQ(getResult.call(*runtime_).getNumber(), 0);

  timerManager_->callTimer(timerID);
  step();
  ABI50_0_0EXPECT_EQ(getResult.call(*runtime_).getNumber(), 123456);
}

TEST_F(ABI50_0_0ReactInstanceTest, testRequestAnimationFrameWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testCancelAnimationFrame) {
  initializeRuntimeWithScript("");
...
function getResult() {
  ...
  auto called = runtime_->global()
                    .getPropertyAsFunction(*runtime_, "getResult")
                    .call(*runtime_);
  ABI50_0_0EXPECT_EQ(called.getBool(), false);
}

TEST_F(ABI50_0_0ReactInstanceTest, testCancelAnimationFrameWithInvalidArgs) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testCancelAnimationFrameWithExpiredTimer) {
  initializeRuntimeWithScript("");
...
TEST_F(ABI50_0_0ReactInstanceTest, testRegisterCallableModule) {
...
ABI50_0_0RN$registerCallableModule('foo', () => module);
  )xyz123");
...
TEST_F(ABI50_0_0ReactInstanceTest, testRegisterCallableModule_invalidArgs) {
  initializeRuntimeWithScript("");

  ABI50_0_0EXPECT_EQ(
      getErrorMessage("ABI50_0_0RN$registerCallableModule();"),
      "registerCallableModule requires exactly 2 arguments");
  ABI50_0_0EXPECT_EQ(
      getErrorMessage("ABI50_0_0RN$registerCallableModule('foo');"),
      "registerCallableModule requires exactly 2 arguments");
  ABI50_0_0EXPECT_EQ(
      getErrorMessage("ABI50_0_0RN$registerCallableModule(1, () => ({}));"),
      "The first argument to registerCallableModule must be a string (the name of the JS module).");
  ABI50_0_0EXPECT_EQ(
      getErrorMessage("ABI50_0_0RN$registerCallableModule('foo', false);"),
      "The second argument to registerCallableModule must be a function that returns the JS module.");
}

TEST_F(ABI50_0_0ReactInstanceTest, testCallFunctionOnModule_invalidModule) {
  initializeRuntimeWithScript("");
  ...
  ABI50_0_0EXPECT_EQ(
      getLastErrorMessage(),
      "Failed to call into JavaScript module method invalidModule.method(). Module has not been registered as callable. Registered callable JavaScript modules (n = 0):. Did you forget to call `ABI50_0_0RN$registerCallableModule`?");
}

TEST_F(ABI50_0_0ReactInstanceTest, testCallFunctionOnModule_undefinedMethod) {
  initializeRuntimeWithScript(R"xyz123(
const module = {
  bar: () => {},
};
...
TEST_F(ABI50_0_0ReactInstanceTest, testCallFunctionOnModule_invalidMethod) {
  initializeRuntimeWithScript(R"xyz123(
const module = {
  bar: false,
};
...
TEST_F(ABI50_0_0ReactInstanceTest, testRegisterCallableModule_withArgs) {
  initializeRuntimeWithScript(R"xyz123(
let result;
const module = {
  bar: thing => {
...
function getResult() {
  ...
  auto result = runtime_->global()
                    .getPropertyAsFunction(*runtime_, "getResult")
                    .call(*runtime_);
  ABI50_0_0EXPECT_EQ(result.getNumber(), 1);
}
