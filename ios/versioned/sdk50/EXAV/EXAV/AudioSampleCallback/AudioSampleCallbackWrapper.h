...
#import <ABI50_0_0EXAV/CallbackWrapper.h>

namespace jsi = ABI50_0_0facebook::jsi;
using CallInvoker = ABI50_0_0facebook::ABI50_0_0React::CallInvoker;

// TODO: Replace this with just ABI50_0_0facebook::react namespace after we upgrade to RN 0.66
using JsiCallbackWrapper = ABI50_0_0expo::CallbackWrapper;
using LongLivedObjectCollection = ABI50_0_0expo::LongLivedObjectCollection;
