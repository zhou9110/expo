//
//  ABI50_0_0AIRGoogleMapWMSTile.m
//  AirMaps
//
...
@implementation ABI50_0_0AIRGoogleMapWMSTile
...
- (void)setUrlTemplate:(NSString *)urlTemplate
{
    ...
    ABI50_0_0WMSTileOverlay *tile = [[ABI50_0_0WMSTileOverlay alloc] init];
...
@implementation ABI50_0_0WMSTileOverlay
-(id) init
{
    self = [super init];
