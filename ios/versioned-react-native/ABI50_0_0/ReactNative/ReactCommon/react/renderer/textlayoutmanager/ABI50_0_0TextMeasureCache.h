...
#include <ABI50_0_0React/utils/ABI50_0_0SimpleThreadSafeCache.h>
...
template <>
struct hash<ABI50_0_0facebook::ABI50_0_0React::TextMeasureCacheKey> {
  size_t operator()(const ABI50_0_0facebook::ABI50_0_0React::TextMeasureCacheKey& key) const {
    return folly::hash::hash_combine(
        0,
