...
@protocol ABI50_0_0RCTExceptionsManagerDelegate <NSObject>
...
@interface ABI50_0_0RCTExceptionsManager : NSObject <ABI50_0_0RCTBridgeModule>
...
@property (nonatomic, weak) id<ABI50_0_0RCTExceptionsManagerDelegate> delegate;
