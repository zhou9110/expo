...
#include <hermes/inspector-modern/ABI50_0_0Inspector.h>
#include <hermes/inspector-modern/chrome/ABI50_0_0MessageConverters.h>
#include <hermes/inspector-modern/chrome/ABI50_0_0RemoteObjectsTable.h>
#include <hermes/inspector-modern/detail/ABI50_0_0CallbackOStream.h>
#include <hermes/inspector-modern/detail/ABI50_0_0SerialExecutor.h>
#include <hermes/inspector-modern/detail/ABI50_0_0Thread.h>
...
using ::ABI50_0_0facebook::ABI50_0_0React::jsinspector_modern::ILocalConnection;
using ::ABI50_0_0facebook::ABI50_0_0React::jsinspector_modern::IRemoteConnection;
using ::folly::Unit;

namespace debugger = ::ABI50_0_0facebook::ABI50_0_0hermes::debugger;
namespace inspector_modern = ::ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern;
namespace m = ::ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern::chrome::message;
...
void Connection::Impl::onMessageAdded(
    ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern::Inspector &inspector,
      ...
      ->evaluate(
          ...
          [this,
           ...
           generatePreview = req.generatePreview.value_or(false)](
              const ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult
                  &evalResult) mutable {
...
class CallFunctionOnRunner {
 public:
  ...
  // N.B.: constexpr char[] broke ABI50_0_0React-native-oss-android.
  ...
  jsi::Value operator()(
      jsi::Runtime &rt,
      RemoteObjectsTable &objTable,
      const ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult &evalResult) {
  ...
  inspector_
      ->evaluate(
          ...
          [this,
           ...
           generatePreview = req.generatePreview.value_or(false),
           runner =
               std::move(runner)](const ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult
                                      &evalResult) mutable {
  ...
  inspector_
      ->executeIfEnabled(
          ...
          [this, req, resp](const debugger::ProgramState &state) {
            ...
            } catch (const ABI50_0_0facebook::jsi::JSIException &err) {
