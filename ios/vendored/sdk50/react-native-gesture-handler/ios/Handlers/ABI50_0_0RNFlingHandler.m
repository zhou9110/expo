#import "ABI50_0_0RNFlingHandler.h"

@interface ABI50_0_0RNBetterSwipeGestureRecognizer : UISwipeGestureRecognizer

- (id)initWithGestureHandler:(ABI50_0_0RNGestureHandler *)gestureHandler;

@end

@implementation ABI50_0_0RNBetterSwipeGestureRecognizer {
...
@implementation ABI50_0_0RNFlingGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI50_0_0RNBetterSwipeGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
- (void)resetConfig
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.direction = [ABI50_0_0RCTConvert NSInteger:prop];
  }

#if !TARGET_OS_TV
  prop = config[@"numberOfPointers"];
  if (prop != nil) {
    recognizer.numberOfTouchesRequired = [ABI50_0_0RCTConvert NSInteger:prop];
  }
#endif
}
...
- (ABI50_0_0RNGestureHandlerEventExtraData *)eventExtraData:(id)_recognizer
{
  ...
  ABI50_0_0RNBetterSwipeGestureRecognizer *recognizer = (ABI50_0_0RNBetterSwipeGestureRecognizer *)_recognizer;
  ...
  return [ABI50_0_0RNGestureHandlerEventExtraData
