...
#import <ABI50_0_0EXSplashScreen/ABI50_0_0EXSplashScreenViewController.h>
#import <ABI50_0_0EXSplashScreen/ABI50_0_0EXSplashScreenViewProvider.h>

NS_ASSUME_NONNULL_BEGIN

typedef NS_OPTIONS(NSUInteger, ABI50_0_0EXSplashScreenOptions) {
  ABI50_0_0EXSplashScreenDefault = 0,

  // Show splash screen even it was already shown before.
  // e.g. show splash screen again when reloading apps,
  ABI50_0_0EXSplashScreenForceShow = 1 << 0,
};
...
*/
@protocol ABI50_0_0EXSplashScreenService <NSObject>
...
/**
 * Entry point for SplashScreen unimodule.
 * Registers SplashScreen for given viewController and ABI50_0_0EXSplashController and presents it in that viewController.
 */
-(void)showSplashScreenFor:(UIViewController *)viewController
                   options:(ABI50_0_0EXSplashScreenOptions)options
...
@interface ABI50_0_0EXSplashScreenService : ABI50_0_0EXSingletonModule <ABI50_0_0EXSplashScreenService, UIApplicationDelegate>
@end
