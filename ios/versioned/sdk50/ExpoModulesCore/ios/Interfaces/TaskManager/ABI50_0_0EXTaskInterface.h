...
@protocol ABI50_0_0EXTaskConsumerInterface;

@protocol ABI50_0_0EXTaskInterface
 ...
 */
@property (nonatomic, strong, readonly) id<ABI50_0_0EXTaskConsumerInterface> __nonnull consumer;
