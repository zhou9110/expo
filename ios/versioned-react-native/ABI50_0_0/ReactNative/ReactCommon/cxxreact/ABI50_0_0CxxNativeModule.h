...
#include <ABI50_0_0cxxreact/ABI50_0_0NativeModule.h>
...
class ABI50_0_0RN_EXPORT CxxNativeModule : public NativeModule {
 public:
  CxxNativeModule(
      std::weak_ptr<Instance> instance,
      std::string name,
  ...
  void invoke(unsigned int ABI50_0_0ReactMethodId, folly::dynamic&& params, int callId)
      override;
