#import "ABI50_0_0RNForceTouchHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI50_0_0React/ABI50_0_0RCTConvert.h>

@interface ABI50_0_0RNForceTouchGestureRecognizer : UIGestureRecognizer
...
@implementation ABI50_0_0RNForceTouchGestureRecognizer {
...
@implementation ABI50_0_0RNForceTouchHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI50_0_0RNForceTouchGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI50_0_0RNForceTouchGestureRecognizer *recognizer = (ABI50_0_0RNForceTouchGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.feedbackOnActivation = [ABI50_0_0RCTConvert BOOL:prop];
  }
}

- (ABI50_0_0RNGestureHandlerEventExtraData *)eventExtraData:(ABI50_0_0RNForceTouchGestureRecognizer *)recognizer
{
  return [ABI50_0_0RNGestureHandlerEventExtraData forForce:recognizer.force
