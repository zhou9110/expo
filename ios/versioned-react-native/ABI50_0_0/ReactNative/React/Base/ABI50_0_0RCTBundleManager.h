...
typedef NSURL * (^ABI50_0_0RCTBridgelessBundleURLGetter)(void);
typedef void (^ABI50_0_0RCTBridgelessBundleURLSetter)(NSURL *bundleURL);

/**
 * A class that allows NativeModules/TurboModules to read/write the bundleURL, with or without the bridge.
 */
@interface ABI50_0_0RCTBundleManager : NSObject
