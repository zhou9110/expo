...
Pod::Spec.new do |spec|
  spec.name        = "ABI50_0_0hermes-engine"
  ...
  if HermesEngineSourceType::isPrebuilt(source_type) then
    ...
    spec.subspec 'Pre-built' do |ss|
      ...
      ss.ios.vendored_frameworks = "destroot/Library/Frameworks/universal/ABI50_0_0hermes.xcframework"
