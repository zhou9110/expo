...
#import "ABI50_0_0RNLongPressHandler.h"
...
@interface ABI50_0_0RNBetterLongPressGestureRecognizer : UILongPressGestureRecognizer {
  uint64_t startTime;
...
@implementation ABI50_0_0RNBetterLongPressGestureRecognizer {
...
@implementation ABI50_0_0RNLongPressGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI50_0_0RNBetterLongPressGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.minimumPressDuration = [ABI50_0_0RCTConvert CGFloat:prop] / 1000.0;
  }

  prop = config[@"maxDist"];
  if (prop != nil) {
    recognizer.allowableMovement = [ABI50_0_0RCTConvert CGFloat:prop];
  }
}
  ...
  return [ABI50_0_0RNGestureHandlerEventExtraData forPosition:[recognizer locationInView:recognizer.view]
                                withAbsolutePosition:[recognizer locationInView:recognizer.view.window]
                                 withNumberOfTouches:recognizer.numberOfTouches
                                        withDuration:[(ABI50_0_0RNBetterLongPressGestureRecognizer *)recognizer getDuration]];
}
@end
