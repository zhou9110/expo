...
@interface ABI50_0_0EXSensorsManagerBinding ()

@property (nonatomic, strong) NSString *scopeKey;
@property (nonatomic, weak) id<ABI50_0_0EXSensorsManagerBindingDelegate> kernelService;

@end

@implementation ABI50_0_0EXSensorsManagerBinding
...
+ (const NSArray<Protocol *> *)exportedInterfaces {
  return @[@protocol(ABI50_0_0EXAccelerometerInterface), @protocol(ABI50_0_0EXBarometerInterface),  @protocol(ABI50_0_0EXDeviceMotionInterface), @protocol(ABI50_0_0EXGyroscopeInterface), @protocol(ABI50_0_0EXMagnetometerInterface), @protocol(ABI50_0_0EXMagnetometerUncalibratedInterface)];
}
