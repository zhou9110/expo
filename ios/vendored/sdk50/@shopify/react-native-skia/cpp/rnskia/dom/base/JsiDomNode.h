...
public:
   ...
   */
  JsiDomNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context, const char *type,
             NodeClass nodeClass)
...
protected:
  ...
  */
  ...
  /**
   ...
   reconciler when properties are set due to changes in ABI50_0_0React.
   */
  ...
  void printDebugInfo(const std::string &message, size_t indentation = 0) {
    ABI50_0_0RNSkLogger::logToConsole("%s%s %lu: %s",
