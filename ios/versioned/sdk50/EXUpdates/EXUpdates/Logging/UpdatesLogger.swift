...
internal final class UpdatesLogger {
  static let ABI50_0_0EXPO_UPDATES_LOG_CATEGORY = "expo-updates"

  private let logger = Logger(category: UpdatesLogger.ABI50_0_0EXPO_UPDATES_LOG_CATEGORY, options: [.logToOS, .logToFile])
