...
#include "ABI50_0_0ShadowNode.h"
#include "ABI50_0_0DynamicPropsUtilities.h"
#include "ABI50_0_0ShadowNodeFragment.h"
...
ShadowNode::ShadowNode(
    ...
    :
      ...
      traits_(traits) {
  ABI50_0_0React_native_assert(props_);
  ABI50_0_0React_native_assert(children_);
...
void ShadowNode::replaceChild(
  ...
  ABI50_0_0React_native_assert(false && "Child to replace was not found.");
}
