 ...
 */
@objc(ABI50_0_0EXUpdatesAppLauncherWithDatabase)
@objcMembers
  ...
  public func ensureAllAssetsExist() {
    ...
    if launchedUpdate.status == UpdateStatus.StatusEmbedded {
      ...
      launchAssetUrl = Bundle.main.url(
        forResource: EmbeddedAppLoader.ABI50_0_0EXUpdatesBareEmbeddedBundleFilename,
        withExtension: EmbeddedAppLoader.ABI50_0_0EXUpdatesBareEmbeddedBundleFileType
      )
