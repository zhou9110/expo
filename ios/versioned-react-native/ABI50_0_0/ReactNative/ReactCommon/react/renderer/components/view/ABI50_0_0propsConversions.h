...
static inline yoga::Style::Edges convertRawProp(
  ...
  result[ABI50_0_0YGEdgeLeft] = convertRawProp(
      context,
      rawProps,
      "Left",
      sourceValue[ABI50_0_0YGEdgeLeft],
      defaultValue[ABI50_0_0YGEdgeLeft],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeTop] = convertRawProp(
      context,
      rawProps,
      "Top",
      sourceValue[ABI50_0_0YGEdgeTop],
      defaultValue[ABI50_0_0YGEdgeTop],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeRight] = convertRawProp(
      context,
      rawProps,
      "Right",
      sourceValue[ABI50_0_0YGEdgeRight],
      defaultValue[ABI50_0_0YGEdgeRight],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeBottom] = convertRawProp(
      context,
      rawProps,
      "Bottom",
      sourceValue[ABI50_0_0YGEdgeBottom],
      defaultValue[ABI50_0_0YGEdgeBottom],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeStart] = convertRawProp(
      context,
      rawProps,
      "Start",
      sourceValue[ABI50_0_0YGEdgeStart],
      defaultValue[ABI50_0_0YGEdgeStart],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeEnd] = convertRawProp(
      context,
      rawProps,
      "End",
      sourceValue[ABI50_0_0YGEdgeEnd],
      defaultValue[ABI50_0_0YGEdgeEnd],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeHorizontal] = convertRawProp(
      context,
      rawProps,
      "Horizontal",
      sourceValue[ABI50_0_0YGEdgeHorizontal],
      defaultValue[ABI50_0_0YGEdgeHorizontal],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeVertical] = convertRawProp(
      context,
      rawProps,
      "Vertical",
      sourceValue[ABI50_0_0YGEdgeVertical],
      defaultValue[ABI50_0_0YGEdgeVertical],
      prefix,
      suffix);
  result[ABI50_0_0YGEdgeAll] = convertRawProp(
      context,
      rawProps,
      "",
      sourceValue[ABI50_0_0YGEdgeAll],
      defaultValue[ABI50_0_0YGEdgeAll],
      prefix,
      suffix);
  return result;
}
...
static inline yoga::Style convertRawProp(
  ...
  yogaStyle.gap()[ABI50_0_0YGGutterRow] = convertRawProp(
      context,
      rawProps,
      "rowGap",
      sourceValue.gap()[ABI50_0_0YGGutterRow],
      yogaStyle.gap()[ABI50_0_0YGGutterRow]);

  yogaStyle.gap()[ABI50_0_0YGGutterColumn] = convertRawProp(
      context,
      rawProps,
      "columnGap",
      sourceValue.gap()[ABI50_0_0YGGutterColumn],
      yogaStyle.gap()[ABI50_0_0YGGutterColumn]);

  yogaStyle.gap()[ABI50_0_0YGGutterAll] = convertRawProp(
      context,
      rawProps,
      "gap",
      sourceValue.gap()[ABI50_0_0YGGutterAll],
  ...
  yogaStyle.setDimension(
      ...
      convertRawProp(
          ...
          rawProps,
          "width",
          sourceValue.dimension(ABI50_0_0YGDimensionWidth),
          {}));
  yogaStyle.setDimension(
      ...
      convertRawProp(
          ...
          rawProps,
          "height",
          sourceValue.dimension(ABI50_0_0YGDimensionHeight),
          {}));
  ...
  yogaStyle.setMinDimension(
      ...
      convertRawProp(
          ...
          rawProps,
          "minWidth",
          sourceValue.minDimension(ABI50_0_0YGDimensionWidth),
          {}));
  yogaStyle.setMinDimension(
      ABI50_0_0YGDimensionHeight,
      convertRawProp(
          ...
          rawProps,
          "minHeight",
          sourceValue.minDimension(ABI50_0_0YGDimensionHeight),
          {}));
  ...
  yogaStyle.setMaxDimension(
      ...
      convertRawProp(
          ...
          rawProps,
          "maxWidth",
          sourceValue.maxDimension(ABI50_0_0YGDimensionWidth),
          {}));
  yogaStyle.setMaxDimension(
      ABI50_0_0YGDimensionHeight,
      convertRawProp(
          ...
          rawProps,
          "maxHeight",
          sourceValue.maxDimension(ABI50_0_0YGDimensionHeight),
          {}));
