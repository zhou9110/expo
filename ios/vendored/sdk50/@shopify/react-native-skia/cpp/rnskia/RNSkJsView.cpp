...
#include "ABI50_0_0RNSkJsView.h"

namespace ABI50_0_0RNSkia {

ABI50_0_0RNSkJsRenderer::ABI50_0_0RNSkJsRenderer(std::function<void()> requestRedraw,
                               std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
    : ABI50_0_0RNSkRenderer(requestRedraw),
      _jsiCanvas(std::make_shared<JsiSkCanvas>(context)),
      _platformContext(context),
      _infoObject(std::make_shared<ABI50_0_0RNSkInfoObject>()),
...
bool ABI50_0_0RNSkJsRenderer::tryRender(
...
void ABI50_0_0RNSkJsRenderer::renderImmediate(
    std::shared_ptr<ABI50_0_0RNSkCanvasProvider> canvasProvider) {
...
void ABI50_0_0RNSkJsRenderer::setDrawCallback(
    std::shared_ptr<jsi::Function> drawCallback) {
  _drawCallback = drawCallback;
}

std::shared_ptr<ABI50_0_0RNSkInfoObject> ABI50_0_0RNSkJsRenderer::getInfoObject() {
  return _infoObject;
}

void ABI50_0_0RNSkJsRenderer::performDraw(
    std::shared_ptr<ABI50_0_0RNSkCanvasProvider> canvasProvider) {
  // Start timing
...
void ABI50_0_0RNSkJsRenderer::callJsDrawCallback(std::shared_ptr<JsiSkCanvas> jsiCanvas,
...
void ABI50_0_0RNSkJsRenderer::drawInJsiCanvas(std::shared_ptr<JsiSkCanvas> jsiCanvas,
