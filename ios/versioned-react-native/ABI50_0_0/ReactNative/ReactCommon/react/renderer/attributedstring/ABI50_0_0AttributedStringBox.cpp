...
#include "ABI50_0_0AttributedStringBox.h"
...
const AttributedString& AttributedStringBox::getValue() const {
  ABI50_0_0React_native_assert(mode_ == AttributedStringBox::Mode::Value);
  ABI50_0_0React_native_assert(value_);
  return *value_;
}

std::shared_ptr<void> AttributedStringBox::getOpaquePointer() const {
  ABI50_0_0React_native_assert(mode_ == AttributedStringBox::Mode::OpaquePointer);
  ABI50_0_0React_native_assert(opaquePointer_);
