...
public:
  explicit JsiShaderNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiImageShaderNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiColorShaderNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  JsiBasePerlinNoiseNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
                         PropId type)
...
public:
  explicit JsiTurbulenceNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiFractalNoiseNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  JsiBaseGradientNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context, PropId type)
      : JsiDomDeclarationNode(context, type, DeclarationType::Shader) {}
...
public:
  explicit JsiLinearGradientNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiRadialGradientNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiSweepGradientNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
