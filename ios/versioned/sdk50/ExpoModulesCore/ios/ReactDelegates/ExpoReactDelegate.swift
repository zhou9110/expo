...
public class ExpoReactDelegate: NSObject {
  ...
  @objc
  public func createBridge(delegate: ABI50_0_0RCTBridgeDelegate, launchOptions: [AnyHashable: Any]?) -> ABI50_0_0RCTBridge {
    ...
    let result = self.handlers.lazy
      ...
      .first(where: { _ in true }) ?? ABI50_0_0RCTBridge(delegate: delegate, launchOptions: launchOptions)!
  ...
  public func createRootView(
    bridge: ABI50_0_0RCTBridge,
    moduleName: String,
    initialProperties: [AnyHashable: Any]?,
    fabricEnabled: Bool = ABI50_0_0EXAppDefines.APP_NEW_ARCH_ENABLED
  ) -> UIView {
    return self.handlers.lazy
      ...
      .first(where: { _ in true }) ?? ABI50_0_0EXAppSetupDefaultRootView(bridge, moduleName, initialProperties, fabricEnabled)
  }
