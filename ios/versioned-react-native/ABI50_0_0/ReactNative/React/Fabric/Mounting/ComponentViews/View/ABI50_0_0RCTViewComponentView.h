...
#import <ABI50_0_0React/ABI50_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI50_0_0React/ABI50_0_0UIView+ComponentViewProtocol.h>
 ...
 */
@interface ABI50_0_0RCTViewComponentView : UIView <ABI50_0_0RCTComponentViewProtocol, ABI50_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics _layoutMetrics;
  ABI50_0_0facebook::ABI50_0_0React::SharedViewProps _props;
  ABI50_0_0facebook::ABI50_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI50_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(const ABI50_0_0facebook::ABI50_0_0React::Props::Shared &)props
           oldProps:(const ABI50_0_0facebook::ABI50_0_0React::Props::Shared &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(const ABI50_0_0facebook::ABI50_0_0React::EventEmitter::Shared &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(const ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics &)layoutMetrics
           oldLayoutMetrics:(const ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics &)oldLayoutMetrics NS_REQUIRES_SUPER;
- (void)finalizeUpdates:(ABI50_0_0RNComponentViewUpdateMask)updateMask NS_REQUIRES_SUPER;
