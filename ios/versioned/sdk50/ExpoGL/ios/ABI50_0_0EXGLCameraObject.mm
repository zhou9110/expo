...
@interface ABI50_0_0EXGLCameraObject () <AVCaptureVideoDataOutputSampleBufferDelegate>

@property (nonatomic, strong) id<ABI50_0_0EXCameraInterface> camera;
...
- (void)captureOutput:(AVCaptureOutput *)output didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection
{
  ...
  if (textureRef) {
    ...
    ABI50_0_0EXGLContextMapObject([self exglCtxId], [self exglObjId], textureName);
  }
