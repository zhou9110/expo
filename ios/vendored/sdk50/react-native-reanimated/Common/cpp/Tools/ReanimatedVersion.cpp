...
#ifdef ABI50_0_0REANIMATED_VERSION
#define STRINGIZE(x) #x
#define STRINGIZE2(x) STRINGIZE(x)
#define ABI50_0_0REANIMATED_VERSION_STRING STRINGIZE2(ABI50_0_0REANIMATED_VERSION)
#endif // ABI50_0_0REANIMATED_VERSION
...
std::string getReanimatedCppVersion() {
  return std::string(ABI50_0_0REANIMATED_VERSION_STRING);
}
