...
@interface ABI50_0_0EXRemoteNotificationPermissionSingletonModule ()

@property (nonatomic, strong) NSPointerArray *delegates;

@end

@implementation ABI50_0_0EXRemoteNotificationPermissionSingletonModule

ABI50_0_0EX_REGISTER_SINGLETON_MODULE(RemoteNotificationPermissionPublisher);
