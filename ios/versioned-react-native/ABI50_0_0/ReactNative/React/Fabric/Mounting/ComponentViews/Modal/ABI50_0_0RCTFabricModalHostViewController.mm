...
@implementation ABI50_0_0RCTFabricModalHostViewController {
...
{
  return [ABI50_0_0RCTSharedApplication() statusBarStyle];
}
...
{
  return [ABI50_0_0RCTSharedApplication() isStatusBarHidden];
}
