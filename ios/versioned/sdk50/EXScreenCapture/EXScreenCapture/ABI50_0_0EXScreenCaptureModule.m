...
@implementation ABI50_0_0EXScreenCaptureModule {
  UIView *_blockView;
}

ABI50_0_0EX_EXPORT_MODULE(ExpoScreenCapture);
...
ABI50_0_0EX_EXPORT_METHOD_AS(preventScreenCapture,
                    preventScreenCaptureWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve
...
ABI50_0_0EX_EXPORT_METHOD_AS(allowScreenCapture,
                    allowScreenCaptureWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve
