...
@implementation ABI50_0_0REAKeyboardEventObserver {
  ABI50_0_0REAUIView *_measuringView;
...
- (ABI50_0_0READisplayLink *)getDisplayLink
{
  ...
  if (!_displayLink) {
    _displayLink = [ABI50_0_0READisplayLink displayLinkWithTarget:self selector:@selector(updateKeyboardFrame)];
#if !TARGET_OS_OSX
