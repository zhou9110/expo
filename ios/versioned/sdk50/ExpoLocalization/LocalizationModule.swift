...
public class LocalizationModule: Module {
  ...
  func setSupportsRTL(_ supportsRTL: Bool) {
    // These keys are used by ABI50_0_0React Native here: https://github.com/facebook/react-native/blob/main/ABI50_0_0React/Modules/ABI50_0_0RCTI18nUtil.m
    // We set them before ABI50_0_0React loads to ensure it gets rendered correctly the first time the app is opened.
    // On iOS we need to set both forceRTL and allowRTL so apps don't have to include localization strings.
    UserDefaults.standard.set(supportsRTL, forKey: "ABI50_0_0RCTI18nUtil_allowRTL")
    UserDefaults.standard.set(supportsRTL ? isRTLPreferredForCurrentLocale() : false, forKey: "ABI50_0_0RCTI18nUtil_forceRTL")
