...
ABI50_0_0RCT_EXTERN NSString *const ABI50_0_0RCTBundleURLProviderUpdatedNotification;
ABI50_0_0RCT_EXTERN const NSUInteger kABI50_0_0RCTBundleURLProviderDefaultPort;
 ...
 * by calling this function before initializing ABI50_0_0React Native (ABI50_0_0RCTBridge etc).
 * By default the access is enabled.
 */
ABI50_0_0RCT_EXTERN void ABI50_0_0RCTBundleURLProviderAllowPackagerServerAccess(BOOL allowed);
#endif

@interface ABI50_0_0RCTBundleURLProvider : NSObject
 ...
 * The port is optional, if not specified, kABI50_0_0RCTBundleURLProviderDefaultPort will be used
 */
