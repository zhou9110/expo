...
internal func ensurePathPermission(_ appContext: AppContext?, path: String, flag: ABI50_0_0EXFileSystemPermissionFlags) throws {
  guard let permissionsManager: ABI50_0_0EXFilePermissionModuleInterface = appContext?.legacyModule(implementing: ABI50_0_0EXFilePermissionModuleInterface.self) else {
