...
import ABI50_0_0EXUpdatesInterface
 ...
 */
@objc(ABI50_0_0EXUpdatesDevLauncherController)
@objcMembers
public final class DevLauncherAppController: NSObject, InternalAppControllerInterface, UpdatesExternalInterface {
  ...
  private static let ErrorDomain = "ABI50_0_0EXUpdatesDevLauncherController"
  ...
  public func requestRelaunch(success successBlockArg: @escaping () -> Void, error errorBlockArg: @escaping (ABI50_0_0ExpoModulesCore.Exception) -> Void) {
    errorBlockArg(NotAvailableInDevClientException())
  }

  public func checkForUpdate(success successBlockArg: @escaping (CheckForUpdateResult) -> Void, error errorBlockArg: @escaping (ABI50_0_0ExpoModulesCore.Exception) -> Void) {
    errorBlockArg(NotAvailableInDevClientException())
  }

  public func fetchUpdate(success successBlockArg: @escaping (FetchUpdateResult) -> Void, error errorBlockArg: @escaping (ABI50_0_0ExpoModulesCore.Exception) -> Void) {
    errorBlockArg(NotAvailableInDevClientException())
  }

  public func getExtraParams(success successBlockArg: @escaping ([String: String]?) -> Void, error errorBlockArg: @escaping (ABI50_0_0ExpoModulesCore.Exception) -> Void) {
    errorBlockArg(NotAvailableInDevClientException())
  }

  public func setExtraParam(key: String, value: String?, success successBlockArg: @escaping () -> Void, error errorBlockArg: @escaping (ABI50_0_0ExpoModulesCore.Exception) -> Void) {
    errorBlockArg(NotAvailableInDevClientException())
  }

  public func getNativeStateMachineContext(success successBlockArg: @escaping (UpdatesStateContext) -> Void, error errorBlockArg: @escaping (ABI50_0_0ExpoModulesCore.Exception) -> Void) {
