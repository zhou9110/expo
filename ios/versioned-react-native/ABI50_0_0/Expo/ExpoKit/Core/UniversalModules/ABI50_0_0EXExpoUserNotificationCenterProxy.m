...
@interface ABI50_0_0EXExpoUserNotificationCenterProxy ()

@property (nonatomic, weak) id<ABI50_0_0EXUserNotificationCenterProxyInterface> userNotificationCenter;

@end

@implementation ABI50_0_0EXExpoUserNotificationCenterProxy
