...
@implementation ABI50_0_0RCTBaseTextInputShadowView {
...
- (instancetype)initWithBridge:(ABI50_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    ABI50_0_0YGNodeSetMeasureFunc(self.yogaNode, ABI50_0_0RCTBaseTextInputShadowViewMeasure);
    ABI50_0_0YGNodeSetBaselineFunc(self.yogaNode, ABI50_0_0RCTTextInputShadowViewBaseline);
  }
...
- (void)uiManagerWillPerformMounting
{
  ...
  ABI50_0_0RCTTextAttributes *textAttributes = [self.textAttributes copy];
  ...
  [attributedText removeAttribute:ABI50_0_0RCTBaseTextShadowViewEmbeddedShadowViewAttributeName
                            range:NSMakeRange(0, attributedText.length)];

  [attributedText removeAttribute:ABI50_0_0RCTTextAttributesTagAttributeName range:NSMakeRange(0, attributedText.length)];
  ...
  [_bridge.uiManager addUIBlock:^(ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ABI50_0_0RCTBaseTextInputView *baseTextInputView = (ABI50_0_0RCTBaseTextInputView *)viewRegistry[tag];
    if (!baseTextInputView) {
      return;
    }

    baseTextInputView.textAttributes = textAttributes;
    baseTextInputView.ABI50_0_0ReactBorderInsets = borderInsets;
    baseTextInputView.ABI50_0_0ReactPaddingInsets = paddingInsets;
...
- (CGSize)sizeThatFitsMinimumSize:(CGSize)minimumSize maximumSize:(CGSize)maximumSize
{
  ...
  return (CGSize){
      MAX(minimumSize.width, MIN(ABI50_0_0RCTCeilPixelValue(size.width), maximumSize.width)),
      MAX(minimumSize.height, MIN(ABI50_0_0RCTCeilPixelValue(size.height), maximumSize.height))};
}
...
static ABI50_0_0YGSize ABI50_0_0RCTBaseTextInputShadowViewMeasure(
    ...
    ABI50_0_0YGMeasureMode heightMode)
{
  ...
  CGSize size = {ABI50_0_0RCTCoreGraphicsFloatFromYogaFloat(width), ABI50_0_0RCTCoreGraphicsFloatFromYogaFloat(height)};
  ...
  return (ABI50_0_0YGSize){
      ABI50_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.width), ABI50_0_0RCTYogaFloatFromCoreGraphicsFloat(measuredSize.height)};
}

static float ABI50_0_0RCTTextInputShadowViewBaseline(ABI50_0_0YGNodeConstRef node, const float width, const float height)
{
  ABI50_0_0RCTBaseTextInputShadowView *shadowTextView = (__bridge ABI50_0_0RCTBaseTextInputShadowView *)ABI50_0_0YGNodeGetContext(node);
