...
typedef void (^ABI50_0_0RNCAsyncStorageCompletion)(NSError *_Nullable error);
typedef void (^ABI50_0_0RNCAsyncStorageResultCallback)(NSArray<id<NSObject>> *valuesOrErrors);

@protocol ABI50_0_0RNCAsyncStorageDelegate <NSObject>

/*!
 * Returns all keys currently stored. If none, an empty array is returned.
 * @param block Block to call with result.
 */
- (void)allKeys:(ABI50_0_0RNCAsyncStorageResultCallback)block;
...
- (void)mergeValues:(NSArray<NSString *> *)values
         ...
         completion:(ABI50_0_0RNCAsyncStorageResultCallback)block;

/*!
 * Removes all values from the store.
 * @param block Block to call with result.
 */
- (void)removeAllValues:(ABI50_0_0RNCAsyncStorageCompletion)block;
 ...
 * @param block Block to call with result.
 */
- (void)valuesForKeys:(NSArray<NSString *> *)keys completion:(ABI50_0_0RNCAsyncStorageResultCallback)block;
