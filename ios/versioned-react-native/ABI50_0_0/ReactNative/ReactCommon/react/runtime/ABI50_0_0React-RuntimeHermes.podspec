...
Pod::Spec.new do |s|
  s.name                   = "ABI50_0_0React-RuntimeHermes"
  s.version                = version
  ...
  s.header_dir             = "ABI50_0_0react/runtime/hermes"
  ...
  if ENV['USE_FRAMEWORKS']
    ...
    s.module_name             = 'ABI50_0_0React_RuntimeHermes'
  end

  s.dependency folly_dep_name, folly_version
  s.dependency "ABI50_0_0React-nativeconfig"
  s.dependency "ABI50_0_0React-jsitracing"
