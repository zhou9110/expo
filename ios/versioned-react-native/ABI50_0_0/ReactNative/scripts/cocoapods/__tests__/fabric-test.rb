...
class FabricTest < Test::Unit::TestCase
    ...
    def check_installed_pods(prefix)
        ...
        check_pod("React-Fabric", :path => "#{prefix}/ReactCommon", :project_name => 'ABI50_0_0')
        check_pod("React-FabricImage", :path => "#{prefix}/ReactCommon", :project_name => 'ABI50_0_0')
        check_pod("React-graphics", :path => "#{prefix}/ReactCommon/react/renderer/graphics", :project_name => 'ABI50_0_0')
        check_pod("React-RCTFabric", :path => "#{prefix}/React", :project_name => 'ABI50_0_0', :modular_headers => true)
        check_pod("RCT-Folly/Fabric", :podspec => "#{prefix}/third-party-podspecs/RCT-Folly.podspec")
        check_pod("React-ImageManager", :path => "#{prefix}/ReactCommon/react/renderer/imagemanager/platform/ios", :project_name => 'ABI50_0_0')
    end
