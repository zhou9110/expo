...
#import <ABI50_0_0ExpoModulesCore/ABI50_0_0EXTaskLaunchReason.h>
...
@protocol ABI50_0_0EXTaskConsumerInterface <NSObject>

@property (nonatomic, strong) id<ABI50_0_0EXTaskInterface> __nullable task;
...
/**
 *  Called by ABI50_0_0EXTaskService when the task is created and associated with the consumer.
 */
- (void)didRegisterTask:(nonnull id<ABI50_0_0EXTaskInterface>)task;
...
/**
 *  Called by ABI50_0_0EXTaskService to inform the consumer that the associated task is ready to be executed with accompanying data.
 */
...
/**
 *  Called by ABI50_0_0EXTaskManager when the task has been completed and we received a result from JS app.
 */
- (void)didFinish;
