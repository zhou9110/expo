...
@implementation ABI50_0_0RCTSyncImageManager {
...
{
  if (self = [super init]) {
    ABI50_0_0RCTAssert(ABI50_0_0RCTRunningInTestEnvironment(), @"This class is only meant to be used in test environment");
...
- (ImageRequest)requestImage:(ImageSource)imageSource surfaceId:(SurfaceId)surfaceId
{
  ...
  if (result != 0) {
    ABI50_0_0RCTLogError(@"Image timed out in test environment for url: %@", loaderRequest.imageURL);
  }
  return imageRequest;
}
