//
//  ABI50_0_0AIRGoogleMapPolygon.h
//
...
@interface ABI50_0_0AIRGoogleMapPolygon : UIView

@property (nonatomic, weak) ABI50_0_0RCTBridge *bridge;
@property (nonatomic, strong) NSString *identifier;
@property (nonatomic, strong) ABI50_0_0AIRGMSPolygon *polygon;
@property (nonatomic, strong) NSArray<ABI50_0_0AIRMapCoordinate *> *coordinates;
@property (nonatomic, strong) NSArray<NSArray<ABI50_0_0AIRMapCoordinate *> *> *holes;
