...
public extension JavaScriptRuntime {
  ...
  func eval(_ source: String) throws -> JavaScriptValue {
    do {
      ...
      try ABI50_0_0EXUtilities.catchException {
  ...
  /**
   ...
   - Note: It refines the ObjC implementation from `ABI50_0_0EXJavaScriptRuntime` to properly catch Swift errors and rethrow them as ObjC `NSError`.
   */
