...
#import <ABI50_0_0React/ABI50_0_0RCTParagraphComponentAccessibilityProvider.h>
...
#import <ABI50_0_0React/renderer/attributedstring/ABI50_0_0TextAttributes.h>
...
#import <ABI50_0_0React/renderer/components/text/ABI50_0_0ParagraphShadowNode.h>
...
#import <ABI50_0_0React/renderer/components/text/ABI50_0_0RawTextShadowNode.h>
#import <ABI50_0_0React/renderer/components/text/ABI50_0_0TextComponentDescriptor.h>
#import <ABI50_0_0React/renderer/components/text/ABI50_0_0TextShadowNode.h>
#import <ABI50_0_0React/renderer/components/view/ABI50_0_0ViewComponentDescriptor.h>
#import <ABI50_0_0React/renderer/element/ABI50_0_0ComponentBuilder.h>
#import <ABI50_0_0React/renderer/element/ABI50_0_0Element.h>
#import <ABI50_0_0React/renderer/element/ABI50_0_0testUtils.h>
...
@interface ABI50_0_0RCTParagraphComponentAccessibilityProviderTests : XCTestCase
...
@implementation ABI50_0_0RCTParagraphComponentAccessibilityProviderTests {
          ...
          .children({
              Element<ParagraphShadowNode>()
                  ...
                  .props([] {
                    ...
                    yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{0, ABI50_0_0YGUnitPoint};
                    yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{0, ABI50_0_0YGUnitPoint};
                    yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(200));
                    yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(200));
                    return sharedProps;
                  })
              ...
              Element<ParagraphShadowNode>()
                  ...
                  .props([] {
                    ...
                    yogaStyle.positionType() = yoga::PositionType::Absolute;
                    yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{0, ABI50_0_0YGUnitPoint};
                    yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{30, ABI50_0_0YGUnitPoint};
                    yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(200));
              ...
              Element<ParagraphShadowNode>()
                  ...
                  .props([] {
                    ...
                    yogaStyle.positionType() = yoga::PositionType::Absolute;
                    yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{0, ABI50_0_0YGUnitPoint};
                    yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{90, ABI50_0_0YGUnitPoint};
                    yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(200));
                    yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(50));
                    return sharedProps;
                  })
...
- (void)testAttributedString
{
  ...
  ABI50_0_0RCTParagraphComponentView *paragraphComponentViewA = [ABI50_0_0RCTParagraphComponentView new];
  ...
  ABI50_0_0RCTParagraphComponentView *paragraphComponentViewB = [ABI50_0_0RCTParagraphComponentView new];
  ...
  ABI50_0_0RCTParagraphComponentView *paragraphComponentViewC = [ABI50_0_0RCTParagraphComponentView new];
...
- (void)testAccessibilityMultipleLinks
{
  ...
  ABI50_0_0RCTParagraphComponentView *paragraphComponentView = [ABI50_0_0RCTParagraphComponentView new];
