...
#include "ABI50_0_0jsireact/ABI50_0_0JSINativeModules.h"
...
std::optional<Object> JSINativeModules::createModule(
  ...
  if (hasLogger) {
    ABI50_0_0ReactMarker::logTaggedMarker(
        ABI50_0_0ReactMarker::NATIVE_MODULE_SETUP_START, name.c_str());
  }
  ...
  if (hasLogger) {
    ABI50_0_0ReactMarker::logTaggedMarker(
        ABI50_0_0ReactMarker::NATIVE_MODULE_SETUP_STOP, name.c_str());
  }
