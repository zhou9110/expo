...
#include "ABI50_0_0NativePerformanceObserver.h"
...
class NativePerformance : public ABI50_0_0NativePerformanceCxxSpec<NativePerformance>,
 ...
 public:
  ...
  // Collect and return the ABI50_0_0RN app startup timing information for performance
  // tracking.
  std::unordered_map<std::string, double> getABI50_0_0ReactNativeStartupTiming(
      jsi::Runtime& rt);
