...
Pod::Spec.new do |s|
  s.name                   = "ABI50_0_0React-CoreModules"
  s.version                = version
  s.summary                = "-"  # TODO
  ...
  s.header_dir             = "ABI50_0_0CoreModules"
  ...
  s.dependency "ABI50_0_0React-Core/CoreModulesHeaders", version
  s.dependency "ABI50_0_0React-RCTImage", version
  s.dependency "ABI50_0_0React-jsi", version
  s.dependency 'ABI50_0_0React-RCTBlob'
