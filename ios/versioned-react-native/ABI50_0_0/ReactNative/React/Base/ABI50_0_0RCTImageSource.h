 ...
 */
@interface ABI50_0_0RCTImageSource : NSObject
...
@interface ABI50_0_0RCTConvert (ImageSource)

+ (ABI50_0_0RCTImageSource *)ABI50_0_0RCTImageSource:(id)json;
+ (NSArray<ABI50_0_0RCTImageSource *> *)ABI50_0_0RCTImageSourceArray:(id)json;
