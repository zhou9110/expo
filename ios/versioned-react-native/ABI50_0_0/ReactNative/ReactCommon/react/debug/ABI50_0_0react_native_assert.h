...
// ABI50_0_0React_native_assert allows us to opt-in to specific asserts on Android and
...
//   2. imply there is a bug in ABI50_0_0React Native when violated.
// For recoverable conditions that can be violated by user mistake (e.g. JS
// code passes an unexpected prop value), consider ABI50_0_0React_native_expect instead.

#include "ABI50_0_0flags.h"

#undef ABI50_0_0React_native_assert

#ifndef ABI50_0_0REACT_NATIVE_DEBUG

#define ABI50_0_0React_native_assert(e) ((void)0)
...
extern "C" {
#endif // __cplusplus
void ABI50_0_0React_native_assert_fail(
    const char* func,
    const char* file,
    int line,
    const char* expr);
...
#define ABI50_0_0React_native_assert(e) \
  ((e) ? (void)0 : ABI50_0_0React_native_assert_fail(__func__, __FILE__, __LINE__, #e))
...
#define ABI50_0_0React_native_assert(cond)                           \
  if (!(cond)) {                                            \
    LOG(ERROR) << "ABI50_0_0React_native_assert failure: " << #cond; \
