...
#include "ABI50_0_0ReactInstance.h"

#include <ABI50_0_0cxxreact/ABI50_0_0ErrorUtils.h>
#include <ABI50_0_0cxxreact/ABI50_0_0JSBigString.h>
#include <ABI50_0_0cxxreact/ABI50_0_0JSExecutor.h>
#include <ABI50_0_0cxxreact/ABI50_0_0SystraceSection.h>
...
#include <ABI50_0_0React/renderer/runtimescheduler/ABI50_0_0RuntimeSchedulerBinding.h>
...
ABI50_0_0ReactInstance::ABI50_0_0ReactInstance(
      ...
      sharedJsMessageQueueThread->runOnQueue(
          [weakRuntime, weakTimerManager, callback = std::move(callback)]() {
            if (auto strongRuntime = weakRuntime.lock()) {
              SystraceSection s("ABI50_0_0ReactInstance::_runtimeExecutor[Callback]");
              try {
                callback(*strongRuntime);
                if (auto strongTimerManager = weakTimerManager.lock()) {
                  strongTimerManager->callABI50_0_0ReactNativeMicrotasks(*strongRuntime);
                }
...
RuntimeExecutor ABI50_0_0ReactInstance::getUnbufferedRuntimeExecutor() noexcept {
...
RuntimeExecutor ABI50_0_0ReactInstance::getBufferedRuntimeExecutor() noexcept {
...
ABI50_0_0ReactInstance::getRuntimeScheduler() noexcept {
 ...
 * ABI50_0_0ReactInstance cannot overwritten by third-party JavaScript code. It also
 ...
 */
void ABI50_0_0ReactInstance::loadScript(
  ...
  runtimeScheduler_->scheduleWork(
      [this,
       ...
       weakBufferedRuntimeExecuter = std::weak_ptr<BufferedRuntimeExecutor>(
        ...
        try {
          SystraceSection s("ABI50_0_0ReactInstance::loadScript");
          bool hasLogger(ABI50_0_0ReactMarker::logTaggedMarkerBridgelessImpl);
          if (hasLogger) {
            ABI50_0_0ReactMarker::logTaggedMarkerBridgeless(
                ABI50_0_0ReactMarker::RUN_JS_BUNDLE_START, scriptName.c_str());
          }

          runtime.evaluateJavaScript(buffer, sourceURL);
          if (hasLogger) {
            ABI50_0_0ReactMarker::logTaggedMarkerBridgeless(
                ABI50_0_0ReactMarker::RUN_JS_BUNDLE_STOP, scriptName.c_str());
            ABI50_0_0ReactMarker::logMarkerBridgeless(
                ABI50_0_0ReactMarker::INIT_REACT_RUNTIME_STOP);
            ABI50_0_0ReactMarker::logMarkerBridgeless(ABI50_0_0ReactMarker::APP_STARTUP_STOP);
          }
 ...
 */
void ABI50_0_0ReactInstance::callFunctionOnModule(
  ...
  bufferedRuntimeExecutor_->execute([=, this](jsi::Runtime& runtime) {
    SystraceSection s(
        "ABI50_0_0ReactInstance::callFunctionOnModule",
        "moduleName",
        moduleName,
        "methodName",
        methodName);
    if (modules_.find(moduleName) == modules_.end()) {
      ...
      throw jsi::JSError(
          ...
          "Failed to call into JavaScript module method " + moduleName + "." +
              ...
              ". Did you forget to call `ABI50_0_0RN$registerCallableModule`?");
    }
...
void ABI50_0_0ReactInstance::registerSegment(
    uint32_t segmentId,
    const std::string& segmentPath) {
  LOG(WARNING) << "Starting to run ABI50_0_0ReactInstance::registerSegment with segment "
               << segmentId;
  runtimeScheduler_->scheduleWork([=](jsi::Runtime& runtime) {
    SystraceSection s("ABI50_0_0ReactInstance::registerSegment");
    ...
    if (hasLogger) {
      ABI50_0_0ReactMarker::logTaggedMarkerBridgeless(
          ABI50_0_0ReactMarker::REGISTER_JS_SEGMENT_START, tag.c_str());
    }
    LOG(WARNING) << "Starting to evaluate segment " << segmentId
                 << " in ABI50_0_0ReactInstance::registerSegment";
    ...
    if (hasLogger) {
      ABI50_0_0ReactMarker::logTaggedMarkerBridgeless(
          ABI50_0_0ReactMarker::REGISTER_JS_SEGMENT_STOP, tag.c_str());
    }
  });
}

namespace {
void defineABI50_0_0ReactInstanceFlags(
    jsi::Runtime& runtime,
    ABI50_0_0ReactInstance::JSRuntimeFlags options) noexcept {
  defineReadOnlyGlobal(runtime, "ABI50_0_0RN$Bridgeless", jsi::Value(true));

  if (options.isProfiling) {
    defineReadOnlyGlobal(runtime, "__ABI50_0_0RCTProfileIsProfiling", jsi::Value(true));
  }

  if (options.runtimeDiagnosticFlags.length() > 0) {
    defineReadOnlyGlobal(
        runtime,
        "ABI50_0_0RN$DiagnosticFlags",
...
void ABI50_0_0ReactInstance::initializeRuntime(
  ...
  runtimeScheduler_->scheduleWork([this, options, bindingsInstallFunc](
                                      jsi::Runtime& runtime) {
    SystraceSection s("ABI50_0_0ReactInstance::initializeRuntime");
    ...
    defineABI50_0_0ReactInstanceFlags(runtime, options);

    defineReadOnlyGlobal(
        runtime,
        "ABI50_0_0RN$registerCallableModule",
...
void ABI50_0_0ReactInstance::handleMemoryPressureJs(int pressureLevel) {
  ...
  switch (pressureLevel) {
    ...
    case TRIM_MEMORY_RUNNING_CRITICAL:
      ...
      runtimeScheduler_->scheduleWork([=](jsi::Runtime& runtime) {
        SystraceSection s("ABI50_0_0ReactInstance::handleMemoryPressure");
