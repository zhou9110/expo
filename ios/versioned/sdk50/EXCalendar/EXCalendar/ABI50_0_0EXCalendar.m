...
#import <ABI50_0_0EXCalendar/ABI50_0_0EXCalendar.h>
#import <ABI50_0_0EXCalendar/ABI50_0_0EXCalendarConverter.h>
...
@implementation ABI50_0_0EXCalendar
...
ABI50_0_0EX_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI50_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI50_0_0EXPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI50_0_0EXCalendarPermissionRequester new],
                                                    [ABI50_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI50_0_0EX_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI50_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI50_0_0EX_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejector:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkCalendarPermissions:reject]) {
    return;
  }
  ...
  resolve([ABI50_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI50_0_0EX_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI50_0_0EXUtilities UIColor:color].CGColor;
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI50_0_0EXUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI50_0_0EXUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI50_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI50_0_0EX_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI50_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI50_0_0EX_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI50_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI50_0_0EXUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI50_0_0EXUtilities NSDate:details[@"instanceStartDate"]];
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI50_0_0EXUtilities NSDate:event[@"instanceStartDate"]];
...
ABI50_0_0EX_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI50_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI50_0_0EX_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI50_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI50_0_0EX_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI50_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI50_0_0EX_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI50_0_0EXUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI50_0_0EXUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI50_0_0EXUtilities NSDate:details[@"completionDate"]];
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI50_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI50_0_0EX_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve([ABI50_0_0EXCalendarConverter serializeSource:source]);
}

ABI50_0_0EX_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI50_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI50_0_0EX_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
...
ABI50_0_0EX_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI50_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI50_0_0EX_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI50_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI50_0_0EXUtilities NSDate:alarm[@"absoluteDate"]];
...
- (EKRecurrenceRule *)_createRecurrenceRule:(NSDictionary *)recurrenceRule
{
  ...
  if (recurrenceRule[@"endDate"]) {
      endDate = [ABI50_0_0EXUtilities NSDate:recurrenceRule[@"endDate"]];
  }
...
- (BOOL)_checkPermissions:(EKEntityType)entity reject:(ABI50_0_0EXPromiseRejectBlock)reject
{
  ...
  switch (entity) {
    case EKEntityTypeEvent:
      requesterClass = [ABI50_0_0EXCalendarPermissionRequester class];
      break;
    case EKEntityTypeReminder:
      requesterClass = [ABI50_0_0EXRemindersPermissionRequester class];
      break;
    default: {
...
- (BOOL)_checkCalendarPermissions:(ABI50_0_0EXPromiseRejectBlock)reject
{
  return [self _checkPermissions:EKEntityTypeEvent reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI50_0_0EXPromiseRejectBlock)reject
{
...
- (void)_initializePermittedEntities
{
  ...
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI50_0_0EXCalendarPermissionRequester class]]) {
    permittedEntities |= EKEntityMaskEvent;
  }
  
  if ([_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI50_0_0EXRemindersPermissionRequester class]]) {
