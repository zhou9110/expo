...
// Register a subclass of this class in ABI50_0_0EXModuleRegistryProvider
...
@interface ABI50_0_0EXExportedModule : NSObject <ABI50_0_0EXInternalModule, NSCopying>

- (NSDictionary *)constantsToExport;
+ (const NSString *)exportedModuleName;
- (NSDictionary<NSString *, NSString *> *)getExportedMethods;
- (void)callExportedMethod:(NSString *)methodName withArguments:(NSArray *)arguments resolver:(ABI50_0_0EXPromiseResolveBlock)resolver rejecter:(ABI50_0_0EXPromiseRejectBlock)rejecter;
