 ...
 *
 *   ABI50_0_0EXUpdatesReleaseChannel
 *   ABI50_0_0EXUpdatesURL
 *
 * and all of the values in json
 *
 *   ABI50_0_0EXUpdatesRequestHeaders
 */
internal final class UpdatesBuildData {
  ...
  static func getBuildDataFromConfig(_ config: UpdatesConfig) -> [String: Any] {
    return [
      "ABI50_0_0EXUpdatesURL": config.updateUrl.absoluteString,
      "ABI50_0_0EXUpdatesReleaseChannel": config.releaseChannel,
      "ABI50_0_0EXUpdatesRequestHeaders": config.requestHeaders
    ]
  }
