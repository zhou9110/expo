...
ABI50_0_0RNSkDomRenderer::ABI50_0_0RNSkDomRenderer(std::function<void()> requestRedraw,
                                 std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
    : ABI50_0_0RNSkRenderer(requestRedraw), _platformContext(std::move(context)),
...
ABI50_0_0RNSkDomRenderer::~ABI50_0_0RNSkDomRenderer() {
  if (_root != nullptr) {
    _root->dispose(true);
    _root = nullptr;
  }
...
bool ABI50_0_0RNSkDomRenderer::tryRender(
  ...
  if (_renderLock->try_lock()) {
    ...
    if (_root != nullptr) {
      result = canvasProvider->renderToCanvas(std::bind(
          &ABI50_0_0RNSkDomRenderer::renderCanvas, this, std::placeholders::_1,
...
void ABI50_0_0RNSkDomRenderer::renderImmediate(
    std::shared_ptr<ABI50_0_0RNSkCanvasProvider> canvasProvider) {
...
void ABI50_0_0RNSkDomRenderer::setRoot(std::shared_ptr<JsiDomRenderNode> node) {
...
void ABI50_0_0RNSkDomRenderer::setOnTouchCallback(
    std::shared_ptr<jsi::Function> onTouchCallback) {
  _touchCallback = onTouchCallback;
}

void ABI50_0_0RNSkDomRenderer::renderCanvas(SkCanvas *canvas, float scaledWidth,
                                   float scaledHeight) {
...
void ABI50_0_0RNSkDomRenderer::updateTouches(std::vector<ABI50_0_0RNSkTouchInfo> &touches) {
...
void ABI50_0_0RNSkDomRenderer::callOnTouch() {
...
void ABI50_0_0RNSkDomRenderer::renderDebugOverlays(SkCanvas *canvas) {
