...
#import <ABI50_0_0EXNotifications/ABI50_0_0EXServerRegistrationModule.h>

// noop (used by code transform to ensure the versioning isn't applied)
#define ABI50_0_0EX_UNVERSIONED(symbol) symbol

static NSString * const kEXDeviceInstallationUUIDKey = ABI50_0_0EX_UNVERSIONED(@"ABI50_0_0EXDeviceInstallationUUIDKey");
static NSString * const kEXDeviceInstallationUUIDLegacyKey = ABI50_0_0EX_UNVERSIONED(@"ABI50_0_0EXDeviceInstallUUIDKey");

static NSString * const kEXRegistrationInfoKey = ABI50_0_0EX_UNVERSIONED(@"ABI50_0_0EXNotificationRegistrationInfoKey");

@implementation ABI50_0_0EXServerRegistrationModule

ABI50_0_0EX_EXPORT_MODULE(NotificationsServerRegistrationModule)

ABI50_0_0EX_EXPORT_METHOD_AS(getInstallationIdAsync,
                    getInstallationIdAsyncWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve
...
ABI50_0_0EX_EXPORT_METHOD_AS(getRegistrationInfoAsync,
                    getRegistrationInfoAsyncWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve
                                                rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  CFTypeRef keychainResult = NULL;
...
ABI50_0_0EX_EXPORT_METHOD_AS(setRegistrationInfoAsync,
