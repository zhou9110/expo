...
@implementation ABI50_0_0RNSVGLine
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNSVGLineProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNSVGLineComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = static_cast<const ABI50_0_0RNSVGLineProps &>(*props);
  ...
  _props = std::static_pointer_cast<ABI50_0_0RNSVGLineProps const>(props);
}
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNSVGLineCls(void)
{
  return ABI50_0_0RNSVGLine.class;
}
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
