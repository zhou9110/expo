...
@interface ABI50_0_0RCTGIFCoderFrame : NSObject
...
@implementation ABI50_0_0RCTGIFCoderFrame
@end

@implementation ABI50_0_0RCTAnimatedImage {
  CGImageSourceRef _imageSource;
  CGFloat _scale;
  NSUInteger _loopCount;
  NSUInteger _frameCount;
  NSArray<ABI50_0_0RCTGIFCoderFrame *> *_frames;
}
...
- (BOOL)scanAndCheckFramesValidWithSource:(CGImageSourceRef)imageSource
{
  ...
  NSMutableArray<ABI50_0_0RCTGIFCoderFrame *> *frames = [NSMutableArray array];

  for (size_t i = 0; i < frameCount; i++) {
    ABI50_0_0RCTGIFCoderFrame *frame = [ABI50_0_0RCTGIFCoderFrame new];
    frame.index = i;
