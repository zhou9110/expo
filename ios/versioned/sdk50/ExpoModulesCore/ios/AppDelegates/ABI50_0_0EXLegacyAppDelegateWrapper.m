...
@implementation ABI50_0_0EXLegacyAppDelegateWrapper
...
- (void)ensureSubcontractorsAreInitializedAndSorted {
  dispatch_once(&onceToken, ^{
    ...
    NSArray<ABI50_0_0EXSingletonModule*> * singletonModules = [[ABI50_0_0EXModuleRegistryProvider singletonModules] allObjects];
    
    for (ABI50_0_0EXSingletonModule *singletonModule in singletonModules) {
