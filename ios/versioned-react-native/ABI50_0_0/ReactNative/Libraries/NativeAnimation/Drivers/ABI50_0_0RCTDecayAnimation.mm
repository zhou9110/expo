...
@interface ABI50_0_0RCTDecayAnimation ()
...
@implementation ABI50_0_0RCTDecayAnimation {
  CGFloat _velocity;
                  ...
                  callBack:(nullable ABI50_0_0RCTResponseSenderBlock)callback
{
  if ((self = [super init])) {
    ...
    _fromValue = 0;
    _lastValue = 0;
    _velocity = [ABI50_0_0RCTConvert CGFloat:config[@"velocity"]]; // initial velocity
...
- (void)resetAnimationConfig:(NSDictionary *)config
{
  ...
  _deceleration = [ABI50_0_0RCTConvert CGFloat:config[@"deceleration"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  if (_frameStartTime == -1) {
    ...
    _frameStartTime = currentTime - ABI50_0_0RCTSingleFrameInterval;
  ...
  CGFloat value = _fromValue +
      (_velocity / (1 - _deceleration)) *
          (1 - exp(-(1 - _deceleration) * (currentTime - _frameStartTime) * 1000.0 / ABI50_0_0RCTAnimationDragCoefficient()));
