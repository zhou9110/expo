...
public final class BareUpdate: Update {
  ...
  public static func update(
    ...
    let jsBundleAsset = UpdateAsset(key: bundleKey, type: EmbeddedAppLoader.ABI50_0_0EXUpdatesBareEmbeddedBundleFileType)
    jsBundleAsset.isLaunchAsset = true
    jsBundleAsset.mainBundleFilename = EmbeddedAppLoader.ABI50_0_0EXUpdatesBareEmbeddedBundleFilename
