...
#import "ABI50_0_0RCTImageComponentView.h"
...
#import <ABI50_0_0React/renderer/components/image/ABI50_0_0ImageComponentDescriptor.h>
#import <ABI50_0_0React/renderer/components/image/ABI50_0_0ImageEventEmitter.h>
#import <ABI50_0_0React/renderer/components/image/ABI50_0_0ImageProps.h>
#import <ABI50_0_0React/renderer/imagemanager/ABI50_0_0ImageRequest.h>
#import <ABI50_0_0React/renderer/imagemanager/ABI50_0_0RCTImagePrimitivesConversions.h>
#import <ABI50_0_0React/utils/ABI50_0_0CoreFeatures.h>

using namespace ABI50_0_0facebook::ABI50_0_0React;

@implementation ABI50_0_0RCTImageComponentView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _imageView.contentMode = ABI50_0_0RCTContentModeFromImageResizeMode(defaultProps->resizeMode);
...
- (void)updateProps:(const Props::Shared &)props oldProps:(const Props::Shared &)oldProps
{
  ...
  if (oldImageProps.resizeMode != newImageProps.resizeMode) {
    _imageView.contentMode = ABI50_0_0RCTContentModeFromImageResizeMode(newImageProps.resizeMode);
  }

  // `tintColor`
  if (oldImageProps.tintColor != newImageProps.tintColor) {
    _imageView.tintColor = ABI50_0_0RCTUIColorFromSharedColor(newImageProps.tintColor);
  }
...
- (void)_setStateAndResubscribeImageResponseObserver:(const ImageShadowNode::ConcreteState::Shared &)state
{
  if (_state) {
    ...
    if (CoreFeatures::cancelImageDownloadsOnRecycle) {
      ...
      // re-create ABI50_0_0RCTImageComponentView with the same image and if it
...
- (void)didReceiveImage:(UIImage *)image metadata:(id)metadata fromObserver:(const void *)observer
{
  ...
  if (imageProps.resizeMode == ImageResizeMode::Repeat) {
    image = [image resizableImageWithCapInsets:ABI50_0_0RCTUIEdgeInsetsFromEdgeInsets(imageProps.capInsets)
  ...
  if (imageProps.blurRadius > __FLT_EPSILON__) {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
      UIImage *blurredImage = ABI50_0_0RCTBlurredImageWithRadius(image, blurRadius);
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTImageCls(void);
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTImageCls(void)
{
  return ABI50_0_0RCTImageComponentView.class;
}
