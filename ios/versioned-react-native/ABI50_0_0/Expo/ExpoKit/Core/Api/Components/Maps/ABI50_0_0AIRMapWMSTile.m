...
@implementation ABI50_0_0AIRMapWMSTile
...
- (void)createTileOverlayAndRendererIfPossible
{
    ...
    if (_tileCachePathSet || _maximumNativeZSet) {
        ...
        self.tileOverlay = [[ABI50_0_0AIRMapWMSTileCachedOverlay alloc] initWithURLTemplate:self.urlTemplate];
        ...
        self.tileOverlay = [[ABI50_0_0AIRMapWMSTileOverlay alloc] initWithURLTemplate:self.urlTemplate];
...
@implementation ABI50_0_0AIRMapWMSTileOverlay
...
{
   return [ABI50_0_0AIRMapWMSTileHelper URLForTilePath:path withURLTemplate:self.URLTemplate withTileSize:self.tileSize.width];
}

@end


@implementation ABI50_0_0AIRMapWMSTileCachedOverlay
...
@implementation ABI50_0_0AIRMapWMSTileHelper 
