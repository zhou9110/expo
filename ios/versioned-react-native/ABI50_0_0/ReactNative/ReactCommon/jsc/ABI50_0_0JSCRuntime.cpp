...
#ifdef ABI50_0_0RN_FABRIC_ENABLED
...
#define JSC_LIKELY(ABI50_0_0EXPR) __builtin_expect((bool)(ABI50_0_0EXPR), true)
#define JSC_UNLIKELY(ABI50_0_0EXPR) __builtin_expect((bool)(ABI50_0_0EXPR), false)
#else
#define JSC_LIKELY(ABI50_0_0EXPR) (ABI50_0_0EXPR)
#define JSC_UNLIKELY(ABI50_0_0EXPR) (ABI50_0_0EXPR)
#endif
