...
#import <ABI50_0_0React/ABI50_0_0RCTDisplayWeakRefreshable.h>
#import <ABI50_0_0React/ABI50_0_0RCTUIImageViewAnimated.h>

#import <mach/mach.h>
#import <objc/runtime.h>

static NSUInteger ABI50_0_0RCTDeviceTotalMemory(void)
{
  return (NSUInteger)[[NSProcessInfo processInfo] physicalMemory];
}

static NSUInteger ABI50_0_0RCTDeviceFreeMemory(void)
{
...
@interface ABI50_0_0RCTUIImageViewAnimated () <CALayerDelegate, ABI50_0_0RCTDisplayRefreshable>
...
@property (nonatomic, strong) UIImage<ABI50_0_0RCTAnimatedImage> *animatedImage;
...
@implementation ABI50_0_0RCTUIImageViewAnimated
...
- (void)setImage:(UIImage *)image
{
  ...
  if ([image respondsToSelector:@selector(animatedImageFrameAtIndex:)]) {
    NSUInteger animatedImageFrameCount = ((UIImage<ABI50_0_0RCTAnimatedImage> *)image).animatedImageFrameCount;
    ...
    self.animatedImage = (UIImage<ABI50_0_0RCTAnimatedImage> *)image;
...
- (CADisplayLink *)displayLink
{
  ...
  // of the use cases. Since this class is used for all ABI50_0_0RCTImageView's, this is especially important.
  if (!_animatedImage) {
    return nil;
  }

  if (!_displayLink) {
    _displayLink = [ABI50_0_0RCTDisplayWeakRefreshable displayLinkWithWeakRefreshable:self];
...
- (void)displayDidRefresh:(CADisplayLink *)displayLink
{
  ...
  if (!fetchFrame && !bufferFull && self.fetchQueue.operationCount == 0) {
    ...
    UIImage<ABI50_0_0RCTAnimatedImage> *animatedImage = self.animatedImage;
...
- (void)calculateMaxBufferCount
{
  ...
  if (self.maxBufferSize > 0) {
    ...
    NSUInteger total = ABI50_0_0RCTDeviceTotalMemory();
    NSUInteger free = ABI50_0_0RCTDeviceFreeMemory();
