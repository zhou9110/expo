//
//  ABI50_0_0RCTConvert+GMSMapViewType.m
//
...
@implementation ABI50_0_0RCTConvert (GMSMapViewType)
  ABI50_0_0RCT_ENUM_CONVERTER(GMSMapViewType,
  (
    @{
...
+ (GMSCameraPosition*)GMSCameraPosition:(id)json
{
    ...
    return [ABI50_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:nil];
}
