...
#include <ABI50_0_0React/renderer/animations/ABI50_0_0LayoutAnimationDriver.h>
#include <ABI50_0_0React/renderer/componentregistry/ABI50_0_0ComponentDescriptorProvider.h>
...
#include <ABI50_0_0React/test_utils/ABI50_0_0Entropy.h>
    ...
    for (int j = 0; j < stages; j++) {
      ...
      for (int k = 0; k < animation_frames + 2; k++) {
        ...
        if (k != (animation_frames + 1)) {
          ABI50_0_0EXPECT_TRUE(animationDriver->shouldOverridePullTransaction());
        } else if (!commits_conflicting_mutations) {
          ABI50_0_0EXPECT_FALSE(animationDriver->shouldOverridePullTransaction());
        }
        ...
        ABI50_0_0EXPECT_TRUE(transaction.has_value() || k == animation_frames);
