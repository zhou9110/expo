...
@protocol ABI50_0_0RCTAutoInsetsProtocol;

@interface ABI50_0_0RCTView : UIView

/**
 * Accessibility event handlers
 */
@property (nonatomic, copy) ABI50_0_0RCTDirectEventBlock onAccessibilityAction;
@property (nonatomic, copy) ABI50_0_0RCTDirectEventBlock onAccessibilityTap;
@property (nonatomic, copy) ABI50_0_0RCTDirectEventBlock onMagicTap;
@property (nonatomic, copy) ABI50_0_0RCTDirectEventBlock onAccessibilityEscape;

/**
 * Used to control how touch events are processed.
 */
@property (nonatomic, assign) ABI50_0_0RCTPointerEvents pointerEvents;
 ...
 * Border curve.
 */
@property (nonatomic, assign) ABI50_0_0RCTBorderCurve borderCurve;

/**
 * Border styles.
 */
@property (nonatomic, assign) ABI50_0_0RCTBorderStyle borderStyle;
...
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onPointerCancel;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onPointerDown;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onPointerMove;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onPointerUp;
@property (nonatomic, assign) ABI50_0_0RCTCapturingEventBlock onPointerEnter;
@property (nonatomic, assign) ABI50_0_0RCTCapturingEventBlock onPointerLeave;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onPointerOver;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onPointerOut;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onGotPointerCapture;
@property (nonatomic, assign) ABI50_0_0RCTBubblingEventBlock onLostPointerCapture;
