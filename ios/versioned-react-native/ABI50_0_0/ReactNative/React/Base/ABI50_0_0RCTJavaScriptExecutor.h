...
typedef void (^ABI50_0_0RCTJavaScriptCompleteBlock)(NSError *error);
typedef void (^ABI50_0_0RCTJavaScriptCallback)(id result, NSError *error);

/**
 * Abstracts away a JavaScript execution context - we may be running code in a
 * web view (for debugging purposes), or may be running code in a `JSContext`.
 */
@protocol ABI50_0_0RCTJavaScriptExecutor <ABI50_0_0RCTInvalidating, ABI50_0_0RCTBridgeModule>
