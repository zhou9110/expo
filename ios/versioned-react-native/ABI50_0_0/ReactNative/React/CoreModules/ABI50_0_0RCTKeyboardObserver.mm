...
#import "ABI50_0_0RCTKeyboardObserver.h"
...
static NSDictionary *ABI50_0_0RCTParseKeyboardNotification(NSNotification *notification);

@interface ABI50_0_0RCTKeyboardObserver () <ABI50_0_0NativeKeyboardObserverSpec>
@end

@implementation ABI50_0_0RCTKeyboardObserver
...
#define IMPLEMENT_KEYBOARD_HANDLER(EVENT)                                              \
  ...
  {                                                                                    \
    ...
    [self sendEventWithName:@ #EVENT body:ABI50_0_0RCTParseKeyboardNotification(notification)]; \
  }
...
{
  return std::make_shared<ABI50_0_0facebook::ABI50_0_0React::NativeKeyboardObserverSpecJSI>(params);
}

@end

NS_INLINE NSDictionary *ABI50_0_0RCTRectDictionaryValue(CGRect rect)
{
  return @{
...
static NSString *ABI50_0_0RCTAnimationNameForCurve(UIViewAnimationCurve curve)
{
  switch (curve) {
...
static NSDictionary *ABI50_0_0RCTParseKeyboardNotification(NSNotification *notification)
{
  ...
  return @{
    @"startCoordinates" : ABI50_0_0RCTRectDictionaryValue(beginFrame),
    @"endCoordinates" : ABI50_0_0RCTRectDictionaryValue(endFrame),
    @"duration" : @(duration * 1000.0), // ms
    @"easing" : ABI50_0_0RCTAnimationNameForCurve(curve),
    @"isEventFromThisApp" : isLocalUserInfoKey == 1 ? @YES : @NO,
  };
}

Class ABI50_0_0RCTKeyboardObserverCls(void)
{
  return ABI50_0_0RCTKeyboardObserver.class;
}
