 ...
 * are also bridge modules, so should be registered using ABI50_0_0RCT_EXPORT_MODULE().
 */
@protocol ABI50_0_0RCTURLRequestHandler <ABI50_0_0RCTBridgeModule>
...
/**
 * If more than one ABI50_0_0RCTURLRequestHandler responds YES to `canHandleRequest:`
