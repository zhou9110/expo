...
@implementation ABI50_0_0EXBarCodeScannerUtils
...
+ (NSDictionary *)ciQRCodeFeatureToDicitionary:(CIQRCodeFeature *)barCodeScannerResult barCodeType:(NSString *)type
{
  ...
  if (!CGRectIsEmpty(barCodeScannerResult.bounds)) {
    ...
    [ABI50_0_0EXBarCodeScannerUtils addEmptyCornerPoints:result];
  }
...
{
  NSMutableDictionary *result = [NSMutableDictionary new];
  result[@"type"] = [ABI50_0_0EXBarCodeScannerUtils zxingFormatToString:barCodeScannerResult.barcodeFormat];
