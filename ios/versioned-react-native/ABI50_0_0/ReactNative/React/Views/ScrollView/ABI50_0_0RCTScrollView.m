...
#import "ABI50_0_0RCTScrollEvent.h"
 ...
 */
@interface ABI50_0_0RCTCustomScrollView : UIScrollView <UIGestureRecognizerDelegate>

@property (nonatomic, assign) BOOL centerContent;
@property (nonatomic, strong) UIView<ABI50_0_0RCTCustomRefreshControlProtocol> *customRefreshControl;
@property (nonatomic, assign) BOOL pinchGestureEnabled;

@end

@implementation ABI50_0_0RCTCustomScrollView
...
- (UIView *)contentView
{
  return ((ABI50_0_0RCTScrollView *)self.superview).contentView;
}
...
- (BOOL)_shouldDisableScrollInteraction
{
  ...
  UIView *JSResponder = [ABI50_0_0RCTUIManager JSResponder];
...
{
  if ([self _shouldDisableScrollInteraction] && ![[ABI50_0_0RCTUIManager JSResponder] isKindOfClass:[ABI50_0_0RCTScrollView class]]) {
 ...
 * touch started inside of a `UIControl` (`UIButton` etc). For ABI50_0_0React scroll
...
- (void)setContentOffset:(CGPoint)contentOffset
{
  ...
  super.contentOffset = CGPointMake(
      ABI50_0_0RCTSanitizeNaNValue(contentOffset.x, @"scrollView.contentOffset.x"),
      ABI50_0_0RCTSanitizeNaNValue(contentOffset.y, @"scrollView.contentOffset.y"));
}
...
- (void)setCustomRefreshControl:(UIView<ABI50_0_0RCTCustomRefreshControlProtocol> *)refreshControl
{
  ...
  // `ABI50_0_0RCTCustomRefreshControlProtocol`'s superview will always be of class
...
@interface ABI50_0_0RCTScrollView () <ABI50_0_0RCTUIManagerObserver>

@end

@implementation ABI50_0_0RCTScrollView {
  id<ABI50_0_0RCTEventDispatcherProtocol> _eventDispatcher;
  CGRect _prevFirstVisibleFrame;
  __weak UIView *_firstVisibleView;
  ABI50_0_0RCTCustomScrollView *_scrollView;
  UIView *_contentView;
...
- (void)_keyboardWillChangeFrame:(NSNotification *)notification
{
  ...
  if ([[UIApplication sharedApplication] sendAction:@selector(ABI50_0_0ReactUpdateResponderOffsetForScrollView:)
                                                 to:nil
                                               from:self
                                           forEvent:nil]) {
  ...
  if (@available(iOS 14.0, *)) {
    ...
    // Fixes similar issue we saw with https://github.com/facebook/ABI50_0_0React-native/pull/34503
...
- (instancetype)initWithEventDispatcher:(id<ABI50_0_0RCTEventDispatcherProtocol>)eventDispatcher
{
  ABI50_0_0RCTAssertParam(eventDispatcher);

  if ((self = [super initWithFrame:CGRectZero])) {
    [self _registerKeyboardListener];
    _eventDispatcher = eventDispatcher;

    _scrollView = [[ABI50_0_0RCTCustomScrollView alloc] initWithFrame:CGRectZero];
...
static inline void ABI50_0_0RCTApplyTransformationAccordingLayoutDirection(
    UIView *view,
...
{
  [super setABI50_0_0ReactLayoutDirection:layoutDirection];

  ABI50_0_0RCTApplyTransformationAccordingLayoutDirection(_scrollView, layoutDirection);
  ABI50_0_0RCTApplyTransformationAccordingLayoutDirection(_contentView, layoutDirection);
}
...
- (void)insertABI50_0_0ReactSubview:(UIView *)view atIndex:(NSInteger)atIndex
{
  [super insertABI50_0_0ReactSubview:view atIndex:atIndex];
  if ([view conformsToProtocol:@protocol(ABI50_0_0RCTCustomRefreshControlProtocol)]) {
    [_scrollView setCustomRefreshControl:(UIView<ABI50_0_0RCTCustomRefreshControlProtocol> *)view];
    ...
    ABI50_0_0RCTAssert(
        _contentView == nil,
        @"ABI50_0_0RCTScrollView may only contain a single subview, the already set subview looks like: %@",
        [_contentView ABI50_0_0React_recursiveDescription]);
    _contentView = view;
    ABI50_0_0RCTApplyTransformationAccordingLayoutDirection(_contentView, self.ABI50_0_0ReactLayoutDirection);
...
- (void)removeABI50_0_0ReactSubview:(UIView *)subview
{
  ...
  if ([subview conformsToProtocol:@protocol(ABI50_0_0RCTCustomRefreshControlProtocol)]) {
    ...
    ABI50_0_0RCTAssert(_contentView == subview, @"Attempted to remove non-existent subview");
    _contentView = nil;
  }
}
...
- (void)layoutSubviews
{
  ...
  ABI50_0_0RCTAssert(self.subviews.count == 1, @"we should only have exactly one subview");
  ABI50_0_0RCTAssert([self.subviews lastObject] == _scrollView, @"our only subview should be a scrollview");

#if !TARGET_OS_TV
  // Adjust the refresh control frame if the scrollview layout changes.
  UIView<ABI50_0_0RCTCustomRefreshControlProtocol> *refreshControl = _scrollView.customRefreshControl;
...
- (void)updateClippedSubviews
{
  ...
  if (shouldClipAgain) {
    ...
    [self ABI50_0_0React_updateClippedSubviewsWithClipRect:clipRect relativeToView:clipView];
...
- (void)setContentInset:(UIEdgeInsets)contentInset
{
  ...
  [ABI50_0_0RCTView autoAdjustInsetsForView:self withScrollView:_scrollView updateOffset:NO];
...
{
  [ABI50_0_0RCTView autoAdjustInsetsForView:self withScrollView:_scrollView updateOffset:YES];
}

#pragma mark - ScrollView delegate

#define ABI50_0_0RCT_SEND_SCROLL_EVENT(_eventName, _userData)                                    \
  {                                                                                     \
...
#define ABI50_0_0RCT_FORWARD_SCROLL_EVENT(call)                                            \
...
#define ABI50_0_0RCT_SCROLL_EVENT_HANDLER(delegateMethod, eventName) \
  -(void)delegateMethod : (UIScrollView *)scrollView        \
  {                                                         \
    ABI50_0_0RCT_SEND_SCROLL_EVENT(eventName, nil);                  \
    ABI50_0_0RCT_FORWARD_SCROLL_EVENT(delegateMethod : scrollView);  \
  }

ABI50_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewWillBeginDecelerating, onMomentumScrollBegin)
ABI50_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewDidZoom, onScroll)
ABI50_0_0RCT_SCROLL_EVENT_HANDLER(scrollViewDidScrollToTop, onScrollToTop)
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  ...
  if (_allowNextScrollNoMatterWhat ||
    ...
    ABI50_0_0RCT_SEND_SCROLL_EVENT(onScroll, nil);
    // Update dispatch time
    _lastScrollDispatchTime = now;
    _allowNextScrollNoMatterWhat = NO;
  }
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidScroll : scrollView);
}

- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
  _allowNextScrollNoMatterWhat = YES; // Ensure next scroll event is recorded, regardless of throttle
  ABI50_0_0RCT_SEND_SCROLL_EVENT(onScrollBeginDrag, nil);
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillBeginDragging : scrollView);
}
              ...
              targetContentOffset:(inout CGPoint *)targetContentOffset
{
  ...
  ABI50_0_0RCT_SEND_SCROLL_EVENT(onScrollEndDrag, userData);
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillEndDragging
...
{
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndDragging : scrollView willDecelerate : decelerate);
}

- (void)scrollViewWillBeginZooming:(UIScrollView *)scrollView withView:(UIView *)view
{
  ABI50_0_0RCT_SEND_SCROLL_EVENT(onScrollBeginDrag, nil);
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewWillBeginZooming : scrollView withView : view);
}

- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(UIView *)view atScale:(CGFloat)scale
{
  ABI50_0_0RCT_SEND_SCROLL_EVENT(onScrollEndDrag, nil);
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndZooming : scrollView withView : view atScale : scale);
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
  ...
  ABI50_0_0RCT_SEND_SCROLL_EVENT(onMomentumScrollEnd, nil);
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndDecelerating : scrollView);
}
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
  ...
  // Fire the end deceleration event
  ABI50_0_0RCT_SEND_SCROLL_EVENT(onMomentumScrollEnd, nil);
  ABI50_0_0RCT_FORWARD_SCROLL_EVENT(scrollViewDidEndScrollingAnimation : scrollView);
}
...
- (CGSize)_calculateViewportSize
{
  ...
  if (_automaticallyAdjustContentInsets) {
    UIEdgeInsets contentInsets = ABI50_0_0RCTContentInsets(self);
...
- (void)uiManagerWillPerformMounting:(ABI50_0_0RCTUIManager *)manager
{
  ...
  [manager prependUIBlock:^(
               __unused ABI50_0_0RCTUIManager *uiManager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
  ...
  [manager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
#define ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setter, getter, type) \
...
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setAlwaysBounceHorizontal, alwaysBounceHorizontal, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setAlwaysBounceVertical, alwaysBounceVertical, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setBounces, bounces, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setBouncesZoom, bouncesZoom, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setCanCancelContentTouches, canCancelContentTouches, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setDecelerationRate, decelerationRate, CGFloat)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setDirectionalLockEnabled, isDirectionalLockEnabled, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setIndicatorStyle, indicatorStyle, UIScrollViewIndicatorStyle)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setKeyboardDismissMode, keyboardDismissMode, UIScrollViewKeyboardDismissMode)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setMaximumZoomScale, maximumZoomScale, CGFloat)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setMinimumZoomScale, minimumZoomScale, CGFloat)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollEnabled, isScrollEnabled, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setPagingEnabled, isPagingEnabled, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollsToTop, scrollsToTop, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setShowsHorizontalScrollIndicator, showsHorizontalScrollIndicator, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setShowsVerticalScrollIndicator, showsVerticalScrollIndicator, BOOL)
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setZoomScale, zoomScale, CGFloat);
ABI50_0_0RCT_SET_AND_PRESERVE_OFFSET(setScrollIndicatorInsets, scrollIndicatorInsets, UIEdgeInsets);
                       ...
                       userData:(NSDictionary *)userData
{
  ...
  if ([self ABI50_0_0ReactLayoutDirection] == UIUserInterfaceLayoutDirectionRightToLeft) {
    offset.x = scrollView.contentSize.width - scrollView.frame.size.width - offset.x;
  }

  ABI50_0_0RCTScrollEvent *scrollEvent = [[ABI50_0_0RCTScrollEvent alloc] initWithEventName:eventName
                                                                 ABI50_0_0ReactTag:self.ABI50_0_0ReactTag
...
void ABI50_0_0RCTSendFakeScrollEvent(id<ABI50_0_0RCTEventDispatcherProtocol> eventDispatcher, NSNumber *ABI50_0_0ReactTag)
{
  ...
  ABI50_0_0RCTScrollEvent *fakeScrollEvent = [[ABI50_0_0RCTScrollEvent alloc] initWithEventName:eventName
                                                                     ABI50_0_0ReactTag:ABI50_0_0ReactTag
