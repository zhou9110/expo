...
@interface ABI50_0_0RCTMultipartDataTask () <NSURLSessionDataDelegate, NSURLSessionDataDelegate>

@end

@implementation ABI50_0_0RCTMultipartDataTask {
  NSURL *_url;
  ABI50_0_0RCTMultipartDataTaskCallback _partHandler;
  ABI50_0_0RCTMultipartProgressCallback _progressHandler;
...
{
  ABI50_0_0RCTMultipartStreamReader *reader = [[ABI50_0_0RCTMultipartStreamReader alloc] initWithInputStream:inputStream
                                                                                  boundary:_boundary];
  ABI50_0_0RCTMultipartDataTaskCallback partHandler = _partHandler;
  _partHandler = nil;
