...
#import "ABI50_0_0AIRGMSMarker.h"
#import "ABI50_0_0AIRGoogleMapCallout.h"
#import "ABI50_0_0AIRDummyView.h"
...
@interface ABI50_0_0AIRGoogleMapMarker ()
- (id)eventFromMarker:(ABI50_0_0AIRGMSMarker*)marker;
@end

@implementation ABI50_0_0AIRGoogleMapMarker {
...
{
  if ((self = [super init])) {
    _realMarker = [[ABI50_0_0AIRGMSMarker alloc] init];
...
- (void)insertABI50_0_0ReactSubview:(id<ABI50_0_0RCTComponent>)subview atIndex:(NSInteger)atIndex {
  if ([subview isKindOfClass:[ABI50_0_0AIRGoogleMapCallout class]]) {
    self.calloutView = (ABI50_0_0AIRGoogleMapCallout *)subview;
  } else { // a child view of the marker
    [self iconViewInsertSubview:(UIView*)subview atIndex:atIndex+1];
  }
  ABI50_0_0AIRDummyView *dummySubview = [[ABI50_0_0AIRDummyView alloc] initWithView:(UIView *)subview];
  [super insertABI50_0_0ReactSubview:(UIView*)dummySubview atIndex:atIndex];
}

- (void)removeABI50_0_0ReactSubview:(id<ABI50_0_0RCTComponent>)dummySubview {
  UIView* subview = ((ABI50_0_0AIRDummyView*)dummySubview).view;
  ...
  [super removeABI50_0_0ReactSubview:(UIView*)dummySubview];
}
...
- (void)didTapInfoWindowOfMarker:(ABI50_0_0AIRGMSMarker *)marker point:(CGPoint)point frame:(CGRect)frame {
...
- (void)didTapInfoWindowOfMarker:(ABI50_0_0AIRGMSMarker *)marker {
    [self didTapInfoWindowOfMarker:marker point:CGPointMake(-1, -1) frame:CGRectZero];
}

- (void)didTapInfoWindowOfMarker:(ABI50_0_0AIRGMSMarker *)marker subview:(ABI50_0_0AIRGoogleMapCalloutSubview*)subview point:(CGPoint)point frame:(CGRect)frame {
...
- (void)didBeginDraggingMarker:(ABI50_0_0AIRGMSMarker *)marker {
  if (!self.onDragStart) return;
  self.onDragStart([self eventFromMarker:marker]);
}

- (void)didEndDraggingMarker:(ABI50_0_0AIRGMSMarker *)marker {
  if (!self.onDragEnd) return;
  self.onDragEnd([self eventFromMarker:marker]);
}

- (void)didDragMarker:(ABI50_0_0AIRGMSMarker *)marker {
...
- (void)setOnPress:(ABI50_0_0RCTBubblingEventBlock)onPress {
  _realMarker.onPress = onPress;
}

- (ABI50_0_0RCTBubblingEventBlock)onPress {
...
- (void)setImageSrc:(NSString *)imageSrc
{
  ...
  if (!_iconImageView) {
    // prevent glitch with marker (cf. https://github.com/ABI50_0_0React-native-maps/ABI50_0_0React-native-maps/issues/738)
  ...
  _reloadImageCancellationBlock = [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI50_0_0RCTConvert NSURLRequest:_imageSrc]
                                                                          size:self.bounds.size
                                                                         scale:ABI50_0_0RCTScreenScale()
                                                                       clipped:YES
                                                                    resizeMode:ABI50_0_0RCTResizeModeCenter
                                                                 progressBlock:nil
...
//                                                                   }
                                                                   ...
                                                                   //       Shouldn't required images have size info automatically via ABI50_0_0RN?
...
- (void)setIconSrc:(NSString *)iconSrc
{
  ...
  if (!_realMarker.icon) {
    // prevent glitch with marker (cf. https://github.com/ABI50_0_0React-native-maps/ABI50_0_0React-native-maps/issues/3657)
    UIImage *emptyImage = [[UIImage alloc] init];
    _realMarker.icon = emptyImage;
  }

  _reloadImageCancellationBlock =
  [[_bridge moduleForName:@"ImageLoader"] loadImageWithURLRequest:[ABI50_0_0RCTConvert NSURLRequest:_iconSrc]
                                          size:self.bounds.size
                                         scale:ABI50_0_0RCTScreenScale()
                                       clipped:YES
                                    resizeMode:ABI50_0_0RCTResizeModeCenter
