...
/**
 * If available, ABI50_0_0RCTImageRedirectProtocol is invoked before loading an asset.
 * Implementation should return either a new URL or nil when redirection is
 * not needed.
 */

@protocol ABI50_0_0RCTImageRedirectProtocol
 ...
 * The priority logic is up to each @ABI50_0_0RCTImageLoaderProtocol implementation
 */
typedef NS_ENUM(NSInteger, ABI50_0_0RCTImageLoaderPriority) { ABI50_0_0RCTImageLoaderPriorityImmediate, ABI50_0_0RCTImageLoaderPriorityPrefetch };

@protocol ABI50_0_0RCTImageLoaderProtocol <ABI50_0_0RCTURLRequestHandler>
 ...
 * `partialLoadBlock` is meant for custom image loaders that do not ship with the core ABI50_0_0RN library.
 ...
 * decoded images as long as it conforms to the ABI50_0_0RCTImageCache
