...
@implementation ABI50_0_0EXForegroundPermissionRequester
...
{
  if ([ABI50_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization] && [self.locationManager  respondsToSelector:whenInUseAuthorizationSelector]) {
