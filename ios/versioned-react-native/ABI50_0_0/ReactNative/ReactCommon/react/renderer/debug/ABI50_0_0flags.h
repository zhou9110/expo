...
// define this, also define `ABI50_0_0RN_DEBUG_STRING_CONVERTIBLE`.
#ifdef ABI50_0_0REACT_NATIVE_DEBUG
#define ABI50_0_0RN_SHADOW_TREE_INTROSPECTION 1
#endif

// This enables certain object-to-string debug conversions to be compiled.
// Enable if `ABI50_0_0RN_SHADOW_TREE_INTROSPECTION` is enabled.
#ifdef ABI50_0_0RN_SHADOW_TREE_INTROSPECTION
#define ABI50_0_0RN_DEBUG_STRING_CONVERTIBLE 1
#endif

#ifndef ABI50_0_0RN_DEBUG_STRING_CONVERTIBLE
#define ABI50_0_0RN_DEBUG_STRING_CONVERTIBLE 0
#endif
...
// Verbose logging for certain Yoga-related things in the ABI50_0_0RN codebase (not Yoga
// codebase). Useful for debugging layout.
//#define ABI50_0_0RN_DEBUG_YOGA_LOGGER 1
