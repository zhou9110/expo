...
@protocol ABI50_0_0RCTBridgeDelegate <NSObject>
...
/**
 * The bridge initializes any registered ABI50_0_0RCTBridgeModules automatically, however
 ...
 * previously called ABI50_0_0facebook::ABI50_0_0React::setCustomJSCWrapper.
 *
 * @experimental
 */
- (BOOL)shouldBridgeUseCustomJSC:(ABI50_0_0RCTBridge *)bridge;
 ...
 */
- (BOOL)bridge:(ABI50_0_0RCTBridge *)bridge didNotFindModule:(NSString *)moduleName;
 ...
 */
- (void)loadSourceForBridge:(ABI50_0_0RCTBridge *)bridge
                 onProgress:(ABI50_0_0RCTSourceLoadProgressBlock)onProgress
                 onComplete:(ABI50_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Similar to loadSourceForBridge:onProgress:onComplete: but without progress
 * reporting.
 */
- (void)loadSourceForBridge:(ABI50_0_0RCTBridge *)bridge withBlock:(ABI50_0_0RCTSourceLoadBlock)loadCallback;

/**
 * Retrieve the list of lazy-native-modules names for the given bridge.
 */
- (NSDictionary<NSString *, Class> *)extraLazyModuleClassesForBridge:(ABI50_0_0RCTBridge *)bridge;
