...
Pod::Spec.new do |s|
  s.name                   = "ABI50_0_0ReactCommon"
  s.module_name            = "ABI50_0_0ReactCommon"
  s.version                = version
  s.summary                = "-"  # TODO
  ...
  s.subspec "turbomodule" do |ss|
    ss.dependency "ABI50_0_0React-callinvoker", version
    ss.dependency "ABI50_0_0React-perflogger", version
    ss.dependency "ABI50_0_0React-cxxreact", version
    ss.dependency "ABI50_0_0React-jsi", version
