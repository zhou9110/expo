...
static const CGFloat ABI50_0_0RCTViewBorderThreshold = 0.001;

BOOL ABI50_0_0RCTBorderInsetsAreEqual(UIEdgeInsets borderInsets)
{
  return ABS(borderInsets.left - borderInsets.right) < ABI50_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.bottom) < ABI50_0_0RCTViewBorderThreshold &&
      ABS(borderInsets.left - borderInsets.top) < ABI50_0_0RCTViewBorderThreshold;
}

BOOL ABI50_0_0RCTCornerRadiiAreEqual(ABI50_0_0RCTCornerRadii cornerRadii)
{
  return ABS(cornerRadii.topLeft - cornerRadii.topRight) < ABI50_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomLeft) < ABI50_0_0RCTViewBorderThreshold &&
      ABS(cornerRadii.topLeft - cornerRadii.bottomRight) < ABI50_0_0RCTViewBorderThreshold;
}

BOOL ABI50_0_0RCTBorderColorsAreEqual(ABI50_0_0RCTBorderColors borderColors)
{
...
ABI50_0_0RCTCornerInsets ABI50_0_0RCTGetCornerInsets(ABI50_0_0RCTCornerRadii cornerRadii, UIEdgeInsets edgeInsets)
{
  return (ABI50_0_0RCTCornerInsets){
      {
...
static UIEdgeInsets ABI50_0_0RCTRoundInsetsToPixel(UIEdgeInsets edgeInsets)
{
  edgeInsets.top = ABI50_0_0RCTRoundPixelValue(edgeInsets.top);
  edgeInsets.bottom = ABI50_0_0RCTRoundPixelValue(edgeInsets.bottom);
  edgeInsets.left = ABI50_0_0RCTRoundPixelValue(edgeInsets.left);
  edgeInsets.right = ABI50_0_0RCTRoundPixelValue(edgeInsets.right);

  return edgeInsets;
}

static void ABI50_0_0RCTPathAddEllipticArc(
...
CGPathRef ABI50_0_0RCTPathCreateWithRoundedRect(CGRect bounds, ABI50_0_0RCTCornerInsets cornerInsets, const CGAffineTransform *transform)
{
  ...
  ABI50_0_0RCTPathAddEllipticArc(
...
static void
ABI50_0_0RCTEllipseGetIntersectionsWithLine(CGRect ellipseBounds, CGPoint lineStart, CGPoint lineEnd, CGPoint intersections[2])
{
...
NS_INLINE BOOL ABI50_0_0RCTCornerRadiiAreAboveThreshold(ABI50_0_0RCTCornerRadii cornerRadii)
{
  return (
      cornerRadii.topLeft > ABI50_0_0RCTViewBorderThreshold || cornerRadii.topRight > ABI50_0_0RCTViewBorderThreshold ||
      cornerRadii.bottomLeft > ABI50_0_0RCTViewBorderThreshold || cornerRadii.bottomRight > ABI50_0_0RCTViewBorderThreshold);
}

static CGPathRef ABI50_0_0RCTPathCreateOuterOutline(BOOL drawToEdge, CGRect rect, ABI50_0_0RCTCornerRadii cornerRadii)
{
  if (drawToEdge) {
    return CGPathCreateWithRect(rect, NULL);
  }

  return ABI50_0_0RCTPathCreateWithRoundedRect(rect, ABI50_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);
}

static UIGraphicsImageRenderer *
ABI50_0_0RCTUIGraphicsImageRenderer(CGSize size, CGColorRef backgroundColor, BOOL hasCornerRadii, BOOL drawToEdge)
{
...
static UIImage *ABI50_0_0RCTGetSolidBorderImage(
    ...
    BOOL drawToEdge)
{
  const BOOL hasCornerRadii = ABI50_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  const ABI50_0_0RCTCornerInsets cornerInsets = ABI50_0_0RCTGetCornerInsets(cornerRadii, borderInsets);
  ...
  borderInsets = ABI50_0_0RCTRoundInsetsToPixel(borderInsets);
  ...
  UIGraphicsImageRenderer *const imageRenderer =
      ABI50_0_0RCTUIGraphicsImageRenderer(size, backgroundColor, hasCornerRadii, drawToEdge);
  UIImage *image = [imageRenderer imageWithActions:^(UIGraphicsImageRendererContext *_Nonnull rendererContext) {
    const CGContextRef context = rendererContext.CGContext;
    const CGRect rect = {.size = size};
    CGPathRef path = ABI50_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
    ...
    CGPathRef insetPath = ABI50_0_0RCTPathCreateWithRoundedRect(UIEdgeInsetsInsetRect(rect, borderInsets), cornerInsets, NULL);

    CGContextAddPath(context, insetPath);
    CGContextEOClip(context);

    BOOL hasEqualColors = ABI50_0_0RCTBorderColorsAreEqual(borderColors);
    if ((drawToEdge || !hasCornerRadii) && hasEqualColors) {
      ...
      if (cornerInsets.topLeft.width > 0 && cornerInsets.topLeft.height > 0) {
        CGPoint points[2];
        ABI50_0_0RCTEllipseGetIntersectionsWithLine(
...
static UIImage *ABI50_0_0RCTGetDashedOrDottedBorderImage(
    ...
    BOOL drawToEdge)
{
  NSCParameterAssert(borderStyle == ABI50_0_0RCTBorderStyleDashed || borderStyle == ABI50_0_0RCTBorderStyleDotted);

  if (!ABI50_0_0RCTBorderColorsAreEqual(borderColors) || !ABI50_0_0RCTBorderInsetsAreEqual(borderInsets)) {
    ABI50_0_0RCTLogWarn(@"Unsupported dashed / dotted border style");
    return nil;
  }
  ...
  const BOOL hasCornerRadii = ABI50_0_0RCTCornerRadiiAreAboveThreshold(cornerRadii);
  UIGraphicsImageRenderer *const imageRenderer =
      ABI50_0_0RCTUIGraphicsImageRenderer(viewSize, backgroundColor, hasCornerRadii, drawToEdge);
  return [imageRenderer imageWithActions:^(UIGraphicsImageRendererContext *_Nonnull rendererContext) {
    ...
    if (backgroundColor) {
      CGPathRef outerPath = ABI50_0_0RCTPathCreateOuterOutline(drawToEdge, rect, cornerRadii);
    ...
    CGPathRef path = ABI50_0_0RCTPathCreateWithRoundedRect(pathRect, ABI50_0_0RCTGetCornerInsets(cornerRadii, UIEdgeInsetsZero), NULL);

    CGFloat dashLengths[2];
    dashLengths[0] = dashLengths[1] = (borderStyle == ABI50_0_0RCTBorderStyleDashed ? 3 : 1) * lineWidth;
...
UIImage *ABI50_0_0RCTGetBorderImage(
    ABI50_0_0RCTBorderStyle borderStyle,
    CGSize viewSize,
    ABI50_0_0RCTCornerRadii cornerRadii,
    UIEdgeInsets borderInsets,
...
{
  switch (borderStyle) {
    case ABI50_0_0RCTBorderStyleSolid:
      return ABI50_0_0RCTGetSolidBorderImage(cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI50_0_0RCTBorderStyleDashed:
    case ABI50_0_0RCTBorderStyleDotted:
      return ABI50_0_0RCTGetDashedOrDottedBorderImage(
          borderStyle, cornerRadii, viewSize, borderInsets, borderColors, backgroundColor, drawToEdge);
    case ABI50_0_0RCTBorderStyleUnset:
      break;
  }
