...
#import <ABI50_0_0EXLocation/ABI50_0_0EXLocation.h>
#import <ABI50_0_0EXLocation/ABI50_0_0EXLocationDelegate.h>
#import <ABI50_0_0EXLocation/ABI50_0_0EXLocationTaskConsumer.h>
#import <ABI50_0_0EXLocation/ABI50_0_0EXGeofencingTaskConsumer.h>
#import <ABI50_0_0EXLocation/ABI50_0_0EXLocationPermissionRequester.h>
#import <ABI50_0_0EXLocation/ABI50_0_0EXForegroundPermissionRequester.h>
#import <ABI50_0_0EXLocation/ABI50_0_0EXBackgroundLocationPermissionRequester.h>
...
NSString * const ABI50_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI50_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI50_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI50_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI50_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI50_0_0EXTaskManagerInterface> tasksManager;

@end

@implementation ABI50_0_0EXLocation

ABI50_0_0EX_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI50_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXTaskManagerInterface)];

  _permissionsManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXPermissionsInterface)];
  [ABI50_0_0EXPermissionsMethodsDelegate registerRequesters:@[
    [ABI50_0_0EXLocationPermissionRequester new],
    [ABI50_0_0EXForegroundPermissionRequester new],
    [ABI50_0_0EXBackgroundLocationPermissionRequester new]
...
{
  return @[ABI50_0_0EXLocationChangedEventName, ABI50_0_0EXHeadingChangedEventName];
}
...
ABI50_0_0EX_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI50_0_0EXLocationDelegate *delegate;

  delegate = [[ABI50_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI50_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI50_0_0EX_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI50_0_0EXLocationDelegate *delegate = [[ABI50_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI50_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI50_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI50_0_0EX_EXPORT_METHOD_AS(getLastKnownPositionAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if ([self.class isLocation:location validWithOptions:options]) {
    resolve([ABI50_0_0EXLocation exportLocation:location]);
  } else {
    resolve([NSNull null]);
  }
}
...
ABI50_0_0EX_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  ABI50_0_0EXLocationDelegate *delegate = [[ABI50_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI50_0_0EXHeadingChangedEventName body:body];
    }
...
ABI50_0_0EX_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ABI50_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI50_0_0EX_EXPORT_METHOD_AS(geocodeAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(reverseGeocodeAsync,
    ...
    if (!error) {
      ...
      for (CLPlacemark* placemark in placemarks) {
        NSDictionary *address = @{
                                  @"city": ABI50_0_0UMNullIfNil(placemark.locality),
                                  @"district": ABI50_0_0UMNullIfNil(placemark.subLocality),
                                  @"streetNumber": ABI50_0_0UMNullIfNil(placemark.subThoroughfare),
                                  @"street": ABI50_0_0EXNullIfNil(placemark.thoroughfare),
                                  @"region": ABI50_0_0EXNullIfNil(placemark.administrativeArea),
                                  @"subregion": ABI50_0_0EXNullIfNil(placemark.subAdministrativeArea),
                                  @"country": ABI50_0_0EXNullIfNil(placemark.country),
                                  @"postalCode": ABI50_0_0EXNullIfNil(placemark.postalCode),
                                  @"name": ABI50_0_0EXNullIfNil(placemark.name),
                                  @"isoCountryCode": ABI50_0_0EXNullIfNil(placemark.ISOcountryCode),
                                  @"timezone": ABI50_0_0EXNullIfNil(placemark.timeZone.name),
                                  };
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI50_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI50_0_0EX_EXPORT_METHOD_AS(getForegroundPermissionsAsync,
                    getForegroundPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI50_0_0EXForegroundPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI50_0_0EX_EXPORT_METHOD_AS(requestForegroundPermissionsAsync,
                    requestForegroundPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI50_0_0EXForegroundPermissionRequester class]
...
ABI50_0_0EX_EXPORT_METHOD_AS(getBackgroundPermissionsAsync,
                    getBackgroundPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI50_0_0EXBackgroundLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI50_0_0EX_EXPORT_METHOD_AS(requestBackgroundPermissionsAsync,
                    requestBackgroundPermissionsAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI50_0_0EXBackgroundLocationPermissionRequester class]
...
ABI50_0_0EX_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI50_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
...
ABI50_0_0EX_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI50_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI50_0_0EX_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI50_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI50_0_0EX_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI50_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI50_0_0EX_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI50_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI50_0_0EX_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI50_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI50_0_0EX_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI50_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(nullable NSDictionary *)options
{
  ...
  if (options) {
    ...
    if (options[@"accuracy"]) {
      ABI50_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI50_0_0EXLocationAccuracyBalanced;
...
- (BOOL)checkForegroundPermissions:(ABI50_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI50_0_0EXForegroundPermissionRequester class]]) {
...
- (BOOL)checkBackgroundPermissions:(ABI50_0_0EXPromiseRejectBlock)reject
{
  if (![CLLocationManager locationServicesEnabled]) {
    reject(@"E_LOCATION_SERVICES_DISABLED", @"Location services are disabled", nil);
    return NO;
  }
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI50_0_0EXBackgroundLocationPermissionRequester class]]) {
...
- (BOOL)checkTaskManagerExists:(ABI50_0_0EXPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI50_0_0EXPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI50_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI50_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI50_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI50_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI50_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI50_0_0EXLocationAccuracyBestForNavigation:
