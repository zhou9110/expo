...
#import <ABI50_0_0EXBarCodeScanner/ABI50_0_0EXBarCodeScannerUtils.h>
...
@interface ABI50_0_0EXBarCodeScannerView ()
...
@property (nonatomic, strong) ABI50_0_0EXBarCodeScanner *barCodeScanner;
...
@property (nonatomic, weak) id<ABI50_0_0EXAppLifecycleService> lifecycleManager;

@property (nonatomic, assign, getter=isSessionPaused) BOOL paused;

@property (nonatomic, copy) ABI50_0_0EXDirectEventBlock onCameraReady;
@property (nonatomic, copy) ABI50_0_0EXDirectEventBlock onMountError;
@property (nonatomic, copy) ABI50_0_0EXDirectEventBlock onBarCodeScanned;

@end

@implementation ABI50_0_0EXBarCodeScannerView
...
- (instancetype)initWithModuleRegistry:(ABI50_0_0EXModuleRegistry *)moduleRegistry
{
  if ((self = [super init])) {
    ...
    _lifecycleManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXAppLifecycleListener)];
...
{
  ABI50_0_0EX_WEAKIFY(self);
  AVCaptureVideoOrientation videoOrientation = [ABI50_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:orientation];
...
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI50_0_0EXBareCodeCameraRequester class]]) {
...
- (void)initializeSession
{
  ...
  AVCaptureVideoOrientation orientation = [ABI50_0_0EXBarCodeScannerUtils videoOrientationForInterfaceOrientation:interfaceOrientation];
  ...
  dispatch_async(_sessionQueue, ^{
    ...
    NSError *error = nil;
    AVCaptureDevice *captureDevice = [ABI50_0_0EXBarCodeScannerUtils deviceWithMediaType:AVMediaTypeVideo
...
- (ABI50_0_0EXBarCodeScanner *)createBarCodeScanner
{
  ABI50_0_0EXBarCodeScanner *barCodeScanner = [ABI50_0_0EXBarCodeScanner new];
