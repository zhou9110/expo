...
@interface ABI50_0_0RCTEnhancedScrollView () <UIScrollViewDelegate>
@end

@implementation ABI50_0_0RCTEnhancedScrollView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _delegateSplitter = [[ABI50_0_0RCTGenericDelegateSplitter alloc] initWithDelegateUpdateBlock:^(id delegate) {
...
#pragma mark - ABI50_0_0RCTGenericDelegateSplitter
