...
static NSString * const ABI50_0_0EXNotificationHandlerErrorDomain = @"expo.notifications.handler";

@interface ABI50_0_0EXSingleNotificationHandlerTask ()
...
@property (nonatomic, weak) id<ABI50_0_0EXSingleNotificationHandlerTaskDelegate> delegate;

@property (nonatomic, strong) NSTimer *timer;

@end

@implementation ABI50_0_0EXSingleNotificationHandlerTask
...
- (instancetype)initWithEventEmitter:(id<ABI50_0_0EXEventEmitterService>)eventEmitter
                        notification:(UNNotification *)notification
                   completionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler
                            delegate:(nonnull id<ABI50_0_0EXSingleNotificationHandlerTaskDelegate>)delegate
{
  if (self = [super init]) {
...
- (void)start
{
  [_eventEmitter sendEventWithName:onHandleNotification body:@{
    ...
    @"notification": [ABI50_0_0EXNotificationSerializer serializedNotification:_notification]
  }];
...
- (nullable NSError *)callCompletionHandlerWithOptions:(UNNotificationPresentationOptions)options
{
  if (_completionHandler) {
    ...
    return [NSError errorWithDomain:ABI50_0_0EXNotificationHandlerErrorDomain code:-1 userInfo:@{
