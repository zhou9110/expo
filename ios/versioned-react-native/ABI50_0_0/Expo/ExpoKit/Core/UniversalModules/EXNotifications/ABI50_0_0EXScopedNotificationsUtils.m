...
@implementation ABI50_0_0EXScopedNotificationsUtils
...
{
  return [ABI50_0_0EXScopedNotificationsUtils shouldNotificationRequest:notification.request beHandledByExperience:scopeKey];
}

+ (NSString *)scopedIdentifierFromId:(NSString *)unscopedId forExperience:(NSString *)scopeKey
{
  NSString *scope = [ABI50_0_0EXScopedNotificationsUtils escapedString:scopeKey];
  NSString *escapedCategoryId = [ABI50_0_0EXScopedNotificationsUtils escapedString:unscopedId];
...
{
  NSString *scopeFromCategoryId = [ABI50_0_0EXScopedNotificationsUtils getScopeAndIdentifierFromScopedIdentifier:identifier].scopeKey;
...
+ (ScopedIdentifierComponents)getScopeAndIdentifierFromScopedIdentifier:(NSString *)scopedIdentifier
{
  ...
  components.scopeKey = [ABI50_0_0EXScopedNotificationsUtils unescapedString:scope];
  components.identifier = [ABI50_0_0EXScopedNotificationsUtils unescapedString:identifier];
  return components;
}
