...
public:
...
#ifdef ANDROID
    __android_log_write(ANDROID_LOG_INFO, "ABI50_0_0RNSkia", message.c_str());
#endif
...
#ifdef ANDROID
    __android_log_write(ANDROID_LOG_INFO, "ABI50_0_0RNSkia", buffer);
#endif
#ifdef TARGET_OS_IPHONE
    syslog(LOG_ERR, "ABI50_0_0RNSKIA: %s\n", buffer);
#endif
    va_end(args);
  }
  ...
  static void logToJavascriptConsole(jsi::Runtime &runtime,
    ...
    auto console = ABI50_0_0RNSkLogger::getJavascriptConsole(runtime).asObject(runtime);
