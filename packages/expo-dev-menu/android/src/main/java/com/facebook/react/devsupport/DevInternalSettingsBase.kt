...
//
// Expo: This is a copy of react-native's {@link com.facebook.react.devsupport.DevInternalSettings}
// just removing the "internal" modifier and adding "open" modifier that we can inherit and reuse.
// From time to time for react-native upgrade, just follow the steps to update the code
//   1. Copy the contents from DevInternalSettings to this file.
//   2. Rename the class to DevInternalSettingsBase.
//   3. Remove the "final" modifier and add "open" modifier.
 ...
 */
open class DevInternalSettingsBase(applicationContext: Context, private val listener: Listener?) :
