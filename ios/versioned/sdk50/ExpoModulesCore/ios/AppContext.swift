...
public final class AppContext: NSObject {
   ...
   */
  public weak var legacyModuleRegistry: ABI50_0_0EXModuleRegistry?

  internal weak var legacyModulesProxy: LegacyNativeModulesProxy?

  /**
   ABI50_0_0React bridge of the context's app. Can be `nil` when the bridge
   hasn't been propagated to the bridge modules yet (see ``ABI50_0_0ExpoBridgeModule``),
   or when the app context is "bridgeless" (for example in native unit tests).
   */
  @objc
  public internal(set) weak var reactBridge: ABI50_0_0RCTBridge?
  ...
  public convenience init(legacyModulesProxy: Any, legacyModuleRegistry: Any, config: AppContextConfig = .default) {
    ...
    self.legacyModuleRegistry = legacyModuleRegistry as? ABI50_0_0EXModuleRegistry
  }
  ...
  public func findView<ViewType>(withTag viewTag: Int, ofType type: ViewType.Type) -> ViewType? {
    let view: UIView? = reactBridge?.uiManager.view(forABI50_0_0ReactTag: NSNumber(value: viewTag))
  ...
  public func executeOnJavaScriptThread(runBlock: @escaping (() -> Void)) {
    reactBridge?.dispatchBlock(runBlock, queue: ABI50_0_0RCTJSThread)
  }
   ...
   */
  public var constants: ABI50_0_0EXConstantsInterface? {
    return legacyModule(implementing: ABI50_0_0EXConstantsInterface.self)
  }

  /**
   Provides access to the file system manager from legacy module registry.
   */
  public var fileSystem: ABI50_0_0EXFileSystemInterface? {
    return legacyModule(implementing: ABI50_0_0EXFileSystemInterface.self)
  }

  /**
   Provides access to the permissions manager from legacy module registry.
   */
  public var permissions: ABI50_0_0EXPermissionsInterface? {
    return legacyModule(implementing: ABI50_0_0EXPermissionsInterface.self)
  }

  /**
   Provides access to the image loader from legacy module registry.
   */
  public var imageLoader: ABI50_0_0EXImageLoaderInterface? {
    return legacyModule(implementing: ABI50_0_0EXImageLoaderInterface.self)
  }

  /**
   Provides access to the utilities from legacy module registry.
   */
  public var utilities: ABI50_0_0EXUtilitiesInterface? {
    return legacyModule(implementing: ABI50_0_0EXUtilitiesInterface.self)
  }

  /**
   Provides access to the event emitter from legacy module registry.
   */
  public var eventEmitter: ABI50_0_0EXEventEmitterService? {
    return legacyModule(implementing: ABI50_0_0EXEventEmitterService.self)
  }
  ...
  public func callFunction(
    ...
    withArgs args: [Any],
    resolve: @escaping ABI50_0_0EXPromiseResolveBlock,
    reject: @escaping ABI50_0_0EXPromiseRejectBlock
  ) {
    moduleRegistry
      .get(moduleHolderForName: moduleName)?
  ...
  internal func prepareRuntime() throws {
    ...
    ABI50_0_0EXJavaScriptRuntimeManager.installExpoModulesHostObject(self)
  }
   ...
   */
  @objc
  public static func modulesProvider(withName providerName: String = "ABI50_0_0ExpoModulesProvider") -> ModulesProvider {
