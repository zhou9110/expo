//
//  ABI50_0_0AIRGoogleMapManager.m
//  AirMaps
//
...
#import "ABI50_0_0AIRGoogleMapManager.h"
...
#import "ABI50_0_0RCTConvert+GMSMapViewType.h"
...
@interface ABI50_0_0AIRGoogleMapManager() <GMSMapViewDelegate>
{
  BOOL didCallOnMapReady;
}
@end

@implementation ABI50_0_0AIRGoogleMapManager
...
- (UIView *)view
{
  ...
  ABI50_0_0AIRGoogleMap *map = [ABI50_0_0AIRGoogleMap new];
...
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(initialCamera, GMSCameraPosition)
ABI50_0_0RCT_REMAP_VIEW_PROPERTY(camera, cameraProp, GMSCameraPosition)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(initialRegion, MKCoordinateRegion)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(region, MKCoordinateRegion)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsBuildings, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsCompass, BOOL)
//ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsScale, BOOL)  // Not supported by GoogleMaps
...
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(scrollDuringRotateOrZoomEnabled, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(pitchEnabled, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(zoomTapEnabled, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsUserLocation, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsMyLocationButton, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsIndoors, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(showsIndoorLevelPicker, BOOL)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(customMapStyleString, NSString)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(mapPadding, UIEdgeInsets)
ABI50_0_0RCT_REMAP_VIEW_PROPERTY(paddingAdjustmentBehavior, paddingAdjustmentBehaviorString, NSString)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onMapReady, ABI50_0_0RCTBubblingEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onMapLoaded, ABI50_0_0RCTBubblingEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onKmlReady, ABI50_0_0RCTBubblingEventBlock)
...
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onRegionChange, ABI50_0_0RCTDirectEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onRegionChangeComplete, ABI50_0_0RCTDirectEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onPoiClick, ABI50_0_0RCTDirectEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onIndoorLevelActivated, ABI50_0_0RCTDirectEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(onIndoorBuildingFocused, ABI50_0_0RCTDirectEventBlock)
ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(mapType, GMSMapViewType)
                  ...
                  rejecter:(ABI50_0_0RCTPromiseRejectBlock)reject)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[ABI50_0_0AIRGoogleMap class]]) {
            reject(@"Invalid argument", [NSString stringWithFormat:@"Invalid view returned from registry, expecting ABI50_0_0AIRGoogleMap, got: %@", view], NULL);
        } else {
            ABI50_0_0AIRGoogleMap *mapView = (ABI50_0_0AIRGoogleMap *)view;
            resolve(@{
                      @"center": @{
                  ...
                  camera:(id)json)
{
    [self.bridge.uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        id view = viewRegistry[ABI50_0_0ReactTag];
        if (![view isKindOfClass:[ABI50_0_0AIRGoogleMap class]]) {
            ABI50_0_0RCTLogError(@"Invalid view returned from registry, expecting ABI50_0_0AIRGoogleMap, got: %@", view);
        } else {
            ABI50_0_0AIRGoogleMap *mapView = (ABI50_0_0AIRGoogleMap *)view;
            GMSCameraPosition *camera = [ABI50_0_0RCTConvert GMSCameraPositionWithDefaults:json existingCamera:[mapView camera]];
                  ...
                  withDuration:(CGFloat)duration)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI50_0_0AIRGoogleMap class]]) {
      ...
      [CATransaction setAnimationDuration:duration/1000];
      ABI50_0_0AIRGoogleMap *mapView = (ABI50_0_0AIRGoogleMap *)view;
      GMSCameraPosition *camera = [ABI50_0_0AIRGoogleMap makeGMSCameraPositionFromMap:mapView andMKCoordinateRegion:region];
      [mapView animateToCameraPosition:camera];
      [CATransaction commit];
    }
  }];
                  ...
                  animated:(BOOL)animated)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI50_0_0AIRGoogleMap class]]) {
      ...
      CLLocationCoordinate2D myLocation = ((ABI50_0_0AIRGoogleMapMarker *)(mapView.markers.firstObject)).realMarker.position;
      GMSCoordinateBounds *bounds = [[GMSCoordinateBounds alloc] initWithCoordinate:myLocation coordinate:myLocation];

      for (ABI50_0_0AIRGoogleMapMarker *marker in mapView.markers)
  ...
  [self.bridge.uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI50_0_0AIRGoogleMap class]]) {
      ...
      NSPredicate *filterMarkers = [NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, NSDictionary *bindings) {
        ABI50_0_0AIRGoogleMapMarker *marker = (ABI50_0_0AIRGoogleMapMarker *)evaluatedObject;
        return [marker isKindOfClass:[ABI50_0_0AIRGoogleMapMarker class]] && [markers containsObject:marker.identifier];
      }];

      NSArray *filteredMarkers = [mapView.markers filteredArrayUsingPredicate:filterMarkers];

      CLLocationCoordinate2D myLocation = ((ABI50_0_0AIRGoogleMapMarker *)(filteredMarkers.firstObject)).realMarker.position;
      GMSCoordinateBounds *bounds = [[GMSCoordinateBounds alloc] initWithCoordinate:myLocation coordinate:myLocation];

      for (ABI50_0_0AIRGoogleMapMarker *marker in filteredMarkers)
        bounds = [bounds includingCoordinate:marker.realMarker.position];
                  ...
                  animated:(BOOL)animated)
{
  [self.bridge.uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    ...
    if (![view isKindOfClass:[ABI50_0_0AIRGoogleMap class]]) {
      ...
      for (ABI50_0_0AIRMapCoordinate *coordinate in coordinates)
...
ABI50_0_0RCT_EXPORT_METHOD(takeSnapshot:(nonnull NSNumber *)ABI50_0_0ReactTag
                  ...
                  withCallback:(ABI50_0_0RCTResponseSenderBlock)callback)
{
...
ABI50_0_0RCT_EXPORT_METHOD(setMapBoundaries:(nonnull NSNumber *)ABI50_0_0ReactTag
...
ABI50_0_0RCT_EXPORT_METHOD(setIndoorActiveLevelIndex:(nonnull NSNumber *)ABI50_0_0ReactTag
...
- (void)mapViewDidStartTileRendering:(GMSMapView *)mapView {
  ABI50_0_0AIRGoogleMap *googleMapView = (ABI50_0_0AIRGoogleMap *)mapView;
...
- (UIView *)mapView:(GMSMapView *)mapView markerInfoWindow:(GMSMarker *)marker {
  ABI50_0_0AIRGMSMarker *aMarker = (ABI50_0_0AIRGMSMarker *)marker;
...
- (void)handleMapDrag:(UIPanGestureRecognizer*)recognizer {
  ABI50_0_0AIRGoogleMap *map = (ABI50_0_0AIRGoogleMap *)recognizer.view;
