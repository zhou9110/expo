...
#include <ABI50_0_0jsi/ABI50_0_0test/testlib.h>
...
TEST_P(JSITest, RuntimeTest) {
  ...
  ABI50_0_0EXPECT_EQ(v.getNumber(), 1);

  rt.evaluateJavaScript(std::make_unique<StringBuffer>("x = 1"), "");
  ABI50_0_0EXPECT_EQ(rt.global().getProperty(rt, "x").getNumber(), 1);
}
...
TEST_P(JSITest, PropNameIDTest) {
  ...
  ABI50_0_0EXPECT_EQ(movedQuux.utf8(rt), "quux");
  movedQuux = PropNameID::forAscii(rt, "quux2");
  ABI50_0_0EXPECT_EQ(movedQuux.utf8(rt), "quux2");
  PropNameID copiedQuux = PropNameID(rt, movedQuux);
  ABI50_0_0EXPECT_TRUE(PropNameID::compare(rt, movedQuux, copiedQuux));

  ABI50_0_0EXPECT_TRUE(PropNameID::compare(rt, movedQuux, movedQuux));
  ABI50_0_0EXPECT_TRUE(PropNameID::compare(
      rt, movedQuux, PropNameID::forAscii(rt, std::string("quux2"))));
  ABI50_0_0EXPECT_FALSE(PropNameID::compare(
  ...
  ABI50_0_0EXPECT_EQ(nonUtf8PropNameID.utf8(rt), "meow");
  PropNameID strPropNameID =
      PropNameID::forString(rt, String::createFromAscii(rt, "meow"));
  ABI50_0_0EXPECT_TRUE(PropNameID::compare(rt, nonUtf8PropNameID, strPropNameID));

  auto names = PropNameID::names(
      rt, "Ala", std::string("ma"), PropNameID::forAscii(rt, "kota"));
  ABI50_0_0EXPECT_EQ(names.size(), 3);
...
TEST_P(JSITest, StringTest) {
  ABI50_0_0EXPECT_TRUE(checkValue(String::createFromAscii(rt, "foobar", 3), "'foo'"));
  ABI50_0_0EXPECT_TRUE(checkValue(String::createFromAscii(rt, "foobar"), "'foobar'"));

  std::string baz = "baz";
  ABI50_0_0EXPECT_TRUE(checkValue(String::createFromAscii(rt, baz), "'baz'"));

  uint8_t utf8[] = {0xF0, 0x9F, 0x86, 0x97};
  ABI50_0_0EXPECT_TRUE(checkValue(
      String::createFromUtf8(rt, utf8, sizeof(utf8)), "'\\uD83C\\uDD97'"));

  ABI50_0_0EXPECT_EQ(eval("'quux'").getString(rt).utf8(rt), "quux");
  ABI50_0_0EXPECT_EQ(eval("'\\u20AC'").getString(rt).utf8(rt), "\xe2\x82\xac");
...
TEST_P(JSITest, ObjectTest) {
  ...
  ABI50_0_0EXPECT_EQ(x.getPropertyNames(rt).size(rt), 4);
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, "1"));
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, PropNameID::forAscii(rt, "1")));
  ABI50_0_0EXPECT_FALSE(x.hasProperty(rt, "2"));
  ABI50_0_0EXPECT_FALSE(x.hasProperty(rt, PropNameID::forAscii(rt, "2")));
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, "3"));
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, PropNameID::forAscii(rt, "3")));
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, "seven"));
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, PropNameID::forAscii(rt, "seven")));
  ABI50_0_0EXPECT_EQ(x.getProperty(rt, "1").getNumber(), 2);
  ABI50_0_0EXPECT_EQ(x.getProperty(rt, PropNameID::forAscii(rt, "1")).getNumber(), 2);
  ABI50_0_0EXPECT_EQ(x.getProperty(rt, "3").getNumber(), 4);
  Value five = 5;
  ABI50_0_0EXPECT_EQ(
  ...
  ABI50_0_0EXPECT_EQ(x.getPropertyNames(rt).size(rt), 5);
  ABI50_0_0EXPECT_TRUE(eval("x.ten == 11").getBool());

  x.setProperty(rt, "e_as_float", 2.71f);
  ABI50_0_0EXPECT_TRUE(eval("Math.abs(x.e_as_float - 2.71) < 0.001").getBool());

  x.setProperty(rt, "e_as_double", 2.71);
  ABI50_0_0EXPECT_TRUE(eval("x.e_as_double == 2.71").getBool());

  uint8_t utf8[] = {0xF0, 0x9F, 0x86, 0x97};
  String nonAsciiName = String::createFromUtf8(rt, utf8, sizeof(utf8));
  x.setProperty(rt, PropNameID::forString(rt, nonAsciiName), "emoji");
  ABI50_0_0EXPECT_EQ(x.getPropertyNames(rt).size(rt), 8);
  ABI50_0_0EXPECT_TRUE(eval("x['\\uD83C\\uDD97'] == 'emoji'").getBool());

  Object seven = x.getPropertyAsObject(rt, "seven");
  ABI50_0_0EXPECT_TRUE(seven.isArray(rt));
  Object evalf = rt.global().getPropertyAsObject(rt, "eval");
  ABI50_0_0EXPECT_TRUE(evalf.isFunction(rt));

  Object movedX = Object(rt);
  movedX = std::move(x);
  ABI50_0_0EXPECT_EQ(movedX.getPropertyNames(rt).size(rt), 8);
  ABI50_0_0EXPECT_EQ(movedX.getProperty(rt, "1").getNumber(), 2);
  ...
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return "
                       "obj.roses == 'red' && "
                       "obj['violets'] == 'blue' && "
  ...
  obj = function(
            ...
            .call(rt)
            .getObject(rt);
  ABI50_0_0EXPECT_EQ(obj.getProperty(rt, "a").getNumber(), 1);
  ABI50_0_0EXPECT_EQ(obj.getProperty(rt, "b").getNumber(), 2);
  Array names = obj.getPropertyNames(rt);
  ABI50_0_0EXPECT_EQ(names.size(rt), 1);
  ABI50_0_0EXPECT_EQ(names.getValueAtIndex(rt, 0).getString(rt).utf8(rt), "a");
}
...
TEST_P(JSITest, HostObjectTest) {
  ...
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj.someRandomProp == 9000; }")
                  .call(rt, cho)
                  .getBool());
  ABI50_0_0EXPECT_TRUE(cho.isHostObject(rt));
  ABI50_0_0EXPECT_TRUE(cho.getHostObject<ConstantHostObject>(rt).get() != nullptr);
  ...
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj.abc == 'abcabc'; }")
                  .call(rt, tho)
                  .getBool());
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj['def'] == 'defdef'; }")
                  .call(rt, tho)
                  .getBool());
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj[12] === '1212'; }")
                  .call(rt, tho)
                  .getBool());
  ABI50_0_0EXPECT_TRUE(tho.isHostObject(rt));
  ABI50_0_0EXPECT_TRUE(
      std::dynamic_pointer_cast<ConstantHostObject>(tho.getHostObject(rt)) ==
      nullptr);
  ABI50_0_0EXPECT_TRUE(tho.getHostObject<TwiceHostObject>(rt).get() != nullptr);
  ...
  ABI50_0_0EXPECT_TRUE(sho.isHostObject(rt));
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj.undef; }")
                  .call(rt, sho)
                  .isUndefined());
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj.somesymbol; }")
                  .call(rt, sho)
                  .getBool());
  ABI50_0_0EXPECT_FALSE(function("function (obj) { return obj.notsomuch; }")
                   .call(rt, sho)
                   .getBool());
  ...
  ABI50_0_0EXPECT_TRUE(bho.isHostObject(rt));
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj.undef; }")
                  .call(rt, bho)
                  .isUndefined());
  ABI50_0_0EXPECT_EQ(
      function("function (obj) { obj.thing = 'hello'; return obj.thing; }")
          ...
          .utf8(rt),
      "hello");
  ABI50_0_0EXPECT_EQ(shbho->getThing(), "hello");
  ...
  ABI50_0_0EXPECT_TRUE(thro.isHostObject(rt));
  std::string exc;
  try {
  ...
  ABI50_0_0EXPECT_NE(exc.find("Cannot get"), std::string::npos);
  exc = "";
  try {
  ...
  ABI50_0_0EXPECT_NE(exc.find("Cannot set"), std::string::npos);

  class NopHostObject : public HostObject {};
  Object nopHo =
      Object::createFromHostObject(rt, std::make_shared<NopHostObject>());
  ABI50_0_0EXPECT_TRUE(nopHo.isHostObject(rt));
  ABI50_0_0EXPECT_TRUE(function("function (obj) { return obj.thing; }")
                  .call(rt, nopHo)
                  .isUndefined());
  ...
  ABI50_0_0EXPECT_NE(nopExc.find("TypeError: "), std::string::npos);
  ...
  ABI50_0_0EXPECT_TRUE(
      hasOwnPropertyName.call(rt, howpn, String::createFromAscii(rt, "c_prop"))
          .getBool());
  ABI50_0_0EXPECT_FALSE(hasOwnPropertyName
...
TEST_P(JSITest, ArrayTest) {
  ...
  ABI50_0_0EXPECT_EQ(names.size(rt), 4);
  std::unordered_set<std::string> strNames;
  for (size_t i = 0; i < names.size(rt); ++i) {
    Value n = names.getValueAtIndex(rt, i);
    ABI50_0_0EXPECT_TRUE(n.isString());
    strNames.insert(n.getString(rt).utf8(rt));
  }

  ABI50_0_0EXPECT_EQ(strNames.size(), 4);
  ABI50_0_0EXPECT_EQ(strNames.count("1"), 1);
  ABI50_0_0EXPECT_EQ(strNames.count("3"), 1);
  ABI50_0_0EXPECT_EQ(strNames.count("5"), 1);
  ABI50_0_0EXPECT_EQ(strNames.count("seven"), 1);

  Object seven = x.getPropertyAsObject(rt, "seven");
  Array arr = seven.getArray(rt);

  ABI50_0_0EXPECT_EQ(arr.size(rt), 2);
  ABI50_0_0EXPECT_EQ(arr.getValueAtIndex(rt, 0).getString(rt).utf8(rt), "eight");
  ABI50_0_0EXPECT_EQ(arr.getValueAtIndex(rt, 1).getString(rt).utf8(rt), "nine");
  // TODO: test out of range

  ABI50_0_0EXPECT_EQ(x.getPropertyAsObject(rt, "seven").getArray(rt).size(rt), 2);

  // Check that property access with both symbols and strings can access
  // array values.
  ABI50_0_0EXPECT_EQ(seven.getProperty(rt, "0").getString(rt).utf8(rt), "eight");
  ABI50_0_0EXPECT_EQ(seven.getProperty(rt, "1").getString(rt).utf8(rt), "nine");
  seven.setProperty(rt, "1", "modified");
  ABI50_0_0EXPECT_EQ(seven.getProperty(rt, "1").getString(rt).utf8(rt), "modified");
  ABI50_0_0EXPECT_EQ(arr.getValueAtIndex(rt, 1).getString(rt).utf8(rt), "modified");
  ABI50_0_0EXPECT_EQ(
  ...
  ABI50_0_0EXPECT_EQ(arr.getValueAtIndex(rt, 0).getString(rt).utf8(rt), "modified2");

  Array alpha = Array(rt, 4);
  ABI50_0_0EXPECT_TRUE(alpha.getValueAtIndex(rt, 0).isUndefined());
  ABI50_0_0EXPECT_TRUE(alpha.getValueAtIndex(rt, 3).isUndefined());
  ABI50_0_0EXPECT_EQ(alpha.size(rt), 4);
  alpha.setValueAtIndex(rt, 0, "a");
  alpha.setValueAtIndex(rt, 1, "b");
  ABI50_0_0EXPECT_EQ(alpha.length(rt), 4);
  ...
  ABI50_0_0EXPECT_EQ(alpha2.size(rt), 4);
  ...
  try {
    ...
    ABI50_0_0EXPECT_EQ(err.value().getNumber(), 72);
  }
  ABI50_0_0EXPECT_EQ(arrWithAccessor.getValueAtIndex(rt, 0).getNumber(), 45);
}
...
TEST_P(JSITest, FunctionTest) {
  ...
  ABI50_0_0EXPECT_EQ(fmove.call(rt).getNumber(), 2);
  ...
  Array a = Array(rt, 1);
  Value v = 42;
  ABI50_0_0EXPECT_TRUE(flv.call(rt, s, o, a, f, v).getBool());

  Function f1 = function("function() { return 1; }");
  Function f2 = function("function() { return 2; }");
  f2 = std::move(f1);
  ABI50_0_0EXPECT_EQ(f2.call(rt).getNumber(), 1);
}
...
TEST_P(JSITest, FunctionThisTest) {
  ...
  ABI50_0_0EXPECT_TRUE(checkPropertyFunction.callWithThis(rt, jsObject).getBool());
  ABI50_0_0EXPECT_TRUE(checkPropertyFunction.callWithThis(rt, hostObject).getBool());
  ABI50_0_0EXPECT_FALSE(checkPropertyFunction.callWithThis(rt, Array(rt, 5)).getBool());
  ABI50_0_0EXPECT_FALSE(checkPropertyFunction.call(rt).getBool());
}
...
TEST_P(JSITest, FunctionConstructorTest) {
  ...
  ABI50_0_0EXPECT_TRUE(empty.isObject());
  auto emptyObj = std::move(empty).getObject(rt);
  ABI50_0_0EXPECT_EQ(emptyObj.getProperty(rt, "pika").getString(rt).utf8(rt), "chu");
  auto who = ctor.callAsConstructor(rt, "who");
  ABI50_0_0EXPECT_TRUE(who.isObject());
  auto whoObj = std::move(who).getObject(rt);
  ABI50_0_0EXPECT_EQ(whoObj.getProperty(rt, "pika").getString(rt).utf8(rt), "who");

  auto instanceof = function("function (o, b) { return o instanceof b; }");
  ABI50_0_0EXPECT_TRUE(instanceof.call(rt, emptyObj, ctor).getBool());
  ABI50_0_0EXPECT_TRUE(instanceof.call(rt, whoObj, ctor).getBool());

  auto dateCtor = rt.global().getPropertyAsFunction(rt, "Date");
  auto date = dateCtor.callAsConstructor(rt);
  ABI50_0_0EXPECT_TRUE(date.isObject());
  ABI50_0_0EXPECT_TRUE(instanceof.call(rt, date, dateCtor).getBool());
...
TEST_P(JSITest, InstanceOfTest) {
  ...
  ABI50_0_0EXPECT_TRUE(instance.instanceOf(rt, ctor));
  ABI50_0_0EXPECT_EQ(
      instance.getProperty(rt, "say").getString(rt).utf8(rt), "wubalubadubdub");
  ABI50_0_0EXPECT_FALSE(Object(rt).instanceOf(rt, ctor));
  ABI50_0_0EXPECT_TRUE(ctor.callAsConstructor(rt, nullptr, 0)
                  .getObject(rt)
                  .instanceOf(rt, ctor));
}
...
TEST_P(JSITest, HostFunctionTest) {
  ...
  ABI50_0_0EXPECT_EQ(plusOne.call(rt, 1, 2).getNumber(), 4);
  ABI50_0_0EXPECT_TRUE(checkValue(plusOne.call(rt, 3, 5), "9"));
  rt.global().setProperty(rt, "plusOne", plusOne);
  ABI50_0_0EXPECT_TRUE(eval("plusOne(20, 300) == 321").getBool());
  ...
  ABI50_0_0EXPECT_TRUE(eval("cons('left', 'right') == 'left.right'").getBool());
  ABI50_0_0EXPECT_TRUE(eval("cons.name == 'dot'").getBool());
  ABI50_0_0EXPECT_TRUE(eval("cons.length == 2").getBool());
  ABI50_0_0EXPECT_TRUE(eval("cons instanceof Function").getBool());

  ABI50_0_0EXPECT_TRUE(eval("(function() {"
                   "  try {"
  ...
  Function coolify = Function::createFromHostFunction(
      ...
      0,
      [](Runtime& rt, const Value& thisVal, const Value* args, size_t count) {
        ABI50_0_0EXPECT_EQ(count, 0);
        std::string ret = thisVal.toString(rt).utf8(rt) + " is cool";
        return String::createFromUtf8(
            rt, reinterpret_cast<const uint8_t*>(ret.data()), ret.size());
      });
  rt.global().setProperty(rt, "coolify", coolify);
  ABI50_0_0EXPECT_TRUE(eval("coolify.name == 'coolify'").getBool());
  ABI50_0_0EXPECT_TRUE(eval("coolify.length == 0").getBool());
  ABI50_0_0EXPECT_TRUE(eval("coolify.bind('R&M')() == 'R&M is cool'").getBool());
  ABI50_0_0EXPECT_TRUE(eval("(function() {"
  ...
  Function lookAtMe = Function::createFromHostFunction(
      ...
      [](Runtime& rt, const Value& thisVal, const Value* args, size_t count)
          -> Value {
        ABI50_0_0EXPECT_TRUE(thisVal.isObject());
        ABI50_0_0EXPECT_EQ(
  ...
  ABI50_0_0EXPECT_TRUE(eval("lookAtMe.bind({'name': 'mr.meeseeks'})()").isUndefined());
  ...
  ABI50_0_0EXPECT_TRUE(callable.isHostFunction(rt));
  ABI50_0_0EXPECT_TRUE(callable.getHostFunction(rt).target<Callable>() != nullptr);
  ...
  ABI50_0_0EXPECT_TRUE(function("function(value) { return value.prop == 'strval1'; }")
                  .call(rt, obj)
                  .getBool());
  strval = "strval2";
  ABI50_0_0EXPECT_TRUE(function("function(value) { return value.prop == 'strval2'; }")
                  .call(rt, obj)
                  .getBool());
}

TEST_P(JSITest, ValueTest) {
  ABI50_0_0EXPECT_TRUE(checkValue(Value::undefined(), "undefined"));
  ABI50_0_0EXPECT_TRUE(checkValue(Value(), "undefined"));
  ABI50_0_0EXPECT_TRUE(checkValue(Value::null(), "null"));
  ABI50_0_0EXPECT_TRUE(checkValue(nullptr, "null"));

  ABI50_0_0EXPECT_TRUE(checkValue(Value(false), "false"));
  ABI50_0_0EXPECT_TRUE(checkValue(false, "false"));
  ABI50_0_0EXPECT_TRUE(checkValue(true, "true"));

  ABI50_0_0EXPECT_TRUE(checkValue(Value(1.5), "1.5"));
  ABI50_0_0EXPECT_TRUE(checkValue(2.5, "2.5"));

  ABI50_0_0EXPECT_TRUE(checkValue(Value(10), "10"));
  ABI50_0_0EXPECT_TRUE(checkValue(20, "20"));
  ABI50_0_0EXPECT_TRUE(checkValue(30, "30"));

  // rvalue implicit conversion
  ABI50_0_0EXPECT_TRUE(checkValue(String::createFromAscii(rt, "one"), "'one'"));
  // lvalue explicit copy
  String s = String::createFromAscii(rt, "two");
  ABI50_0_0EXPECT_TRUE(checkValue(Value(rt, s), "'two'"));

  {
    ...
    v2 = std::move(v1);
    ABI50_0_0EXPECT_TRUE(v2.isNumber());
    ABI50_0_0EXPECT_EQ(v2.getNumber(), 100);
  }

  {
    ...
    Value v2 = 100;
    v2 = std::move(v1);
    ABI50_0_0EXPECT_TRUE(v2.isString());
    ABI50_0_0EXPECT_EQ(v2.getString(rt).utf8(rt), "hundred");
  }

  Object o = Object(rt);
  ABI50_0_0EXPECT_TRUE(function("function(value) { return typeof(value) == 'object'; }")
                  .call(rt, Value(rt, o))
                  .getBool());
  ...
  ABI50_0_0EXPECT_TRUE(eval("undefined").isUndefined());
  ABI50_0_0EXPECT_TRUE(eval("null").isNull());
  ABI50_0_0EXPECT_TRUE(eval("true").isBool());
  ABI50_0_0EXPECT_TRUE(eval("false").isBool());
  ABI50_0_0EXPECT_TRUE(eval("123").isNumber());
  ABI50_0_0EXPECT_TRUE(eval("123.4").isNumber());
  ABI50_0_0EXPECT_TRUE(eval("'str'").isString());
  // "{}" returns undefined.  empty code block?
  ABI50_0_0EXPECT_TRUE(eval("({})").isObject());
  ABI50_0_0EXPECT_TRUE(eval("[]").isObject());
  ABI50_0_0EXPECT_TRUE(eval("(function(){})").isObject());

  ABI50_0_0EXPECT_EQ(eval("123").getNumber(), 123);
  ABI50_0_0EXPECT_EQ(eval("123.4").getNumber(), 123.4);
  ABI50_0_0EXPECT_EQ(eval("'str'").getString(rt).utf8(rt), "str");
  ABI50_0_0EXPECT_TRUE(eval("[]").getObject(rt).isArray(rt));

  ABI50_0_0EXPECT_TRUE(eval("true").asBool());
  ABI50_0_0EXPECT_THROW(eval("123").asBool(), JSIException);
  ABI50_0_0EXPECT_EQ(eval("456").asNumber(), 456);
  ABI50_0_0EXPECT_THROW(eval("'word'").asNumber(), JSIException);
  ABI50_0_0EXPECT_EQ(
      eval("({1:2, 3:4})").asObject(rt).getProperty(rt, "1").getNumber(), 2);
  ABI50_0_0EXPECT_THROW(eval("'oops'").asObject(rt), JSIException);

  ABI50_0_0EXPECT_EQ(eval("['zero',1,2,3]").toString(rt).utf8(rt), "zero,1,2,3");
}

TEST_P(JSITest, EqualsTest) {
  ABI50_0_0EXPECT_TRUE(Object::strictEquals(rt, rt.global(), rt.global()));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, 1, 1));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(rt, true, 1));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(rt, true, false));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, false, false));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(rt, nullptr, 1));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, nullptr, nullptr));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, Value::undefined(), Value()));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, rt.global(), Value(rt.global())));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(
      rt,
  ...
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(
      ...
      std::numeric_limits<double>::signaling_NaN()));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, +0.0, -0.0));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, -0.0, +0.0));
  ...
  ABI50_0_0EXPECT_TRUE(Object::strictEquals(rt, noop, noopDup));
  ABI50_0_0EXPECT_TRUE(Object::strictEquals(rt, noopDup, noop));
  ABI50_0_0EXPECT_FALSE(Object::strictEquals(rt, noop, rt.global()));
  ABI50_0_0EXPECT_TRUE(Object::strictEquals(rt, noop, noop));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, Value(rt, noop), Value(rt, noop)));
  ...
  ABI50_0_0EXPECT_TRUE(String::strictEquals(rt, str, str));
  ABI50_0_0EXPECT_TRUE(String::strictEquals(rt, str, strDup));
  ABI50_0_0EXPECT_TRUE(String::strictEquals(rt, strDup, str));
  ABI50_0_0EXPECT_FALSE(String::strictEquals(rt, str, otherStr));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(rt, Value(rt, str), Value(rt, str)));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(rt, Value(rt, str), Value(rt, noop)));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(rt, Value(rt, str), 1.0));
}
...
TEST_P(JSITest, ExceptionStackTraceTest) {
  ...
  ABI50_0_0EXPECT_NE(stack.find("world"), std::string::npos);
}
...
TEST_P(JSITest, PreparedJavaScriptSourceTest) {
  ...
  ABI50_0_0EXPECT_EQ(rt.global().getProperty(rt, "q").getNumber(), 0);
  rt.evaluatePreparedJavaScript(prep);
  ABI50_0_0EXPECT_EQ(rt.global().getProperty(rt, "q").getNumber(), 1);
  rt.evaluatePreparedJavaScript(prep);
  ABI50_0_0EXPECT_EQ(rt.global().getProperty(rt, "q").getNumber(), 2);
}
...
TEST_P(JSITest, PreparedJavaScriptURLInBacktrace) {
  ...
  } catch (ABI50_0_0facebook::jsi::JSError err) {
    ABI50_0_0EXPECT_NE(std::string::npos, err.getStack().find(sourceURL))
...
TEST_P(JSITest, JSErrorsArePropagatedNicely) {
  ...
  try {
    ...
    ABI50_0_0EXPECT_EQ(error.getMessage(), "Omg, what a nasty exception");
    ABI50_0_0EXPECT_EQ(countOccurences("sometimesThrows", error.getStack()), 6);

    // system JSC JSI does not implement host function names
    // ABI50_0_0EXPECT_EQ(countOccurences("callback", error.getStack(rt)), 5);
  }
}

TEST_P(JSITest, JSErrorsCanBeConstructedWithStack) {
  auto err = JSError(rt, "message", "stack");
  ABI50_0_0EXPECT_EQ(err.getMessage(), "message");
  ABI50_0_0EXPECT_EQ(err.getStack(), "stack");
}
...
TEST_P(JSITest, JSErrorStackOverflowHandling) {
  ...
  try {
    ...
    ABI50_0_0EXPECT_NE(std::string(ex.what()).find("exceeded"), std::string::npos);
  }
}
...
TEST_P(JSITest, ScopeDoesNotCrashWhenValueEscapes) {
  ...
  ABI50_0_0EXPECT_EQ(v.getObject(rt).getProperty(rt, "a").getNumber(), 5);
}
...
TEST_P(JSITest, HostObjectWithValueMembers) {
  ...
  ABI50_0_0EXPECT_TRUE(checkFoo.call(rt, jsbag).getBool());
  ABI50_0_0EXPECT_TRUE(checkCount.call(rt, jsbag).getBool());
  ABI50_0_0EXPECT_TRUE(checkNul.call(rt, jsbag).getBool());
  ABI50_0_0EXPECT_TRUE(checkIsCool.call(rt, jsbag).getBool());
  ABI50_0_0EXPECT_TRUE(checkObj.call(rt, jsbag).getBool());

  // Check this looks good from c++
  ABI50_0_0EXPECT_EQ(bag["foo"].getString(rt).utf8(rt), "bar");
  ABI50_0_0EXPECT_EQ(bag["count"].getNumber(), 37);
  ABI50_0_0EXPECT_TRUE(bag["nul"].isNull());
  ABI50_0_0EXPECT_TRUE(bag["iscool"].getBool());
  ABI50_0_0EXPECT_EQ(
...
TEST_P(JSITest, DecoratorTest) {
  ...
  crt.description();
  ABI50_0_0EXPECT_EQ(crt.count(), kInit + 1);

  crt.global().setProperty(crt, "o", Object(crt));
  ABI50_0_0EXPECT_EQ(crt.count(), kInit + 6);
}
...
TEST_P(JSITest, MultiDecoratorTest) {
  ...
  Function expectNestOne = Function::createFromHostFunction(
      ...
      [](Runtime& rt, const Value& thisVal, const Value* args, size_t count) {
        ...
        ABI50_0_0EXPECT_TRUE(funcmrt != nullptr);
        ABI50_0_0EXPECT_EQ(funcmrt->count(), 3);
        ABI50_0_0EXPECT_EQ(funcmrt->nest(), 1);
        return Value::undefined();
      });

  expectNestOne.call(mrt);

  ABI50_0_0EXPECT_EQ(mrt.count(), 3);
  ABI50_0_0EXPECT_EQ(mrt.nest(), 0);
}
...
TEST_P(JSITest, SymbolTest) {
  ...
  Object x = rt.global().getPropertyAsObject(rt, "x");
  ABI50_0_0EXPECT_EQ(x.getPropertyNames(rt).size(rt), 2);
  ABI50_0_0EXPECT_TRUE(x.hasProperty(rt, "three"));
  ABI50_0_0EXPECT_EQ(
      x.getProperty(rt, "three").getSymbol(rt).toString(rt), "Symbol(four)");

  // ValueTest
  ABI50_0_0EXPECT_TRUE(eval("Symbol('sym')").isSymbol());
  ABI50_0_0EXPECT_EQ(eval("Symbol('sym')").getSymbol(rt).toString(rt), "Symbol(sym)");

  // EqualsTest
  ABI50_0_0EXPECT_FALSE(Symbol::strictEquals(
      rt,
      eval("Symbol('a')").getSymbol(rt),
      eval("Symbol('a')").getSymbol(rt)));
  ABI50_0_0EXPECT_TRUE(Symbol::strictEquals(
      rt,
      eval("Symbol.for('a')").getSymbol(rt),
      eval("Symbol.for('a')").getSymbol(rt)));
  ABI50_0_0EXPECT_FALSE(
      Value::strictEquals(rt, eval("Symbol('a')"), eval("Symbol('a')")));
  ABI50_0_0EXPECT_TRUE(Value::strictEquals(
      rt, eval("Symbol.for('a')"), eval("Symbol.for('a')")));
  ABI50_0_0EXPECT_FALSE(Value::strictEquals(rt, eval("Symbol('a')"), eval("'a'")));
}
...
TEST_P(JSITest, JSErrorTest) {
  ...
  ABI50_0_0EXPECT_THROW(eval("throw 17;"), JSIException);

  ABI50_0_0EXPECT_THROW(eval("throw undefined;"), JSIException);
...
class HO : public HostObject {
 public:
  ...
  Value get(Runtime& rt, const PropNameID& name) override {
    ABI50_0_0EXPECT_EQ(expectedRT_, &rt);
    return Value(17.0);
  }
...
TEST_P(JSITest, MultilevelDecoratedHostObject) {
  ...
  ABI50_0_0EXPECT_TRUE(v.isNumber());
  ABI50_0_0EXPECT_EQ(17.0, v.asNumber());
  auto ho2 = obj.getHostObject(rd2);
  ABI50_0_0EXPECT_EQ(ho, ho2);
  ABI50_0_0EXPECT_EQ(1, RD1::numGets);
  ABI50_0_0EXPECT_EQ(1, RD2::numGets);
}

TEST_P(JSITest, ArrayBufferSizeTest) {
  auto ab =
      eval("var x = new ArrayBuffer(10); x").getObject(rt).getArrayBuffer(rt);
  ABI50_0_0EXPECT_EQ(ab.size(rt), 10);
