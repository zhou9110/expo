...
public class PersistentFileLog {
  private static let ABI50_0_0EXPO_MODULES_CORE_LOG_QUEUE_LABEL = "dev.expo.modules.core.logging"
  private static let serialQueue = DispatchQueue(label: ABI50_0_0EXPO_MODULES_CORE_LOG_QUEUE_LABEL)
  ...
  public init(category: String) {
    ...
    let fileName = "\(PersistentFileLog.ABI50_0_0EXPO_MODULES_CORE_LOG_QUEUE_LABEL).\(category).txt"
