...
#import "ABI50_0_0RNCWebView.h"
#import "ABI50_0_0RNCWebViewImpl.h"

#import <react/renderer/components/ABI50_0_0RNCWebViewSpec/ComponentDescriptors.h>
#import <react/renderer/components/ABI50_0_0RNCWebViewSpec/EventEmitters.h>
#import <react/renderer/components/ABI50_0_0RNCWebViewSpec/Props.h>
#import <react/renderer/components/ABI50_0_0RNCWebViewSpec/ABI50_0_0RCTComponentViewHelpers.h>
...
auto stringToOnShouldStartLoadWithRequestNavigationTypeEnum(std::string value) {
    if (value == "click") return ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequestNavigationType::Click;
    if (value == "formsubmit") return ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequestNavigationType::Formsubmit;
    if (value == "backforward") return ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequestNavigationType::Backforward;
    if (value == "reload") return ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequestNavigationType::Reload;
    if (value == "formresubmit") return ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequestNavigationType::Formresubmit;
    return ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequestNavigationType::Other;
}

auto stringToOnLoadingStartNavigationTypeEnum(std::string value) {
    if (value == "click") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingStartNavigationType::Click;
    if (value == "formsubmit") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingStartNavigationType::Formsubmit;
    if (value == "backforward") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingStartNavigationType::Backforward;
    if (value == "reload") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingStartNavigationType::Reload;
    if (value == "formresubmit") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingStartNavigationType::Formresubmit;
    return ABI50_0_0RNCWebViewEventEmitter::OnLoadingStartNavigationType::Other;
}

auto stringToOnLoadingFinishNavigationTypeEnum(std::string value) {
    if (value == "click") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinishNavigationType::Click;
    if (value == "formsubmit") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinishNavigationType::Formsubmit;
    if (value == "backforward") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinishNavigationType::Backforward;
    if (value == "reload") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinishNavigationType::Reload;
    if (value == "formresubmit") return ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinishNavigationType::Formresubmit;
    return ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinishNavigationType::Other;
}

@interface ABI50_0_0RNCWebView () <ABI50_0_0RCTRNCWebViewViewProtocol>

@end

@implementation ABI50_0_0RNCWebView {
    ABI50_0_0RNCWebViewImpl * _view;
}

+ (ComponentDescriptorProvider)componentDescriptorProvider
{
    return concreteComponentDescriptorProvider<ABI50_0_0RNCWebViewComponentDescriptor>();
}

// Reproduce the idea from here: https://github.com/facebook/react-native/blob/8bd3edec88148d0ab1f225d2119435681fbbba33/ABI50_0_0React/Fabric/Mounting/ComponentViews/InputAccessory/ABI50_0_0RCTInputAccessoryComponentView.mm#L142
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        static const auto defaultProps = std::make_shared<const ABI50_0_0RNCWebViewProps>();
        _props = defaultProps;
        
        _view = [[ABI50_0_0RNCWebViewImpl alloc] init];
        
        _view.onShouldStartLoadWithRequest = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnShouldStartLoadWithRequest data = {
        ...
        _view.onLoadingStart = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnLoadingStart data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
        ...
        _view.onLoadingError = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnLoadingError data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
        ...
        _view.onMessage = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnMessage data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
                    .canGoBack = [[dictionary valueForKey:@"canGoBack"] boolValue],
        ...
        _view.onLoadingFinish = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnLoadingFinish data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
        ...
        _view.onLoadingProgress = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnLoadingProgress data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
                    .canGoBack = [[dictionary valueForKey:@"canGoBack"] boolValue],
        ...
        _view.onContentProcessDidTerminate = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnContentProcessDidTerminate data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
                    .canGoBack = [[dictionary valueForKey:@"canGoBack"] boolValue],
        ...
        _view.onCustomMenuSelection = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnCustomMenuSelection data = {
        ...
        _view.onScroll = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                ...
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnScroll data = {
                    .contentOffset = {
        ...
        _view.onHttpError = [self](NSDictionary* dictionary) {
            if (_eventEmitter) {
                auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnHttpError data = {
                    .url = std::string([[dictionary valueForKey:@"url"] UTF8String]),
                    .lockIdentifier = [[dictionary valueForKey:@"lockIdentifier"] doubleValue],
                    .title = std::string([[dictionary valueForKey:@"title"] UTF8String]),
...
{
    const auto &oldViewProps = *std::static_pointer_cast<ABI50_0_0RNCWebViewProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<ABI50_0_0RNCWebViewProps const>(props);
...
#define REMAP_WEBVIEW_STRING_PROP(name)                             \
    if (oldViewProps.name != newViewProps.name) {                   \
        _view.name = ABI50_0_0RCTNSStringFromString(newViewProps.name);      \
    }
    ...
    if (oldViewProps.dataDetectorTypes != newViewProps.dataDetectorTypes) {
        WKDataDetectorTypes dataDetectorTypes = WKDataDetectorTypeNone;
            if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::Address) {
                dataDetectorTypes |= WKDataDetectorTypeAddress;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::Link) {
                dataDetectorTypes |= WKDataDetectorTypeLink;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::CalendarEvent) {
                dataDetectorTypes |= WKDataDetectorTypeCalendarEvent;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::TrackingNumber) {
                dataDetectorTypes |= WKDataDetectorTypeTrackingNumber;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::FlightNumber) {
                dataDetectorTypes |= WKDataDetectorTypeFlightNumber;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::LookupSuggestion) {
                dataDetectorTypes |= WKDataDetectorTypeLookupSuggestion;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::PhoneNumber) {
                dataDetectorTypes |= WKDataDetectorTypePhoneNumber;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::All) {
                dataDetectorTypes |= WKDataDetectorTypeAll;
            } else if (dataDetectorTypes & ABI50_0_0RNCWebViewDataDetectorTypes::None) {
    ...
    if (oldViewProps.basicAuthCredential.username != newViewProps.basicAuthCredential.username || oldViewProps.basicAuthCredential.password != newViewProps.basicAuthCredential.password) {
        [_view setBasicAuthCredential: @{
            @"username": ABI50_0_0RCTNSStringFromString(newViewProps.basicAuthCredential.username),
            @"password": ABI50_0_0RCTNSStringFromString(newViewProps.basicAuthCredential.password)
        }];
    }
    if (oldViewProps.contentInsetAdjustmentBehavior != newViewProps.contentInsetAdjustmentBehavior) {
        if (newViewProps.contentInsetAdjustmentBehavior == ABI50_0_0RNCWebViewContentInsetAdjustmentBehavior::Never) {
            [_view setContentInsetAdjustmentBehavior: UIScrollViewContentInsetAdjustmentNever];
        } else if (newViewProps.contentInsetAdjustmentBehavior == ABI50_0_0RNCWebViewContentInsetAdjustmentBehavior::Automatic) {
            [_view setContentInsetAdjustmentBehavior: UIScrollViewContentInsetAdjustmentAutomatic];
        } else if (newViewProps.contentInsetAdjustmentBehavior == ABI50_0_0RNCWebViewContentInsetAdjustmentBehavior::ScrollableAxes) {
            [_view setContentInsetAdjustmentBehavior: UIScrollViewContentInsetAdjustmentScrollableAxes];
        } else if (newViewProps.contentInsetAdjustmentBehavior == ABI50_0_0RNCWebViewContentInsetAdjustmentBehavior::Always) {
    ...
    if (oldViewProps.menuItems != newViewProps.menuItems) {
        ...
        for (const auto &menuItem: newViewProps.menuItems) {
            [newMenuItems addObject:@{
                @"key": ABI50_0_0RCTNSStringFromString(menuItem.key),
                @"label": ABI50_0_0RCTNSStringFromString(menuItem.label),
            }];
    ...
    if(oldViewProps.suppressMenuItems != newViewProps.suppressMenuItems) {
        ...
        for (const auto &menuItem: newViewProps.suppressMenuItems) {
            [suppressMenuItems addObject: ABI50_0_0RCTNSStringFromString(menuItem)];
        }
    ...
    if (oldViewProps.hasOnFileDownload != newViewProps.hasOnFileDownload) {
        if (newViewProps.hasOnFileDownload) {
            _view.onFileDownload = [self](NSDictionary* dictionary) {
                if (_eventEmitter) {
                    auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                    ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnFileDownload data = {
    ...
    if (oldViewProps.hasOnOpenWindowEvent != newViewProps.hasOnOpenWindowEvent) {
        if (newViewProps.hasOnOpenWindowEvent) {
            _view.onOpenWindow = [self](NSDictionary* dictionary) {
                if (_eventEmitter) {
                    auto webViewEventEmitter = std::static_pointer_cast<ABI50_0_0RNCWebViewEventEmitter const>(_eventEmitter);
                    ABI50_0_0facebook::ABI50_0_0React::ABI50_0_0RNCWebViewEventEmitter::OnOpenWindow data = {
...
//
    ...
    if (oldViewProps.contentMode != newViewProps.contentMode) {
        if (newViewProps.contentMode == ABI50_0_0RNCWebViewContentMode::Recommended) {
            [_view setContentMode: WKContentModeRecommended];
        } else if (newViewProps.contentMode == ABI50_0_0RNCWebViewContentMode::Mobile) {
            [_view setContentMode:WKContentModeMobile];
        } else if (newViewProps.contentMode == ABI50_0_0RNCWebViewContentMode::Desktop) {
    ...
    if (oldViewProps.mediaCapturePermissionGrantType != newViewProps.mediaCapturePermissionGrantType) {
        if (newViewProps.mediaCapturePermissionGrantType == ABI50_0_0RNCWebViewMediaCapturePermissionGrantType::Prompt) {
            [_view setMediaCapturePermissionGrantType:ABI50_0_0RNCWebViewPermissionGrantType_Prompt];
        } else if (newViewProps.mediaCapturePermissionGrantType == ABI50_0_0RNCWebViewMediaCapturePermissionGrantType::Grant) {
            [_view setMediaCapturePermissionGrantType:ABI50_0_0RNCWebViewPermissionGrantType_Grant];
        } else if (newViewProps.mediaCapturePermissionGrantType == ABI50_0_0RNCWebViewMediaCapturePermissionGrantType::Deny) {
            [_view setMediaCapturePermissionGrantType:ABI50_0_0RNCWebViewPermissionGrantType_Deny];
        }else if (newViewProps.mediaCapturePermissionGrantType == ABI50_0_0RNCWebViewMediaCapturePermissionGrantType::GrantIfSameHostElsePrompt) {
            [_view setMediaCapturePermissionGrantType:ABI50_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElsePrompt];
        }else if (newViewProps.mediaCapturePermissionGrantType == ABI50_0_0RNCWebViewMediaCapturePermissionGrantType::GrantIfSameHostElseDeny) {
            [_view setMediaCapturePermissionGrantType:ABI50_0_0RNCWebViewPermissionGrantType_GrantIfSameHost_ElseDeny];
        }
    }
#endif
    ...
    if (!newViewProps.newSource.uri.empty()) {
        [source setValue:ABI50_0_0RCTNSStringFromString(newViewProps.newSource.uri) forKey:@"uri"];
    }
    NSMutableDictionary* headers = [[NSMutableDictionary alloc] init];
    for (auto & element : newViewProps.newSource.headers) {
        [headers setValue:ABI50_0_0RCTNSStringFromString(element.value) forKey:ABI50_0_0RCTNSStringFromString(element.name)];
    }
    if (headers.count > 0) {
        [source setObject:headers forKey:@"headers"];
    }
    if (!newViewProps.newSource.baseUrl.empty()) {
        [source setValue:ABI50_0_0RCTNSStringFromString(newViewProps.newSource.baseUrl) forKey:@"baseUrl"];
    }
    if (!newViewProps.newSource.body.empty()) {
        [source setValue:ABI50_0_0RCTNSStringFromString(newViewProps.newSource.body) forKey:@"body"];
    }
    if (!newViewProps.newSource.html.empty()) {
        [source setValue:ABI50_0_0RCTNSStringFromString(newViewProps.newSource.html) forKey:@"html"];
    }
    if (!newViewProps.newSource.method.empty()) {
        [source setValue:ABI50_0_0RCTNSStringFromString(newViewProps.newSource.method) forKey:@"method"];
    }
...
- (void)handleCommand:(nonnull const NSString *)commandName args:(nonnull const NSArray *)args {
    ABI50_0_0RCTRNCWebViewHandleCommand(self, commandName, args);
}


Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNCWebViewCls(void)
{
    return ABI50_0_0RNCWebView.class;
}
