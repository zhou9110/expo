...
#define JSI_EXPORT_FUNCTIONS(...)                                              \
  const ABI50_0_0RNJsi::JsiFunctionMap &getExportedFunctionMap() override {             \
    static ABI50_0_0RNJsi::JsiFunctionMap map = {__VA_ARGS__};                          \
    return map;                                                                \
  }
...
#define JSI_EXPORT_PROPERTY_GETTERS(...)                                       \
  const ABI50_0_0RNJsi::JsiPropertyGettersMap &getExportedPropertyGettersMap()          \
      override {                                                               \
    static ABI50_0_0RNJsi::JsiPropertyGettersMap map = {__VA_ARGS__};                   \
    return map;                                                                \
  }
...
#define JSI_EXPORT_PROPERTY_SETTERS(...)                                       \
  const ABI50_0_0RNJsi::JsiPropertySettersMap &getExportedPropertySettersMap()          \
      override {                                                               \
    static ABI50_0_0RNJsi::JsiPropertySettersMap map = {__VA_ARGS__};                   \
    return map;                                                                \
  }

namespace ABI50_0_0RNJsi {
...
protected:
   ...
   */
  virtual const ABI50_0_0RNJsi::JsiFunctionMap &getExportedFunctionMap() {
    static const ABI50_0_0RNJsi::JsiFunctionMap empty;
    return empty;
  }
