#import "ABI50_0_0RNAWSCognito.h"
...
@implementation ABI50_0_0RNAWSCognito
...
ABI50_0_0RCT_EXPORT_SYNCHRONOUS_TYPED_METHOD(NSString*, getRandomBase64:(NSUInteger)byteLength) {
...
ABI50_0_0RCT_EXPORT_METHOD(computeModPow:(NSDictionary *)values
    ...
    if (result) {
        ...
        callback(@[@[ABI50_0_0RCTMakeError(@"computeModPow error", nil, nil)], [NSNull null]]);
    }
}

ABI50_0_0RCT_EXPORT_METHOD(computeS:(NSDictionary *)values
                  callback:(ABI50_0_0RCTResponseSenderBlock)callback) {
    ...
    if (result) {
        ...
        callback(@[@[ABI50_0_0RCTMakeError(@"computeS error", nil, nil)], [NSNull null]]);
    }
}
