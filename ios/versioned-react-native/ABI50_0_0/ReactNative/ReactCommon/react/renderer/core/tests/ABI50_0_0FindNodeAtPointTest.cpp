...
TEST(FindNodeAtPointTest, withoutTransform) {
  ...
  ABI50_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {105, 105})->getTag(), 2);
  ABI50_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {900, 900})->getTag(), 1);
  ABI50_0_0EXPECT_EQ(
...
TEST(FindNodeAtPointTest, viewIsTranslated) {
  ...
  ABI50_0_0EXPECT_EQ(
      ...
      3);
  ABI50_0_0EXPECT_EQ(LayoutableShadowNode::findNodeAtPoint(parentShadowNode, {5, 5})->getTag(), 2);
}
