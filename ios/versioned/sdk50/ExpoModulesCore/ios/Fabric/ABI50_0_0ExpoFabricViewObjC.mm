...
#import <ABI50_0_0ExpoModulesCore/ABI50_0_0ExpoViewComponentDescriptor.h>
...
/**
 ABI50_0_0React Native doesn't use the "on" prefix internally. Instead, it uses "top" but it's on the roadmap to get rid of it too.
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0expo::ExpoViewProps>();
    _props = defaultProps;
...
+ (ABI50_0_0facebook::ABI50_0_0React::ComponentDescriptorProvider)componentDescriptorProvider
{
  ...
  return ComponentDescriptorProvider {
    ...
    componentName,
    flavor,
    &ABI50_0_0facebook::ABI50_0_0React::concreteComponentDescriptorConstructor<ABI50_0_0expo::ExpoViewComponentDescriptor>
  };
}
...
- (void)dispatchEvent:(nonnull NSString *)eventName payload:(nullable id)payload
{
  _eventEmitter->dispatch([normalizeEventName(eventName) UTF8String], [payload](jsi::Runtime &runtime) {
    return jsi::Value(runtime, ABI50_0_0expo::convertObjCObjectToJSIValue(runtime, payload));
  });
}
...
- (nullable ABI50_0_0EXAppContext *)__injectedAppContext
{
