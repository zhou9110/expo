...
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0Vector.h>
...
template <>
struct hash<ABI50_0_0facebook::ABI50_0_0React::Transform> {
  size_t operator()(const ABI50_0_0facebook::ABI50_0_0React::Transform& transform) const {
