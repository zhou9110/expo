...
/**
 * The image loader (i.e. ABI50_0_0RCTImageLoader) implement this to declare whether image performance should be logged.
 */
@protocol ABI50_0_0RCTImageLoaderLoggableProtocol
 ...
 */
@protocol ABI50_0_0RCTImageLoaderLoggable
