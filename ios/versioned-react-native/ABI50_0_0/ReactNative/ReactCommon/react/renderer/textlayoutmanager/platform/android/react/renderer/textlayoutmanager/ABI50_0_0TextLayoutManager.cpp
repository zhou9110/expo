...
#include <ABI50_0_0React/common/mapbuffer/ABI50_0_0JReadableMapBuffer.h>
...
Size measureAndroidComponent(
  ...
  static auto measure =
      jni::findClassStatic("com/facebook/ABI50_0_0React/fabric/FabricUIManager")
          ->getMethod<jlong(
              jint,
              jstring,
    ...
    for (const auto& fragment : fragments) {
      ...
      if (isAttachment != fragment.items().end() &&
        ...
        auto rect = ABI50_0_0facebook::ABI50_0_0React::Rect{
            {left, top}, ABI50_0_0facebook::ABI50_0_0React::Size{width, height}};
