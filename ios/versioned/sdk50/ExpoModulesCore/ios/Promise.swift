...
public struct Promise: AnyArgument {
  ...
  /**
   The rejecter that is compatible with the legacy `ABI50_0_0EXPromiseRejectBlock`.
   Necessary in some places not converted to Swift, such as `ABI50_0_0EXPermissionsMethodsDelegate`.
   */
  public var legacyRejecter: ABI50_0_0EXPromiseRejectBlock {
