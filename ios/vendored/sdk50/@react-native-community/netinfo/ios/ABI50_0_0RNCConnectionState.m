...
@implementation ABI50_0_0RNCConnectionState
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        _type = ABI50_0_0RNCConnectionTypeUnknown;
...
- (instancetype)initWithReachabilityFlags:(SCNetworkReachabilityFlags)flags
{
    ...
    if (self) {
        ...
        if ((flags & kSCNetworkReachabilityFlagsReachable) == 0 ||
            ...
            _type = ABI50_0_0RNCConnectionTypeNone;
        }
#if !TARGET_OS_TV && !TARGET_OS_OSX && !TARGET_OS_MACCATALYST
        else if ((flags & kSCNetworkReachabilityFlagsIsWWAN) != 0) {
            _type = ABI50_0_0RNCConnectionTypeCellular;
            _expensive = true;
            ...
            if (netinfo) {
                if ([netinfo.currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyGPRS] ||
                    ...
                    _cellularGeneration = ABI50_0_0RNCCellularGeneration2g;
                    ...
                    _cellularGeneration = ABI50_0_0RNCCellularGeneration3g;
                } else if ([netinfo.currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyLTE]) {
                    _cellularGeneration = ABI50_0_0RNCCellularGeneration4g;
                    ...
                    if ([netinfo.currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyNRNSA] ||
                        ...
                        _cellularGeneration = ABI50_0_0RNCCellularGeneration5g;
                    }
                }
            }
        }
            ...
            _type = ABI50_0_0RNCConnectionTypeWifi;
#if TARGET_OS_TV || TARGET_OS_OSX || TARGET_OS_MACCATALYST
                ...
                while (temp_addr != NULL) {
                    if (temp_addr->ifa_addr->sa_family == AF_INET) {
                        ...
                        if ([ifname isEqualToString:@"en0"]) {
                            _type = ABI50_0_0RNCConnectionTypeEthernet;
                        }
                    }
...
- (BOOL)connected
{
    return ![self.type isEqualToString:ABI50_0_0RNCConnectionTypeNone] && ![self.type isEqualToString:ABI50_0_0RNCConnectionTypeUnknown];
}
