...
#include "ABI50_0_0LayoutAnimationKeyFrameManager.h"
...
#include <ABI50_0_0React/renderer/animations/ABI50_0_0conversions.h>
#include <ABI50_0_0React/renderer/animations/ABI50_0_0utils.h>
#include <ABI50_0_0React/renderer/componentregistry/ABI50_0_0ComponentDescriptorFactory.h>
#include <react/renderer/components/image/ABI50_0_0ImageProps.h>
#include <ABI50_0_0React/renderer/components/view/ABI50_0_0ViewProps.h>
#include <ABI50_0_0React/renderer/components/view/ABI50_0_0ViewPropsInterpolation.h>
...
LayoutAnimationKeyFrameManager::pullTransaction(
  ...
  if (!mutations.empty()) {
#ifdef ABI50_0_0RN_SHADOW_TREE_INTROSPECTION
    {
    ...
    if (currentAnimation.has_value()) {
      ...
      for (const auto& mutation : mutations) {
        ...
        ABI50_0_0React_native_assert(baselineShadowView.tag > 0);
          ...
          if (mutation.type == ShadowViewMutation::Type::Insert) {
            for (auto& keyframe : keyFramesToAnimate) {
              if (keyframe.tag == baselineShadowView.tag) {
                ...
                // "newChildShadowView"
                ABI50_0_0React_native_assert(mutation.newChildShadowView.tag > 0);
            ...
            for (auto& keyframe : keyFramesToAnimate) {
              if (keyframe.tag == baselineShadowView.tag) {
                ...
                // "oldChildShadowView"
                ABI50_0_0React_native_assert(mutation.oldChildShadowView.tag > 0);
        ...
        if (!wasInsertedTagRemoved && !isRemoveReinserted && !isReparented &&
          ...
          ShadowView viewStart = ShadowView(
              mutation.type == ShadowViewMutation::Type::Insert
                  ? mutation.newChildShadowView
                  : mutation.oldChildShadowView);
          ABI50_0_0React_native_assert(viewStart.tag > 0);
          ShadowView viewFinal = ShadowView(
              mutation.type == ShadowViewMutation::Type::Update
                  ? mutation.newChildShadowView
                  : viewStart);
          ABI50_0_0React_native_assert(viewFinal.tag > 0);
          ...
          if (mutation.type == ShadowViewMutation::Type::Insert) {
            if (mutationConfig.animationProperty ==
              ...
              ABI50_0_0React_native_assert(props != nullptr);
              if (props != nullptr) {
...
/*            Tag deleteTag = mutation.oldChildShadowView.tag;
            ...
            ABI50_0_0React_native_assert(correspondingRemoveIt != mutations.end());
*/
#endif
#endif
            continue;
            ...
            if (correspondingInsertIt == mutations.end()) {
              ...
              ABI50_0_0React_native_assert(correspondingDeleteIt != mutations.end());
          ...
          for (auto& conflictingKeyFrame : conflictingAnimations) {
            ...
            if (conflictingMutationBaselineShadowView.tag == tag) {
              ...
              ABI50_0_0React_native_assert(keyFrame.viewStart.tag > 0);
...
#endif
          ABI50_0_0React_native_assert(keyFrame.viewStart.tag > 0);
          ABI50_0_0React_native_assert(keyFrame.viewEnd.tag > 0);
          ABI50_0_0React_native_assert(keyFrame.viewPrev.tag > 0);
...
ShadowView LayoutAnimationKeyFrameManager::createInterpolatedShadowView(
  ...
  ABI50_0_0React_native_assert(startingView.tag > 0);
  ABI50_0_0React_native_assert(finalView.tag > 0);
  if (!hasComponentDescriptorForShadowView(startingView)) {
    LOG(ERROR) << "No ComponentDescriptor for ShadowView being animated: ["
               << startingView.tag << "]";
    ABI50_0_0React_native_assert(false);
    return finalView;
  }
  ...
  ABI50_0_0React_native_assert(mutatedShadowView.tag > 0);

  ABI50_0_0React_native_assert(startingView.props != nullptr);
  ABI50_0_0React_native_assert(finalView.props != nullptr);
  ...
  ABI50_0_0React_native_assert(mutatedShadowView.props != nullptr);
...
void LayoutAnimationKeyFrameManager::queueFinalMutationsForCompletedKeyFrame(
  ...
  if (!keyframe.finalMutationsForKeyFrame.empty()) {
    ...
    if (interrupted) {
      ...
      ABI50_0_0React_native_assert(generatedMutation.oldChildShadowView.tag > 0);
      ABI50_0_0React_native_assert(generatedMutation.newChildShadowView.tag > 0);
      PrintMutationInstruction(
...
void LayoutAnimationKeyFrameManager::adjustDelayedMutationIndicesForMutation(
  ...
  auto tag = isRemoveMutation ? mutation.oldChildShadowView.tag
                              : mutation.newChildShadowView.tag;
  ABI50_0_0React_native_assert(isRemoveMutation || isInsertMutation);
