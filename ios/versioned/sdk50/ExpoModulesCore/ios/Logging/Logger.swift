...
public let log = Logger(category: Logger.ABI50_0_0EXPO_LOG_CATEGORY)
 ...
 */
public class Logger {
  public static let ABI50_0_0EXPO_MODULES_LOG_SUBSYSTEM = "dev.expo.modules"
  public static let ABI50_0_0EXPO_LOG_CATEGORY = "expo"

  #if DEBUG || ABI50_0_0EXPO_CONFIGURATION_DEBUG
