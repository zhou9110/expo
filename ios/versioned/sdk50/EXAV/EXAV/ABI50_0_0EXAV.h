...
typedef NS_OPTIONS(NSUInteger, ABI50_0_0EXAudioInterruptionMode)
{
  ABI50_0_0EXAudioInterruptionModeMixWithOthers = 0,
  ABI50_0_0EXAudioInterruptionModeDoNotMix      = 1,
  ABI50_0_0EXAudioInterruptionModeDuckOthers    = 2
};

typedef NS_OPTIONS(NSUInteger, ABI50_0_0EXAudioRecordingOptionBitRateStrategy)
{
  ABI50_0_0EXAudioRecordingOptionBitRateStrategyConstant            = 0,
  ABI50_0_0EXAudioRecordingOptionBitRateStrategyLongTermAverage     = 1,
  ABI50_0_0EXAudioRecordingOptionBitRateStrategyVariableConstrained = 2,
  ABI50_0_0EXAudioRecordingOptionBitRateStrategyVariable            = 3
};

@protocol ABI50_0_0EXAVScopedModuleDelegate
...
@protocol ABI50_0_0EXAVInterface
...
@interface ABI50_0_0EXAV : ABI50_0_0EXExportedModule <ABI50_0_0RCTBridgeModule, ABI50_0_0EXEventEmitter, ABI50_0_0EXAppLifecycleListener, ABI50_0_0EXModuleRegistryConsumer, ABI50_0_0EXAVInterface>
