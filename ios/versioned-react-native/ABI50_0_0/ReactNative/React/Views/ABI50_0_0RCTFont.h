...
typedef UIFont * (^ABI50_0_0RCTFontHandler)(CGFloat fontSize, NSString *fontWeightDescription);

/**
 * ABI50_0_0React Native will use the System font for rendering by default. If you want to
 ...
 */
ABI50_0_0RCT_EXTERN void ABI50_0_0RCTSetDefaultFontHandler(ABI50_0_0RCTFontHandler handler);
ABI50_0_0RCT_EXTERN BOOL ABI50_0_0RCTHasFontHandlerSet(void);

@interface ABI50_0_0RCTFont : NSObject
...
@interface ABI50_0_0RCTConvert (ABI50_0_0RCTFont)
