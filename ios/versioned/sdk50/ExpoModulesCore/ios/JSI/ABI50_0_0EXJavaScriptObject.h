...
@class ABI50_0_0EXJavaScriptWeakObject;

/**
 The property descriptor options for the property being defined or modified.
 */
typedef NS_OPTIONS(NSInteger, ABI50_0_0EXJavaScriptObjectPropertyDescriptor) {
  /**
