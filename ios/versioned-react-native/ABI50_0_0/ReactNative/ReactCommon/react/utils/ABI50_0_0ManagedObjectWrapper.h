...
@interface ABI50_0_0RCTInternalGenericWeakWrapper : NSObject
...
{
  ABI50_0_0RCTInternalGenericWeakWrapper *weakWrapper = [ABI50_0_0RCTInternalGenericWeakWrapper new];
...
{
  ABI50_0_0RCTInternalGenericWeakWrapper *weakWrapper = (ABI50_0_0RCTInternalGenericWeakWrapper *)unwrapManagedObject(object);
  ABI50_0_0React_native_assert(weakWrapper && "`ABI50_0_0RCTInternalGenericWeakWrapper` instance must not be `nil`.");
