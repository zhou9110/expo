...
@implementation ABI50_0_0RCTPropsAnimatedNode {
     ...
     surfacePresenter:(id<ABI50_0_0RCTSurfacePresenterStub>)surfacePresenter
{
  ...
  _managedByFabric = ABI50_0_0RCTUIManagerTypeForTagIsFabric(viewTag);
}
...
- (void)performUpdate
{
  ...
  for (NSNumber *parentTag in self.parentNodes.keyEnumerator) {
    ABI50_0_0RCTAnimatedNode *parentNode = [self.parentNodes objectForKey:parentTag];
    if ([parentNode isKindOfClass:[ABI50_0_0RCTStyleAnimatedNode class]]) {
      ABI50_0_0RCTStyleAnimatedNode *styleAnimatedNode = (ABI50_0_0RCTStyleAnimatedNode *)parentNode;
      [_propsDictionary addEntriesFromDictionary:styleAnimatedNode.propsDictionary];
    } else if ([parentNode isKindOfClass:[ABI50_0_0RCTValueAnimatedNode class]]) {
      ABI50_0_0RCTValueAnimatedNode *valueAnimatedNode = (ABI50_0_0RCTValueAnimatedNode *)parentNode;
    ...
    } else if ([parentNode isKindOfClass:[ABI50_0_0RCTColorAnimatedNode class]]) {
      ABI50_0_0RCTColorAnimatedNode *colorAnimatedNode = (ABI50_0_0RCTColorAnimatedNode *)parentNode;
      NSString *property = [self propertyNameForParentTag:parentTag];
      _propsDictionary[property] = @(colorAnimatedNode.color);
    } else if ([parentNode isKindOfClass:[ABI50_0_0RCTObjectAnimatedNode class]]) {
      ABI50_0_0RCTObjectAnimatedNode *objectAnimatedNode = (ABI50_0_0RCTObjectAnimatedNode *)parentNode;
      NSString *property = [self propertyNameForParentTag:parentTag];
