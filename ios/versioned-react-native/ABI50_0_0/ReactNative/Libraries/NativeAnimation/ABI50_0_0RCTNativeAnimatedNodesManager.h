...
@protocol ABI50_0_0RCTValueAnimatedNodeObserver;

NS_ASSUME_NONNULL_BEGIN

@interface ABI50_0_0RCTNativeAnimatedNodesManager : NSObject

- (nonnull instancetype)initWithBridge:(nullable ABI50_0_0RCTBridge *)bridge
