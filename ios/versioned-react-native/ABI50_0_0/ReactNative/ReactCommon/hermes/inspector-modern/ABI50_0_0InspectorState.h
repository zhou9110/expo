...
// with MSVC and BUCK
#ifndef HERMES_INSPECTOR_MODERN_INSPECTOR_STATE_H
#define HERMES_INSPECTOR_MODERN_INSPECTOR_STATE_H
...
using CommandPtr = std::unique_ptr<ABI50_0_0facebook::ABI50_0_0hermes::debugger::Command>;
 ...
 * JS. For instance, ABI50_0_0React Native could be blocked in a native message queue
...
#endif // HERMES_INSPECTOR_MODERN_INSPECTOR_STATE_H
