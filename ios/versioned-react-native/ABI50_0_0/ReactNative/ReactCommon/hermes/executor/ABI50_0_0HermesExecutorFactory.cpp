...
#include "ABI50_0_0HermesExecutorFactory.h"
...
class HermesExecutorRuntimeAdapter
    : public ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern::RuntimeAdapter {
 public:
...
class DecoratedRuntime : public jsi::WithRuntimeDecorator<ReentrancyCheck> {
 public:
  ...
  DecoratedRuntime(
    ...
    if (enableDebugger_) {
      ...
      debugToken_ = ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern::chrome::enableDebugging(
...
#ifdef HERMES_ENABLE_DEBUGGER
    if (enableDebugger_) {
      ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern::chrome::disableDebugging(debugToken_);
    }
#endif // HERMES_ENABLE_DEBUGGER
  }
 ...
 private:
  ...
  ABI50_0_0facebook::ABI50_0_0hermes::inspector_modern::chrome::DebugSessionToken debugToken_;
#endif // HERMES_ENABLE_DEBUGGER
};
...
std::unique_ptr<JSExecutor> HermesExecutorFactory::createJSExecutor(
  ...
  std::unique_ptr<HermesRuntime> hermesRuntime;
  {
    ...
    hermesRuntime = ABI50_0_0hermes::makeHermesRuntime(runtimeConfig_);
  }
...
::ABI50_0_0hermes::vm::RuntimeConfig HermesExecutorFactory::defaultRuntimeConfig() {
  return ::ABI50_0_0hermes::vm::RuntimeConfig::Builder()
