...
public:
  JsiBaseImageFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
                         const char *type)
...
public:
  explicit JsiBlendImageFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiBlurImageFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
