...
#include <ABI50_0_0React/renderer/mounting/ABI50_0_0Differentiator.h>
#include <ABI50_0_0React/renderer/mounting/ABI50_0_0stubs.h>

#include <ABI50_0_0React/test_utils/ABI50_0_0shadowTreeGeneration.h>
...
static SharedViewProps nonFlattenedDefaultProps(
  ...
  contextContainer.insert(
      "ABI50_0_0ReactNativeConfig", std::make_shared<EmptyABI50_0_0ReactNativeConfig>());
...
TEST(MountingTest, testReorderingInstructionGeneration) {
  ...
  ABI50_0_0EXPECT_TRUE(mutations1.size() == 2);
  ABI50_0_0EXPECT_TRUE(mutations1[0].type == ShadowViewMutation::Create);
  ABI50_0_0EXPECT_TRUE(mutations1[0].newChildShadowView.tag == 100);
  ABI50_0_0EXPECT_TRUE(mutations1[1].type == ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_TRUE(mutations1[1].newChildShadowView.tag == 100);
  ABI50_0_0EXPECT_TRUE(mutations1[1].index == 0);
  ...
  ABI50_0_0EXPECT_TRUE(mutations2.size() == 2);
  ABI50_0_0EXPECT_TRUE(mutations2[0].type == ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_TRUE(mutations2[0].oldChildShadowView.tag == 100);
  ABI50_0_0EXPECT_TRUE(mutations2[0].index == 0);
  ABI50_0_0EXPECT_TRUE(mutations2[1].type == ShadowViewMutation::Delete);
  ABI50_0_0EXPECT_TRUE(mutations2[1].oldChildShadowView.tag == 100);
  ...
  // end.
  ABI50_0_0EXPECT_TRUE(mutations3.size() == 4);
  ABI50_0_0EXPECT_TRUE(mutations3[0].type == ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_TRUE(mutations3[0].oldChildShadowView.tag == 102);
  ABI50_0_0EXPECT_TRUE(mutations3[0].index == 1);
  ABI50_0_0EXPECT_TRUE(mutations3[1].type == ShadowViewMutation::Delete);
  ABI50_0_0EXPECT_TRUE(mutations3[1].oldChildShadowView.tag == 102);
  ABI50_0_0EXPECT_TRUE(mutations3[2].type == ShadowViewMutation::Create);
  ABI50_0_0EXPECT_TRUE(mutations3[2].newChildShadowView.tag == 104);
  ABI50_0_0EXPECT_TRUE(mutations3[3].type == ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_TRUE(mutations3[3].newChildShadowView.tag == 104);
  ABI50_0_0EXPECT_TRUE(mutations3[3].index == 2);
  ...
  // moving them around does not change layout.
  ABI50_0_0EXPECT_TRUE(mutations4.size() == 6);
  ABI50_0_0EXPECT_TRUE(mutations4[0].type == ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_TRUE(mutations4[0].oldChildShadowView.tag == 103);
  ABI50_0_0EXPECT_TRUE(mutations4[0].index == 1);
  ABI50_0_0EXPECT_TRUE(mutations4[1].type == ShadowViewMutation::Delete);
  ABI50_0_0EXPECT_TRUE(mutations4[1].oldChildShadowView.tag == 103);
  ABI50_0_0EXPECT_TRUE(mutations4[2].type == ShadowViewMutation::Create);
  ABI50_0_0EXPECT_TRUE(mutations4[2].newChildShadowView.tag == 100);
  ABI50_0_0EXPECT_TRUE(mutations4[3].type == ShadowViewMutation::Create);
  ABI50_0_0EXPECT_TRUE(mutations4[3].newChildShadowView.tag == 102);
  ABI50_0_0EXPECT_TRUE(mutations4[4].type == ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_TRUE(mutations4[4].newChildShadowView.tag == 100);
  ABI50_0_0EXPECT_TRUE(mutations4[4].index == 1);
  ABI50_0_0EXPECT_TRUE(mutations4[5].type == ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_TRUE(mutations4[5].newChildShadowView.tag == 102);
  ABI50_0_0EXPECT_TRUE(mutations4[5].index == 3);
  ...
  ABI50_0_0EXPECT_TRUE(mutations5.size() == 4);
  ABI50_0_0EXPECT_TRUE(mutations5[0].type == ShadowViewMutation::Create);
  ABI50_0_0EXPECT_TRUE(mutations5[0].newChildShadowView.tag == 103);
  ABI50_0_0EXPECT_TRUE(mutations5[1].type == ShadowViewMutation::Create);
  ABI50_0_0EXPECT_TRUE(mutations5[1].newChildShadowView.tag == 105);
  ABI50_0_0EXPECT_TRUE(mutations5[2].type == ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_TRUE(mutations5[2].newChildShadowView.tag == 103);
  ABI50_0_0EXPECT_TRUE(mutations5[2].index == 2);
  ABI50_0_0EXPECT_TRUE(mutations5[3].type == ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_TRUE(mutations5[3].newChildShadowView.tag == 105);
  ABI50_0_0EXPECT_TRUE(mutations5[3].index == 3);
  ...
  // 105.
  ABI50_0_0EXPECT_TRUE(mutations6.size() == 25);
  for (auto& i : mutations6) {
    if (i.type == ShadowViewMutation::Create) {
      ABI50_0_0EXPECT_TRUE(i.newChildShadowView.tag > 105);
    }
  }
}
...
TEST(MountingTest, testViewReparentingInstructionGeneration) {
  ...
  ABI50_0_0EXPECT_EQ(mutations1.size(), 5);
  ABI50_0_0EXPECT_EQ(mutations1[0].type, ShadowViewMutation::Update);
  ABI50_0_0EXPECT_EQ(mutations1[0].oldChildShadowView.tag, 106);
  ABI50_0_0EXPECT_EQ(mutations1[1].type, ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_EQ(mutations1[1].oldChildShadowView.tag, 1000);
  ABI50_0_0EXPECT_EQ(mutations1[2].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations1[2].newChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(mutations1[3].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations1[3].newChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(mutations1[4].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations1[4].newChildShadowView.tag, 1000);

  auto mutations2 = calculateShadowViewMutations(*rootNodeV2, *rootNodeV3);

  ABI50_0_0EXPECT_EQ(mutations2.size(), 5);
  ABI50_0_0EXPECT_EQ(mutations2[0].type, ShadowViewMutation::Update);
  ABI50_0_0EXPECT_EQ(mutations2[0].oldChildShadowView.tag, 106);
  ABI50_0_0EXPECT_EQ(mutations2[1].type, ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_EQ(mutations2[1].oldChildShadowView.tag, 1000);
  ABI50_0_0EXPECT_EQ(mutations2[2].type, ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_EQ(mutations2[2].oldChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(
      mutations2[3].type,
      ShadowViewMutation::Delete); // correct, 107 is removed from tree entirely
  ABI50_0_0EXPECT_EQ(mutations2[3].oldChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(mutations2[4].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations2[4].newChildShadowView.tag, 1000);
  ...
  ABI50_0_0EXPECT_EQ(mutations3.size(), 15);
  ABI50_0_0EXPECT_EQ(mutations3[0].type, ShadowViewMutation::Update);
  ABI50_0_0EXPECT_EQ(mutations3[0].oldChildShadowView.tag, 106);
  ABI50_0_0EXPECT_EQ(mutations3[1].type, ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_EQ(mutations3[1].oldChildShadowView.tag, 1000);
  ABI50_0_0EXPECT_EQ(mutations3[2].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations3[2].newChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(mutations3[3].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations3[3].newChildShadowView.tag, 2000);
  ABI50_0_0EXPECT_EQ(mutations3[4].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations3[4].newChildShadowView.tag, 108);
  ABI50_0_0EXPECT_EQ(mutations3[5].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations3[5].newChildShadowView.tag, 105);
  ABI50_0_0EXPECT_EQ(mutations3[6].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations3[6].newChildShadowView.tag, 104);
  ABI50_0_0EXPECT_EQ(mutations3[7].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations3[7].newChildShadowView.tag, 103);
  ABI50_0_0EXPECT_EQ(mutations3[8].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[8].newChildShadowView.tag, 105);
  ABI50_0_0EXPECT_EQ(mutations3[9].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[9].newChildShadowView.tag, 104);
  ABI50_0_0EXPECT_EQ(mutations3[10].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[10].newChildShadowView.tag, 103);
  ABI50_0_0EXPECT_EQ(mutations3[11].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[11].newChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(mutations3[12].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[12].newChildShadowView.tag, 108);
  ABI50_0_0EXPECT_EQ(mutations3[13].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[13].newChildShadowView.tag, 2000);
  ABI50_0_0EXPECT_EQ(mutations3[14].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations3[14].newChildShadowView.tag, 1000);

  auto mutations4 = calculateShadowViewMutations(*rootNodeV4, *rootNodeV5);

  ABI50_0_0EXPECT_EQ(mutations4.size(), 9);
  ABI50_0_0EXPECT_EQ(mutations4[0].type, ShadowViewMutation::Update);
  ABI50_0_0EXPECT_EQ(mutations4[0].oldChildShadowView.tag, 106);
  ABI50_0_0EXPECT_EQ(mutations4[1].type, ShadowViewMutation::Update);
  ABI50_0_0EXPECT_EQ(mutations4[1].oldChildShadowView.tag, 107);
  ABI50_0_0EXPECT_EQ(mutations4[2].type, ShadowViewMutation::Update);
  ABI50_0_0EXPECT_EQ(mutations4[2].oldChildShadowView.tag, 108);
  ABI50_0_0EXPECT_EQ(mutations4[3].type, ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_EQ(mutations4[3].oldChildShadowView.tag, 1000);
  ABI50_0_0EXPECT_EQ(mutations4[4].type, ShadowViewMutation::Remove);
  ABI50_0_0EXPECT_EQ(mutations4[4].oldChildShadowView.tag, 2000);
  ABI50_0_0EXPECT_EQ(mutations4[5].type, ShadowViewMutation::Create);
  ABI50_0_0EXPECT_EQ(mutations4[5].newChildShadowView.tag, 109);
  ABI50_0_0EXPECT_EQ(mutations4[6].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations4[6].newChildShadowView.tag, 109);
  ABI50_0_0EXPECT_EQ(mutations4[7].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations4[7].newChildShadowView.tag, 1000);
  ABI50_0_0EXPECT_EQ(mutations4[8].type, ShadowViewMutation::Insert);
  ABI50_0_0EXPECT_EQ(mutations4[8].newChildShadowView.tag, 2000);
}
