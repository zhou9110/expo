...
#import "ABI50_0_0ReactNativePageView.h"
...
@interface ABI50_0_0ReactNativePageView () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate>

@property(nonatomic, assign) UIPanGestureRecognizer* panGestureRecognizer;

@property(nonatomic, strong) UIPageViewController *reactPageViewController;
@property(nonatomic, strong) ABI50_0_0RCTEventDispatcher *eventDispatcher;
...
@implementation ABI50_0_0ReactNativePageView {
    uint16_t _coalescingKey;
}

- (instancetype)initWithEventDispatcher:(ABI50_0_0RCTEventDispatcher *)eventDispatcher {
    if (self = [super init]) {
        _scrollEnabled = YES;
        _pageMargin = 0;
...
- (void)didUpdateABI50_0_0ReactSubviews {
    if (!self.reactPageViewController && self.ABI50_0_0ReactViewController != nil) {
        [self embed];
...
- (void)didMoveToWindow {
    ...
    if (self.ABI50_0_0ReactViewController.navigationController != nil && self.ABI50_0_0ReactViewController.navigationController.interactivePopGestureRecognizer != nil) {
        [self.scrollView.panGestureRecognizer requireGestureRecognizerToFail:self.ABI50_0_0ReactViewController.navigationController.interactivePopGestureRecognizer];
    }
}
...
- (void)embed {
    ...
    [self ABI50_0_0ReactAddControllerToClosestParent:pageViewController];
...
- (void)setupInitialController {
    UIView *initialView = self.ABI50_0_0ReactSubviews[self.initialPage];
    if (initialView) {
        UIViewController *initialController = nil;
        if (initialView.ABI50_0_0ReactViewController) {
            initialController = initialView.ABI50_0_0ReactViewController;
        } else {
        ...
        [self setABI50_0_0ReactViewControllers:self.initialPage
...
- (void)setABI50_0_0ReactViewControllers:(NSInteger)index
    ...
    __weak ABI50_0_0ReactNativePageView *weakSelf = self;
        ...
        if (strongSelf.eventDispatcher) {
            if (strongSelf.lastReportedIndex != strongSelf.currentIndex) {
                if (shouldCallOnPageSelected) {
                    [strongSelf.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageSelected alloc] initWithABI50_0_0ReactTag:strongSelf.ABI50_0_0ReactTag position:@(index) coalescingKey:coalescingKey]];
                }
...
- (UIViewController *)findCachedControllerForView:(UIView *)view {
    for (UIViewController *controller in self.cachedControllers) {
        if (controller.view.ABI50_0_0ReactTag == view.ABI50_0_0ReactTag) {
            return controller;
        }
    }
    return nil;
...
- (void)updateDataSource {
    if (!self.currentView && self.ABI50_0_0ReactSubviews.count == 0) {
        return;
    }
    
    NSInteger newIndex = self.currentView ? [self.ABI50_0_0ReactSubviews indexOfObject:self.currentView] : 0;
    
    if (newIndex == NSNotFound) {
        //Current view was removed
        NSInteger maxPage = self.ABI50_0_0ReactSubviews.count - 1;
...
- (void)goTo:(NSInteger)index animated:(BOOL)animated {
    NSInteger numberOfPages = self.ABI50_0_0ReactSubviews.count;
...
- (void)goToViewController:(NSInteger)index
                            ...
                            animated:(BOOL)animated
                            shouldCallOnPageSelected:(BOOL)shouldCallOnPageSelected {
    UIView *viewToDisplay = self.ABI50_0_0ReactSubviews[index];
    UIViewController *controllerToDisplay = [self findAndCacheControllerForView:viewToDisplay];
    [self setABI50_0_0ReactViewControllers:index
...
- (UIViewController *)findAndCacheControllerForView:(UIView *)viewToDisplay {
    ...
    if (!controllerToDisplay && current.view.ABI50_0_0ReactTag == viewToDisplay.ABI50_0_0ReactTag) {
        controllerToDisplay = current;
    }
    if (!controllerToDisplay) {
        if (viewToDisplay.ABI50_0_0ReactViewController) {
            controllerToDisplay = viewToDisplay.ABI50_0_0ReactViewController;
        } else {
...
- (UIViewController *)nextControllerForController:(UIViewController *)controller
    ...
    NSUInteger numberOfPages = self.ABI50_0_0ReactSubviews.count;
    NSInteger index = [self.ABI50_0_0ReactSubviews indexOfObject:controller.view];
...
- (void)pageViewController:(UIPageViewController *)pageViewController
   ...
   previousViewControllers:(nonnull NSArray<UIViewController *> *)previousViewControllers
    ...
    if (completed) {
        ...
        NSUInteger currentIndex = [self.ABI50_0_0ReactSubviews indexOfObject:currentVC.view];
        
        self.currentIndex = currentIndex;
        self.currentView = currentVC.view;
        [self.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageSelected alloc] initWithABI50_0_0ReactTag:self.ABI50_0_0ReactTag position:@(currentIndex) coalescingKey:_coalescingKey++]];
        [self.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageScrollEvent alloc] initWithABI50_0_0ReactTag:self.ABI50_0_0ReactTag position:@(currentIndex) offset:@(0.0)]];
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [self.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageScrollStateChanged alloc] initWithABI50_0_0ReactTag:self.ABI50_0_0ReactTag state:@"dragging" coalescingKey:_coalescingKey++]];
}

- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset {
    [self.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageScrollStateChanged alloc] initWithABI50_0_0ReactTag:self.ABI50_0_0ReactTag state:@"settling" coalescingKey:_coalescingKey++]];
    
    if (!_overdrag) {
        NSInteger maxIndex = self.ABI50_0_0ReactSubviews.count - 1;
        ...
        if ((isFirstPage && contentOffset <= topBound) || (isLastPage && contentOffset >= topBound)) {
            ...
            *targetContentOffset = croppedOffset;
            ...
            [self.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageScrollStateChanged alloc] initWithABI50_0_0ReactTag:self.ABI50_0_0ReactTag state:@"idle" coalescingKey:_coalescingKey++]];
        }
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    [self.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageScrollEvent alloc] initWithABI50_0_0ReactTag:self.ABI50_0_0ReactTag position:@(position) offset:@(interpolatedOffset)]];
}
