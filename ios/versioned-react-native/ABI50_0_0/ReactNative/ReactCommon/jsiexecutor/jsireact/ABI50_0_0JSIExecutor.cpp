...
#include <ABI50_0_0Reactperflogger/ABI50_0_0BridgeNativeModulePerfLogger.h>
...
void JSIExecutor::initializeRuntime() {
  ...
  bool hasLogger(ABI50_0_0ReactMarker::logTaggedMarkerImpl);
  if (hasLogger) {
    ABI50_0_0ReactMarker::logMarker(ABI50_0_0ReactMarker::CREATE_REACT_CONTEXT_STOP);
  }
}
...
void JSIExecutor::loadBundle(
  ...
  if (hasLogger) {
    ABI50_0_0ReactMarker::logTaggedMarker(
  ...
  if (hasLogger) {
    ...
    ABI50_0_0ReactMarker::logMarker(ABI50_0_0ReactMarker::INIT_REACT_RUNTIME_STOP);
    ABI50_0_0ReactMarker::logMarker(ABI50_0_0ReactMarker::APP_STARTUP_STOP);
  }
}
        ...
        Function::createFromHostFunction(
            *runtime_,
            ...
            [this](
                ...
                const ABI50_0_0facebook::jsi::Value&,
...
Value JSIExecutor::nativeRequire(const Value* args, size_t count) {
  ...
  return ABI50_0_0facebook::jsi::Value();
}
...
Value JSIExecutor::nativeCallSyncHook(const Value* args, size_t count) {
  ...
  /**
   * Note:
   * In ABI50_0_0RCTNativeModule, std::nullopt is returned from
