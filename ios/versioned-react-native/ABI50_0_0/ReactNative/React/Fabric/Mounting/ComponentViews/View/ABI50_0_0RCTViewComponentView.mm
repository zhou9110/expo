...
#import "ABI50_0_0RCTViewComponentView.h"
...
#import <ABI50_0_0React/ABI50_0_0RCTBorderDrawing.h>
#import <ABI50_0_0React/ABI50_0_0RCTConversions.h>
#import <ABI50_0_0React/ABI50_0_0RCTLocalizedString.h>
#import <ABI50_0_0React/renderer/components/view/ABI50_0_0ViewComponentDescriptor.h>
#import <ABI50_0_0React/renderer/components/view/ABI50_0_0ViewEventEmitter.h>
#import <ABI50_0_0React/renderer/components/view/ABI50_0_0ViewProps.h>
#import <ABI50_0_0React/renderer/components/view/ABI50_0_0accessibilityPropsConversions.h>

#ifdef ABI50_0_0RCT_DYNAMIC_FRAMEWORKS
#import <ABI50_0_0React/ABI50_0_0RCTComponentViewFactory.h>
#endif

using namespace ABI50_0_0facebook::ABI50_0_0React;

@implementation ABI50_0_0RCTViewComponentView {
...
+ (void)load
{
  [ABI50_0_0RCTComponentViewFactory.currentComponentViewFactory registerComponentViewClass:self];
}
#endif
...
- (void)setContentView:(UIView *)contentView
{
  ...
  if (_contentView) {
    ...
    _contentView.frame = ABI50_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI50_0_0RCTAssert(
      self == [ABI50_0_0RCTViewComponentView class],
      @"`+[ABI50_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
{
  if (_removeClippedSubviews) {
    [_ABI50_0_0ReactSubviews removeObjectAtIndex:index];
  } else {
    ABI50_0_0RCTAssert(
...
- (void)updateClippedSubviewsWithClipRect:(CGRect)clipRect relativeToView:(UIView *)clipView
{
  ...
  if (_ABI50_0_0ReactSubviews.count == 0) {
  ...
  // Mount / unmount views
  for (UIView *view in _ABI50_0_0ReactSubviews) {
...
{
  ABI50_0_0RCTAssert(props, @"`props` must not be `null`.");

#ifndef NS_BLOCK_ASSERTIONS
  auto propsRawPtr = _props.get();
  ABI50_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI50_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI50_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.removeClippedSubviews != newViewProps.removeClippedSubviews) {
    ...
    if (_removeClippedSubviews && self.subviews.count > 0) {
      _ABI50_0_0ReactSubviews = [NSMutableArray arrayWithArray:self.subviews];
    }
  }

  // `backgroundColor`
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI50_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI50_0_0RCTCreateCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI50_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if ((oldViewProps.transform != newViewProps.transform ||
    ...
    self.layer.transform = ABI50_0_0RCTCATransform3DFromTransformMatrix(newTransform);
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }
  ...
  if (oldViewProps.accessibilityLanguage != newViewProps.accessibilityLanguage) {
    self.accessibilityElement.accessibilityLanguage =
        ABI50_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLanguage);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
  ...
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits =
        ABI50_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
  ...
  if (oldViewProps.accessibilityValue != newViewProps.accessibilityValue) {
    if (newViewProps.accessibilityValue.text.has_value()) {
      self.accessibilityElement.accessibilityValue =
          ABI50_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityValue.text.value());
    } else if (
  ...
  if (oldViewProps.testId != newViewProps.testId) {
    self.accessibilityIdentifier = ABI50_0_0RCTNSStringFromString(newViewProps.testId);
  }
...
- (void)prepareForRecycle
{
  ...
  if ([_propKeysManagedByAnimated_DO_NOT_USE_THIS_IS_BROKEN containsObject:@"transform"]) {
    self.layer.transform = ABI50_0_0RCTCATransform3DFromTransformMatrix(props.transform);
  }
...
static ABI50_0_0RCTCornerRadii ABI50_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
...
static ABI50_0_0RCTBorderColors ABI50_0_0RCTCreateABI50_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI50_0_0RCTBorderColors{
      .top = ABI50_0_0RCTCreateCGColorRefFromSharedColor(borderColors.top),
      .left = ABI50_0_0RCTCreateCGColorRefFromSharedColor(borderColors.left),
      .bottom = ABI50_0_0RCTCreateCGColorRefFromSharedColor(borderColors.bottom),
      .right = ABI50_0_0RCTCreateCGColorRefFromSharedColor(borderColors.right)};
}

static void ABI50_0_0RCTReleaseABI50_0_0RCTBorderColors(ABI50_0_0RCTBorderColors borderColors)
{
...
static ABI50_0_0RCTBorderStyle ABI50_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI50_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI50_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI50_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      const ABI50_0_0RCTCornerInsets cornerInsets =
          ABI50_0_0RCTGetCornerInsets(ABI50_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI50_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI50_0_0RCTCreateCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    ABI50_0_0RCTBorderColors borderColors = ABI50_0_0RCTCreateABI50_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors);

    UIImage *image = ABI50_0_0RCTGetBorderImage(
        ABI50_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI50_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        ABI50_0_0RCTUIEdgeInsetsFromEdgeInsets(borderMetrics.borderWidths),
        borderColors,
        _backgroundColor.CGColor,
        self.clipsToBounds);

    ABI50_0_0RCTReleaseABI50_0_0RCTBorderColors(borderColors);
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI50_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI50_0_0RCTGetCornerInsets(ABI50_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
- (NSString *)accessibilityValue
{
  ...
  if ([roleString isEqualToString:@"checkbox"]) {
    [valueComponents addObject:ABI50_0_0RCTLocalizedString("checkbox", "checkable interactive control")];
  }

  if ([roleString isEqualToString:@"radio"]) {
    [valueComponents
        addObject:
            ABI50_0_0RCTLocalizedString(
                "radio button",
  ...
  if (props.accessibilityState.checked == AccessibilityState::Checked) {
    [valueComponents
        addObject:ABI50_0_0RCTLocalizedString("checked", "a checkbox, radio button, or other widget which is checked")];
  }
  if (props.accessibilityState.checked == AccessibilityState::Unchecked) {
    [valueComponents
        addObject:ABI50_0_0RCTLocalizedString("unchecked", "a checkbox, radio button, or other widget which is unchecked")];
  }
  if (props.accessibilityState.checked == AccessibilityState::Mixed) {
    [valueComponents
        addObject:ABI50_0_0RCTLocalizedString(
                      "mixed", "a checkbox, radio button, or other widget which is both checked and unchecked")];
  }
  if (props.accessibilityState.expanded) {
    [valueComponents
        addObject:ABI50_0_0RCTLocalizedString("expanded", "a menu, dialog, accordian panel, or other widget which is expanded")];
  }

  if (props.accessibilityState.busy) {
    [valueComponents addObject:ABI50_0_0RCTLocalizedString("busy", "an element currently being updated or modified")];
  }
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (const auto &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI50_0_0RCTNSStringFromString(accessibilityAction.name)
                                                             target:self
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  if (_eventEmitter && _props->onAccessibilityAction) {
    _eventEmitter->onAccessibilityAction(ABI50_0_0RCTStringFromNSString(action.name));
    return YES;
  } else {
    return NO;
  }
...
{
  return ABI50_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTViewCls(void);
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTViewCls(void)
{
  return ABI50_0_0RCTViewComponentView.class;
}
