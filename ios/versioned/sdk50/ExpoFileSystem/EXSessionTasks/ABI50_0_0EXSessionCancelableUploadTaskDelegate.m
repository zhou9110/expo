...
@interface ABI50_0_0EXSessionCancelableUploadTaskDelegate ()

@property (strong, nonatomic, readonly) ABI50_0_0EXUploadDelegateOnSendCallback onSendCallback;
@property (weak, nonatomic) ABI50_0_0EXTaskHandlersManager *manager;
@property (strong, nonatomic) NSString *uuid;

@end

@implementation ABI50_0_0EXSessionCancelableUploadTaskDelegate
