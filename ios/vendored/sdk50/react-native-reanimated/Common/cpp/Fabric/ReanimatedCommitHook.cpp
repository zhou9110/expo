...
RootShadowNode::Unshared ReanimatedCommitHook::shadowTreeWillCommit(
  ...
  // If the commit comes from ABI50_0_0React Native then skip one commit from Reanimated
  // since the ShadowTree to be committed by Reanimated may not include the new
  // changes from ABI50_0_0React Native yet and all changes of animated props will be
