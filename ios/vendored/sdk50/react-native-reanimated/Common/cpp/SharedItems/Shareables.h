...
inline void runOnRuntimeGuarded(
  ...
  // JavaScript and propagating them to the main ABI50_0_0React Native thread such that
...
inline void cleanupIfRuntimeExists(
  ...
  if (rt != nullptr && !WorkletRuntimeRegistry::isRuntimeAlive(rt)) {
    ...
    // This scenario can only occur when the ABI50_0_0React instance is torn down which
