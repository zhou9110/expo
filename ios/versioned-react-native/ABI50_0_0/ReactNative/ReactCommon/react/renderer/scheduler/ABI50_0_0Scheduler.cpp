...
Scheduler::Scheduler(
  ...
  ABI50_0_0ReactNativeConfig_ =
      contextContainer_->at<std::shared_ptr<const ABI50_0_0ReactNativeConfig>>(
  ...
  reduceDeleteCreateMutationLayoutAnimation_ = ABI50_0_0ReactNativeConfig_->getBool(
      "ABI50_0_0React_fabric:reduce_delete_create_mutation_layout_animation_android");
#else
  removeOutstandingSurfacesOnDestruction_ = ABI50_0_0ReactNativeConfig_->getBool(
      "ABI50_0_0React_fabric:remove_outstanding_surfaces_on_destruction_ios");
  reduceDeleteCreateMutationLayoutAnimation_ = true;
#endif

  CoreFeatures::blockPaintForUseLayoutEffect = ABI50_0_0ReactNativeConfig_->getBool(
      "ABI50_0_0React_fabric:block_paint_for_use_layout_effect");

  CoreFeatures::cacheLastTextMeasurement =
      ABI50_0_0ReactNativeConfig_->getBool("ABI50_0_0React_fabric:enable_text_measure_cache");

  CoreFeatures::enableGranularShadowTreeStateReconciliation =
      ABI50_0_0ReactNativeConfig_->getBool(
          "ABI50_0_0React_fabric:enable_granular_shadow_tree_state_reconciliation");
...
void Scheduler::renderTemplateToSurface(
  ...
  try {
    ...
    LOG(ERROR) << "    >>>> ABI50_0_0EXCEPTION <<<  rendering uiTemplate in "
