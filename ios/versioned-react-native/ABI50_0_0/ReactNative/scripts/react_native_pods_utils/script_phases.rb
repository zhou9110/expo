...
def get_script_phases_with_codegen_discovery_ABI50_0_0(options)
    export_vars = {
    ...
    return get_script_template_ABI50_0_0(options[:react_native_path], export_vars)
end

def get_script_phases_no_codegen_discovery_ABI50_0_0(options)
    export_vars = {
...
def get_script_template_ABI50_0_0(react_native_path, export_vars={})
    template =<<~EOS
