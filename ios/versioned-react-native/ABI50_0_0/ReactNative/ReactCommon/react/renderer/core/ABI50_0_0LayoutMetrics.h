...
#include <ABI50_0_0React/renderer/debug/ABI50_0_0flags.h>
...
struct LayoutMetrics {
  ...
  // Whether ABI50_0_0React Native treated cardinal directions as flow-relative
...
template <>
struct hash<ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics> {
  size_t operator()(const ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics& layoutMetrics) const {
