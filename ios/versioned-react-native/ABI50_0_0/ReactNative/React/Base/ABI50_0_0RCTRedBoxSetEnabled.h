...
// builds where ABI50_0_0RCTRedBox is actually compiled in.
ABI50_0_0RCT_EXTERN void ABI50_0_0RCTRedBoxSetEnabled(BOOL enabled);
ABI50_0_0RCT_EXTERN BOOL ABI50_0_0RCTRedBoxGetEnabled(void);
