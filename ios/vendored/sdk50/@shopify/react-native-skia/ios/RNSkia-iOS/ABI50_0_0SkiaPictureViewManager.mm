...
@implementation ABI50_0_0SkiaPictureViewManager

ABI50_0_0RCT_EXPORT_MODULE(SkiaPictureView)
  ...
  return [[ABI50_0_0SkiaUIView alloc]
      initWithManager:skManager.get()
              factory:[](std::shared_ptr<ABI50_0_0RNSkia::ABI50_0_0RNSkPlatformContext> context) {
                return std::make_shared<ABI50_0_0RNSkiOSView<ABI50_0_0RNSkia::ABI50_0_0RNSkPictureView>>(
                    context);
              }];
}
