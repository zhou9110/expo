...
#include "ABI50_0_0UIManagerBinding.h"
...
void UIManagerBinding::dispatchEventToJS(
  ...
  auto instanceHandle = eventTarget != nullptr
    ? [&]() {
      ...
      ABI50_0_0React_native_assert(payload.isObject());
  ...
  eventHandlerWrapper.callback.call(
      ...
      {std::move(instanceHandle),
       ...
       std::move(payload)});
  currentEventPriority_ = ABI50_0_0ReactEventPriority::Default;
}
...
jsi::Value UIManagerBinding::get(
  ...
  if (methodName == "unstable_DefaultEventPriority") {
    return {serialize(ABI50_0_0ReactEventPriority::Default)};
  }

  if (methodName == "unstable_DiscreteEventPriority") {
    return {serialize(ABI50_0_0ReactEventPriority::Discrete)};
  }
  ...
  if (methodName == "getBoundingClientRect") {
    // This is a ABI50_0_0React Native implementation of
  ...
  if (methodName == "getParentNode") {
    // This is a ABI50_0_0React Native implementation of `Node.prototype.parentNode`
  ...
  if (methodName == "getChildNodes") {
    // This is a ABI50_0_0React Native implementation of `Node.prototype.childNodes`
  ...
  if (methodName == "isConnected") {
    // This is a ABI50_0_0React Native implementation of `Node.prototype.isConnected`
  ...
  if (methodName == "getOffset") {
    ...
    // ABI50_0_0React Native are currently "positioned") and its offset relative to its
    // parent.
  ...
  if (methodName == "getTagName") {
    ...
    return jsi::Function::createFromHostFunction(
        ...
        [methodName, paramCount](
          ...
          // Prefix with ABI50_0_0RN:
          canonicalComponentName.insert(0, "ABI50_0_0RN:");
