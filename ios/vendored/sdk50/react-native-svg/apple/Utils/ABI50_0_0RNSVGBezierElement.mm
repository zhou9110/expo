...
@implementation ABI50_0_0RNSVGBezierElement
- (instancetype)init
{
  self = [super init];
  if (self) {
    _elementType = kCGPathElementMoveToPoint;
    _point = ABI50_0_0RNSVGNULLPOINT;
    _controlPoint1 = ABI50_0_0RNSVGNULLPOINT;
    _controlPoint2 = ABI50_0_0RNSVGNULLPOINT;
  }
  return self;
}
...
{
  ABI50_0_0RNSVGBezierElement *newElement = [[self alloc] init];
...
// Convert one element to ABI50_0_0RNSVGBezierElement and save to array
void ABI50_0_0RNSVGBezierElement_getBezierElements(void *info, const CGPathElement *element)
{
  NSMutableArray *bezierElements = (__bridge NSMutableArray *)info;
  if (element)
    [bezierElements addObject:[ABI50_0_0RNSVGBezierElement elementWithPathElement:*element]];
}
...
+ (NSArray *)elementsFromCGPath:(CGPathRef)path
{
  ...
  CGPathApply(path, (__bridge void *)elements, ABI50_0_0RNSVGBezierElement_getBezierElements);
  return elements;
}
