...
@objc(ABI50_0_0StripeSdk)
class StripeSdk: ABI50_0_0RCTEventEmitter, STPBankSelectionViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    var confirmPaymentResolver: ABI50_0_0RCTPromiseResolveBlock? = nil
    
    var confirmApplePayResolver: ABI50_0_0RCTPromiseResolveBlock? = nil
    ...
    var createPlatformPayPaymentMethodResolver: ABI50_0_0RCTPromiseResolveBlock? = nil
    ...
    var shippingMethodUpdateJSCallback: ABI50_0_0RCTDirectEventBlock? = nil
    var shippingContactUpdateJSCallback: ABI50_0_0RCTDirectEventBlock? = nil
    var couponCodeEnteredJSCallback: ABI50_0_0RCTDirectEventBlock? = nil
    var platformPayOrderTrackingJSCallback: ABI50_0_0RCTDirectEventBlock? = nil
    ...
    func initialise(params: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void {
    ...
    func initPaymentSheet(params: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func intentCreationCallback(result: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                          rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func confirmPaymentSheetPayment(resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                                    rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func resetPaymentSheetCustomer(resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                                   rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func presentPaymentSheet(options: NSDictionary,
                             resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func createTokenForCVCUpdate(cvc: String?, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) {
    ...
    func confirmSetupIntent (setupIntentClientSecret: String, params: NSDictionary,
                             options: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                             rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) {
    ...
    func openApplePaySetup(resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void {
        PKPassLibrary.init().openPaymentSetup()
        resolve([])
    }

    @objc(handleURLCallback:resolver:rejecter:)
    func handleURLCallback(url: String?, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) {
    ...
    func dismissPlatformPay(resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void {
