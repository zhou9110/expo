...
#define ABI50_0_0EXPECT_JSI_THROW(expr) ABI50_0_0EXPECT_THROW((expr), ABI50_0_0facebook::jsi::JSIException)
 ...
 protected:
  BridgingTest()
      : invoker(std::make_shared<TestCallInvoker>()),
        runtime(ABI50_0_0hermes::makeHermesRuntime(
  ...
  void TearDown() override {
    ...
    ABI50_0_0EXPECT_EQ(0, LongLivedObjectCollection::get().size());
  }
