 ...
 */
@interface ABI50_0_0RCTComponentViewRegistry : NSObject

@property (nonatomic, strong, readonly) ABI50_0_0RCTComponentViewFactory *componentViewFactory;
 ...
 * #RefuseSingleUse
 */
- (const ABI50_0_0RCTComponentViewDescriptor &)dequeueComponentViewWithComponentHandle:
                                          (ABI50_0_0facebook::ABI50_0_0React::ComponentHandle)componentHandle
                                                                          tag:(ABI50_0_0facebook::ABI50_0_0React::Tag)tag;

/**
 * Puts a given native component view to the recycle pool.
 * #RefuseSingleUse
 */
- (void)enqueueComponentViewWithComponentHandle:(ABI50_0_0facebook::ABI50_0_0React::ComponentHandle)componentHandle
                                            tag:(ABI50_0_0facebook::ABI50_0_0React::Tag)tag
 ...
 */
- (const ABI50_0_0RCTComponentViewDescriptor &)componentViewDescriptorWithTag:(ABI50_0_0facebook::ABI50_0_0React::Tag)tag;

/**
 * Finds a native component view by given `tag`.
 * Returns `nil` if there is no registered component with the `tag`.
 */
- (nullable UIView<ABI50_0_0RCTComponentViewProtocol> *)findComponentViewWithTag:(ABI50_0_0facebook::ABI50_0_0React::Tag)tag;
