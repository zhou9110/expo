...
#import "ABI50_0_0RNCAsyncStorageDelegate.h"
 ...
 * being atomic, unless someone bypasses the `ABI50_0_0RNCAsyncStorage` API.
 *
 * Keys and values must always be strings or an error is returned.
 */
@interface ABI50_0_0RNCAsyncStorage : NSObject <ABI50_0_0RCTBridgeModule, ABI50_0_0RCTInvalidating>

@property (nonatomic, weak, nullable) id<ABI50_0_0RNCAsyncStorageDelegate> delegate;
...
// Clear the ABI50_0_0RNCAsyncStorage data from native code
- (void)clearAllData;

// Grab data from the cache. ResponseBlock result array will have an error at position 0, and an
// array of arrays at position 1.
- (void)multiGet:(NSArray<NSString *> *)keys callback:(ABI50_0_0RCTResponseSenderBlock)callback;
...
- (void)getAllKeys:(ABI50_0_0RCTResponseSenderBlock)callback;
