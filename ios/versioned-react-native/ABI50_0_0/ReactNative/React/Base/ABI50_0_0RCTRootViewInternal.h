 ...
 * classes to change the ABI50_0_0RCTRootViews's internal state.
 */
@interface ABI50_0_0RCTRootView ()

/**
 * This setter should be used only by ABI50_0_0RCTUIManager on ABI50_0_0React root view
