 ...
 * `ABI50_0_0RCTEnhancedScrollView` has a delegate (conforming to this protocol) that allows customizing such behaviors without
 * creating a subclass.
 */
@protocol ABI50_0_0RCTEnhancedScrollViewOverridingDelegate <NSObject>
 ...
 * which are not directly related to ABI50_0_0React Native.
 */
@interface ABI50_0_0RCTEnhancedScrollView : UIScrollView
 ...
 */
@property (nonatomic, strong, readonly) ABI50_0_0RCTGenericDelegateSplitter<id<UIScrollViewDelegate>> *delegateSplitter;

@property (nonatomic, weak) id<ABI50_0_0RCTEnhancedScrollViewOverridingDelegate> overridingDelegate;
