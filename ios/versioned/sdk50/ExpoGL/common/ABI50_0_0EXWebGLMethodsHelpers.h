#pragma once
// it should be included only in ABI50_0_0EXWebGLMethods.cpp
...
inline jsi::Value exglGetActiveInfo(
    ABI50_0_0EXGLContext *ctx,
    jsi::Runtime &runtime,
    ABI50_0_0EXGLObjectId fProgram,
    GLuint index,
    GLenum lengthParam,
    Func glFunc) {
  if (fProgram == 0) {
  ...
  jsi::Object jsResult =
      createWebGLObject(runtime, ABI50_0_0EXWebGLClass::WebGLActiveInfo, {}).asObject(runtime);
...
inline jsi::Value exglCall(ABI50_0_0EXGLContext *ctx, Func func, T &&... args) {
...
template <typename Func, typename T>
inline jsi::Value
exglUniformv(ABI50_0_0EXGLContext *ctx, Func func, GLuint uniform, size_t dim, std::vector<T> &&data) {
...
template <typename Func, typename T>
inline jsi::Value
exglVertexAttribv(ABI50_0_0EXGLContext *ctx, Func func, GLuint index, std::vector<T> &&data) {
  ctx->addToNextBatch([=, data{std::move(data)}] { func(index, data.data()); });
  return nullptr;
}

inline jsi::Value
exglIsObject(ABI50_0_0EXGLContext *ctx, ABI50_0_0EXGLObjectId id, std::function<GLboolean(GLuint)> func) {
  GLboolean glResult;
...
inline jsi::Value exglGenObject(
    ABI50_0_0EXGLContext *ctx,
    jsi::Runtime &runtime,
    std::function<void(GLsizei, ABI50_0_0EXGLObjectId *)> func,
...
inline jsi::Value
exglDeleteObject(ABI50_0_0EXGLContext *ctx, ABI50_0_0EXGLObjectId id, std::function<void(ABI50_0_0EXGLObjectId)> func) {
...
inline jsi::Value exglDeleteObject(
    ABI50_0_0EXGLContext *ctx,
    ABI50_0_0EXGLObjectId id,
    std::function<void(GLsizei, const ABI50_0_0EXGLObjectId *)> func) {
  ctx->addToNextBatch([=] {
...
inline jsi::Value exglUnimplemented(std::string name) {
  throw std::runtime_error("ABI50_0_0EXGL: " + name + "() isn't implemented yet!");
}
