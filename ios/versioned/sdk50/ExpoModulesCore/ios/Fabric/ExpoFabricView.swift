...
public class ExpoFabricView: ExpoFabricViewObjC {
  ...
  public override func updateProps(_ props: [String: Any]) {
    ...
    for (key, prop) in propsDict {
      ...
      // method signature in Objective-C. Maybe just call `ABI50_0_0RCTLogError`?
  ...
  /**
   ...
   Fabric sets this property to the corresponding ABI50_0_0React tag
