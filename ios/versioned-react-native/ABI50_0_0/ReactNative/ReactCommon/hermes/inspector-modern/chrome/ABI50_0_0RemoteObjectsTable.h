...
class RemoteObjectsTable {
 public:
   ...
   */
  std::string addValue(
      ::ABI50_0_0facebook::jsi::Value value,
      const std::string &objectGroup);
   ...
   */
  const ::ABI50_0_0facebook::jsi::Value *getValue(const std::string &objId) const;
 ...
 private:
  ...
  std::unordered_map<int64_t, ::ABI50_0_0facebook::jsi::Value> values_;
