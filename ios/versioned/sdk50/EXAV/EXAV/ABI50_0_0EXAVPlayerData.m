...
typedef struct AVAudioTapProcessorContext {
  ...
  void *self; // a pointer to ABI50_0_0EXAVPlayerData
} AVAudioTapProcessorContext;

NSString *const ABI50_0_0EXAVPlayerDataStatusIsLoadedKeyPath = @"isLoaded";
NSString *const ABI50_0_0EXAVPlayerDataStatusURIKeyPath = @"uri";
NSString *const ABI50_0_0EXAVPlayerDataStatusHeadersKeyPath = @"headers";
NSString *const ABI50_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath = @"progressUpdateIntervalMillis";
NSString *const ABI50_0_0EXAVPlayerDataStatusDurationMillisKeyPath = @"durationMillis";
NSString *const ABI50_0_0EXAVPlayerDataStatusPositionMillisKeyPath = @"positionMillis";
NSString *const ABI50_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath = @"seekMillisToleranceBefore";
NSString *const ABI50_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath = @"seekMillisToleranceAfter";
NSString *const ABI50_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath = @"playableDurationMillis";
NSString *const ABI50_0_0EXAVPlayerDataStatusShouldPlayKeyPath = @"shouldPlay";
NSString *const ABI50_0_0EXAVPlayerDataStatusIsPlayingKeyPath = @"isPlaying";
NSString *const ABI50_0_0EXAVPlayerDataStatusIsBufferingKeyPath = @"isBuffering";
NSString *const ABI50_0_0EXAVPlayerDataStatusRateKeyPath = @"rate";
NSString *const ABI50_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath = @"pitchCorrectionQuality";
NSString *const ABI50_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath = @"shouldCorrectPitch";
NSString *const ABI50_0_0EXAVPlayerDataStatusVolumeKeyPath = @"volume";
NSString *const ABI50_0_0EXAVPlayerDataStatusIsMutedKeyPath = @"isMuted";
NSString *const ABI50_0_0EXAVPlayerDataStatusIsLoopingKeyPath = @"isLooping";
NSString *const ABI50_0_0EXAVPlayerDataStatusDidJustFinishKeyPath = @"didJustFinish";
NSString *const ABI50_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath = @"hasJustBeenInterrupted";

NSString *const ABI50_0_0EXAVPlayerDataObserverStatusKeyPath = @"status";
NSString *const ABI50_0_0EXAVPlayerDataObserverRateKeyPath = @"rate";
NSString *const ABI50_0_0EXAVPlayerDataObserverCurrentItemKeyPath = @"currentItem";
NSString *const ABI50_0_0EXAVPlayerDataObserverTimeControlStatusPath = @"timeControlStatus";
NSString *const ABI50_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath = @"playbackBufferEmpty";
NSString *const ABI50_0_0EXAVPlayerDataObserverMetadataKeyPath = @"timedMetadata";

@interface ABI50_0_0EXAVPlayerData ()

@property (nonatomic, weak) ABI50_0_0EXAV *exAV;
...
@property (nonatomic, strong) ABI50_0_0EXPromiseResolveBlock replayResolve;

@end

@implementation ABI50_0_0EXAVPlayerData
{
  ABI50_0_0EXAudioSampleCallback* _audioSampleBufferCallback;
}
...
{
  return @{ABI50_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(NO)};
}
         ...
         withLoadFinishBlock:(void (^)(BOOL success, NSDictionary *successStatus, NSString *error))loadFinishBlock
{
  if ((self = [super init])) {
    ...
    _url = [NSURL URLWithString:[source objectForKey:ABI50_0_0EXAVPlayerDataStatusURIKeyPath]];
    _headers = [self validatedRequestHeaders:source[ABI50_0_0EXAVPlayerDataStatusHeadersKeyPath]];
...
- (void)_loadNewPlayer
{
  ...
  [avAsset loadValuesAsynchronouslyForKeys:@[ @"duration" ] completionHandler:^{
    ...
    if (self.player) {
      [self _addObserver:self.player forKeyPath:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath];
      [self _addObserver:self.player.currentItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath];
      [self _addObserver:self.player.currentItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverMetadataKeyPath];
    } else {
...
- (void)_finishLoadingNewPlayer
{
  ...
  [_player seekToTime:_currentPosition completionHandler:^(BOOL finished) {
    ABI50_0_0EX_ENSURE_STRONGIFY(self);
    __strong ABI50_0_0EXAV *strongEXAV = self.exAV;
    if (strongEXAV) {
         ...
         rejecter:(ABI50_0_0EXPromiseRejectBlock)reject
{
  ...
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath] != nil) {
    NSNumber *progressUpdateIntervalMillis = parameters[ABI50_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusPositionMillisKeyPath] != nil) {
    NSNumber *currentPositionMillis = parameters[ABI50_0_0EXAVPlayerDataStatusPositionMillisKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath] != nil) {
    NSNumber *seekMillisToleranceBefore = parameters[ABI50_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath] != nil) {
    NSNumber *seekMillisToleranceAfter = parameters[ABI50_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath];
    toleranceAfter = CMTimeMakeWithSeconds(seekMillisToleranceAfter.floatValue / 1000, NSEC_PER_SEC);
  }
  
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusShouldPlayKeyPath] != nil) {
    NSNumber *shouldPlay = parameters[ABI50_0_0EXAVPlayerDataStatusShouldPlayKeyPath];
    _shouldPlay = shouldPlay.boolValue;
  }
  
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusRateKeyPath] != nil) {
    NSNumber *rate = parameters[ABI50_0_0EXAVPlayerDataStatusRateKeyPath];
    _rate = rate;
  }
  
  if (parameters[ABI50_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath] != nil) {
    _pitchCorrectionQuality = parameters[ABI50_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath];
  }
  
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath] != nil) {
    NSNumber *shouldCorrectPitch = parameters[ABI50_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath];
    _shouldCorrectPitch = shouldCorrectPitch.boolValue;
  }
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusVolumeKeyPath] != nil) {
    NSNumber *volume = parameters[ABI50_0_0EXAVPlayerDataStatusVolumeKeyPath];
    _volume = volume;
  }
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusIsMutedKeyPath] != nil) {
    NSNumber *isMuted = parameters[ABI50_0_0EXAVPlayerDataStatusIsMutedKeyPath];
    _isMuted = isMuted.boolValue;
  }
  if ([parameters objectForKey:ABI50_0_0EXAVPlayerDataStatusIsLoopingKeyPath] != nil) {
    NSNumber *isLooping = parameters[ABI50_0_0EXAVPlayerDataStatusIsLoopingKeyPath];
  ...
  if (_player && _isLoaded) {
    ...
    void (^applyPostSeekParameters)(BOOL) = ^(BOOL seekSucceeded) {
      ...
      if (audioSessionError) {
        ...
        if (reject) {
          reject(@"E_AV_SEEKING", nil, ABI50_0_0EXErrorWithMessage(@"Seeking interrupted."));
        }
      } else if (resolve) {
...
- (NSDictionary *)getStatus
{
  if (!_isLoaded || _player == nil) {
    return [ABI50_0_0EXAVPlayerData getUnloadedStatus];
  }
  ...
  NSMutableDictionary *mutableStatus = [@{ABI50_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(YES),
                                          
                                          ABI50_0_0EXAVPlayerDataStatusURIKeyPath: [_url absoluteString],
                                          
                                          ABI50_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath: _progressUpdateIntervalMillis,
                                          // positionMillis, playableDurationMillis, and durationMillis may be nil and are added after this definition.
                                          
                                          ABI50_0_0EXAVPlayerDataStatusShouldPlayKeyPath: @(_shouldPlay),
                                          ABI50_0_0EXAVPlayerDataStatusIsPlayingKeyPath: @(isPlaying),
                                          ABI50_0_0EXAVPlayerDataStatusIsBufferingKeyPath: @(isBuffering),
                                          
                                          ABI50_0_0EXAVPlayerDataStatusRateKeyPath: _rate,
                                          ABI50_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath: @(_shouldCorrectPitch),
                                          ABI50_0_0EXAVPlayerDataStatusPitchCorrectionQualityKeyPath: _pitchCorrectionQuality,
                                          ABI50_0_0EXAVPlayerDataStatusVolumeKeyPath: @(_player.volume),
                                          ABI50_0_0EXAVPlayerDataStatusIsMutedKeyPath: @(_player.muted),
                                          ABI50_0_0EXAVPlayerDataStatusIsLoopingKeyPath: @(_isLooping),
                                          
                                          ABI50_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(NO),
                                          ABI50_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @(NO),
                                          } mutableCopy];
  
  mutableStatus[ABI50_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath] = playableDurationMillis;
  mutableStatus[ABI50_0_0EXAVPlayerDataStatusDurationMillisKeyPath] = durationMillis;
  mutableStatus[ABI50_0_0EXAVPlayerDataStatusPositionMillisKeyPath] = positionMillis;
                ...
                rejecter:(ABI50_0_0EXPromiseRejectBlock)reject
{
  [self _callStatusUpdateCallbackWithExtraFields:@{
                                                   ABI50_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @([self _isPlayerPlaying]),
                                                   }];
...
{
  [self _tryRemoveObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath];
  [self _removeObserversForPlayerItems];
  [self _tryRemoveObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverRateKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverCurrentItemKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverTimeControlStatusPath];
}
...
{
  [self _tryRemoveObserver:playerItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath];
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [self _tryRemoveObserver:playerItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverMetadataKeyPath];
}
...
- (void)_addObserversForPlayerItem:(AVPlayerItem *)playerItem
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    ...
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        ABI50_0_0EX_ENSURE_STRONGIFY(self);
        [self _callStatusUpdateCallbackWithExtraFields:@{ABI50_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(YES)}];
        // If the player is looping, we would only like to advance to next item (which is handled by actionAtItemEnd)
        if (!self.isLooping) {
          [self.player pause];
          self.shouldPlay = NO;
          __strong ABI50_0_0EXAV *strongEXAVInner = self.exAV;
          if (strongEXAVInner) {
  ...
  [self _addObserver:playerItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [self _addObserver:playerItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath];
  [self _addObserver:playerItem forKeyPath:ABI50_0_0EXAVPlayerDataObserverMetadataKeyPath];
}
...
- (void)_addObserversForNewPlayer
{
  ...
  [self _addObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverRateKeyPath];
  NSUInteger currentItemObservationOptions = NSKeyValueObservingOptionOld | NSKeyValueObservingOptionNew;
  [self _addObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverCurrentItemKeyPath options:currentItemObservationOptions];
  [self _addObserver:_player forKeyPath:ABI50_0_0EXAVPlayerDataObserverTimeControlStatusPath]; // Only available after iOS 10
                       ...
                       context:(void *)context
{
  ...
  __weak ABI50_0_0EXAVPlayerData *weakSelf = nil;
  ...
  // as the ABI50_0_0EXAVPlayerData is being deallocated, so let's early return.
  //
  ...
  __strong ABI50_0_0EXAV *strongEXAV = _exAV;
  if (strongEXAV == nil) {
    return;
  }
  
  dispatch_async(strongEXAV.methodQueue, ^{
    __strong ABI50_0_0EXAVPlayerData *strongSelf = weakSelf;
    if (strongSelf) {
      if (object == strongSelf.player) {
        if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverRateKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverTimeControlStatusPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverCurrentItemKeyPath]) {
        ...
        if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverStatusKeyPath]) {
          ...
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath]) {
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI50_0_0EXAVPlayerDataObserverMetadataKeyPath] && strongSelf.metadataUpdateCallback) {
...
- (void)setSampleBufferCallback:(ABI50_0_0EXAudioSampleCallback *)sampleBufferCallback
{
...
- (ABI50_0_0EXAudioSampleCallback *)sampleBufferCallback
{
...
- (void)installTap
{
  ...
  if (!track)
  {
    ABI50_0_0EXLogError(@"Failed to find a track in the current player item!");
    return;
  }
  ...
  if (audioMix) {
    ...
    if (audioMixInputParameters) {
      ...
      callbacks.init = ABI50_0_0EXTapInit;
      callbacks.finalize = ABI50_0_0EXTapFinalize;
      callbacks.prepare = ABI50_0_0EXTapPrepare;
      callbacks.unprepare = ABI50_0_0EXTapUnprepare;
      callbacks.process = ABI50_0_0EXTapProcess;
      ...
      if (status == noErr) {
        ...
        ABI50_0_0EXLogError(@"Failed to create MTAudioProcessingTap!");
      }
    }
  }
}
...
void ABI50_0_0EXTapInit(MTAudioProcessingTapRef tap, void *clientInfo, void **tapStorageOut)
{
...
void ABI50_0_0EXTapFinalize(MTAudioProcessingTapRef tap)
{
...
void ABI50_0_0EXTapPrepare(MTAudioProcessingTapRef tap, CMItemCount maxFrames, const AudioStreamBasicDescription *processingFormat)
{
  AVAudioTapProcessorContext *context = (AVAudioTapProcessorContext *)MTAudioProcessingTapGetStorage(tap);
  ...
  if (processingFormat->mFormatID != kAudioFormatLinearPCM) {
    ABI50_0_0EXLogInfo(@"Audio Format ID for audioProcessingTap: LinearPCM");
  ...
  if (!(processingFormat->mFormatFlags & kAudioFormatFlagIsFloat)) {
    ABI50_0_0EXLogInfo(@"Audio Format ID for audioProcessingTap: Float only");
...
void ABI50_0_0EXTapUnprepare(MTAudioProcessingTapRef tap)
{
...
void ABI50_0_0EXTapProcess(MTAudioProcessingTapRef tap, CMItemCount numberFrames, MTAudioProcessingTapFlags flags, AudioBufferList *bufferListInOut, CMItemCount *numberFramesOut, MTAudioProcessingTapFlags *flagsOut)
{
  AVAudioTapProcessorContext *context =
    (AVAudioTapProcessorContext *)MTAudioProcessingTapGetStorage(tap);

  if (!context->self) {
    ABI50_0_0EXLogWarn(@"Audio Processing Tap has been destroyed!");
    return;
  }

  ABI50_0_0EXAVPlayerData *_self = ((__bridge ABI50_0_0EXAVPlayerData *)context->self);
  ...
  if (noErr != status) {
    ABI50_0_0EXLogWarn(@"MTAudioProcessingTapGetSourceAudio: %d", (int)status);
    return;
  }
...
#pragma mark - ABI50_0_0EXAVObject
...
- (ABI50_0_0EXAVAudioSessionMode)getAudioSessionModeRequired
{
  if (_player && ([self _isPlayerPlaying] || [self _shouldPlayerPlay])) {
    return _isMuted ? ABI50_0_0EXAVAudioSessionModeActiveMuted : ABI50_0_0EXAVAudioSessionModeActive;
  }
  return ABI50_0_0EXAVAudioSessionModeInactive;
}
...
{
  // ABI50_0_0EXAudio already forced pause.
}
...
/*
 * Call this synchronously on the main thread to remove the ABI50_0_0EXAVPlayerData
