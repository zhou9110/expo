...
#import "ABI50_0_0AIRMapOverlayRenderer.h"

@class ABI50_0_0RCTBridge;

@interface ABI50_0_0AIRMapOverlay : UIView <MKOverlay>

@property (nonatomic, strong) ABI50_0_0AIRMapOverlayRenderer *renderer;
