...
#include "ABI50_0_0SampleCxxModule.h"
...
ABI50_0_0facebook::xplat::module::CxxModule* SampleCxxModule() {
  return new ABI50_0_0facebook::xplat::samples::SampleCxxModule(
      std::make_unique<ABI50_0_0facebook::xplat::samples::Sample>());
}
