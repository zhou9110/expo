...
@interface ABI50_0_0RCTDataRequestHandler () <ABI50_0_0RCTTurboModule>
@end

@implementation ABI50_0_0RCTDataRequestHandler {
...
Class ABI50_0_0RCTDataRequestHandlerCls(void)
{
  return ABI50_0_0RCTDataRequestHandler.class;
}
