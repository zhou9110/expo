...
@interface ABI50_0_0EXFontLoaderProcessor ()
...
@implementation ABI50_0_0EXFontLoaderProcessor
         ...
         scaleMultiplier:(CGFloat)scaleMultiplier
{
  ...
  ABI50_0_0EXFont *exFont = nil;

  // Did we get a new family, and if so, is it associated with an ABI50_0_0EXFont?
  ...
  // Did the passed-in UIFont come from an ABI50_0_0EXFont?
  if (!exFont && uiFont) {
    exFont = objc_getAssociatedObject(uiFont, ABI50_0_0EXFontAssocKey);
  }

  // If it's an ABI50_0_0EXFont, generate the corresponding UIFont, else fallback to ABI50_0_0React Native's built-in method
  if (exFont) {
