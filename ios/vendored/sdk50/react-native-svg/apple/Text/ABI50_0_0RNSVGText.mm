...
@implementation ABI50_0_0RNSVGText {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNSVGTextProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNSVGTextComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = static_cast<const ABI50_0_0RNSVGTextProps &>(*props);

  setCommonTextProps(newProps, self);
  _props = std::static_pointer_cast<ABI50_0_0RNSVGTextProps const>(props);
}
...
- (void)setInlineSize:(ABI50_0_0RNSVGLength *)inlineSize
{
...
- (void)setTextLength:(ABI50_0_0RNSVGLength *)textLength
{
...
- (void)setDeltaX:(NSArray<ABI50_0_0RNSVGLength *> *)deltaX
{
  if (deltaX == _deltaX) {
    return;
  }
...
- (void)setDeltaY:(NSArray<ABI50_0_0RNSVGLength *> *)deltaY
{
  if (deltaY == _deltaY) {
    return;
  }
...
- (void)setPositionX:(NSArray<ABI50_0_0RNSVGLength *> *)positionX
{
...
- (void)setPositionY:(NSArray<ABI50_0_0RNSVGLength *> *)positionY
{
...
- (void)setRotate:(NSArray<ABI50_0_0RNSVGLength *> *)rotate
{
  if (rotate == _rotate) {
    return;
  }
...
- (void)setupGlyphContext:(CGContextRef)context
{
  ...
  _glyphContext = [[ABI50_0_0RNSVGGlyphContext alloc] initWithWidth:size.width height:size.height];
}
...
- (ABI50_0_0RNSVGText *)textRoot
{
  ABI50_0_0RNSVGText *root = self;
  while (root && [root class] != [ABI50_0_0RNSVGText class]) {
    if (![root isKindOfClass:[ABI50_0_0RNSVGText class]]) {
      // todo: throw exception here
      break;
    }
    root = (ABI50_0_0RNSVGText *)[root superview];
  }
...
- (NSString *)alignmentBaseline
{
  ...
  while (parent != nil) {
    if ([parent isKindOfClass:[ABI50_0_0RNSVGText class]]) {
      ABI50_0_0RNSVGText *node = (ABI50_0_0RNSVGText *)parent;
  ...
  if (_alignmentBaseline == nil) {
    _alignmentBaseline = ABI50_0_0RNSVGAlignmentBaselineStrings[0];
  }
  return _alignmentBaseline;
}
...
- (ABI50_0_0RNSVGText *)getTextAnchorRoot
{
  ABI50_0_0RNSVGGlyphContext *gc = [self.textRoot getGlyphContext];
  NSArray *font = [gc getFontContext];
  ABI50_0_0RNSVGText *node = self;
  ABI50_0_0RNSVGPlatformView *parent = [self superview];
  for (NSInteger i = [font count] - 1; i >= 0; i--) {
    ABI50_0_0RNSVGFontData *fontData = [font objectAtIndex:i];
    if (![parent isKindOfClass:[ABI50_0_0RNSVGText class]] || fontData->textAnchor == ABI50_0_0RNSVGTextAnchorStart ||
        node.positionX != nil) {
      return node;
    }
    node = (ABI50_0_0RNSVGText *)parent;
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNSVGTextCls(void)
{
  return ABI50_0_0RNSVGText.class;
}
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
