#include "ABI50_0_0SkiaDrawViewManager.h"
...
@implementation ABI50_0_0SkiaDrawViewManager

ABI50_0_0RCT_EXPORT_MODULE(ABI50_0_0SkiaDrawView)
  ...
  return [[ABI50_0_0SkiaUIView alloc]
      initWithManager:skManager.get()
              factory:[](std::shared_ptr<ABI50_0_0RNSkia::ABI50_0_0RNSkPlatformContext> context) {
                return std::make_shared<ABI50_0_0RNSkiOSView<ABI50_0_0RNSkia::ABI50_0_0RNSkJsView>>(
                    context);
              }];
}
