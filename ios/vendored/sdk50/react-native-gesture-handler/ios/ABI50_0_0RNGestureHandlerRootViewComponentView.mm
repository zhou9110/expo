...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNGestureHandlerRootViewCls(void)
{
  // ABI50_0_0RNGestureHandlerRootView is Android-only.
  // However, if we set `excludedPlatforms: ['iOS']` in `codegenNativeComponent`,
  // codegen still generates `ABI50_0_0RNGestureHandlerRootViewShadowNode` (which it shouldn't)
  // and thus the project fails to compile due to missing `ABI50_0_0RNGestureHandlerRootViewProps`.
