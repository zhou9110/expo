...
@interface ABI50_0_0EXSessionUploadTaskDelegate ()

@property (strong, nonatomic) NSMutableData *responseData;

@end

@implementation ABI50_0_0EXSessionUploadTaskDelegate

- (instancetype)initWithResolve:(ABI50_0_0EXPromiseResolveBlock)resolve reject:(ABI50_0_0EXPromiseRejectBlock)reject
{
...
- (void)URLSession:(NSURLSession *)session task:(NSURLSessionTask *)task didCompleteWithError:(NSError *)error
{
  ...
  // We only set ABI50_0_0EXSessionUploadTaskDelegates as delegates of upload tasks
...
- (NSDictionary *)parseServerResponse:(NSURLResponse *)response
{
  ...
  result[@"body"] = ABI50_0_0EXNullIfNil([[NSString alloc] initWithData:_responseData encoding:NSUTF8StringEncoding]);
  return result;
}
