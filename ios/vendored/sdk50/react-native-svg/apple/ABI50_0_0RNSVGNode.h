...
@class ABI50_0_0RNSVGGroup;

/**
 * ABI50_0_0RNSVG nodes are implemented as base NSViews/UIViews. They should be implementation for all basic
 ...
 */
extern CGFloat const ABI50_0_0RNSVG_M_SQRT1_2l;
extern CGFloat const ABI50_0_0RNSVG_DEFAULT_FONT_SIZE;

@property (nonatomic, strong) NSString *name;
@property (nonatomic, strong) NSString *display;
@property (nonatomic, assign) CGFloat opacity;
@property (nonatomic, assign) ABI50_0_0RNSVGCGFCRule clipRule;
...
@property (nonatomic, strong) ABI50_0_0RNSVGPlatformView *parentComponentView;
...
/**
 * ABI50_0_0RNSVGSvgView which ownes current ABI50_0_0RNSVGNode
 */
@property (nonatomic, readonly, weak) ABI50_0_0RNSVGSvgView *svgView;
@property (nonatomic, readonly, weak) ABI50_0_0RNSVGGroup *textRoot;
