...
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0PlatformColorParser.h>
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0Point.h>
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0Rect.h>
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0RectangleCorners.h>
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0RectangleEdges.h>
...
inline void fromRawValue(
  ...
  if (value.hasType<int>()) {
    ...
    ABI50_0_0React_native_expect(length == 3 || length == 4);
...
inline void fromRawValue(
  ...
  ABI50_0_0React_native_expect(value.hasType<std::vector<Float>>());
  if (value.hasType<std::vector<Float>>()) {
    auto array = (std::vector<Float>)value;
    ABI50_0_0React_native_expect(array.size() == 2);
    if (array.size() >= 2) {
...
inline void fromRawValue(
  ...
  if (value.hasType<std::vector<Float>>()) {
    auto array = (std::vector<Float>)value;
    ABI50_0_0React_native_expect(array.size() == 4);
    if (array.size() >= 4) {
