...
@interface ABI50_0_0EXSaveToLibraryDelegate ()

@property (nonatomic, strong) ABI50_0_0EXSaveToLibraryCallback callback;

@end

@implementation ABI50_0_0EXSaveToLibraryDelegate : NSObject
