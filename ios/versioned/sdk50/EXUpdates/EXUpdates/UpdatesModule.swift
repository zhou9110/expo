 ...
 *
 * Communicates with the updates hub (AppController in most apps, ABI50_0_0EXAppLoaderExpoUpdates in
 * Expo Go and legacy standalone apps) via ABI50_0_0EXUpdatesService, an internal module which is overridden
 * by ABI50_0_0EXUpdatesBinding, a scoped module, in Expo Go.
 */
