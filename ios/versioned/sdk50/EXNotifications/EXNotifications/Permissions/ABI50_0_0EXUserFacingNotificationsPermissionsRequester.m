...
@interface ABI50_0_0EXUserFacingNotificationsPermissionsRequester ()

@property (nonatomic, assign) dispatch_queue_t methodQueue;

@end

@implementation ABI50_0_0EXUserFacingNotificationsPermissionsRequester
...
- (NSDictionary *)getPermissions
{
  ...
  __block ABI50_0_0EXPermissionStatus generalStatus = ABI50_0_0EXPermissionStatusUndetermined;

  [[UNUserNotificationCenter currentNotificationCenter] getNotificationSettingsWithCompletionHandler:^(UNNotificationSettings *settings) {
    if (settings.authorizationStatus == UNAuthorizationStatusAuthorized) {
      generalStatus = ABI50_0_0EXPermissionStatusGranted;
    } else if (settings.authorizationStatus == UNAuthorizationStatusDenied) {
      generalStatus = ABI50_0_0EXPermissionStatusDenied;
    }
...
- (void)requestPermissions:(NSDictionary *)permissions withResolver:(ABI50_0_0EXPromiseResolveBlock)resolve rejecter:(ABI50_0_0EXPromiseRejectBlock)reject
{
...
- (void)requestAuthorizationOptions:(UNAuthorizationOptions)options withResolver:(ABI50_0_0EXPromiseResolveBlock)resolve rejecter:(ABI50_0_0EXPromiseRejectBlock)reject
{
