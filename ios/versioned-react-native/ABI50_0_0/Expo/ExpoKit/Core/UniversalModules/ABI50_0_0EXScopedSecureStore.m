...
@interface ABI50_0_0EXSecureStore (Protected)
...
@interface ABI50_0_0EXScopedSecureStore ()
...
@implementation ABI50_0_0EXScopedSecureStore
         ...
         withOptions:(NSDictionary *)options
{
  ...
  if (setValue) {
    ...
    ABI50_0_0EXLogWarn(@"Encountered an error while saving SecureStore data: %@.", [[super class] _messageForError:error]);
  }
}
