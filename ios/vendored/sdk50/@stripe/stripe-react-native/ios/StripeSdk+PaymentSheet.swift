...
extension StripeSdk {
    ...
    internal func preparePaymentSheetInstance(
        ...
        resolve: @escaping ABI50_0_0RCTPromiseResolveBlock
    ) {
        ...
        return PaymentSheet.IntentConfiguration.init(
            ...
            confirmHandler: { paymentMethod, shouldSavePaymentMethod, intentCreationCallback in
                if (self.hasEventListeners) {
                    ...
                    ABI50_0_0RCTMakeAndLogError("Tried to call confirmHandler, but no callback was found. Please file an issue: https://github.com/stripe/stripe-react-native/issues", nil, nil)
                }
            })
    }
    ...
    private func buildCustomerHandlersForPaymentSheet(applePayParams: NSDictionary) -> PaymentSheet.ApplePayConfiguration.Handlers? {
        ...
        return PaymentSheet.ApplePayConfiguration.Handlers(paymentRequestHandler: { request in
            do {
                ...
                ABI50_0_0RCTMakeAndLogError(error.localizedDescription, nil, nil)
            }
            return request
            ...
            if applePayParams.object(forKey: "setOrderTracking") != nil {
                if (self.hasEventListeners) {
                    ...
                    ABI50_0_0RCTMakeAndLogError("Order tracking is enabled, but no callback was found. Please file an issue: https://github.com/stripe/stripe-react-native/issues", nil, nil)
                }
            } else {
                completion(result)
            }
