...
#import <ABI50_0_0React/utils/ABI50_0_0SimpleThreadSafeCache.h>

using namespace ABI50_0_0facebook::ABI50_0_0React;

@implementation ABI50_0_0RCTTextLayoutManager {
  SimpleThreadSafeCache<AttributedString, std::shared_ptr<void>, 256> _cache;
}

static NSLineBreakMode ABI50_0_0RCTNSLineBreakModeFromEllipsizeMode(EllipsizeMode ellipsizeMode)
{
                 ...
                 textStorage:(NSTextStorage *_Nullable)textStorage
{
  ...
  if (!createdStorageForFrame) {
    ...
    static auto threshold = 1.0 / ABI50_0_0RCTScreenScale() + 0.01; // Size of a pixel plus some small threshold.
    ...
    if (std::abs(ABI50_0_0RCTCeilPixelValue(rect.size.width) - frame.size.width) < threshold) {
      ...
      origin.x -= ABI50_0_0RCTCeilPixelValue(rect.origin.x);
    }
  }
                                          ...
                                          usingBlock:^(
                                            ...
                                            UIFont *font = [[textStorage attributedSubstringFromRange:range]
                                                     attribute:NSFontAttributeName
                                                       atIndex:0
                                                effectiveRange:nil];
                                            auto rect = ABI50_0_0facebook::ABI50_0_0React::Rect{
                                                ABI50_0_0facebook::ABI50_0_0React::Point{usedRect.origin.x, usedRect.origin.y},
                                                ABI50_0_0facebook::ABI50_0_0React::Size{usedRect.size.width, usedRect.size.height}};
                                                 ...
                                                 atPoint:(CGPoint)point
{
  ...
  if (textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI50_0_0RCTWeakEventEmitterWrapper *eventEmitterWrapper =
        (ABI50_0_0RCTWeakEventEmitterWrapper *)[textStorage attribute:ABI50_0_0RCTAttributedStringEventEmitterKey
                                                ...
                                                size:(CGSize)size
{
  ...
  textContainer.lineBreakMode = paragraphAttributes.maximumNumberOfLines > 0
      ? ABI50_0_0RCTNSLineBreakModeFromEllipsizeMode(paragraphAttributes.ellipsizeMode)
...
- (NSAttributedString *)_nsAttributedStringFromAttributedString:(AttributedString)attributedString
{
  auto sharedNSAttributedString = _cache.get(attributedString, [](AttributedString attributedString) {
    return wrapManagedObject(ABI50_0_0RCTNSAttributedStringFromAttributedString(attributedString));
  });
...
- (TextMeasurement)_measureTextStorage:(NSTextStorage *)textStorage
{
  ...
  size = (CGSize){ABI50_0_0RCTCeilPixelValue(size.width), ABI50_0_0RCTCeilPixelValue(size.height)};
  ...
  [textStorage
      enumerateAttribute:NSAttachmentAttributeName
              ...
              usingBlock:^(NSTextAttachment *attachment, NSRange range, BOOL *stop) {
                ...
                auto rect = ABI50_0_0facebook::ABI50_0_0React::Rect{
                    ABI50_0_0facebook::ABI50_0_0React::Point{frame.origin.x, frame.origin.y},
                    ABI50_0_0facebook::ABI50_0_0React::Size{frame.size.width, frame.size.height}};
