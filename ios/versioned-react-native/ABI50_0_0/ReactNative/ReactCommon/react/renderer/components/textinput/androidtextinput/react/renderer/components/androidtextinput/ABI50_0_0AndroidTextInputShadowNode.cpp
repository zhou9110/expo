...
AttributedString AndroidTextInputShadowNode::getMostRecentAttributedString()
  ...
  auto ABI50_0_0ReactTreeAttributedString = getAttributedString();
  ...
  bool treeAttributedStringChanged =
      !state.ABI50_0_0ReactTreeAttributedString.compareTextAttributesWithoutFrame(
          ABI50_0_0ReactTreeAttributedString);
...
void AndroidTextInputShadowNode::updateStateIfNeeded() {
  ...
  auto newEventCount =
      state.ABI50_0_0ReactTreeAttributedString.isContentEqual(ABI50_0_0ReactTreeAttributedString)
      ? 0
