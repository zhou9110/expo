...
#include "ABI50_0_0YogaLayoutableShadowNode.h"
#include <ABI50_0_0logger/ABI50_0_0React_native_log.h>
#include <ABI50_0_0React/debug/ABI50_0_0flags.h>
...
static int FabricDefaultYogaLog(
    const ABI50_0_0YGConfigConstRef /*unused*/,
    const ABI50_0_0YGNodeConstRef /*unused*/,
  ...
  switch (level) {
    case ABI50_0_0YGLogLevelError:
      ABI50_0_0React_native_log_error(buffer.data());
      break;
    case ABI50_0_0YGLogLevelFatal:
      ABI50_0_0React_native_log_fatal(buffer.data());
      break;
    case ABI50_0_0YGLogLevelWarn:
      ABI50_0_0React_native_log_warn(buffer.data());
      break;
    case ABI50_0_0YGLogLevelInfo:
    case ABI50_0_0YGLogLevelDebug:
    case ABI50_0_0YGLogLevelVerbose:
    default:
      ABI50_0_0React_native_log_info(buffer.data());
  }
...
YogaLayoutableShadowNode::YogaLayoutableShadowNode(
  ...
  ABI50_0_0YGConfigConstRef previousConfig =
      &static_cast<const YogaLayoutableShadowNode&>(sourceShadowNode)
           .yogaConfig_;
...
void YogaLayoutableShadowNode::adoptYogaChild(size_t index) {
  ...
  if (childNode.yogaNode_.getOwner() == nullptr) {
    ...
    // ABI50_0_0React_native_assert(layoutableChildNode.yogaNode_.isDirty());
  } else {
    // The child is owned by some other node, we need to clone that.
    // TODO: At this point, ABI50_0_0React has wrong reference to the node. (T138668036)
...
void YogaLayoutableShadowNode::replaceChild(
  ...
  if (layoutableNewChild) {
    ...
    ABI50_0_0React_native_assert(layoutableNewChild->yogaNode_.getOwner() == nullptr);
...
/*static*/ yoga::Style YogaLayoutableShadowNode::applyAliasedProps(
  ...
  if (!props.inset.isUndefined()) {
    result.position()[ABI50_0_0YGEdgeAll] = props.inset;
  }
  if (!props.insetBlock.isUndefined()) {
    result.position()[ABI50_0_0YGEdgeVertical] = props.insetBlock;
  }
  if (!props.insetInline.isUndefined()) {
    result.position()[ABI50_0_0YGEdgeHorizontal] = props.insetInline;
  }
  if (!props.insetInlineEnd.isUndefined()) {
    result.position()[ABI50_0_0YGEdgeEnd] = props.insetInlineEnd;
  }
  if (!props.insetInlineStart.isUndefined()) {
    result.position()[ABI50_0_0YGEdgeStart] = props.insetInlineStart;
  }
  if (!props.marginInline.isUndefined()) {
    result.margin()[ABI50_0_0YGEdgeHorizontal] = props.marginInline;
  }
  if (!props.marginInlineStart.isUndefined()) {
    result.margin()[ABI50_0_0YGEdgeStart] = props.marginInlineStart;
  }
  if (!props.marginInlineEnd.isUndefined()) {
    result.margin()[ABI50_0_0YGEdgeEnd] = props.marginInlineEnd;
  }
  if (!props.marginBlock.isUndefined()) {
    result.margin()[ABI50_0_0YGEdgeVertical] = props.marginBlock;
  }
  if (!props.paddingInline.isUndefined()) {
    result.padding()[ABI50_0_0YGEdgeHorizontal] = props.paddingInline;
  }
  if (!props.paddingInlineStart.isUndefined()) {
    result.padding()[ABI50_0_0YGEdgeStart] = props.paddingInlineStart;
  }
  if (!props.paddingInlineEnd.isUndefined()) {
    result.padding()[ABI50_0_0YGEdgeEnd] = props.paddingInlineEnd;
  }
  if (!props.paddingBlock.isUndefined()) {
    result.padding()[ABI50_0_0YGEdgeVertical] = props.paddingBlock;
  }

  // Aliases without precedence
  if (CompactValue(result.position()[ABI50_0_0YGEdgeBottom]).isUndefined()) {
    result.position()[ABI50_0_0YGEdgeBottom] = props.insetBlockEnd;
  }
  if (CompactValue(result.position()[ABI50_0_0YGEdgeTop]).isUndefined()) {
    result.position()[ABI50_0_0YGEdgeTop] = props.insetBlockStart;
  }
  if (CompactValue(result.margin()[ABI50_0_0YGEdgeTop]).isUndefined()) {
    result.margin()[ABI50_0_0YGEdgeTop] = props.marginBlockStart;
  }
  if (CompactValue(result.margin()[ABI50_0_0YGEdgeBottom]).isUndefined()) {
    result.margin()[ABI50_0_0YGEdgeBottom] = props.marginBlockEnd;
  }
  if (CompactValue(result.padding()[ABI50_0_0YGEdgeTop]).isUndefined()) {
    result.padding()[ABI50_0_0YGEdgeTop] = props.paddingBlockStart;
  }
  if (CompactValue(result.padding()[ABI50_0_0YGEdgeBottom]).isUndefined()) {
    result.padding()[ABI50_0_0YGEdgeBottom] = props.paddingBlockEnd;
  }
...
void YogaLayoutableShadowNode::configureYogaTree(
    ...
    ABI50_0_0YGErrata defaultErrata,
    bool swapLeftAndRight) {
  ensureUnsealed();

  // Set state on our own Yoga node
  ABI50_0_0YGErrata errata = resolveErrata(defaultErrata);
  ABI50_0_0YGConfigSetErrata(&yogaConfig_, errata);
  ABI50_0_0YGConfigSetPointScaleFactor(&yogaConfig_, pointScaleFactor);
  ...
  for (size_t i = 0; i < yogaLayoutableChildren_.size(); i++) {
    ...
    auto childErrata =
        ABI50_0_0YGConfigGetErrata(const_cast<yoga::Config*>(&child.yogaConfig_));
...
ABI50_0_0YGErrata YogaLayoutableShadowNode::resolveErrata(ABI50_0_0YGErrata defaultErrata) const {
  if (auto viewShadowNode = traitCast<const ViewShadowNode*>(this)) {
    ...
    switch (props.experimental_layoutConformance) {
      case LayoutConformance::Classic:
        return ABI50_0_0YGErrataAll;
      case LayoutConformance::Strict:
        return ABI50_0_0YGErrataNone;
...
void YogaLayoutableShadowNode::setSize(Size size) const {
  ...
  style.setDimension(
      ABI50_0_0YGDimensionWidth, yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(size.width));
  style.setDimension(
      ABI50_0_0YGDimensionHeight, yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(size.height));
...
void YogaLayoutableShadowNode::setPadding(RectangleEdges<Float> padding) const {
  ...
  auto leftPadding = yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.left);
  auto topPadding = yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.top);
  auto rightPadding = yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.right);
  auto bottomPadding = yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.bottom);

  if (leftPadding != style.padding()[ABI50_0_0YGEdgeLeft] ||
      topPadding != style.padding()[ABI50_0_0YGEdgeTop] ||
      rightPadding != style.padding()[ABI50_0_0YGEdgeRight] ||
      bottomPadding != style.padding()[ABI50_0_0YGEdgeBottom]) {
    style.padding()[ABI50_0_0YGEdgeTop] =
        yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.top);
    style.padding()[ABI50_0_0YGEdgeLeft] =
        yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.left);
    style.padding()[ABI50_0_0YGEdgeRight] =
        yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.right);
    style.padding()[ABI50_0_0YGEdgeBottom] =
        yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(padding.bottom);
    yogaNode_.setStyle(style);
    yogaNode_.setDirty(true);
  }
}
...
void YogaLayoutableShadowNode::setPositionType(
    ABI50_0_0YGPositionType positionType) const {
  ensureUnsealed();
...
void YogaLayoutableShadowNode::layoutTree(
...

  {
    ...
    configureYogaTree(
        ...
        ABI50_0_0YGErrataAll /*defaultErrata*/,
        swapLeftAndRight);
  }
  ...
  ABI50_0_0React_native_assert(!std::isnan(minimumSize.width));
  ABI50_0_0React_native_assert(!std::isnan(minimumSize.height));
  ABI50_0_0React_native_assert(!std::isnan(maximumSize.width));
  ABI50_0_0React_native_assert(!std::isnan(maximumSize.height));
  // Values cannot be negative.
  ABI50_0_0React_native_assert(minimumSize.width >= 0);
  ABI50_0_0React_native_assert(minimumSize.height >= 0);
  ABI50_0_0React_native_assert(maximumSize.width >= 0);
  ABI50_0_0React_native_assert(maximumSize.height >= 0);
  // Minimum size cannot be infinity.
  ABI50_0_0React_native_assert(!std::isinf(minimumSize.width));
  ABI50_0_0React_native_assert(!std::isinf(minimumSize.height));
  ...
  // Module`. Yoga C++ API (and `ABI50_0_0YGNodeCalculateLayout` function particularly)
  ...
  yogaStyle.setMaxDimension(
      ...
      yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(maximumSize.width));

  yogaStyle.setMaxDimension(
      ABI50_0_0YGDimensionHeight,
      yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(maximumSize.height));

  yogaStyle.setMinDimension(
      ABI50_0_0YGDimensionWidth,
      yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(minimumSize.width));

  yogaStyle.setMinDimension(
      ABI50_0_0YGDimensionHeight,
      yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>(minimumSize.height));
  ...
  {
    SystraceSection s3("YogaLayoutableShadowNode::ABI50_0_0YGNodeCalculateLayout");
    ABI50_0_0YGNodeCalculateLayout(&yogaNode_, ownerWidth, ownerHeight, direction);
  }
...
ABI50_0_0YGNodeRef YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector(
    ABI50_0_0YGNodeConstRef /*oldYogaNode*/,
    ABI50_0_0YGNodeConstRef parentYogaNode,
    size_t childIndex) {
...
ABI50_0_0YGSize YogaLayoutableShadowNode::yogaNodeMeasureCallbackConnector(
    ABI50_0_0YGNodeConstRef yogaNode,
    float width,
...
YogaLayoutableShadowNode& YogaLayoutableShadowNode::shadowNodeFromContext(
  ...
  return traitCast<YogaLayoutableShadowNode&>(
      *static_cast<ShadowNode*>(ABI50_0_0YGNodeGetContext(yogaNode)));
}

yoga::Config& YogaLayoutableShadowNode::initializeYogaConfig(
    yoga::Config& config,
    ABI50_0_0YGConfigConstRef previousConfig) {
  ABI50_0_0YGConfigSetCloneNodeFunc(
      &config, YogaLayoutableShadowNode::yogaNodeCloneCallbackConnector);
  if (previousConfig != nullptr) {
    ABI50_0_0YGConfigSetPointScaleFactor(
        &config, ABI50_0_0YGConfigGetPointScaleFactor(previousConfig));
    ABI50_0_0YGConfigSetErrata(&config, ABI50_0_0YGConfigGetErrata(previousConfig));
  }

#ifdef ABI50_0_0RN_DEBUG_YOGA_LOGGER
  ABI50_0_0YGConfigSetPrintTreeFlag(&config, true);
#endif
  return config;
}
...
void YogaLayoutableShadowNode::swapLeftAndRightInYogaStyleProps(
  ...
  if (yogaStyle.position()[ABI50_0_0YGEdgeLeft] != ABI50_0_0YGValueUndefined) {
    yogaStyle.position()[ABI50_0_0YGEdgeStart] = position[ABI50_0_0YGEdgeLeft];
    yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValueUndefined;
  }

  if (yogaStyle.position()[ABI50_0_0YGEdgeRight] != ABI50_0_0YGValueUndefined) {
    yogaStyle.position()[ABI50_0_0YGEdgeEnd] = position[ABI50_0_0YGEdgeRight];
    yogaStyle.position()[ABI50_0_0YGEdgeRight] = ABI50_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI50_0_0YGEdgeLeft] != ABI50_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI50_0_0YGEdgeStart] = padding[ABI50_0_0YGEdgeLeft];
    yogaStyle.padding()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValueUndefined;
  }

  if (yogaStyle.padding()[ABI50_0_0YGEdgeRight] != ABI50_0_0YGValueUndefined) {
    yogaStyle.padding()[ABI50_0_0YGEdgeEnd] = padding[ABI50_0_0YGEdgeRight];
    yogaStyle.padding()[ABI50_0_0YGEdgeRight] = ABI50_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI50_0_0YGEdgeLeft] != ABI50_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI50_0_0YGEdgeStart] = margin[ABI50_0_0YGEdgeLeft];
    yogaStyle.margin()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValueUndefined;
  }

  if (yogaStyle.margin()[ABI50_0_0YGEdgeRight] != ABI50_0_0YGValueUndefined) {
    yogaStyle.margin()[ABI50_0_0YGEdgeEnd] = margin[ABI50_0_0YGEdgeRight];
    yogaStyle.margin()[ABI50_0_0YGEdgeRight] = ABI50_0_0YGValueUndefined;
  }
...
void YogaLayoutableShadowNode::swapLeftAndRightInViewProps(
  ...
  if (props.yogaStyle.border()[ABI50_0_0YGEdgeLeft] != ABI50_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI50_0_0YGEdgeStart] = border[ABI50_0_0YGEdgeLeft];
    props.yogaStyle.border()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValueUndefined;
  }

  if (props.yogaStyle.border()[ABI50_0_0YGEdgeRight] != ABI50_0_0YGValueUndefined) {
    props.yogaStyle.border()[ABI50_0_0YGEdgeEnd] = border[ABI50_0_0YGEdgeRight];
    props.yogaStyle.border()[ABI50_0_0YGEdgeRight] = ABI50_0_0YGValueUndefined;
  }
}
...
void YogaLayoutableShadowNode::ensureYogaChildrenLookFine() const {
#ifdef ABI50_0_0REACT_NATIVE_DEBUG
  ...
  for (const auto& yogaChild : yogaChildren) {
    ABI50_0_0React_native_assert(yogaChild->getContext());
    ABI50_0_0React_native_assert(yogaChild->getChildren().size() < 16384);
    if (!yogaChild->getChildren().empty()) {
      ABI50_0_0React_native_assert(!yogaChild->hasMeasureFunc());
    }
  }
#endif
}
...
void YogaLayoutableShadowNode::ensureYogaChildrenAlignment() const {
  ...
  if (getTraits().check(ShadowNodeTraits::Trait::LeafYogaNode)) {
    ABI50_0_0React_native_assert(yogaChildren.empty());
    return;
  }

  ABI50_0_0React_native_assert(yogaChildren.size() == children.size());
