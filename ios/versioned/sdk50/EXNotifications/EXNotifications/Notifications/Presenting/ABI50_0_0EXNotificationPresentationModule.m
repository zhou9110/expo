...
#import <ABI50_0_0EXNotifications/ABI50_0_0EXNotificationPresentationModule.h>
...
@interface ABI50_0_0EXNotificationPresentationModule ()

@property (nonatomic, weak) id<ABI50_0_0EXNotificationBuilder> notificationBuilder;
...
@implementation ABI50_0_0EXNotificationPresentationModule

ABI50_0_0EX_EXPORT_MODULE(ExpoNotificationPresenter);
...
// Remove once presentNotificationAsync is removed
ABI50_0_0EX_EXPORT_METHOD_AS(presentNotificationAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  __weak ABI50_0_0EXNotificationPresentationModule *weakSelf = self;
...
ABI50_0_0EX_EXPORT_METHOD_AS(getPresentedNotificationsAsync,
                    getPresentedNotificationsAsyncWithResolve:(ABI50_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
...
ABI50_0_0EX_EXPORT_METHOD_AS(dismissNotificationAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(dismissAllNotificationsAsync,
                    dismissAllNotificationsWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
...
{
  _notificationBuilder = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXNotificationBuilder)];

  // Remove once presentNotificationAsync is removed
  id<ABI50_0_0EXNotificationCenterDelegate> notificationCenterDelegate = (id<ABI50_0_0EXNotificationCenterDelegate>)[moduleRegistry getSingletonModuleForName:@"NotificationCenterDelegate"];
...
- (NSArray * _Nonnull)serializeNotifications:(NSArray<UNNotification *> * _Nonnull)notifications
{
  ...
  for (UNNotification *notification in notifications) {
    [serializedNotifications addObject:[ABI50_0_0EXNotificationSerializer serializedNotification:notification]];
  }
