...
NSString *const ABI50_0_0EXAudioRecordingOptionsIsMeteringEnabledKey = @"isMeteringEnabled";
NSString *const ABI50_0_0EXAudioRecordingOptionsKeepAudioActiveHintKey = @"keepAudioActiveHint";
NSString *const ABI50_0_0EXAudioRecordingOptionsKey = @"ios";
NSString *const ABI50_0_0EXAudioRecordingOptionExtensionKey = @"extension";
NSString *const ABI50_0_0EXAudioRecordingOptionOutputFormatKey = @"outputFormat";
NSString *const ABI50_0_0EXAudioRecordingOptionAudioQualityKey = @"audioQuality";
NSString *const ABI50_0_0EXAudioRecordingOptionSampleRateKey = @"sampleRate";
NSString *const ABI50_0_0EXAudioRecordingOptionNumberOfChannelsKey = @"numberOfChannels";
NSString *const ABI50_0_0EXAudioRecordingOptionBitRateKey = @"bitRate";
NSString *const ABI50_0_0EXAudioRecordingOptionBitRateStrategyKey = @"bitRateStrategy";
NSString *const ABI50_0_0EXAudioRecordingOptionBitDepthHintKey = @"bitDepthHint";
NSString *const ABI50_0_0EXAudioRecordingOptionLinearPCMBitDepthKey = @"linearPCMBitDepth";
NSString *const ABI50_0_0EXAudioRecordingOptionLinearPCMIsBigEndianKey = @"linearPCMIsBigEndian";
NSString *const ABI50_0_0EXAudioRecordingOptionLinearPCMIsFloatKey = @"linearPCMIsFloat";
...
- (void)setModuleRegistry:(ABI50_0_0EXModuleRegistry *)expoModuleRegistry
{
  ...
  _permissionsManager = [_expoModuleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXPermissionsInterface)];
  [ABI50_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI50_0_0EXAudioRecordingPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSError *)_setAudioMode:(NSDictionary *)mode
{
  ...
  if (!playsInSilentMode && interruptionMode == ABI50_0_0EXAudioInterruptionModeDuckOthers) {
    ...
    return ABI50_0_0EXErrorWithMessage(@"Impossible audio mode: playsInSilentMode == false and allowsRecording == true cannot be set on iOS.");
...
- (ABI50_0_0EXAVAudioSessionMode)_getAudioSessionModeRequired
{
  ...
  if (_audioRecorder) {
    if (_audioRecorderShouldBeginRecording || [_audioRecorder isRecording]) {
      audioSessionModeRequired = ABI50_0_0EXAVAudioSessionModeActive;
    } else if (_audioRecorderIsPreparing && audioSessionModeRequired == ABI50_0_0EXAVAudioSessionModeInactive) {
      audioSessionModeRequired = ABI50_0_0EXAVAudioSessionModeActiveMuted;
    }
  }
...
{
  return @{ABI50_0_0EXAudioRecordingOptionOutputFormatKey: AVFormatIDKey,
           ABI50_0_0EXAudioRecordingOptionAudioQualityKey:
             bitRateStrategy == AVAudioBitRateStrategy_Variable
           ? AVEncoderAudioQualityForVBRKey : AVEncoderAudioQualityKey,
           ABI50_0_0EXAudioRecordingOptionSampleRateKey: AVSampleRateKey,
           ABI50_0_0EXAudioRecordingOptionNumberOfChannelsKey: AVNumberOfChannelsKey,
           ABI50_0_0EXAudioRecordingOptionBitRateKey: AVEncoderBitRateKey,
           ABI50_0_0EXAudioRecordingOptionBitDepthHintKey: AVEncoderBitDepthHintKey,
           ABI50_0_0EXAudioRecordingOptionLinearPCMBitDepthKey: AVLinearPCMBitDepthKey,
           ABI50_0_0EXAudioRecordingOptionLinearPCMIsBigEndianKey: AVLinearPCMIsBigEndianKey,
           ABI50_0_0EXAudioRecordingOptionLinearPCMIsFloatKey: AVLinearPCMIsFloatKey};
}
...
{
  NSDictionary *iosOptionsFromJS = optionsFromJS[ABI50_0_0EXAudioRecordingOptionsKey];
  
  NSString *extension = iosOptionsFromJS[ABI50_0_0EXAudioRecordingOptionExtensionKey];
  _audioRecorderFilename = [NSString stringWithFormat:@"recording-%@%@", [[NSUUID UUID] UUIDString], extension];
  
  NSString *bitRateStrategy = [self _getBitRateStrategyFromEnum:iosOptionsFromJS[ABI50_0_0EXAudioRecordingOptionBitRateStrategyKey]];
  ...
  if (
      iosOptionsFromJS[ABI50_0_0EXAudioRecordingOptionOutputFormatKey] &&
      [iosOptionsFromJS[ABI50_0_0EXAudioRecordingOptionOutputFormatKey] isKindOfClass:[NSString class]]
      ) {
    recorderSettings[AVFormatIDKey] =
    @([self _getFormatIDFromString:iosOptionsFromJS[ABI50_0_0EXAudioRecordingOptionOutputFormatKey]]);
  }
...
{
  if (_audioRecorder) {
    return ABI50_0_0EXErrorWithMessage(@"Recorder is already prepared.");
  }
  
  id<ABI50_0_0EXFileSystemInterface> fileSystem = [_expoModuleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXFileSystemInterface)];
  
  if (!fileSystem) {
    return ABI50_0_0EXErrorWithMessage(@"No FileSystem module.");
  }
...
- (BOOL)_checkAudioRecorderExistsOrReject:(ABI50_0_0EXPromiseRejectBlock)reject
{
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [ABI50_0_0EXPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI50_0_0EXAudioRecordingPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
{
  _mediaServicesDidReset = false;
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI50_0_0EXAudioRecordingPermissionRequester class]]) {
  ...
  if (_audioRecorder && !error) {
    ...
    if (options[ABI50_0_0EXAudioRecordingOptionsIsMeteringEnabledKey]) {
    ...
    _audioRecorderIsPreparing = false;
    if (!options[ABI50_0_0EXAudioRecordingOptionsKeepAudioActiveHintKey]) {
      [self demoteAudioSessionIfPossible];
    }
  } else {
    reject(@"E_AUDIO_RECORDERNOTCREATED", [NSString stringWithFormat:@"Prepare encountered an error: %@", error.description], error);
