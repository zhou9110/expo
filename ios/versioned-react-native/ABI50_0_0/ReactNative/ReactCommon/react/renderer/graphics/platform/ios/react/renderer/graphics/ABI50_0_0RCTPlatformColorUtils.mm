...
#import "ABI50_0_0RCTPlatformColorUtils.h"
...
static inline ABI50_0_0facebook::ABI50_0_0React::ColorComponents _ColorComponentsFromUIColor(UIColor *color)
{
  CGFloat rgba[4];
...
ABI50_0_0facebook::ABI50_0_0React::ColorComponents ABI50_0_0RCTPlatformColorComponentsFromSemanticItems(std::vector<std::string> &semanticItems)
{
