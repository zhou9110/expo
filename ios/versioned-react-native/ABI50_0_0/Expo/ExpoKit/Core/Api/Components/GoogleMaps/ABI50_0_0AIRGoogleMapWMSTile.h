//
//  ABI50_0_0AIRGoogleMapWMSTile.h
//  AirMaps
//
...
@interface ABI50_0_0WMSTileOverlay : GMSSyncTileLayer
...
@interface ABI50_0_0AIRGoogleMapWMSTile : UIView
@property (nonatomic, strong) ABI50_0_0WMSTileOverlay *tileLayer;
