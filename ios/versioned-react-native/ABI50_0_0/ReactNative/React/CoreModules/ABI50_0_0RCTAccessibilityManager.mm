...
#import "ABI50_0_0RCTAccessibilityManager+Internal.h"
...
NSString *const ABI50_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification =
    @"ABI50_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification";

@interface ABI50_0_0RCTAccessibilityManager () <ABI50_0_0NativeAccessibilityManagerSpec>
...
@implementation ABI50_0_0RCTAccessibilityManager
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    self.contentSizeCategory = ABI50_0_0RCTSharedApplication().preferredContentSizeCategory;
...
- (void)invalidateMultiplier
{
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTAccessibilityManagerDidUpdateMultiplierNotification
                                                      object:self];
}
...
- (CGFloat)multiplierForContentSizeCategory:(NSString *)category
{
  ...
  if (m.doubleValue <= 0.0) {
    ABI50_0_0RCTLogError(@"Can't determine multiplier for category %@. Using 1.0.", category);
    m = @1.0;
  }
...
ABI50_0_0RCT_EXPORT_METHOD(setAccessibilityContentSizeMultipliers
                  : (ABI50_0_0JS::NativeAccessibilityManager::SpecSetAccessibilityContentSizeMultipliersJSMultipliers &)
                      JSMultipliers)
{
...
ABI50_0_0RCT_EXPORT_METHOD(setAccessibilityFocus : (double)ABI50_0_0ReactTag)
{
  dispatch_async(dispatch_get_main_queue(), ^{
    UIView *view = [self.viewRegistry_DEPRECATED viewForABI50_0_0ReactTag:@(ABI50_0_0ReactTag)];
    UIAccessibilityPostNotification(UIAccessibilityLayoutChangedNotification, view);
  });
}

ABI50_0_0RCT_EXPORT_METHOD(announceForAccessibility : (NSString *)announcement)
{
  UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, announcement);
}

ABI50_0_0RCT_EXPORT_METHOD(announceForAccessibilityWithOptions
                  : (NSString *)announcement options
                  : (ABI50_0_0JS::NativeAccessibilityManager::SpecAnnounceForAccessibilityWithOptionsOptions &)options)
{
...
ABI50_0_0RCT_EXPORT_METHOD(getMultiplier : (ABI50_0_0RCTResponseSenderBlock)callback)
{
  if (callback) {
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentBoldTextState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
  onSuccess(@[ @(_isBoldTextEnabled) ]);
}

ABI50_0_0RCT_EXPORT_METHOD(getCurrentGrayscaleState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentInvertColorsState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentReduceMotionState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentPrefersCrossFadeTransitionsState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentReduceTransparencyState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentVoiceOverState
                  : (ABI50_0_0RCTResponseSenderBlock)onSuccess onError
                  : (__unused ABI50_0_0RCTResponseSenderBlock)onError)
{
...
{
  return std::make_shared<ABI50_0_0facebook::ABI50_0_0React::NativeAccessibilityManagerSpecJSI>(params);
}
...
@implementation ABI50_0_0RCTBridge (ABI50_0_0RCTAccessibilityManager)

- (ABI50_0_0RCTAccessibilityManager *)accessibilityManager
{
  return [self moduleForClass:[ABI50_0_0RCTAccessibilityManager class]];
}

@end

@implementation ABI50_0_0RCTBridgeProxy (ABI50_0_0RCTAccessibilityManager)
...
Class ABI50_0_0RCTAccessibilityManagerCls(void)
{
  return ABI50_0_0RCTAccessibilityManager.class;
}
