 ...
 */
class JSI_EXPORT TurboModule : public ABI50_0_0facebook::jsi::HostObject {
 public:
  ...
  virtual std::vector<ABI50_0_0facebook::jsi::PropNameID> getPropertyNames(
 ...
 protected:
  ...
  struct MethodMetadata {
    size_t argCount;
    ABI50_0_0facebook::jsi::Value (*invoker)(
  ...
  /**
   * Calls ABI50_0_0RCTDeviceEventEmitter.emit to JavaScript, with given event name and
  ...
  virtual jsi::Value create(
    ...
    if (p == methodMap_.end()) {
      ...
      return ABI50_0_0facebook::jsi::Value::undefined();
    } else {
