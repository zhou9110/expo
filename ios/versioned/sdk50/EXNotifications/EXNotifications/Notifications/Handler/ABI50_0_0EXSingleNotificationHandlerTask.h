...
@class ABI50_0_0EXSingleNotificationHandlerTask;

@protocol ABI50_0_0EXSingleNotificationHandlerTaskDelegate

- (void)taskDidFinish:(ABI50_0_0EXSingleNotificationHandlerTask *)task;

@end

@interface ABI50_0_0EXSingleNotificationHandlerTask : NSObject
...
- (instancetype)initWithEventEmitter:(id<ABI50_0_0EXEventEmitterService>)eventEmitter
                   ...
                   completionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler
                            delegate:(id<ABI50_0_0EXSingleNotificationHandlerTaskDelegate>)delegate;
