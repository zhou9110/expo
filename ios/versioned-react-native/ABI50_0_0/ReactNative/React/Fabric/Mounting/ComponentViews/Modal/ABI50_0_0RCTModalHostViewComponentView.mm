...
#import "ABI50_0_0RCTModalHostViewComponentView.h"

#import <ABI50_0_0React/ABI50_0_0RCTBridge+Private.h>
#import <ABI50_0_0React/ABI50_0_0RCTModalManager.h>
#import <ABI50_0_0React/ABI50_0_0UIView+React.h>
#import <ABI50_0_0React/renderer/components/modal/ABI50_0_0ModalHostViewComponentDescriptor.h>
#import <ABI50_0_0React/renderer/components/modal/ABI50_0_0ModalHostViewState.h>
...
#import "ABI50_0_0RCTFabricModalHostViewController.h"
...
@interface ABI50_0_0RCTModalHostViewComponentView () <ABI50_0_0RCTFabricModalHostViewControllerDelegate>

@end

@implementation ABI50_0_0RCTModalHostViewComponentView {
  ABI50_0_0RCTFabricModalHostViewController *_viewController;
...
- (ABI50_0_0RCTFabricModalHostViewController *)viewController
{
  if (!_viewController) {
    _viewController = [ABI50_0_0RCTFabricModalHostViewController new];
...
{
  UIViewController *controller = [self ABI50_0_0ReactViewController];
...
#pragma mark - ABI50_0_0RCTFabricModalHostViewControllerDelegate
...
- (void)boundsDidChange:(CGRect)newBounds
{
  ...
  if (_state != nullptr) {
    auto newState = ModalHostViewState{ABI50_0_0RCTSizeFromCGSize(newBounds.size)};
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTModalHostViewCls(void);
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTModalHostViewCls(void)
{
  return ABI50_0_0RCTModalHostViewComponentView.class;
}
