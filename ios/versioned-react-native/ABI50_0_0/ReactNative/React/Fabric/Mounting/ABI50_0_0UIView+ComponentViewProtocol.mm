...
#import "ABI50_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI50_0_0RCTAssert(NO, @"`-[ABI50_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
...
{
  ABI50_0_0RCTAssert(NO, @"props access should be implemented by ABI50_0_0RCTViewComponentView.");
  return nullptr;
}
