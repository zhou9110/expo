...
$ABI50_0_0CODEGEN_OUTPUT_DIR = 'versioned-react-native/ABI50_0_0/ReactNative/codegen/ios'
...
def use_react_native_ABI50_0_0! (
  ...
  ENV['ABI50_0_0REACT_NATIVE_PATH'] = path
  ...
  pod 'ABI50_0_0FBLazyVector', :path => "#{prefix}/Libraries/FBLazyVector", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0FBReactNativeSpec', :path => "#{prefix}/React/FBReactNativeSpec", :project_name => 'ABI50_0_0' if !NewArchitectureHelper.new_arch_enabled
  pod 'ABI50_0_0RCTRequired', :path => "#{prefix}/Libraries/RCTRequired", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0RCTTypeSafety', :path => "#{prefix}/Libraries/TypeSafety", :project_name => 'ABI50_0_0', :modular_headers => true
  pod 'ABI50_0_0React', :path => "#{prefix}/", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-Core', :path => "#{prefix}/", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-CoreModules', :path => "#{prefix}/React/CoreModules", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTAppDelegate', :path => "#{prefix}/Libraries/AppDelegate", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTActionSheet', :path => "#{prefix}/Libraries/ActionSheetIOS", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTAnimation', :path => "#{prefix}/Libraries/NativeAnimation", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTBlob', :path => "#{prefix}/Libraries/Blob", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTImage', :path => "#{prefix}/Libraries/Image", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTLinking', :path => "#{prefix}/Libraries/LinkingIOS", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTNetwork', :path => "#{prefix}/Libraries/Network", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTSettings', :path => "#{prefix}/Libraries/Settings", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTText', :path => "#{prefix}/Libraries/Text", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-RCTVibration', :path => "#{prefix}/Libraries/Vibration", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-Core/RCTWebSocket', :path => "#{prefix}/", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-rncore', :path => "#{prefix}/ReactCommon", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-cxxreact', :path => "#{prefix}/ReactCommon/cxxreact", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-debug', :path => "#{prefix}/ReactCommon/react/debug", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-utils', :path => "#{prefix}/ReactCommon/react/utils", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-Mapbuffer', :path => "#{prefix}/ReactCommon", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-jserrorhandler', :path => "#{prefix}/ReactCommon/jserrorhandler", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-nativeconfig', :path => "#{prefix}/ReactCommon", :project_name => 'ABI50_0_0'

  if hermes_enabled
    setup_hermes_ABI50_0_0!(:react_native_path => prefix)
  else
    setup_jsc_ABI50_0_0!(:react_native_path => prefix, :fabric_enabled => fabric_enabled)
  end

  pod 'ABI50_0_0React-jsiexecutor', :path => "#{prefix}/ReactCommon/jsiexecutor", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-jsinspector', :path => "#{prefix}/ReactCommon/jsinspector-modern", :project_name => 'ABI50_0_0'

  pod 'ABI50_0_0React-callinvoker', :path => "#{prefix}/ReactCommon/callinvoker", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-runtimeexecutor', :path => "#{prefix}/ReactCommon/runtimeexecutor", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-runtimescheduler', :path => "#{prefix}/ReactCommon/react/renderer/runtimescheduler", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-rendererdebug', :path => "#{prefix}/ReactCommon/react/renderer/debug", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-perflogger', :path => "#{prefix}/ReactCommon/reactperflogger", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0React-logger', :path => "#{prefix}/ReactCommon/logger", :project_name => 'ABI50_0_0'
  pod 'ABI50_0_0ReactCommon/turbomodule/core', :path => "#{prefix}/ReactCommon", :project_name => 'ABI50_0_0', :modular_headers => true
  pod 'ABI50_0_0React-NativeModulesApple', :path => "#{prefix}/ReactCommon/react/nativemodule/core/platform/ios", :project_name => 'ABI50_0_0', :modular_headers => true
  pod 'ABI50_0_0Yoga', :path => "#{prefix}/ReactCommon/yoga", :project_name => 'ABI50_0_0', :modular_headers => true

  # pod 'ABI50_0_0DoubleConversion', :podspec => "#{prefix}/third-party-podspecs/DoubleConversion.podspec"
  # pod 'ABI50_0_0glog', :podspec => "#{prefix}/third-party-podspecs/glog.podspec"
  # pod 'ABI50_0_0boost', :podspec => "#{prefix}/third-party-podspecs/boost.podspec"
  # pod 'ABI50_0_0RCT-Folly', :podspec => "#{prefix}/third-party-podspecs/RCT-Folly.podspec", :modular_headers => true

  run_codegen_ABI50_0_0!(
    app_path,
    config_file_dir,
    :new_arch_enabled => NewArchitectureHelper.new_arch_enabled,
    ...
    :codegen_output_dir => $ABI50_0_0CODEGEN_OUTPUT_DIR,
    :package_json_file => File.join(__dir__, "..", "package.json"),
    :folly_version => $FOLLY_VERSION
  )

  pod 'ABI50_0_0React-Codegen', :path => $ABI50_0_0CODEGEN_OUTPUT_DIR, :modular_headers => true
...
# =====================
def use_react_native_codegen_ABI50_0_0!(spec, options={})
  ...
  relative_installation_root = Pod::Config.instance.installation_root.relative_path_from(Pathname.pwd)
  output_dir = options[:output_dir] ||= $ABI50_0_0CODEGEN_OUTPUT_DIR
  ...
  spec.script_phase = {
    ...
    :script => get_script_phases_no_codegen_discovery_ABI50_0_0(
