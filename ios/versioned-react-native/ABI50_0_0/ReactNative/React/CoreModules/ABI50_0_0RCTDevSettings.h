...
@protocol ABI50_0_0RCTPackagerClientMethod;

/**
 * An abstraction for a key-value store to manage ABI50_0_0RCTDevSettings behavior.
 * The default implementation persists settings using NSUserDefaults.
 */
@protocol ABI50_0_0RCTDevSettingsDataSource <NSObject>
...
@protocol ABI50_0_0RCTDevSettingsInspectable <NSObject>
...
@interface ABI50_0_0RCTDevSettings : ABI50_0_0RCTEventEmitter <ABI50_0_0RCTInitializing>
...
/*
 * Whether shaking will show ABI50_0_0RCTDevMenu. The menu is enabled by default if ABI50_0_0RCT_DEV=1, but
...
- (void)addHandler:(id<ABI50_0_0RCTPackagerClientMethod>)handler
    forPackagerMethod:(NSString *)name __deprecated_msg("Use ABI50_0_0RCTPackagerConnection directly instead");
#endif

@end

@interface ABI50_0_0RCTBridge (ABI50_0_0RCTDevSettings)

@property (nonatomic, readonly) ABI50_0_0RCTDevSettings *devSettings;

@end

@interface ABI50_0_0RCTBridgeProxy (ABI50_0_0RCTDevSettings)
...
// (i.e. ABI50_0_0RCT_DEV or ABI50_0_0RCT_DEV_MENU is set)
ABI50_0_0RCT_EXTERN void ABI50_0_0RCTDevSettingsSetEnabled(BOOL enabled);
