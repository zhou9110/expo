...
#import "ABI50_0_0RCTTextInputComponentView.h"

#import <ABI50_0_0React/renderer/components/iostextinput/ABI50_0_0TextInputComponentDescriptor.h>
...
#import <ABI50_0_0React/ABI50_0_0RCTUITextField.h>
#import <ABI50_0_0React/ABI50_0_0RCTUITextView.h>
#import <ABI50_0_0React/ABI50_0_0RCTUtils.h>

#import "ABI50_0_0RCTConversions.h"
#import "ABI50_0_0RCTTextInputNativeCommands.h"
...
@interface ABI50_0_0RCTTextInputComponentView () <ABI50_0_0RCTBackedTextInputDelegate, ABI50_0_0RCTTextInputViewProtocol>
@end

@implementation ABI50_0_0RCTTextInputComponentView {
  TextInputShadowNode::ConcreteState::Shared _state;
  UIView<ABI50_0_0RCTBackedTextInputViewProtocol> *_backedTextInputView;
   ...
   * if UITextView is backing text input view, inside `-[ABI50_0_0RCTTextInputComponentView textInputDidChangeSelection]` we make
   * sure to call `onChange` before `onSelectionChange` and ignore next `-[ABI50_0_0RCTTextInputComponentView
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _backedTextInputView = props.traits.multiline ? [ABI50_0_0RCTUITextView new] : [ABI50_0_0RCTUITextField new];
...
#pragma mark - ABI50_0_0RCTViewComponentView overrides
...
- (void)updateProps:(const Props::Shared &)props oldProps:(const Props::Shared &)oldProps
{
  ...
  if (newTextInputProps.traits.autocapitalizationType != oldTextInputProps.traits.autocapitalizationType) {
    _backedTextInputView.autocapitalizationType =
        ABI50_0_0RCTUITextAutocapitalizationTypeFromAutocapitalizationType(newTextInputProps.traits.autocapitalizationType);
  }

  if (newTextInputProps.traits.autoCorrect != oldTextInputProps.traits.autoCorrect) {
    _backedTextInputView.autocorrectionType =
        ABI50_0_0RCTUITextAutocorrectionTypeFromOptionalBool(newTextInputProps.traits.autoCorrect);
  }
  ...
  if (newTextInputProps.traits.keyboardAppearance != oldTextInputProps.traits.keyboardAppearance) {
    _backedTextInputView.keyboardAppearance =
        ABI50_0_0RCTUIKeyboardAppearanceFromKeyboardAppearance(newTextInputProps.traits.keyboardAppearance);
  }

  if (newTextInputProps.traits.spellCheck != oldTextInputProps.traits.spellCheck) {
    _backedTextInputView.spellCheckingType =
        ABI50_0_0RCTUITextSpellCheckingTypeFromOptionalBool(newTextInputProps.traits.spellCheck);
  }
  ...
  if (newTextInputProps.traits.clearButtonMode != oldTextInputProps.traits.clearButtonMode) {
    _backedTextInputView.clearButtonMode =
        ABI50_0_0RCTUITextFieldViewModeFromTextInputAccessoryVisibilityMode(newTextInputProps.traits.clearButtonMode);
  }
  ...
  if (newTextInputProps.traits.keyboardType != oldTextInputProps.traits.keyboardType) {
    _backedTextInputView.keyboardType = ABI50_0_0RCTUIKeyboardTypeFromKeyboardType(newTextInputProps.traits.keyboardType);
  }

  if (newTextInputProps.traits.returnKeyType != oldTextInputProps.traits.returnKeyType) {
    _backedTextInputView.returnKeyType = ABI50_0_0RCTUIReturnKeyTypeFromReturnKeyType(newTextInputProps.traits.returnKeyType);
  }

  if (newTextInputProps.traits.textContentType != oldTextInputProps.traits.textContentType) {
    _backedTextInputView.textContentType = ABI50_0_0RCTUITextContentTypeFromString(newTextInputProps.traits.textContentType);
  }

  if (newTextInputProps.traits.passwordRules != oldTextInputProps.traits.passwordRules) {
    _backedTextInputView.passwordRules = ABI50_0_0RCTUITextInputPasswordRulesFromString(newTextInputProps.traits.passwordRules);
  }
  ...
  if (newTextInputProps.traits.smartInsertDelete != oldTextInputProps.traits.smartInsertDelete) {
    _backedTextInputView.smartInsertDeleteType =
        ABI50_0_0RCTUITextSmartInsertDeleteTypeFromOptionalBool(newTextInputProps.traits.smartInsertDelete);
  }
  ...
  if (newTextInputProps.placeholder != oldTextInputProps.placeholder) {
    _backedTextInputView.placeholder = ABI50_0_0RCTNSStringFromString(newTextInputProps.placeholder);
  }

  if (newTextInputProps.placeholderTextColor != oldTextInputProps.placeholderTextColor) {
    _backedTextInputView.placeholderColor = ABI50_0_0RCTUIColorFromSharedColor(newTextInputProps.placeholderTextColor);
  }

  if (newTextInputProps.textAttributes != oldTextInputProps.textAttributes) {
    _backedTextInputView.defaultTextAttributes =
        ABI50_0_0RCTNSTextAttributesFromTextAttributes(newTextInputProps.getEffectiveTextAttributes(ABI50_0_0RCTFontSizeMultiplier()));
  }

  if (newTextInputProps.selectionColor != oldTextInputProps.selectionColor) {
    _backedTextInputView.tintColor = ABI50_0_0RCTUIColorFromSharedColor(newTextInputProps.selectionColor);
  }

  if (newTextInputProps.inputAccessoryViewID != oldTextInputProps.inputAccessoryViewID) {
    _backedTextInputView.inputAccessoryViewID = ABI50_0_0RCTNSStringFromString(newTextInputProps.inputAccessoryViewID);
  }
...
- (void)updateState:(const State::Shared &)state oldState:(const State::Shared &)oldState
{
  ...
  if (_mostRecentEventCount == _state->getData().mostRecentEventCount) {
    _comingFromJS = YES;
    [self _setAttributedString:ABI50_0_0RCTNSAttributedStringFromAttributedStringBox(data.attributedStringBox)];
    _comingFromJS = NO;
  }
}
           ...
           oldLayoutMetrics:(const LayoutMetrics &)oldLayoutMetrics
{
  ...
  _backedTextInputView.frame =
      UIEdgeInsetsInsetRect(self.bounds, ABI50_0_0RCTUIEdgeInsetsFromEdgeInsets(layoutMetrics.borderWidth));
  _backedTextInputView.textContainerInset =
      ABI50_0_0RCTUIEdgeInsetsFromEdgeInsets(layoutMetrics.contentInsets - layoutMetrics.borderWidth);
...
#pragma mark - ABI50_0_0RCTBackedTextInputDelegate
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!_backedTextInputView.textWasPasted) {
    if (_eventEmitter) {
      ...
      keyPressMetrics.text = ABI50_0_0RCTStringFromNSString(text);
...
#pragma mark - ABI50_0_0RCTBackedTextInputDelegate (UIScrollViewDelegate)
...
{
  ABI50_0_0RCTTextInputHandleCommand(self, commandName, args);
}
...
- (TextInputMetrics)_textInputMetrics
{
  ...
  metrics.text = ABI50_0_0RCTStringFromNSString(_backedTextInputView.attributedText.string);
...
- (void)_updateState
{
  ...
  data.attributedStringBox = ABI50_0_0RCTAttributedStringBoxFromNSAttributedString(attributedString);
...
- (void)_setMultiline:(BOOL)multiline
{
  ...
  UIView<ABI50_0_0RCTBackedTextInputViewProtocol> *backedTextInputView = multiline ? [ABI50_0_0RCTUITextView new] : [ABI50_0_0RCTUITextField new];
  backedTextInputView.frame = _backedTextInputView.frame;
  ABI50_0_0RCTCopyBackedTextInput(_backedTextInputView, backedTextInputView);
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RCTTextInputCls(void)
{
  return ABI50_0_0RCTTextInputComponentView.class;
}
