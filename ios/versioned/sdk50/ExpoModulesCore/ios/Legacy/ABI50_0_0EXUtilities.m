...
@interface ABI50_0_0EXUtilities ()

@property (nonatomic, nullable, weak) ABI50_0_0EXModuleRegistry *moduleRegistry;

@end

@protocol ABI50_0_0EXUtilService
...
@implementation ABI50_0_0EXUtilities

ABI50_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI50_0_0EXUtilitiesInterface)];
}
...
- (nullable NSDictionary *)launchOptions
{
  id<ABI50_0_0EXUtilService> utilService = [_moduleRegistry getSingletonModuleForName:@"Util"];
...
+ (UIColor *)UIColor:(id)json
{
  ...
  if ([json isKindOfClass:[NSArray class]]) {
    ...
    ABI50_0_0EXLogInfo(@"%@ cannot be converted to a UIColor", json);
    return nil;
  }
}
...
+ (NSDate *)NSDate:(id)json
{
  if ([json isKindOfClass:[NSNumber class]]) {
    ...
    if (!date) {
      ABI50_0_0EXLogError(@"JSON String '%@' could not be interpreted as a date. "
                  "Expected format: YYYY-MM-DD'T'HH:mm:ss.sssZ", json);
    }
    return date;
  } else if (json) {
    ABI50_0_0EXLogError(json, @"a date");
  }
  return nil;
}
...
UIApplication * ABI50_0_0EXSharedApplication(void)
{
...
NSError *ABI50_0_0EXErrorWithMessage(NSString *message)
{
  NSDictionary<NSString *, id> *errorInfo = @{NSLocalizedDescriptionKey: message};
  return [[NSError alloc] initWithDomain:@"ABI50_0_0EXModulesErrorDomain" code:0 userInfo:errorInfo];
}
