...
#include "ABI50_0_0NativeMutationObserver.h"
#include <ABI50_0_0React/ABI50_0_0renderer/core/ShadowNode.h>
#include <ABI50_0_0React/ABI50_0_0renderer/debug/SystraceSection.h>
...
NativeMutationObserverModuleProvider(
  ...
  return std::make_shared<ABI50_0_0facebook::ABI50_0_0React::NativeMutationObserver>(
      std::move(jsInvoker));
}
...
NativeMutationObserver::NativeMutationObserver(
    ...
    : ABI50_0_0NativeMutationObserverCxxSpec(std::move(jsInvoker)) {}
