...
ABI50_0_0RNSkMetalCanvasProvider::ABI50_0_0RNSkMetalCanvasProvider(
    std::function<void()> requestRedraw,
    std::shared_ptr<ABI50_0_0RNSkia::ABI50_0_0RNSkPlatformContext> context)
    : ABI50_0_0RNSkCanvasProvider(requestRedraw), _context(context) {
#pragma clang diagnostic push
 ...
 */
float ABI50_0_0RNSkMetalCanvasProvider::getScaledWidth() {
 ...
 */
float ABI50_0_0RNSkMetalCanvasProvider::getScaledHeight() {
...
/**
 Render to a canvas
 */
bool ABI50_0_0RNSkMetalCanvasProvider::renderToCanvas(
...
void ABI50_0_0RNSkMetalCanvasProvider::setSize(int width, int height) {
  _width = width;
  _height = height;
...
CALayer *ABI50_0_0RNSkMetalCanvasProvider::getLayer() { return _layer; }
