...
@implementation ABI50_0_0RNCSegmentedControl
...
- (void)setValues:(NSArray *)values {
	...
	for (id segment in values) {
		if ([segment isKindOfClass:[NSMutableDictionary class]]){
			UIImage *image = [[ABI50_0_0RCTConvert UIImage:segment] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
