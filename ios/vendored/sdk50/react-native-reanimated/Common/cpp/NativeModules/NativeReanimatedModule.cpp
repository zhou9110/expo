...
#if ABI50_0_0REACT_NATIVE_MINOR_VERSION >= 72
#include <react/renderer/core/TraitCast.h>
#endif
#include <react/renderer/uimanager/UIManagerBinding.h>
#include <react/renderer/uimanager/primitives.h>
#if ABI50_0_0REACT_NATIVE_MINOR_VERSION >= 73 && defined(ABI50_0_0RCT_NEW_ARCH_ENABLED)
...
jsi::Value NativeReanimatedModule::scheduleOnRuntime(
  ...
  ABI50_0_0reanimated::scheduleOnRuntime(rt, workletRuntimeValue, shareableWorkletValue);
...
void NativeReanimatedModule::updateDataSynchronously(
  ...
  ABI50_0_0reanimated::updateDataSynchronously(rt, synchronizedDataHolderRef, newData);
}

jsi::Value NativeReanimatedModule::getDataSynchronously(
    jsi::Runtime &rt,
    const jsi::Value &synchronizedDataHolderRef) {
  return ABI50_0_0reanimated::getDataSynchronously(rt, synchronizedDataHolderRef);
}
...
jsi::Value NativeReanimatedModule::makeShareableClone(
  ...
  return ABI50_0_0reanimated::makeShareableClone(rt, value, shouldRetainRemote);
}
...
void NativeReanimatedModule::performOperations() {
...

  {
    ...
    // PropsRegistry anyway so that ABI50_0_0React doesn't overwrite it in the next
  ...
  if (propsRegistry_->shouldReanimatedSkipCommit()) {
    ...
    // while ABI50_0_0React Native tries to commit a new tree on the JS thread.
    // In this case, we should skip the commit here and let ABI50_0_0React Native do it.
    ...
    shadowTree.commit(
        [&](RootShadowNode const &oldRootShadowNode)
          ...
          for (const auto &[shadowNode, props] : copiedOperationsQueue) {
            ...
            // in 0.72.4 but we have only check for minor version of ABI50_0_0React
            // Native so enable that optimization in ABI50_0_0React Native >= 0.73
            if (propsRegistry_->shouldReanimatedSkipCommit()) {
              return nullptr;
            }
#endif
            ...
            if (newRootNode == nullptr) {
              // this happens when ABI50_0_0React removed the component but Reanimated
...
jsi::Value NativeReanimatedModule::measure(
  ...
  if (layoutMetrics == EmptyLayoutMetrics) {
    // Originally, in this case ABI50_0_0React Native returns `{0, 0, 0, 0, 0, 0}`, most
  ...
  ABI50_0_0facebook::ABI50_0_0React::Point originRelativeToParent =
      layoutableShadowNode != nullptr
      ? layoutableShadowNode->getLayoutMetrics().frame.origin
      : ABI50_0_0facebook::ABI50_0_0React::Point();
