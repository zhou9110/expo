 ...
 * bundle's format.
 */
ABI50_0_0RN_EXPORT ScriptTag parseTypeFromHeader(const BundleHeader& header);

/**
 * Convert an `ScriptTag` enum into a string, useful for emitting in errors
 * and diagnostic messages.
 */
ABI50_0_0RN_EXPORT const char* stringForScriptTag(const ScriptTag& tag);

/**
 * Check whether a given bundle is hermesc-generated bytecode
 */
ABI50_0_0RN_EXPORT bool isHermesBytecodeBundle(const BundleHeader& header);
