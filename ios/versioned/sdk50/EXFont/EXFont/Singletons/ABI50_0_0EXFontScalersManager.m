...
@implementation UIFont (ABI50_0_0EXFontLoader)

- (UIFont *)ABI50_0_0EXFontWithSize:(CGFloat)fontSize
{
  for (id<ABI50_0_0EXFontScalerInterface> fontScaler in currentFontScalers) {
  ...
  return [self ABI50_0_0EXFontWithSize:fontSize];
}
...
@implementation ABI50_0_0EXFontScalersManager

ABI50_0_0EX_REGISTER_SINGLETON_MODULE(FontScalersManager);
...
+ (void)initialize
{
  ...
  dispatch_once(&initializeCurrentFontScalersOnce, ^{
    ...
    SEL exUpdate = @selector(ABI50_0_0EXFontWithSize:);
...
- (void)registerFontScaler:(id<ABI50_0_0EXFontScalerInterface>)fontScaler
{
