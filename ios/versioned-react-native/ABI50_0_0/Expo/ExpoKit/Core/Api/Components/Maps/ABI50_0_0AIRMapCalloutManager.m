...
#import "ABI50_0_0AIRMapCalloutManager.h"
...
@interface ABI50_0_0AIRMapCalloutManager()

@end

@implementation ABI50_0_0AIRMapCalloutManager

ABI50_0_0RCT_EXPORT_MODULE()

- (UIView *)view
{
    return [ABI50_0_0AIRMapCallout new];
}
