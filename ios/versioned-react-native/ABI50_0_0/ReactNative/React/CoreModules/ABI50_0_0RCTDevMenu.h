...
ABI50_0_0RCT_EXTERN NSString *const ABI50_0_0RCTShowDevMenuNotification;

#endif

@class ABI50_0_0RCTDevMenuItem;

/**
 * Developer menu, useful for exposing extra functionality when debugging.
 */
@interface ABI50_0_0RCTDevMenu : NSObject

/**
 * Deprecated, use ABI50_0_0RCTDevSettings instead.
 */
 ...
 */
@property (nonatomic, copy, readonly) NSArray<ABI50_0_0RCTDevMenuItem *> *presentedItems;
...
/**
 * Deprecated, use `ABI50_0_0RCTReloadCommand` instead.
 */
...
typedef NSString * (^ABI50_0_0RCTDevMenuItemTitleBlock)(void);

/**
 * Developer menu item, used to expose additional functionality via the menu.
 */
@interface ABI50_0_0RCTDevMenuItem : NSObject
 ...
 */
+ (instancetype)buttonItemWithTitleBlock:(ABI50_0_0RCTDevMenuItemTitleBlock)titleBlock handler:(dispatch_block_t)handler;

@end

/**
 * This category makes the developer menu instance available via the
 * ABI50_0_0RCTBridge, which is useful for any class that needs to access the menu.
 */
@interface ABI50_0_0RCTBridge (ABI50_0_0RCTDevMenu)

@property (nonatomic, readonly) ABI50_0_0RCTDevMenu *devMenu;

@end

@interface ABI50_0_0RCTBridgeProxy (ABI50_0_0RCTDevMenu)
