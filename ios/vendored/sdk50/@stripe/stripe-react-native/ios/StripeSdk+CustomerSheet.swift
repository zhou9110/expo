...
extension StripeSdk {
    ...
    func initCustomerSheet(params: NSDictionary, customerAdapterOverrides: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
    ...
    func presentCustomerSheet(params: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                           rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func retrieveCustomerSheetPaymentOptionSelection(resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                              rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func customerAdapterFetchPaymentMethodsCallback(paymentMethods: [NSDictionary], resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                                                     rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func customerAdapterAttachPaymentMethodCallback(unusedPaymentMethod: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                                                     rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func customerAdapterDetachPaymentMethodCallback(unusedPaymentMethod: NSDictionary, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                                                     rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func customerAdapterSetSelectedPaymentOptionCallback(resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock,
                                                     rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func customerAdapterFetchSelectedPaymentOptionCallback(paymentOption: String?, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
    ...
    func customerAdapterSetupIntentClientSecretForCustomerAttachCallback(clientSecret: String, resolver resolve: @escaping ABI50_0_0RCTPromiseResolveBlock, rejecter reject: @escaping ABI50_0_0RCTPromiseRejectBlock) -> Void  {
