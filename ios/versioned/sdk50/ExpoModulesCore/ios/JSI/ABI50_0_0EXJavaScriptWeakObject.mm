...
@implementation ABI50_0_0EXJavaScriptWeakObject {
  /**
                         ...
                         runtime:(nonnull ABI50_0_0EXJavaScriptRuntime *)runtime
{
  if (self = [super init]) {
    ...
    if (ABI50_0_0expo::isWeakRefSupported(*[runtime get])) {
      _weakObject = ABI50_0_0expo::createWeakRef(*[runtime get], jsObject);
    } else {
...
#else
  std::shared_ptr<jsi::Object> objectPtr = ABI50_0_0expo::isWeakRefSupported(*runtime)
    ? ABI50_0_0expo::derefWeakRef(*runtime, _weakObject)
    : _weakObject;
#endif
