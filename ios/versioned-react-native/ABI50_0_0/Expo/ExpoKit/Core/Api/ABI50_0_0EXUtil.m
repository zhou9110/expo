...
@interface ABI50_0_0EXUtil ()

@property (nonatomic, weak) id<ABI50_0_0EXUtilService> kernelUtilService;

@end

ABI50_0_0EX_DEFINE_SCOPED_MODULE_GETTER(ABI50_0_0EXUtil, util)

@implementation ABI50_0_0EXUtil

ABI50_0_0EX_EXPORT_SCOPED_MODULE(ExponentUtil, UtilService);

- (instancetype)initWithExperienceStableLegacyId:(NSString *)experienceStableLegacyId
                                        scopeKey:(NSString *)scopeKey
                                    easProjectId:(NSString *)easProjectId
                           kernelServiceDelegate:(id<ABI50_0_0EXUtilService>)kernelServiceInstance
