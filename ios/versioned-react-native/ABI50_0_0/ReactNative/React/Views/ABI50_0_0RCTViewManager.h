...
@class ABI50_0_0RCTUIManager;

typedef void (^ABI50_0_0RCTViewManagerUIBlock)(ABI50_0_0RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry);

@interface ABI50_0_0RCTViewManager : NSObject <ABI50_0_0RCTBridgeModule>

/**
 * The bridge can be used to access both the ABI50_0_0RCTUIIManager and the ABI50_0_0RCTEventDispatcher,
 ...
 * an ordinary ABI50_0_0RCTShadowView instance will be created, which is typically fine for
...
/**
 * DEPRECATED: declare properties of type ABI50_0_0RCTBubblingEventBlock instead
 *
 ...
 */
- (NSArray<NSString *> *)customBubblingEventTypes __deprecated_msg("Use ABI50_0_0RCTBubblingEventBlock props instead.");

/**
 * This handles the simple case, where JS and native property names match.
 */
#define ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(name, type)            \
  +(NSArray<NSString *> *)propConfig_##name ABI50_0_0RCT_DYNAMIC \
  {                                                     \
    return @[ @ #type ];                                \
  }
 ...
 */
#define ABI50_0_0RCT_REMAP_VIEW_PROPERTY(name, keyPath, type)    \
  +(NSArray<NSString *> *)propConfig_##name ABI50_0_0RCT_DYNAMIC \
  {                                                     \
    return @[ @ #type, @ #keyPath ];                    \
  }
 ...
 */
#define ABI50_0_0RCT_CUSTOM_VIEW_PROPERTY(name, type, viewClass) \
  ABI50_0_0RCT_REMAP_VIEW_PROPERTY(name, __custom__, type)       \
  -(void)set_##name : (id)json forView : (viewClass *)view withDefaultView : (viewClass *)defaultView ABI50_0_0RCT_DYNAMIC

/**
 * This macro is used to map properties to the shadow view, instead of the view.
 */
#define ABI50_0_0RCT_EXPORT_SHADOW_PROPERTY(name, type)                \
  +(NSArray<NSString *> *)propConfigShadow_##name ABI50_0_0RCT_DYNAMIC \
  {                                                           \
    return @[ @ #type ];                                      \
  }
 ...
 */
#define ABI50_0_0RCT_REMAP_SHADOW_PROPERTY(name, keyPath, type)        \
  +(NSArray<NSString *> *)propConfigShadow_##name ABI50_0_0RCT_DYNAMIC \
  {                                                           \
    return @[ @ #type, @ #keyPath ];                          \
  }
 ...
 */
#define ABI50_0_0RCT_CUSTOM_SHADOW_PROPERTY(name, type, viewClass) \
  ABI50_0_0RCT_REMAP_SHADOW_PROPERTY(name, __custom__, type)       \
  -(void)set_##name : (id)json forShadowView : (viewClass *)view ABI50_0_0RCT_DYNAMIC
