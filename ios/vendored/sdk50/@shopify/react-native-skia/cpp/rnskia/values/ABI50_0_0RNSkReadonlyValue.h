...
/**
 ...
 started.
 */
class ABI50_0_0RNSkReadonlyValue
    : public JsiSkHostObject,
      public std::enable_shared_from_this<ABI50_0_0RNSkReadonlyValue> {
public:
  explicit ABI50_0_0RNSkReadonlyValue(
      std::shared_ptr<ABI50_0_0RNSkPlatformContext> platformContext)
      : JsiSkHostObject(platformContext),
        _valueHolder(std::make_shared<ABI50_0_0RNJsi::JsiValue>()) {}

  virtual ~ABI50_0_0RNSkReadonlyValue() { invalidate(); }
  ...
  JSI_EXPORT_PROPERTY_GETTERS(JSI_EXPORT_PROP_GET(ABI50_0_0RNSkReadonlyValue,
                                                  __typename__),
                              JSI_EXPORT_PROP_GET(ABI50_0_0RNSkReadonlyValue, current))
        ...
        addListener([weakSelf = weak_from_this(),
          ...
          if (self) {
            auto selfReadonlyValue =
                std::dynamic_pointer_cast<ABI50_0_0RNSkReadonlyValue>(self);
  ...
  virtual void update(jsi::Runtime &runtime, const jsi::Value &value) {
    auto equal = _valueHolder->operator==(ABI50_0_0RNJsi::JsiValue(runtime, value));
    if (!equal) {
   ...
   */
  std::shared_ptr<ABI50_0_0RNJsi::JsiValue> getCurrent() { return _valueHolder; }
...
private:
  std::shared_ptr<ABI50_0_0RNJsi::JsiValue> _valueHolder;
