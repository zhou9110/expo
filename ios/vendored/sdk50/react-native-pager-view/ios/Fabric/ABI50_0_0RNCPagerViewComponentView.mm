...
#import "ABI50_0_0RNCPagerViewComponentView.h"
#import <react/renderer/components/ABI50_0_0RNCViewPager/ComponentDescriptors.h>
#import <react/renderer/components/ABI50_0_0RNCViewPager/EventEmitters.h>
#import <react/renderer/components/ABI50_0_0RNCViewPager/Props.h>
#import <react/renderer/components/ABI50_0_0RNCViewPager/ABI50_0_0RCTComponentViewHelpers.h>
...
@interface ABI50_0_0RNCPagerViewComponentView () <ABI50_0_0RCTRNCViewPagerViewProtocol, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate>

@property(nonatomic, assign) UIPanGestureRecognizer* panGestureRecognizer;

@end

@implementation ABI50_0_0RNCPagerViewComponentView {
    LayoutMetrics _layoutMetrics;
    UIScrollView *scrollView;
}

- (void)initializeNativePageViewController {
    const auto &viewProps = *std::static_pointer_cast<const ABI50_0_0RNCViewPagerProps>(_props);
    ...
    switch (viewProps.orientation) {
        case ABI50_0_0RNCViewPagerOrientation::Horizontal:
            orientation = UIPageViewControllerNavigationOrientationHorizontal;
            break;
        case ABI50_0_0RNCViewPagerOrientation::Vertical:
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        static const auto defaultProps = std::make_shared<const ABI50_0_0RNCViewPagerProps>();
        _props = defaultProps;
...
-(void)updateLayoutMetrics:(const ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics &)layoutMetrics oldLayoutMetrics:(const ABI50_0_0facebook::ABI50_0_0React::LayoutMetrics &)oldLayoutMetrics {
    [super updateLayoutMetrics:layoutMetrics oldLayoutMetrics:_layoutMetrics];
    self.contentView.frame = ABI50_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
...
- (void)shouldDismissKeyboard:(ABI50_0_0RNCViewPagerKeyboardDismissMode)dismissKeyboard {
    UIScrollViewKeyboardDismissMode dismissKeyboardMode = UIScrollViewKeyboardDismissModeNone;
    switch (dismissKeyboard) {
        case ABI50_0_0RNCViewPagerKeyboardDismissMode::None:
            dismissKeyboardMode = UIScrollViewKeyboardDismissModeNone;
            break;
        case ABI50_0_0RNCViewPagerKeyboardDismissMode::OnDrag:
...
- (void)updateProps:(const ABI50_0_0facebook::ABI50_0_0React::Props::Shared &)props oldProps:(const ABI50_0_0facebook::ABI50_0_0React::Props::Shared &)oldProps{
    const auto &oldScreenProps = *std::static_pointer_cast<const ABI50_0_0RNCViewPagerProps>(_props);
    const auto &newScreenProps = *std::static_pointer_cast<const ABI50_0_0RNCViewPagerProps>(props);
    ...
    const auto newLayoutDirectionStr = ABI50_0_0RCTNSStringFromString(toString(newScreenProps.layoutDirection));
...
- (void)handleCommand:(const NSString *)commandName args:(const NSArray *)args {
    ABI50_0_0RCTRNCViewPagerHandleCommand(self, commandName, args);
}
...
- (void)setPagerViewControllers:(NSInteger)index
    ...
    __weak ABI50_0_0RNCPagerViewComponentView *weakSelf = self;
    [_nativePageViewController setViewControllers:@[[_nativeChildrenViewControllers objectAtIndex:index]]
                                        direction:direction
                                         animated:animated
                                       completion:^(BOOL finished) {
        __strong ABI50_0_0RNCPagerViewComponentView *strongSelf = weakSelf;
        [strongSelf enableSwipe];
        if (strongSelf->_eventEmitter != nullptr ) {
            const auto strongEventEmitter = *std::dynamic_pointer_cast<const ABI50_0_0RNCViewPagerEventEmitter>(strongSelf->_eventEmitter);
            int position = (int) index;
            strongEventEmitter.onPageSelected(ABI50_0_0RNCViewPagerEventEmitter::OnPageSelected{.position =  static_cast<double>(position)});
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    const auto strongEventEmitter = *std::dynamic_pointer_cast<const ABI50_0_0RNCViewPagerEventEmitter>(_eventEmitter);
    strongEventEmitter.onPageScrollStateChanged(ABI50_0_0RNCViewPagerEventEmitter::OnPageScrollStateChanged{.pageScrollState =  ABI50_0_0RNCViewPagerEventEmitter::OnPageScrollStateChangedPageScrollState::Dragging });
}

- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset {
    
    const auto strongEventEmitter = *std::dynamic_pointer_cast<const ABI50_0_0RNCViewPagerEventEmitter>(_eventEmitter);
    strongEventEmitter.onPageScrollStateChanged(ABI50_0_0RNCViewPagerEventEmitter::OnPageScrollStateChanged{.pageScrollState =  ABI50_0_0RNCViewPagerEventEmitter::OnPageScrollStateChangedPageScrollState::Settling });
    ...
    if (!_overdrag) {
        ...
        if ((isFirstPage && contentOffset <= topBound) || (isLastPage && contentOffset >= topBound)) {
            ...
            *targetContentOffset = croppedOffset;
            ...
            strongEventEmitter.onPageScrollStateChanged(ABI50_0_0RNCViewPagerEventEmitter::OnPageScrollStateChanged{.pageScrollState =  ABI50_0_0RNCViewPagerEventEmitter::OnPageScrollStateChangedPageScrollState::Idle });
        }
    }
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    strongEventEmitter.onPageScroll(ABI50_0_0RNCViewPagerEventEmitter::OnPageScroll{.position =  static_cast<double>(eventPosition), .offset = interpolatedOffset});
    ...
    if (bridge) {
        [bridge.eventDispatcher sendEvent:[[ABI50_0_0RCTOnPageScrollEvent alloc] initWithABI50_0_0ReactTag:[NSNumber numberWithInt:self.tag] position:@(position) offset:@(interpolatedOffset)]];
    }
...
- (void)pageViewController:(UIPageViewController *)pageViewController
   ...
   previousViewControllers:(nonnull NSArray<UIViewController *> *)previousViewControllers
    ...
    if (completed) {
        ...
        const auto strongEventEmitter = *std::dynamic_pointer_cast<const ABI50_0_0RNCViewPagerEventEmitter>(_eventEmitter);
        strongEventEmitter.onPageSelected(ABI50_0_0RNCViewPagerEventEmitter::OnPageSelected{.position =  static_cast<double>(position)});
        strongEventEmitter.onPageScroll(ABI50_0_0RNCViewPagerEventEmitter::OnPageScroll{.position =  static_cast<double>(position), .offset =  0.0});
    }
}
...
{
    return concreteComponentDescriptorProvider<ABI50_0_0RNCViewPagerComponentDescriptor>();
}
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    ...
    if (gestureRecognizer == self.panGestureRecognizer && [NSStringFromClass([otherGestureRecognizer class]) isEqual: @"ABI50_0_0RNSPanGestureRecognizer"]) {
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNCViewPagerCls(void)
{
    return ABI50_0_0RNCPagerViewComponentView.class;
}
