...
TEST(RawPropsTest, handleProps) {
  ...
  ABI50_0_0EXPECT_FALSE(props->getSealed());

  ABI50_0_0EXPECT_STREQ(props->nativeId.c_str(), "abc");
}
...
TEST(RawPropsTest, handleRawPropsSingleString) {
  ...
  ABI50_0_0EXPECT_STREQ(value.c_str(), "abc");
}
...
TEST(RawPropsTest, handleRawPropsSingleFloat) {
  ...
  ABI50_0_0EXPECT_NEAR(value, 42.42, 0.00001);
}
...
TEST(RawPropsTest, handleRawPropsSingleIntGetManyTimes) {
  ...
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
}
...
TEST(RawPropsTest, handleRawPropsPrimitiveTypes) {
  ...
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
  ABI50_0_0EXPECT_NEAR((double)*raw.at("doubleValue", nullptr, nullptr), 17.42, 0.0001);
  ABI50_0_0EXPECT_NEAR((float)*raw.at("floatValue", nullptr, nullptr), 66.67, 0.00001);
  ABI50_0_0EXPECT_STREQ(
      ((std::string)*raw.at("stringValue", nullptr, nullptr)).c_str(),
      "helloworld");
  ABI50_0_0EXPECT_EQ((bool)*raw.at("boolValue", nullptr, nullptr), true);
}
...
TEST(RawPropsTest, handleRawPropsPrimitiveTypesIncomplete) {
  ...
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
  ABI50_0_0EXPECT_EQ(raw.at("doubleValue", nullptr, nullptr), nullptr);
  ABI50_0_0EXPECT_EQ(raw.at("floatValue", nullptr, nullptr), nullptr);
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
  ABI50_0_0EXPECT_EQ(raw.at("stringValue", nullptr, nullptr), nullptr);
  ABI50_0_0EXPECT_EQ(raw.at("boolValue", nullptr, nullptr), nullptr);
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
}
...
TEST(RawPropsTest, handleRawPropsPrimitiveTypesIncorrectLookup) {
  ...
  // test this in debug.
  ABI50_0_0EXPECT_EQ(raw.at("flurb", nullptr, nullptr), nullptr);
  ABI50_0_0EXPECT_EQ((int)*raw.at("intValue", nullptr, nullptr), 42);
}
#endif
...
TEST(RawPropsTest, handlePropsMultiLookup) {
  ...
  ABI50_0_0EXPECT_NEAR(props->floatValue, 10.0, 0.00001);
  ABI50_0_0EXPECT_NEAR(props->derivedFloatValue, 20.0, 0.00001);
}
