 ...
 */
@objc(ABI50_0_0EXUpdatesEmbeddedAppLoader)
@objcMembers
public final class EmbeddedAppLoader: AppLoader {
  public static let ABI50_0_0EXUpdatesEmbeddedManifestName = "app"
  public static let ABI50_0_0EXUpdatesEmbeddedManifestType = "manifest"
  public static let ABI50_0_0EXUpdatesEmbeddedBundleFilename = "app"
  public static let ABI50_0_0EXUpdatesEmbeddedBundleFileType = "bundle"
  public static let ABI50_0_0EXUpdatesBareEmbeddedBundleFilename = "main"
  public static let ABI50_0_0EXUpdatesBareEmbeddedBundleFileType = "jsbundle"

  private static let ErrorDomain = "ABI50_0_0EXUpdatesEmbeddedAppLoader"
  ...
  public static func embeddedManifest(withConfig config: UpdatesConfig, database: UpdatesDatabase?) -> BareUpdate? {
    ...
    if let resourceUrl = frameworkBundle.resourceURL,
      let bundle = Bundle(url: resourceUrl.appendingPathComponent("ABI50_0_0EXUpdates.bundle")),
      let path = bundle.path(
        forResource: EmbeddedAppLoader.ABI50_0_0EXUpdatesEmbeddedManifestName,
        ofType: EmbeddedAppLoader.ABI50_0_0EXUpdatesEmbeddedManifestType
      ) {
      manifestNSData = NSData(contentsOfFile: path)
    }

    // Fallback to main bundle if the embedded manifest is not found in ABI50_0_0EXUpdates.bundle. This is a special case
    ...
    // Not found in ABI50_0_0EXUpdates.bundle or main bundle
