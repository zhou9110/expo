...
@implementation ABI50_0_0RCTLayoutAnimationGroup
...
- (instancetype)initWithConfig:(NSDictionary *)config callback:(ABI50_0_0RCTResponseSenderBlock)callback
{
  ...
  if (self = [super init]) {
    NSTimeInterval duration = [ABI50_0_0RCTConvert NSTimeInterval:config[@"duration"]];
    ...
    _creatingLayoutAnimation = [[ABI50_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"create"]];
    _updatingLayoutAnimation = [[ABI50_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"update"]];
    _deletingLayoutAnimation = [[ABI50_0_0RCTLayoutAnimation alloc] initWithDuration:duration config:config[@"delete"]];
    _callback = callback;
  }
...
- (BOOL)isEqual:(ABI50_0_0RCTLayoutAnimationGroup *)layoutAnimation
{
  ABI50_0_0RCTLayoutAnimation *creatingLayoutAnimation = layoutAnimation.creatingLayoutAnimation;
  ABI50_0_0RCTLayoutAnimation *updatingLayoutAnimation = layoutAnimation.updatingLayoutAnimation;
  ABI50_0_0RCTLayoutAnimation *deletingLayoutAnimation = layoutAnimation.deletingLayoutAnimation;
