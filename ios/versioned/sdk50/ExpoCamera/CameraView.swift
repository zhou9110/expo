...
public class CameraView: ExpoView, ABI50_0_0EXCameraInterface, ABI50_0_0EXAppLifecycleListener,
  ...
  // MARK: - Legacy Modules
  private var faceDetector: ABI50_0_0EXFaceDetectorManagerInterface?
  private var lifecycleManager: ABI50_0_0EXAppLifecycleService?
  private var barCodeScanner: ABI50_0_0EXBarCodeScannerInterface?
  private var permissionsManager: ABI50_0_0EXPermissionsInterface?
  ...
  required init(appContext: AppContext? = nil) {
    ...
    lifecycleManager = appContext?.legacyModule(implementing: ABI50_0_0EXAppLifecycleService.self)
    permissionsManager = appContext?.legacyModule(implementing: ABI50_0_0EXPermissionsInterface.self)
  ...
  func initializeCaptureSessionInput() {
    ...
    ABI50_0_0EXUtilities.performSynchronously {
  ...
  private func createFaceDetectorManager() -> ABI50_0_0EXFaceDetectorManagerInterface? {
    let provider: ABI50_0_0EXFaceDetectorManagerProviderInterface? =
      appContext?.legacyModule(implementing: ABI50_0_0EXFaceDetectorManagerProviderInterface.self)
  ...
  private func createBarCodeScanner() -> ABI50_0_0EXBarCodeScannerInterface? {
    guard let barCodeScnnerProvider: ABI50_0_0EXBarCodeScannerProviderInterface? =
      appContext?.legacyModule(implementing: ABI50_0_0EXBarCodeScannerProviderInterface.self) else {
      return nil
    }
