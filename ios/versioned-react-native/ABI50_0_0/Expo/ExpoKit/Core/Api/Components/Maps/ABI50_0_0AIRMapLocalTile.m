...
#import "ABI50_0_0AIRMapLocalTileOverlay.h"

@implementation ABI50_0_0AIRMapLocalTile {
...
- (void) createTileOverlayAndRendererIfPossible
{
    ...
    self.tileOverlay = [[ABI50_0_0AIRMapLocalTileOverlay alloc] initWithURLTemplate:self.pathTemplate];
