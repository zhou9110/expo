...
public struct Exceptions {
  ...
  /**
   An exception to throw when there is no module implementing the `ABI50_0_0EXFileSystemInterface` interface.
   */
  ...
  /**
   An exception to throw when there is no module implementing the `ABI50_0_0EXPermissionsInterface` interface.
