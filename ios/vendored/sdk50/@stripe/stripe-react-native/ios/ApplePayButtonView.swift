...
@objc(ABI50_0_0ApplePayButtonView)
class ApplePayButtonView: UIView {
    var applePayButton: PKPaymentButton?
    var stripeSdk: StripeSdk?
    
    @objc var onPressAction: ABI50_0_0RCTDirectEventBlock?
    @objc var onShippingMethodSelectedAction: ABI50_0_0RCTDirectEventBlock?
    @objc var onShippingContactSelectedAction: ABI50_0_0RCTDirectEventBlock?
    @objc var onCouponCodeEnteredAction: ABI50_0_0RCTDirectEventBlock?
    @objc var onOrderTrackingAction: ABI50_0_0RCTDirectEventBlock?
