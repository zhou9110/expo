...
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0HostPlatformColor.h>
...
template <>
struct std::hash<ABI50_0_0facebook::ABI50_0_0React::SharedColor> {
  size_t operator()(ABI50_0_0facebook::ABI50_0_0React::SharedColor color) const {
