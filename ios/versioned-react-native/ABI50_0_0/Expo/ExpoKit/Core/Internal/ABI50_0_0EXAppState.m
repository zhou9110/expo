...
@interface ABI50_0_0EXAppState ()

@property (nonatomic, assign) BOOL isObserving;

@end

@implementation ABI50_0_0EXAppState

+ (NSString *)moduleName { return @"ABI50_0_0RCTAppState"; }
...
- (void)setState:(NSString *)state
{
  if (![state isEqualToString:_lastKnownState]) {
    ...
    // TODO: just make ABI50_0_0EXAppState an expo module implementing ABI50_0_0EXAppLifecycleService
    id<ABI50_0_0EXAppLifecycleService> lifeCycleManager = [[[self.bridge moduleForClass:[ABI50_0_0EXModuleRegistryHolderReactModule class]] exModuleRegistry] getModuleImplementingProtocol:@protocol(ABI50_0_0EXAppLifecycleService)];
...
ABI50_0_0RCT_EXPORT_METHOD(getCurrentAppState:(ABI50_0_0RCTResponseSenderBlock)callback
                  error:(__unused ABI50_0_0RCTResponseSenderBlock)error)
{
