...
using ::ABI50_0_0facebook::ABI50_0_0React::jsinspector_modern::IInspector;
...
class LocalConnection : public ILocalConnection {
 ...
 private:
  std::shared_ptr<ABI50_0_0hermes::inspector_modern::chrome::CDPHandler> conn_;
...
DebugSessionToken ConnectionDemux::enableDebugging(
  ...
  return addPage(ABI50_0_0hermes::inspector_modern::chrome::CDPHandler::create(
