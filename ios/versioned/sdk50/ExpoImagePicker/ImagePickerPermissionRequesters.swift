...
public class CameraPermissionRequester: NSObject, ABI50_0_0EXPermissionsRequester {
  static public func permissionType() -> String {
    return "camera"
  }

  public func requestPermissions(resolver resolve: @escaping ABI50_0_0EXPromiseResolveBlock, rejecter reject: ABI50_0_0EXPromiseRejectBlock) {
...
public class MediaLibraryPermissionRequester: DefaultMediaLibraryPermissionRequester,
                                              ABI50_0_0EXPermissionsRequester {
...
/**
 * This extension is adding default implmentation for ABI50_0_0EXPermissionsRequester that can be shared by many classe.
 ...
 * to this extension. I'm using as a mixin that implements major part of ABI50_0_0EXPermissionsRequester protocol.
 */
