...
#import <ABI50_0_0EXMediaLibrary/ABI50_0_0EXSaveToLibraryDelegate.h>
#import <ABI50_0_0EXMediaLibrary/ABI50_0_0EXMediaLibraryMediaLibraryPermissionRequester.h>
...
NSString *const ABI50_0_0EXAssetMediaTypeAudio = @"audio";
NSString *const ABI50_0_0EXAssetMediaTypePhoto = @"photo";
NSString *const ABI50_0_0EXAssetMediaTypeVideo = @"video";
NSString *const ABI50_0_0EXAssetMediaTypeUnknown = @"unknown";
NSString *const ABI50_0_0EXAssetMediaTypeAll = @"all";

NSString *const ABI50_0_0EXMediaLibraryDidChangeEvent = @"mediaLibraryDidChange";

NSString *const ABI50_0_0EXMediaLibraryCachesDirectory = @"MediaLibrary";

NSString *const ABI50_0_0EXMediaLibraryShouldDownloadFromNetworkKey = @"shouldDownloadFromNetwork";

@interface ABI50_0_0EXMediaLibrary ()
...
@implementation ABI50_0_0EXMediaLibrary

ABI50_0_0EX_EXPORT_MODULE(ExpoMediaLibrary);
...
- (void)setModuleRegistry:(ABI50_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  [ABI50_0_0EXPermissionsMethodsDelegate registerRequesters:@[[ABI50_0_0EXMediaLibraryMediaLibraryPermissionRequester new], [ABI50_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester new]] withPermissionsManager:_permissionsManager];
}
...
- (NSDictionary *)constantsToExport
{
  return @{
           @"MediaType": @{
               @"audio": ABI50_0_0EXAssetMediaTypeAudio,
               @"photo": ABI50_0_0EXAssetMediaTypePhoto,
               @"video": ABI50_0_0EXAssetMediaTypeVideo,
               @"unknown": ABI50_0_0EXAssetMediaTypeUnknown,
               @"all": ABI50_0_0EXAssetMediaTypeAll,
               },
           @"SortBy": @{
               @"default": @"default",
           ...
           @"CHANGE_LISTENER_NAME": ABI50_0_0EXMediaLibraryDidChangeEvent,
           };
}

- (NSArray<NSString *> *)supportedEvents
{
  return @[ABI50_0_0EXMediaLibraryDidChangeEvent];
}

- (id)requesterClass:(BOOL)writeOnly
{
  if (writeOnly) {
    return [ABI50_0_0EXMediaLibraryMediaLibraryWriteOnlyPermissionRequester class];
  } else {
    return [ABI50_0_0EXMediaLibraryMediaLibraryPermissionRequester class];
  }
}
...
ABI50_0_0EX_EXPORT_METHOD_AS(presentPermissionsPickerAsync,
                    presentPermissionsPickerAsync:(ABI50_0_0EXPromiseResolveBlock)resolve
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
#ifdef __IPHONE_14_0
  if (@available(iOS 14, *)) {
...
ABI50_0_0EX_EXPORT_METHOD_AS(createAssetAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAssetMediaType assetType = [ABI50_0_0EXMediaLibrary _assetTypeForUri:localUri];
  ...
  if (!([_fileSystem permissionsForURI:assetUrl] & ABI50_0_0EXFileSystemPermissionRead)) {
  ...
  [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
    ...
    if (success) {
      PHAsset *asset = [ABI50_0_0EXMediaLibrary _getAssetById:assetPlaceholder.localIdentifier];
      resolve([ABI50_0_0EXMediaLibrary _exportAsset:asset]);
    } else {
...
ABI50_0_0EX_EXPORT_METHOD_AS(saveToLibraryAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  __block ABI50_0_0EXSaveToLibraryDelegate *delegate = [ABI50_0_0EXSaveToLibraryDelegate new];
  [_saveToLibraryDelegates addObject:delegate];
  ABI50_0_0EXSaveToLibraryCallback callback = ^(id asset, NSError *error){
...
ABI50_0_0EX_EXPORT_METHOD_AS(addAssetsToAlbumAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI50_0_0EXMediaLibrary _addAssets:assetIds toAlbum:albumId withCallback:^(BOOL success, NSError *error) {
      if (error) {
...
ABI50_0_0EX_EXPORT_METHOD_AS(removeAssetsFromAlbumAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      PHAssetCollection *collection = [ABI50_0_0EXMediaLibrary _getAlbumById:albumId];
      PHFetchResult *assets = [ABI50_0_0EXMediaLibrary _getAssetsByIds:assetIds];
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteAssetsAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(getAlbumsAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    ...
    [albums addObjectsFromArray:[ABI50_0_0EXMediaLibrary _exportCollections:userAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    ...
    if ([options[@"includeSmartAlbums"] boolValue]) {
      ...
      [albums addObjectsFromArray:[ABI50_0_0EXMediaLibrary _exportCollections:smartAlbumsFetchResult withFetchOptions:fetchOptions inFolder:nil]];
    }
...
ABI50_0_0EX_EXPORT_METHOD_AS(getMomentsAsync,
                    getMoments:(ABI50_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  if (![self _checkPermissions:reject]) {
    return;
  ...
  NSArray<NSDictionary *> *albums = [ABI50_0_0EXMediaLibrary _exportCollections:fetchResult withFetchOptions:options inFolder:nil];
  
  resolve(albums);
}

ABI50_0_0EX_EXPORT_METHOD_AS(getAlbumAsync,
                    getAlbumWithTitle:(nonnull NSString *)title
                    resolve:(ABI50_0_0EXPromiseResolveBlock)resolve
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHAssetCollection *collection = [ABI50_0_0EXMediaLibrary _getAlbumWithTitle:title];
    resolve(ABI50_0_0EXNullIfNil([ABI50_0_0EXMediaLibrary _exportCollection:collection]));
  }];
}

ABI50_0_0EX_EXPORT_METHOD_AS(createAlbumAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    [ABI50_0_0EXMediaLibrary _createAlbumWithTitle:title completion:^(PHAssetCollection *collection, NSError *error) {
      if (collection) {
        if (assetId) {
          [ABI50_0_0EXMediaLibrary _addAssets:@[assetId] toAlbum:collection.localIdentifier withCallback:^(BOOL success, NSError *error) {
            if (success) {
              resolve(ABI50_0_0EXNullIfNil([ABI50_0_0EXMediaLibrary _exportCollection:collection]));
            } else {
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteAlbumsAsync,
...
{
  [self _runIfAllPermissionsWereGranted:reject block:^{
    PHFetchResult *collections = [ABI50_0_0EXMediaLibrary _getAlbumsById:albumIds];
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
      if (assetRemove) {
...
ABI50_0_0EX_EXPORT_METHOD_AS(getAssetInfoAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  PHAsset *asset = [ABI50_0_0EXMediaLibrary _getAssetById:assetId];
    
  BOOL shouldDownloadFromNetwork = [options objectForKey:ABI50_0_0EXMediaLibraryShouldDownloadFromNetworkKey] != nil
    ? [[options objectForKey:ABI50_0_0EXMediaLibraryShouldDownloadFromNetworkKey] boolValue]
    : YES;
  
  if (asset) {
    NSMutableDictionary *result = [ABI50_0_0EXMediaLibrary _exportAssetInfo:asset];
    if (asset.mediaType == PHAssetMediaTypeImage) {
      ...
      [[PHImageManager defaultManager] requestAVAssetForVideo:asset
        ...
        if ([asset isKindOfClass:[AVComposition class]]) {
            NSString *directory = [self.fileSystem.cachesDirectory stringByAppendingPathComponent:ABI50_0_0EXMediaLibraryCachesDirectory];
...
ABI50_0_0EX_EXPORT_METHOD_AS(getAssetsAsync,
                    ...
                    reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  NSDate *createdAfter = [ABI50_0_0EXUtilities NSDate:options[@"createdAfter"]];
  NSDate *createdBefore = [ABI50_0_0EXUtilities NSDate:options[@"createdBefore"]];
  ...
  if (albumId) {
    [self _runIfAllPermissionsWereGranted:reject block:^{
      ...
      [ABI50_0_0EXMediaLibrary _getAssetsWithAfter:after
                                    first:first
                                mediaType:mediaType
                                   sortBy:sortBy
...
- (void)startObserving
{
  _allAssetsFetchResult = [ABI50_0_0EXMediaLibrary _getAllAssets];
    ...
    if (changeDetails != nil) {
      ...
      if (changeDetails.hasIncrementalChanges && (changeDetails.insertedObjects.count > 0 || changeDetails.removedObjects.count > 0)) {
        ...
        for (PHAsset *asset in changeDetails.insertedObjects) {
          [insertedAssets addObject:[ABI50_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.removedObjects) {
          [deletedAssets addObject:[ABI50_0_0EXMediaLibrary _exportAsset:asset]];
        }
        for (PHAsset *asset in changeDetails.changedObjects) {
          [updatedAssets addObject:[ABI50_0_0EXMediaLibrary _exportAsset:asset]];
        }
        
        [_eventEmitter sendEventWithName:ABI50_0_0EXMediaLibraryDidChangeEvent body:body];
        return;
      }
      ...
      if (!changeDetails.hasIncrementalChanges) {
        [_eventEmitter sendEventWithName:ABI50_0_0EXMediaLibraryDidChangeEvent body:@{
                     ...
                     reject:(ABI50_0_0EXPromiseRejectBlock)reject
{
  ...
  PHAsset *cursor;
  if (after) {
    cursor = [ABI50_0_0EXMediaLibrary _getAssetById:after];
  ...
  if (mediaType && [mediaType count] > 0) {
    NSMutableArray<NSNumber *> *assetTypes = [ABI50_0_0EXMediaLibrary _convertMediaTypes:mediaType];
  ...
  if (sortBy && sortBy.count > 0) {
    fetchOptions.sortDescriptors = [ABI50_0_0EXMediaLibrary _prepareSortDescriptors:sortBy];
  }
  ...
  if (fetchOptions.sortDescriptors.count == 0) {
    ...
    for (NSInteger i = startIndex; i >= endIndex; i--) {
      ...
      [assets addObject:[ABI50_0_0EXMediaLibrary _exportAsset:asset]];
    }
...
{
  if (assetId) {
    return [ABI50_0_0EXMediaLibrary _getAssetsByIds:@[assetId]].firstObject;
  }
  return nil;
}
...
+ (void)_ensureAlbumWithTitle:(nonnull NSString *)title completion:(void(^)(PHAssetCollection *collection, NSError *error))completion
{
  ...
  [ABI50_0_0EXMediaLibrary _createAlbumWithTitle:title completion:completion];
}
...
+ (NSDictionary *)_exportAsset:(PHAsset *)asset
{
  if (asset) {
    ...
    return @{
             ...
             @"filename": ABI50_0_0EXNullIfNil(fileName),
             @"uri": [ABI50_0_0EXMediaLibrary _assetUriForLocalId:asset.localIdentifier],
             @"mediaType": [ABI50_0_0EXMediaLibrary _stringifyMediaType:asset.mediaType],
             @"mediaSubtypes": [ABI50_0_0EXMediaLibrary _stringifyMediaSubtypes:asset.mediaSubtypes],
             @"width": @(asset.pixelWidth),
             @"height": @(asset.pixelHeight),
             @"creationTime": [ABI50_0_0EXMediaLibrary _exportDate:asset.creationDate],
             @"modificationTime": [ABI50_0_0EXMediaLibrary _exportDate:asset.modificationDate],
...
{
  NSMutableDictionary *assetDict = [[ABI50_0_0EXMediaLibrary _exportAsset:asset] mutableCopy];
  
  if (assetDict) {
    assetDict[@"location"] = [ABI50_0_0EXMediaLibrary _exportLocation:asset.location];
...
{
  return [ABI50_0_0EXMediaLibrary _exportCollection:collection inFolder:nil];
}
...
+ (nullable NSDictionary *)_exportCollection:(PHAssetCollection *)collection inFolder:(nullable NSString *)folderName
{
  if (collection) {
    return @{
             @"id": [ABI50_0_0EXMediaLibrary _assetIdFromLocalId:collection.localIdentifier],
             @"title": ABI50_0_0EXNullIfNil(collection.localizedTitle),
             @"folderName": ABI50_0_0EXNullIfNil(folderName),
             @"type": [ABI50_0_0EXMediaLibrary _stringifyAlbumType:collection.assetCollectionType],
             @"assetCount": [ABI50_0_0EXMediaLibrary _assetCountOfCollection:collection],
             @"startTime": [ABI50_0_0EXMediaLibrary _exportDate:collection.startDate],
             @"endTime": [ABI50_0_0EXMediaLibrary _exportDate:collection.endDate],
             @"approximateLocation": [ABI50_0_0EXMediaLibrary _exportLocation:collection.approximateLocation],
             @"locationNames": ABI50_0_0EXNullIfNil(collection.localizedLocationNames),
             };
  }
  return nil;
}
                       ...
                       inFolder:(nullable NSString *)folderName
{
  ...
  for (PHCollection *collection in collections) {
    if ([collection isKindOfClass:[PHAssetCollection class]]) {
      [albums addObject:[ABI50_0_0EXMediaLibrary _exportCollection:(PHAssetCollection *)collection inFolder:folderName]];
      ...
      [albums addObjectsFromArray:[ABI50_0_0EXMediaLibrary _exportCollections:collectionsInFolder withFetchOptions:options inFolder:collection.localizedTitle]];
    }
  }
  return [albums copy];
}
...
{
  NSString *assetId = [ABI50_0_0EXMediaLibrary _assetIdFromLocalId:localId];
...
+ (PHAssetMediaType)assetTypeForFileExtension:(nonnull NSString *)fileExtension
{
  ...
  ABI50_0_0EXLogWarn(@"Asset media type is recognized from file extension and this behavior can differ on iOS Simulator and a physical device.");
...
+ (PHAssetMediaType)_assetTypeForUri:(nonnull NSString *)localUri
{
  ...
  if (fileUTI == nil){
    return [ABI50_0_0EXMediaLibrary assetTypeForFileExtension:[localUri pathExtension]];
  }
...
+ (NSString *)_stringifyMediaType:(PHAssetMediaType)mediaType
{
  switch (mediaType) {
    case PHAssetMediaTypeAudio:
      return ABI50_0_0EXAssetMediaTypeAudio;
    case PHAssetMediaTypeImage:
      return ABI50_0_0EXAssetMediaTypePhoto;
    case PHAssetMediaTypeVideo:
      return ABI50_0_0EXAssetMediaTypeVideo;
    default:
      return ABI50_0_0EXAssetMediaTypeUnknown;
  }
}

+ (PHAssetMediaType)_convertMediaType:(NSString *)mediaType
{
  if ([mediaType isEqualToString:ABI50_0_0EXAssetMediaTypeAudio]) {
    return PHAssetMediaTypeAudio;
  }
  if ([mediaType isEqualToString:ABI50_0_0EXAssetMediaTypePhoto]) {
    return PHAssetMediaTypeImage;
  }
  if ([mediaType isEqualToString:ABI50_0_0EXAssetMediaTypeVideo]) {
    return PHAssetMediaTypeVideo;
  }
  return PHAssetMediaTypeUnknown;
}
...
+ (NSMutableArray<NSNumber *> *)_convertMediaTypes:(NSArray<NSString *> *)mediaTypes
{
  ...
  [mediaTypes enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    if ([obj isEqualToString:ABI50_0_0EXAssetMediaTypeAll]) {
      *stop = YES;
      assetTypes = nil;
      return;
    }
    PHAssetMediaType assetType = [ABI50_0_0EXMediaLibrary _convertMediaType:obj];
...
+ (NSString *)_convertSortByKey:(NSString *)key
{
  ...
  if (value == nil) {
    ...
    @throw [NSException exceptionWithName:@"ABI50_0_0EXMediaLibrary.UNSUPPORTED_SORTBY_KEY" reason:reason userInfo:nil];
  }
  return value;
}
...
+ (NSSortDescriptor *)_sortDescriptorFrom:(id)config
{
  ...
  NSString *key = [ABI50_0_0EXMediaLibrary _convertSortByKey:parts[0]];
...
+ (NSArray *)_prepareSortDescriptors:(NSArray *)sortBy
{
  ...
  for (id config in sortByArray) {
    NSSortDescriptor *sortDescriptor = [ABI50_0_0EXMediaLibrary _sortDescriptorFrom:config];
...
- (void)_runIfAllPermissionsWereGranted:(ABI50_0_0EXPromiseRejectBlock)reject block:(void (^)(void))block
{
  [_permissionsManager getPermissionUsingRequesterClass:[ABI50_0_0EXMediaLibraryMediaLibraryPermissionRequester class] resolve:^(id result) {
...
- (BOOL)_checkPermissions:(ABI50_0_0EXPromiseRejectBlock)reject
{
