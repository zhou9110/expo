...
/**
 Internal `ABI50_0_0EXReactDelegateWrapper` interface for the designated initializer with `ExpoReactDelegate`.
 ...
 */
@interface ABI50_0_0EXReactDelegateWrapper(Private)
