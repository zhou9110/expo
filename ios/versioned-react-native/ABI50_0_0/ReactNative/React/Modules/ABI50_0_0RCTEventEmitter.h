...
/**
 * ABI50_0_0RCTEventEmitter is an abstract base class to be used for modules that emit
 * events to be observed by JS.
 */
@interface ABI50_0_0RCTEventEmitter : NSObject <ABI50_0_0RCTBridgeModule, ABI50_0_0RCTInvalidating>

@property (nonatomic, weak) ABI50_0_0RCTBridge *bridge;
@property (nonatomic, weak) ABI50_0_0RCTModuleRegistry *moduleRegistry;
@property (nonatomic, weak) ABI50_0_0RCTViewRegistry *viewRegistry_DEPRECATED;
