...
static NSString * const ABI50_0_0EXNotificationResponseDefaultActionIdentifier = @"expo.modules.notifications.actions.DEFAULT";

@implementation ABI50_0_0EXNotificationSerializer
...
+ (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)response
{
  ...
  if ([UNNotificationDefaultActionIdentifier isEqualToString:actionIdentifier]) {
    actionIdentifier = ABI50_0_0EXNotificationResponseDefaultActionIdentifier;
  }
