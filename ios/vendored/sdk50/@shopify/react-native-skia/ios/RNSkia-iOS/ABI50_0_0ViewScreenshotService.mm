#import "ABI50_0_0ViewScreenshotService.h"
...
@implementation ABI50_0_0ViewScreenshotService {
...
- (sk_sp<SkImage>)screenshotOfViewWithTag:(NSNumber *)viewTag {
  ...
  auto view = [_uiManager viewForABI50_0_0ReactTag:viewTag];
  if (view == NULL) {
    ABI50_0_0RCTFatal(ABI50_0_0RCTErrorWithMessage(@"Could not find view with tag"));
    return nullptr;
  }
