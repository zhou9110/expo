...
template <>
struct hash<ABI50_0_0facebook::ABI50_0_0React::Rect> {
  size_t operator()(const ABI50_0_0facebook::ABI50_0_0React::Rect& rect) const noexcept {
    return ABI50_0_0facebook::ABI50_0_0React::hash_combine(rect.origin, rect.size);
  }
};
