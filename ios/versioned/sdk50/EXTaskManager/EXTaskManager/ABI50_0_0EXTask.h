...
@protocol ABI50_0_0EXTaskDelegate <NSObject>
...
@interface ABI50_0_0EXTask : NSObject <ABI50_0_0EXTaskInterface>

@property (nonatomic, strong, readonly) NSString *name;
@property (nonatomic, strong, readonly) NSString *appId;
@property (nonatomic, strong, readonly) NSString *appUrl;
@property (nonatomic, strong, readonly) id<ABI50_0_0EXTaskConsumerInterface> consumer;
@property (nonatomic, strong) NSDictionary *options;
@property (nonatomic, weak) id<ABI50_0_0EXTaskDelegate> delegate;
...
- (instancetype)initWithName:(nonnull NSString *)name
               ...
               consumerClass:(Class)consumerClass
                    ...
                    delegate:(nullable id<ABI50_0_0EXTaskDelegate>)delegate;
