#include "ABI50_0_0EXWebGLMethods.h"
#include "ABI50_0_0EXGLContextManager.h"
#include "ABI50_0_0EXGLImageUtils.h"
#include "ABI50_0_0EXJsiArgsTransform.h"
#include "ABI50_0_0EXWebGLMethodsHelpers.h"
#include "ABI50_0_0EXWebGLRenderer.h"

#include <algorithm>

#define ARG(index, type)                                   \
  (argc > index ? unpackArg<type>(runtime, jsArgv + index) \
                : throw std::runtime_error("ABI50_0_0EXGL: Too few arguments"))
...
ContextWithLock getContext(jsi::Runtime &runtime, const jsi::Value &jsThis) {
  ...
  return ContextGet(static_cast<ABI50_0_0EXGLContextId>(exglCtxId));
}
  ...
  switch (pname) {
      ...
      for (const auto &pair : ctx->objects) {
        if (static_cast<int>(pair.second) == glInt) {
          return createWebGLObject(
              runtime, ABI50_0_0EXWebGLClass::WebGLBuffer, {static_cast<double>(pair.first)});
        }
      }
      return nullptr;
    }
    ...
    case GL_CURRENT_PROGRAM: {
      ...
      for (const auto &pair : ctx->objects) {
        if (static_cast<int>(pair.second) == glInt) {
          return createWebGLObject(
              runtime, ABI50_0_0EXWebGLClass::WebGLProgram, {static_cast<double>(pair.first)});
        }
      }
      return nullptr;
    }
    ...
    case GL_VERTEX_ARRAY_BINDING:
      throw std::runtime_error(
          "ABI50_0_0EXGL: getParameter() doesn't support gl." + std::to_string(pname) + " yet!");
...
NATIVE_METHOD(pixelStorei) {
  ...
  switch (pname) {
    ...
    default:
      jsConsoleLog(runtime, { jsi::String::createFromUtf8(runtime, "ABI50_0_0EXGL: gl.pixelStorei() doesn't support this parameter yet!") });
  }
  return nullptr;
}
...
NATIVE_METHOD(bindBuffer) {
  ...
  auto buffer = ARG(1, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(createBuffer) {
  CTX();
  return exglGenObject(ctx, runtime, glGenBuffers, ABI50_0_0EXWebGLClass::WebGLBuffer);
}

NATIVE_METHOD(deleteBuffer) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteBuffers);
}
...
NATIVE_METHOD(isBuffer) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsBuffer);
}
...
NATIVE_METHOD(bindFramebuffer) {
  CTX();
  auto target = ARG(0, GLenum);
  auto framebuffer = ARG(1, ABI50_0_0EXWebGLClass);
  ctx->addToNextBatch([=] {
    glBindFramebuffer(
...
NATIVE_METHOD(createFramebuffer) {
  CTX();
  return exglGenObject(ctx, runtime, glGenFramebuffers, ABI50_0_0EXWebGLClass::WebGLFramebuffer);
}

NATIVE_METHOD(deleteFramebuffer) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteFramebuffers);
}
...
NATIVE_METHOD(framebufferRenderbuffer) {
  ...
  auto fRenderbuffer = ARG(3, ABI50_0_0EXWebGLClass);
  ctx->addToNextBatch([=] {
...
NATIVE_METHOD(framebufferTexture2D, 5) {
  ...
  auto fTexture = ARG(3, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(isFramebuffer) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsFramebuffer);
}
...
NATIVE_METHOD(framebufferTextureLayer) {
  ...
  auto target = ARG(0, GLenum);
  auto attachment = ARG(1, GLenum);
  auto texture = ARG(2, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(bindRenderbuffer) {
  CTX();
  auto target = ARG(0, GLenum);
  auto fRenderbuffer = ARG(1, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(createRenderbuffer) {
  CTX();
  return exglGenObject(ctx, runtime, glGenRenderbuffers, ABI50_0_0EXWebGLClass::WebGLRenderbuffer);
}

NATIVE_METHOD(deleteRenderbuffer) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteRenderbuffers);
}
...
NATIVE_METHOD(isRenderbuffer) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsRenderbuffer);
}
...
NATIVE_METHOD(bindTexture) {
  CTX();
  auto target = ARG(0, GLenum);
  auto texture = ARG(1, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(createTexture) {
  CTX();
  return exglGenObject(ctx, runtime, glGenTextures, ABI50_0_0EXWebGLClass::WebGLTexture);
}

NATIVE_METHOD(deleteTexture) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteTextures);
}
...
NATIVE_METHOD(isTexture) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsTexture);
}
...
NATIVE_METHOD(texImage2D, 6) {
  ...
  if (argc == 9) {
    ...
    throw std::runtime_error("ABI50_0_0EXGL: Invalid number of arguments to gl.texImage2D()!");
  }
  return nullptr;
}
...
NATIVE_METHOD(texSubImage2D, 6) {
  ...
  if (argc == 9) {
    ...
    throw std::runtime_error("ABI50_0_0EXGL: Invalid number of arguments to gl.texSubImage2D()!");
  }
  return nullptr;
}
...
NATIVE_METHOD(attachShader) {
  CTX();
  auto program = ARG(0, ABI50_0_0EXWebGLClass);
  auto shader = ARG(1, ABI50_0_0EXWebGLClass);
  ctx->addToNextBatch(
...
NATIVE_METHOD(compileShader) {
  CTX();
  auto shader = ARG(0, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(createProgram) {
  CTX();
  return exglCreateObject(ctx, runtime, glCreateProgram, ABI50_0_0EXWebGLClass::WebGLProgram);
}
...
NATIVE_METHOD(createShader) {
  ...
  if (type == GL_VERTEX_SHADER || type == GL_FRAGMENT_SHADER) {
    return exglCreateObject(
        ctx, runtime, std::bind(glCreateShader, type), ABI50_0_0EXWebGLClass::WebGLShader);
  } else {
...
NATIVE_METHOD(deleteProgram) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteProgram);
}

NATIVE_METHOD(deleteShader) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteShader);
}
...
NATIVE_METHOD(getAttachedShaders) {
  CTX();
  auto fProgram = ARG(0, ABI50_0_0EXWebGLClass);
  ...
  for (auto i = 0; i < count; ++i) {
    ABI50_0_0EXGLObjectId exglObjId = 0;
    for (const auto &pair : ctx->objects) {
    ...
    if (exglObjId == 0) {
      throw std::runtime_error(
          "ABI50_0_0EXGL: Internal error: couldn't find ABI50_0_0EXGLObjectId "
          "associated with shader in getAttachedShaders()!");
    }
    jsResults.setValueAtIndex(
        runtime,
        i,
        createWebGLObject(runtime, ABI50_0_0EXWebGLClass::WebGLShader, {static_cast<double>(exglObjId)}));
  }
  return jsResults;
}
...
NATIVE_METHOD(getShaderParameter) {
  CTX();
  auto fShader = ARG(0, ABI50_0_0EXWebGLClass);
  auto pname = ARG(1, GLenum);
  GLint glResult;
...
NATIVE_METHOD(getShaderPrecisionFormat) {
  ...
  jsi::Object jsResult =
      createWebGLObject(runtime, ABI50_0_0EXWebGLClass::WebGLShaderPrecisionFormat, {}).asObject(runtime);
...
NATIVE_METHOD(getProgramInfoLog) {
  CTX();
  auto fObj = ARG(0, ABI50_0_0EXWebGLClass);
  std::string str;
  ctx->addBlockingToNextBatch([&] {
...
NATIVE_METHOD(isShader) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsShader);
}

NATIVE_METHOD(isProgram) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsProgram);
}
...
NATIVE_METHOD(getUniformLocation) {
  ...
  return location == -1
      ? jsi::Value::null()
      : createWebGLObject(runtime, ABI50_0_0EXWebGLClass::WebGLUniformLocation, {location});
}
...
NATIVE_METHOD(uniform1f) {
  CTX();
  auto uniform = ARG(0, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(uniform1fv) {
  CTX();
  return exglUniformv(ctx, glUniform1fv, ARG(0, ABI50_0_0EXWebGLClass), 1, ARG(1, std::vector<float>));
};

NATIVE_METHOD(uniform2fv) {
  CTX();
  return exglUniformv(ctx, glUniform2fv, ARG(0, ABI50_0_0EXWebGLClass), 2, ARG(1, std::vector<float>));
};

NATIVE_METHOD(uniform3fv) {
  CTX();
  return exglUniformv(ctx, glUniform3fv, ARG(0, ABI50_0_0EXWebGLClass), 3, ARG(1, std::vector<float>));
};

NATIVE_METHOD(uniform4fv) {
  CTX();
  return exglUniformv(ctx, glUniform4fv, ARG(0, ABI50_0_0EXWebGLClass), 4, ARG(1, std::vector<float>));
};

NATIVE_METHOD(uniform1iv) {
  CTX();
  return exglUniformv(ctx, glUniform1iv, ARG(0, ABI50_0_0EXWebGLClass), 1, ARG(1, std::vector<int32_t>));
};

NATIVE_METHOD(uniform2iv) {
  CTX();
  return exglUniformv(ctx, glUniform2iv, ARG(0, ABI50_0_0EXWebGLClass), 2, ARG(1, std::vector<int32_t>));
};

NATIVE_METHOD(uniform3iv) {
  CTX();
  return exglUniformv(ctx, glUniform3iv, ARG(0, ABI50_0_0EXWebGLClass), 3, ARG(1, std::vector<int32_t>));
};

NATIVE_METHOD(uniform4iv) {
  CTX();
  return exglUniformv(ctx, glUniform4iv, ARG(0, ABI50_0_0EXWebGLClass), 4, ARG(1, std::vector<int32_t>));
};
...
NATIVE_METHOD(vertexAttrib1fv) {
  ...
  return exglVertexAttribv(
      ctx, glVertexAttrib1fv, ARG(0, ABI50_0_0EXWebGLClass), ARG(1, std::vector<float>));
}

NATIVE_METHOD(vertexAttrib2fv) {
  CTX();
  return exglVertexAttribv(
      ctx, glVertexAttrib2fv, ARG(0, ABI50_0_0EXWebGLClass), ARG(1, std::vector<float>));
}

NATIVE_METHOD(vertexAttrib3fv) {
  CTX();
  return exglVertexAttribv(
      ctx, glVertexAttrib3fv, ARG(0, ABI50_0_0EXWebGLClass), ARG(1, std::vector<float>));
}

NATIVE_METHOD(vertexAttrib4fv) {
  CTX();
  return exglVertexAttribv(
      ctx, glVertexAttrib4fv, ARG(0, ABI50_0_0EXWebGLClass), ARG(1, std::vector<float>));
}
...
NATIVE_METHOD(uniform1uiv) {
  CTX();
  return exglUniformv(ctx, glUniform1uiv, ARG(0, ABI50_0_0EXWebGLClass), 1, ARG(1, std::vector<uint32_t>));
};

NATIVE_METHOD(uniform2uiv) {
  CTX();
  return exglUniformv(ctx, glUniform2uiv, ARG(0, ABI50_0_0EXWebGLClass), 2, ARG(1, std::vector<uint32_t>));
};

NATIVE_METHOD(uniform3uiv) {
  CTX();
  return exglUniformv(ctx, glUniform3uiv, ARG(0, ABI50_0_0EXWebGLClass), 3, ARG(1, std::vector<uint32_t>));
};

NATIVE_METHOD(uniform4uiv) {
  CTX();
  return exglUniformv(ctx, glUniform4uiv, ARG(0, ABI50_0_0EXWebGLClass), 4, ARG(1, std::vector<uint32_t>));
};
...
NATIVE_METHOD(createQuery) {
  CTX();
  return exglGenObject(ctx, runtime, glGenQueries, ABI50_0_0EXWebGLClass::WebGLQuery);
}

NATIVE_METHOD(deleteQuery) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteQueries);
}

NATIVE_METHOD(isQuery) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsQuery);
}

NATIVE_METHOD(beginQuery) {
  CTX();
  auto target = ARG(0, GLenum);
  auto query = ARG(1, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(getQuery) {
  ...
  return params == 0
      ? jsi::Value::null()
      : createWebGLObject(runtime, ABI50_0_0EXWebGLClass::WebGLQuery, {static_cast<double>(params)});
}

NATIVE_METHOD(getQueryParameter) {
  CTX();
  auto query = ARG(0, ABI50_0_0EXWebGLClass);
  auto pname = ARG(1, GLenum);
  GLuint params;
  ctx->addBlockingToNextBatch(
...
NATIVE_METHOD(createSampler) {
  CTX();
  return exglGenObject(ctx, runtime, glGenSamplers, ABI50_0_0EXWebGLClass::WebGLSampler);
}

NATIVE_METHOD(deleteSampler) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteSamplers);
}

NATIVE_METHOD(bindSampler) {
  CTX();
  auto unit = ARG(0, GLuint);
  auto sampler = ARG(1, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(isSampler) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsSampler);
}

NATIVE_METHOD(samplerParameteri) {
  CTX();
  auto sampler = ARG(0, ABI50_0_0EXWebGLClass);
  auto pname = ARG(1, GLenum);
...
NATIVE_METHOD(createTransformFeedback) {
  CTX();
  return exglGenObject(ctx, runtime, glGenTransformFeedbacks, ABI50_0_0EXWebGLClass::WebGLTransformFeedback);
}

NATIVE_METHOD(deleteTransformFeedback) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteTransformFeedbacks);
}

NATIVE_METHOD(isTransformFeedback) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsTransformFeedback);
}

NATIVE_METHOD(bindTransformFeedback) {
  CTX();
  auto target = ARG(0, GLenum);
  auto transformFeedback = ARG(1, ABI50_0_0EXWebGLClass);
  ctx->addToNextBatch(
...
NATIVE_METHOD(bindBufferBase) {
  ...
  auto target = ARG(0, GLenum);
  auto index = ARG(1, GLuint);
  auto buffer = ARG(2, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(createVertexArray) {
  CTX();
  return exglGenObject(ctx, runtime, glGenVertexArrays, ABI50_0_0EXWebGLClass::WebGLVertexArrayObject);
}

NATIVE_METHOD(deleteVertexArray) {
  CTX();
  return exglDeleteObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glDeleteVertexArrays);
}

NATIVE_METHOD(isVertexArray) {
  CTX();
  return exglIsObject(ctx, ARG(0, ABI50_0_0EXWebGLClass), glIsVertexArray);
}

NATIVE_METHOD(bindVertexArray) {
  CTX();
  auto vertexArray = ARG(0, ABI50_0_0EXWebGLClass);
...
NATIVE_METHOD(getExtension) {
  ...
  if (name == "ABI50_0_0EXT_texture_filter_anisotropic") {
