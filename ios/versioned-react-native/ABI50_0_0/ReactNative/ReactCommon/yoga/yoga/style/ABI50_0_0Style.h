...
#include <ABI50_0_0yoga/enums/ABI50_0_0Align.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0Direction.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0Display.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0FlexDirection.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0Justify.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0Overflow.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0PositionType.h>
#include <ABI50_0_0yoga/enums/ABI50_0_0Wrap.h>
...
class ABI50_0_0YG_EXPORT Style {
  template <typename Enum>
  using Values = std::array<CompactValue, ordinalCount<Enum>()>;

 public:
  using Dimensions = Values<ABI50_0_0YGDimension>;
  using Edges = Values<ABI50_0_0YGEdge>;
  using Gutters = Values<ABI50_0_0YGGutter>;
  ...
  struct IdxRef {
    struct Ref {
      ...
      operator ABI50_0_0YGValue() const {
        return (style.*Prop)[idx];
      }
 ...
 public:
  ...
  IdxRef<ABI50_0_0YGEdge, &Style::margin_> margin() {
    return {*this};
  }
  ...
  IdxRef<ABI50_0_0YGEdge, &Style::position_> position() {
    return {*this};
  }
  ...
  IdxRef<ABI50_0_0YGEdge, &Style::padding_> padding() {
    return {*this};
  }
  ...
  IdxRef<ABI50_0_0YGEdge, &Style::border_> border() {
    return {*this};
  }
  ...
  IdxRef<ABI50_0_0YGGutter, &Style::gap_> gap() {
    return {*this};
  }

  CompactValue dimension(ABI50_0_0YGDimension axis) const {
    return dimensions_[axis];
  }
  void setDimension(ABI50_0_0YGDimension axis, CompactValue value) {
    dimensions_[axis] = value;
  }

  CompactValue minDimension(ABI50_0_0YGDimension axis) const {
    return minDimensions_[axis];
  }
  void setMinDimension(ABI50_0_0YGDimension axis, CompactValue value) {
    minDimensions_[axis] = value;
  }

  CompactValue maxDimension(ABI50_0_0YGDimension axis) const {
    return maxDimensions_[axis];
  }
  void setMaxDimension(ABI50_0_0YGDimension axis, CompactValue value) {
