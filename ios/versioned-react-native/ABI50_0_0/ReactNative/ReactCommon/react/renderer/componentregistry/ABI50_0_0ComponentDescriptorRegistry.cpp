...
#include "ABI50_0_0componentNameByReactViewName.h"
...
const ComponentDescriptor& ComponentDescriptorRegistry::at(
  ...
  auto unifiedComponentName = componentNameByABI50_0_0ReactViewName(componentName);
...
ShadowNode::Shared ComponentDescriptorRegistry::createNode(
  ...
  auto unifiedComponentName = componentNameByABI50_0_0ReactViewName(viewName);
