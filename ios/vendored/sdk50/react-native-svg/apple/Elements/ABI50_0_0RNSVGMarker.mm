...
@implementation ABI50_0_0RNSVGMarker
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNSVGMarkerProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNSVGMarkerComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = static_cast<const ABI50_0_0RNSVGMarkerProps &>(*props);

  self.refX = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.refX)];
  self.refY = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.refY)];
  self.markerHeight = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.markerHeight)];
  self.markerWidth = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.markerWidth)];
  self.markerUnits = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.markerUnits);
  self.orient = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.orient);
  ...
  _props = std::static_pointer_cast<ABI50_0_0RNSVGMarkerProps const>(props);
}
...
- (void)setX:(ABI50_0_0RNSVGLength *)refX
{
...
- (void)setY:(ABI50_0_0RNSVGLength *)refY
{
...
- (void)setMarkerWidth:(ABI50_0_0RNSVGLength *)markerWidth
{
...
- (void)setMarkerHeight:(ABI50_0_0RNSVGLength *)markerHeight
{
...
static CGFloat ABI50_0_0RNSVG_degToRad = (CGFloat)M_PI / 180;

double ABI50_0_0deg2rad(CGFloat deg)
{
  return deg * ABI50_0_0RNSVG_degToRad;
}

- (void)renderMarker:(CGContextRef)context
                rect:(CGRect)rect
            position:(ABI50_0_0RNSVGMarkerPosition *)position
         strokeWidth:(CGFloat)strokeWidth
{
  ...
  float rad = ABI50_0_0deg2rad(angle);
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNSVGMarkerCls(void)
{
  return ABI50_0_0RNSVGMarker.class;
}
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
