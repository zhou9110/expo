...
typedef CGSize (^ABI50_0_0RCTWrapperMeasureBlock)(CGSize minimumSize, CGSize maximumSize);

@class ABI50_0_0RCTBridge;

NS_ASSUME_NONNULL_BEGIN

@interface ABI50_0_0RCTWrapperView : UIView

@property (nonatomic, retain, nullable) UIView *contentView;
@property (nonatomic, readonly) ABI50_0_0RCTWrapperMeasureBlock measureBlock;
