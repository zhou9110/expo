...
public final class BarCodeScannerModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    Constants([
      "Type": [
        "front": ABI50_0_0EXCameraType.front.rawValue,
        "back": ABI50_0_0EXCameraType.back.rawValue
      ],
      "BarCodeType": ABI50_0_0EXBarCodeScannerUtils.validBarCodeTypes()
    ])

    OnCreate {
      let permissionsManager = self.appContext?.permissions

      ABI50_0_0EXPermissionsMethodsDelegate.register(
        [ABI50_0_0EXBareCodeCameraRequester()],
    ...
    AsyncFunction("getPermissionsAsync") { (promise: Promise) in
      ABI50_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        ...
        withRequester: ABI50_0_0EXBareCodeCameraRequester.self,
    ...
    View(ABI50_0_0EXBarCodeScannerView.self) {
  ...
  private func getResultFrom(_ features: [CIFeature]) -> [[AnyHashable: Any]?] {
    ...
    for feature in features {
      if let qrCodeFeature = feature as? CIQRCodeFeature {
        let item = ABI50_0_0EXBarCodeScannerUtils.ciQRCodeFeature(
