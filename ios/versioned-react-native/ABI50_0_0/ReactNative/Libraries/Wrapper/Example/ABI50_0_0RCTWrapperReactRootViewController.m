...
@implementation ABI50_0_0RCTWrapperABI50_0_0ReactRootViewController {
...
- (void)loadView
{
  ABI50_0_0RCTRootView *rootView = [[ABI50_0_0RCTRootView alloc] initWithBridge:_bridge
  ...
  rootView.sizeFlexibility = ABI50_0_0RCTRootViewSizeFlexibilityWidthAndHeight;
  self.view = rootView;
}
