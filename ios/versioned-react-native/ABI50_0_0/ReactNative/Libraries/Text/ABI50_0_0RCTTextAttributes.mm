...
#import <ABI50_0_0React/ABI50_0_0RCTTextAttributes.h>
...
NSString *const ABI50_0_0RCTTextAttributesIsHighlightedAttributeName = @"ABI50_0_0RCTTextAttributesIsHighlightedAttributeName";
NSString *const ABI50_0_0RCTTextAttributesTagAttributeName = @"ABI50_0_0RCTTextAttributesTagAttributeName";

@implementation ABI50_0_0RCTTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
    _textTransform = ABI50_0_0RCTTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(ABI50_0_0RCTTextAttributes *)textAttributes
{
  ...
  _dynamicTypeRamp = textAttributes->_dynamicTypeRamp != ABI50_0_0RCTDynamicTypeRampUndefined ? textAttributes->_dynamicTypeRamp
                                                                                     : _dynamicTypeRamp;
  ...
  _textDecorationLine = textAttributes->_textDecorationLine != ABI50_0_0RCTTextDecorationLineTypeNone
  ...
  _layoutDirection = textAttributes->_layoutDirection != UIUserInterfaceLayoutDirectionLeftToRight
      ...
      : _layoutDirection;
  _textTransform =
      textAttributes->_textTransform != ABI50_0_0RCTTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  if (_textDecorationLine == ABI50_0_0RCTTextDecorationLineTypeUnderline ||
      _textDecorationLine == ABI50_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
    attributes[NSUnderlineStyleAttributeName] = @(_textDecorationStyle);
  }

  if (_textDecorationLine == ABI50_0_0RCTTextDecorationLineTypeStrikethrough ||
      _textDecorationLine == ABI50_0_0RCTTextDecorationLineTypeUnderlineStrikethrough) {
    isTextDecorationEnabled = YES;
  ...
  // Special
  if (_isHighlighted) {
    attributes[ABI50_0_0RCTTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[ABI50_0_0RCTTextAttributesTagAttributeName] = _tag;
  }
...
{
  // FIXME: ABI50_0_0RCTFont has thread-safety issues and must be rewritten.
  return [ABI50_0_0RCTFont updateFont:nil
...
{
  bool fontScalingEnabled = !ABI50_0_0RCTHasFontHandlerSet() && _allowFontScaling;

  if (fontScalingEnabled) {
    CGFloat fontSizeMultiplier = !isnan(_fontSizeMultiplier) ? _fontSizeMultiplier : 1.0;
    if (_dynamicTypeRamp != ABI50_0_0RCTDynamicTypeRampUndefined) {
      UIFontMetrics *fontMetrics = ABI50_0_0RCTUIFontMetricsForDynamicTypeRamp(_dynamicTypeRamp);
      // Using a specific font size reduces rounding errors from -scaledValueForValue:
      CGFloat requestedSize = isnan(_fontSize) ? ABI50_0_0RCTBaseSizeForDynamicTypeRamp(_dynamicTypeRamp) : _fontSize;
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case ABI50_0_0RCTTextTransformUndefined:
    case ABI50_0_0RCTTextTransformNone:
      return text;
    case ABI50_0_0RCTTextTransformLowercase:
      return [text lowercaseString];
    case ABI50_0_0RCTTextTransformUppercase:
      return [text uppercaseString];
    case ABI50_0_0RCTTextTransformCapitalize:
      return capitalizeText(text);
  }
}

- (ABI50_0_0RCTTextAttributes *)copyWithZone:(NSZone *)zone
{
  ABI50_0_0RCTTextAttributes *textAttributes = [ABI50_0_0RCTTextAttributes new];
...
- (BOOL)isEqual:(ABI50_0_0RCTTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
...
#define ABI50_0_0RCTTextAttributesCompareFloats(a) ((a == textAttributes->a) || (isnan(a) && isnan(textAttributes->a)))
#define ABI50_0_0RCTTextAttributesCompareSize(a) CGSizeEqualToSize(a, textAttributes->a)
#define ABI50_0_0RCTTextAttributesCompareObjects(a) ((a == textAttributes->a) || [a isEqual:textAttributes->a])
#define ABI50_0_0RCTTextAttributesCompareStrings(a) ((a == textAttributes->a) || [a isEqualToString:textAttributes->a])
#define ABI50_0_0RCTTextAttributesCompareOthers(a) (a == textAttributes->a)

  return ABI50_0_0RCTTextAttributesCompareObjects(_foregroundColor) && ABI50_0_0RCTTextAttributesCompareObjects(_backgroundColor) &&
      ABI50_0_0RCTTextAttributesCompareFloats(_opacity) &&
      // Font
      ABI50_0_0RCTTextAttributesCompareObjects(_fontFamily) && ABI50_0_0RCTTextAttributesCompareFloats(_fontSize) &&
      ABI50_0_0RCTTextAttributesCompareFloats(_fontSizeMultiplier) && ABI50_0_0RCTTextAttributesCompareFloats(_maxFontSizeMultiplier) &&
      ABI50_0_0RCTTextAttributesCompareStrings(_fontWeight) && ABI50_0_0RCTTextAttributesCompareObjects(_fontStyle) &&
      ABI50_0_0RCTTextAttributesCompareObjects(_fontVariant) && ABI50_0_0RCTTextAttributesCompareOthers(_allowFontScaling) &&
      ABI50_0_0RCTTextAttributesCompareOthers(_dynamicTypeRamp) && ABI50_0_0RCTTextAttributesCompareFloats(_letterSpacing) &&
      // Paragraph Styles
      ABI50_0_0RCTTextAttributesCompareFloats(_lineHeight) && ABI50_0_0RCTTextAttributesCompareFloats(_alignment) &&
      ABI50_0_0RCTTextAttributesCompareOthers(_baseWritingDirection) && ABI50_0_0RCTTextAttributesCompareOthers(_lineBreakStrategy) &&
      // Decoration
      ABI50_0_0RCTTextAttributesCompareObjects(_textDecorationColor) && ABI50_0_0RCTTextAttributesCompareOthers(_textDecorationStyle) &&
      ABI50_0_0RCTTextAttributesCompareOthers(_textDecorationLine) &&
      // Shadow
      ABI50_0_0RCTTextAttributesCompareSize(_textShadowOffset) && ABI50_0_0RCTTextAttributesCompareFloats(_textShadowRadius) &&
      ABI50_0_0RCTTextAttributesCompareObjects(_textShadowColor) &&
      // Special
      ABI50_0_0RCTTextAttributesCompareOthers(_isHighlighted) && ABI50_0_0RCTTextAttributesCompareObjects(_tag) &&
      ABI50_0_0RCTTextAttributesCompareOthers(_layoutDirection) && ABI50_0_0RCTTextAttributesCompareOthers(_textTransform);
}
