...
#import <ABI50_0_0EXConstants/ABI50_0_0EXConstantsInstallationIdProvider.h>

NSString * const ABI50_0_0EXConstantsExecutionEnvironmentBare = @"bare";
NSString * const ABI50_0_0EXConstantsExecutionEnvironmentStoreClient = @"storeClient";

@interface ABI50_0_0EXConstantsService ()

@property (nonatomic, strong) NSString *sessionId;
@property (nonatomic, strong) ABI50_0_0EXConstantsInstallationIdProvider *installationIdProvider;

@end

@implementation ABI50_0_0EXConstantsService

- (instancetype)init
{
  return [self initWithInstallationIdProvider:[[ABI50_0_0EXConstantsInstallationIdProvider alloc] init]];
}

- (instancetype)initWithInstallationIdProvider:(ABI50_0_0EXConstantsInstallationIdProvider *)installationIdProvider
{
  if (self = [super init]) {
...
{
  return @[@protocol(ABI50_0_0EXConstantsInterface)];
}
...
- (NSDictionary *)constants
{
  ...
  return @{
           ...
           @"executionEnvironment": ABI50_0_0EXConstantsExecutionEnvironmentBare,
           ...
           @"manifest": ABI50_0_0EXNullIfNil([[self class] appConfig]),
           @"platform": @{
               @"ios": @{
...
{
  NSBundle *frameworkBundle = [NSBundle bundleForClass:[ABI50_0_0EXConstantsService class]];
  NSURL *bundleUrl = [frameworkBundle.resourceURL URLByAppendingPathComponent:@"ABI50_0_0EXConstants.bundle"];
