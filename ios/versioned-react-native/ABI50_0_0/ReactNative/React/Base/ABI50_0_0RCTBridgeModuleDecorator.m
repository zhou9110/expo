...
#include "ABI50_0_0RCTBridgeModuleDecorator.h"

@implementation ABI50_0_0RCTBridgeModuleDecorator
...
{
  /**
   * Attach the ABI50_0_0RCTViewRegistry to this TurboModule, which allows this TurboModule
   * To query a ABI50_0_0React component's UIView, given its ABI50_0_0ReactTag.
   *
  ...
  /**
   * Attach the ABI50_0_0RCTBundleManager to this TurboModule, which allows this TurboModule to
  ...
  /**
   * Attach the ABI50_0_0RCTCallableJSModules to this TurboModule, which allows this TurboModule
  ...
  /**
   * Attach the ABI50_0_0RCTModuleRegistry to this TurboModule, which allows this TurboModule
