...
@interface ABI50_0_0EXTaskExecutionRequest ()

@property (nonatomic, strong, nullable) NSMutableSet<id<ABI50_0_0EXTaskInterface>> *tasks;
...
@implementation ABI50_0_0EXTaskExecutionRequest
...
- (void)_maybeExecuteCallback
{
  if (_callback) {
    ...
    __strong ABI50_0_0EXTaskExecutionRequest *strongSelf = self;
