...
class ABI50_0_0EXGLContext {
 ...
 public:
  ABI50_0_0EXGLContext(ABI50_0_0EXGLContextId ctxId) : ctxId(ctxId) {}
  ...
  ABI50_0_0EXGLObjectId createObject(void) noexcept;
  void destroyObject(ABI50_0_0EXGLObjectId exglObjId) noexcept;
  void mapObject(ABI50_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept;
  GLuint lookupObject(ABI50_0_0EXGLObjectId exglObjId) noexcept;
 ...
 public:
  ...
  // Object mapping
  std::unordered_map<ABI50_0_0EXGLObjectId, GLuint> objects;
