...
std::shared_ptr<NativeDevMenuReanimatedModule> createDevMenuReanimatedModule(
    RCTBridge *bridge,
    std::shared_ptr<CallInvoker> jsInvoker)
{
  ...
  std::shared_ptr<NativeDevMenuReanimatedModule> module;
  ...
  module = std::make_shared<NativeDevMenuReanimatedModule>(
      jsInvoker,
      scheduler,
      animatedRuntime,
      errorHandler,
