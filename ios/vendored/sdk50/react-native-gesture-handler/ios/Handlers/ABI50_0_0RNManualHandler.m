#import "ABI50_0_0RNManualHandler.h"

@interface ABI50_0_0RNManualRecognizer : UIGestureRecognizer

- (id)initWithGestureHandler:(ABI50_0_0RNGestureHandler *)gestureHandler;

@end

@implementation ABI50_0_0RNManualRecognizer {
...
@implementation ABI50_0_0RNManualGestureHandler

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI50_0_0RNManualRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
