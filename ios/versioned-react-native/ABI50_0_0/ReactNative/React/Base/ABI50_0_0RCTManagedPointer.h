...
@interface ABI50_0_0RCTManagedPointer : NSObject
...
ABI50_0_0RCTManagedPointer *managedPointer(P initializer)
{
  auto ptr = std::shared_ptr<void>(new T(initializer));
  return [[ABI50_0_0RCTManagedPointer alloc] initWithPointer:std::move(ptr)];
}
