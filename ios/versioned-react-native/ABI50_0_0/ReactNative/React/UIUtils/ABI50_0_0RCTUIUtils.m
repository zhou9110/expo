...
#import "ABI50_0_0RCTUIUtils.h"

#import "ABI50_0_0RCTUtils.h"

ABI50_0_0RCTDimensions ABI50_0_0RCTGetDimensions(CGFloat fontScale)
{
  UIScreen *mainScreen = UIScreen.mainScreen;
  CGSize screenSize = mainScreen.bounds.size;

  UIView *mainWindow;
  mainWindow = ABI50_0_0RCTKeyWindow();
  // We fallback to screen size if a key window is not found.
  CGSize windowSize = mainWindow ? mainWindow.bounds.size : screenSize;

  ABI50_0_0RCTDimensions result;
...
CGFloat ABI50_0_0RCTGetMultiplierForContentSizeCategory(UIContentSizeCategory category)
{
