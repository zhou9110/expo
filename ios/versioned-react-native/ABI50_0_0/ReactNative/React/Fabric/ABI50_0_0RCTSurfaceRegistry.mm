...
#import "ABI50_0_0RCTSurfaceRegistry.h"
...
@implementation ABI50_0_0RCTSurfaceRegistry {
  std::shared_mutex _mutex;
  NSMapTable<id, ABI50_0_0RCTFabricSurface *> *_registry;
}
...
- (void)enumerateWithBlock:(ABI50_0_0RCTSurfaceEnumeratorBlock)block
{
...
- (void)registerSurface:(ABI50_0_0RCTFabricSurface *)surface
{
  ...
  ABI50_0_0ReactTag rootTag = surface.rootViewTag.integerValue;
