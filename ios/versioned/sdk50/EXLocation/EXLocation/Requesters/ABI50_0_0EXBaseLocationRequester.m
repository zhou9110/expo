...
#import <ABI50_0_0EXLocation/ABI50_0_0EXBaseLocationRequester.h>
#import <ABI50_0_0ExpoModulesCore/ABI50_0_0EXUtilities.h>

#import <objc/message.h>
#import <CoreLocation/CLLocationManagerDelegate.h>

@interface ABI50_0_0EXBaseLocationRequester () <CLLocationManagerDelegate>
...
@implementation ABI50_0_0EXBaseLocationRequester
...
# pragma mark - ABI50_0_0UMPermissionsRequester

- (NSDictionary *)getPermissions {

  CLAuthorizationStatus systemStatus;
  if (![ABI50_0_0EXBaseLocationRequester isConfiguredForAlwaysAuthorization] && ![ABI50_0_0EXBaseLocationRequester isConfiguredForWhenInUseAuthorization]) {
...
- (void)requestPermissionsWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve rejecter:(ABI50_0_0EXPromiseRejectBlock)reject {
  ...
  if (existingPermissions && [existingPermissions[@"status"] intValue] != ABI50_0_0EXPermissionStatusUndetermined) {
