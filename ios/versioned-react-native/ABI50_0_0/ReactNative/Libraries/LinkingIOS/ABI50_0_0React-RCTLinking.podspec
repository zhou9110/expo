...
Pod::Spec.new do |s|
  s.name                   = "ABI50_0_0React-RCTLinking"
  s.version                = version
  ...
  s.header_dir             = "ABI50_0_0RCTLinking"
  ...
  s.dependency "ABI50_0_0React-Core/RCTLinkingHeaders", version
  s.dependency "ABI50_0_0ReactCommon/turbomodule/core", version
