...
@interface ABI50_0_0EXScopedNotificationSchedulerModule ()

@property (nonatomic, strong) NSString *scopeKey;

@end

@implementation ABI50_0_0EXScopedNotificationSchedulerModule
...
{
  NSString *scopedIdentifier = [ABI50_0_0EXScopedNotificationsUtils scopedIdentifierFromId:identifier
...
- (NSArray * _Nonnull)serializeNotificationRequests:(NSArray<UNNotificationRequest *> * _Nonnull) requests;
{
  ...
  for (UNNotificationRequest *request in requests) {
    if ([ABI50_0_0EXScopedNotificationsUtils isId:request.identifier scopedByExperience:_scopeKey]) {
      [serializedRequests addObject:[ABI50_0_0EXScopedNotificationSerializer serializedNotificationRequest:request]];
    }
  }
...
- (void)cancelAllNotificationsWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve rejecting:(ABI50_0_0EXPromiseRejectBlock)reject
{
  ...
  [[UNUserNotificationCenter currentNotificationCenter] getPendingNotificationRequestsWithCompletionHandler:^(NSArray<UNNotificationRequest *> * _Nonnull requests) {
    ...
    for (UNNotificationRequest *request in requests) {
      if ([ABI50_0_0EXScopedNotificationsUtils isId:request.identifier scopedByExperience:scopeKey]) {
