...
@interface ABI50_0_0RNSVGGlyphContext () {
 @public
  ...
  NSMutableArray<NSArray<ABI50_0_0RNSVGLength *> *> *mXsContext_;
  NSMutableArray<NSArray<ABI50_0_0RNSVGLength *> *> *mYsContext_;
  NSMutableArray<NSArray<ABI50_0_0RNSVGLength *> *> *mDXsContext_;
  NSMutableArray<NSArray<ABI50_0_0RNSVGLength *> *> *mDYsContext_;
  NSMutableArray<NSArray<ABI50_0_0RNSVGLength *> *> *mRsContext_;
  ...
  CGFloat mFontSize_;
  ABI50_0_0RNSVGFontData *topFont_;
  ...
  NSArray<ABI50_0_0RNSVGLength *> *mXs_;

  // https://www.w3.org/TR/SVG/text.html#TSpanElementYAttribute
  NSArray<ABI50_0_0RNSVGLength *> *mYs_;
  ...
  NSArray<ABI50_0_0RNSVGLength *> *mDXs_;

  // https://www.w3.org/TR/SVG/text.html#TSpanElementDYAttribute
  NSArray<ABI50_0_0RNSVGLength *> *mDYs_;
  ...
  NSArray<ABI50_0_0RNSVGLength *> *mRs_;
...
- (void)pushContext:(ABI50_0_0RNSVGText *)node
               font:(NSDictionary *)font
                  x:(NSArray<ABI50_0_0RNSVGLength *> *)x
                  y:(NSArray<ABI50_0_0RNSVGLength *> *)y
             deltaX:(NSArray<ABI50_0_0RNSVGLength *> *)deltaX
             deltaY:(NSArray<ABI50_0_0RNSVGLength *> *)deltaY
             rotate:(NSArray<ABI50_0_0RNSVGLength *> *)rotate;

- (void)pushContext:(ABI50_0_0RNSVGGroup *)node font:(NSDictionary *)font;
@end

@implementation ABI50_0_0RNSVGGlyphContext
...
- (CTFontRef)getGlyphFont
{
  ...
  NSString *fontStyle = ABI50_0_0RNSVGFontStyleStrings[topFont_->fontStyle];
  NSString *fontWeight = ABI50_0_0RNSVGFontWeightStrings[topFont_->fontWeight];
  UIFont *font = [ABI50_0_0RCTFont updateFont:nil
...
- (instancetype)initWithWidth:(CGFloat)width height:(CGFloat)height
{
  ...
  self->mFontSize_ = ABI50_0_0RNSVGFontData_DEFAULT_FONT_SIZE;
  self->topFont_ = [ABI50_0_0RNSVGFontData Defaults];

  self->mXs_ = [[NSArray alloc] init];
  self->mYs_ = [[NSArray alloc] init];
  self->mDXs_ = [[NSArray alloc] init];
  self->mDYs_ = [[NSArray alloc] init];
  self->mRs_ = [[NSArray alloc] initWithObjects:[ABI50_0_0RNSVGLength lengthWithNumber:0], nil];
...
- (ABI50_0_0RNSVGFontData *)getFont
{
  return topFont_;
}

- (ABI50_0_0RNSVGFontData *)getTopOrParentFont:(ABI50_0_0RNSVGGroup *)child
{
  if (self->mTop_ > 0) {
    return self->topFont_;
  } else {
    ABI50_0_0RNSVGGroup *parentRoot = [child getParentTextRoot];
    ABI50_0_0RNSVGFontData *Defaults = [ABI50_0_0RNSVGFontData Defaults];
    while (parentRoot != nil) {
      ABI50_0_0RNSVGFontData *map = [[parentRoot getGlyphContext] getFont];
      if (map != Defaults) {
        return map;
      }
...
- (void)pushNode:(ABI50_0_0RNSVGGroup *)node andFont:(NSDictionary *)font
{
  ABI50_0_0RNSVGFontData *parent = [self getTopOrParentFont:node];
  self->mTop_++;
  if (font == nil) {
    [self->mFontContext_ addObject:parent];
    return;
  }
  ABI50_0_0RNSVGFontData *data = [ABI50_0_0RNSVGFontData initWithNSDictionary:font parent:parent];
...
- (void)pushContext:(ABI50_0_0RNSVGText *)node
             ...
             rotate:(NSArray<ABI50_0_0RNSVGLength *> *)rotate
{
  [self pushNode:(ABI50_0_0RNSVGGroup *)node andFont:font];
  if (x != nil && [x count] != 0) {
    mXsIndex_++;
    mXIndex_ = -1;
...
{
  [ABI50_0_0RNSVGGlyphContext incrementIndices:mXIndices_ topIndex:mXsIndex_];
  long nextIndex = mXIndex_ + 1;
  if (nextIndex < [mXs_ count]) {
    mDX_ = 0;
    mXIndex_ = nextIndex;
    ABI50_0_0RNSVGLength *length = [mXs_ objectAtIndex:nextIndex];
    mX_ = [ABI50_0_0RNSVGPropHelper fromRelative:length relative:mWidth_ fontSize:mFontSize_];
  }
  mX_ += advance;
  return mX_;
}
...
- (CGFloat)nextY
{
  [ABI50_0_0RNSVGGlyphContext incrementIndices:mYIndices_ topIndex:mYsIndex_];
  long nextIndex = mYIndex_ + 1;
  if (nextIndex < [mYs_ count]) {
    mDY_ = 0;
    mYIndex_ = nextIndex;
    ABI50_0_0RNSVGLength *length = [mYs_ objectAtIndex:nextIndex];
    mY_ = [ABI50_0_0RNSVGPropHelper fromRelative:length relative:mHeight_ fontSize:mFontSize_];
  }
  return mY_;
}
...
- (CGFloat)nextDeltaX
{
  [ABI50_0_0RNSVGGlyphContext incrementIndices:mDXIndices_ topIndex:mDXsIndex_];
  long nextIndex = mDXIndex_ + 1;
  if (nextIndex < [mDXs_ count]) {
    mDXIndex_ = nextIndex;
    ABI50_0_0RNSVGLength *length = [mDXs_ objectAtIndex:nextIndex];
    CGFloat val = [ABI50_0_0RNSVGPropHelper fromRelative:length relative:mWidth_ fontSize:mFontSize_];
    mDX_ += val;
  }
  return mDX_;
}
...
- (CGFloat)nextDeltaY
{
  [ABI50_0_0RNSVGGlyphContext incrementIndices:mDYIndices_ topIndex:mDYsIndex_];
  long nextIndex = mDYIndex_ + 1;
  if (nextIndex < [mDYs_ count]) {
    mDYIndex_ = nextIndex;
    ABI50_0_0RNSVGLength *length = [mDYs_ objectAtIndex:nextIndex];
    CGFloat val = [ABI50_0_0RNSVGPropHelper fromRelative:length relative:mHeight_ fontSize:mFontSize_];
    mDY_ += val;
  }
  return mDY_;
}
...
{
  [ABI50_0_0RNSVGGlyphContext incrementIndices:mRIndices_ topIndex:mRsIndex_];
