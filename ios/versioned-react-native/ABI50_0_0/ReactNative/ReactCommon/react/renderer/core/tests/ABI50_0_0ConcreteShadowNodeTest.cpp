...
TEST(ConcreteShadowNodeTest, testSetStateData) {
  ...
  ABI50_0_0EXPECT_EQ(stateData.contentOffset.x, 10);
  ABI50_0_0EXPECT_EQ(stateData.contentOffset.y, 11);

  ABI50_0_0EXPECT_EQ(stateData.contentBoundingRect.origin.x, 21);
  ABI50_0_0EXPECT_EQ(stateData.contentBoundingRect.origin.y, 22);

  ABI50_0_0EXPECT_EQ(stateData.contentBoundingRect.size.width, 301);
  ABI50_0_0EXPECT_EQ(stateData.contentBoundingRect.size.height, 302);
}
