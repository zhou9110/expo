...
#import "ABI50_0_0RCTRedBoxExtraDataViewController.h"

@interface ABI50_0_0RCTRedBoxExtraDataCell : UITableViewCell
...
@implementation ABI50_0_0RCTRedBoxExtraDataCell
...
@interface ABI50_0_0RCTRedBoxExtraDataViewController ()

@end

@implementation ABI50_0_0RCTRedBoxExtraDataViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  ABI50_0_0RCTRedBoxExtraDataCell *cell =
      (ABI50_0_0RCTRedBoxExtraDataCell *)[tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

  if (cell == nil) {
    cell = [[ABI50_0_0RCTRedBoxExtraDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
  }
