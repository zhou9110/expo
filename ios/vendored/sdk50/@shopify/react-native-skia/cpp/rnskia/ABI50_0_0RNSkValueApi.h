...
#include "ABI50_0_0RNSkComputedValue.h"
...
class ABI50_0_0RNSkValueApi : public ABI50_0_0RNJsi::JsiHostObject {
public:
  /**
   * Constructor
   * @param platformContext Platform context
   */
  explicit ABI50_0_0RNSkValueApi(std::shared_ptr<ABI50_0_0RNSkPlatformContext> platformContext)
   ...
   * Destructor
   */
  ~ABI50_0_0RNSkValueApi() {}

  JSI_HOST_FUNCTION(createValue) {
    return jsi::Object::createFromHostObject(
        runtime, std::make_shared<ABI50_0_0RNSkValue>(_platformContext, runtime,
                                             arguments, count));
  }
  ...
  JSI_HOST_FUNCTION(createComputedValue) {
    ...
    auto computedValue = std::make_shared<ABI50_0_0RNSkComputedValue>(
  ...
  JSI_HOST_FUNCTION(createAnimation) {
    return jsi::Object::createFromHostObject(
        runtime,
        std::make_shared<ABI50_0_0RNSkAnimation>(_platformContext, ++_valueIdentifier,
  ...
  JSI_HOST_FUNCTION(createClockValue) {
    return jsi::Object::createFromHostObject(
        runtime,
        std::make_shared<ABI50_0_0RNSkClockValue>(_platformContext, ++_valueIdentifier,
                                         runtime, arguments, count));
  }

  JSI_EXPORT_FUNCTIONS(JSI_EXPORT_FUNC(ABI50_0_0RNSkValueApi, createValue),
                       JSI_EXPORT_FUNC(ABI50_0_0RNSkValueApi, createComputedValue),
                       JSI_EXPORT_FUNC(ABI50_0_0RNSkValueApi, createClockValue),
                       JSI_EXPORT_FUNC(ABI50_0_0RNSkValueApi, createAnimation))
