#import "ABI50_0_0RNGestureHandlerModule.h"
...
#import <ABI50_0_0ReactCommon/CallInvoker.h>
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
@interface ABI50_0_0RNGestureHandlerModule () <ABI50_0_0RCTSurfacePresenterObserver, ABI50_0_0RNGestureHandlerStateManager>

@end
#else
@interface ABI50_0_0RNGestureHandlerModule () <ABI50_0_0RCTUIManagerObserver, ABI50_0_0RNGestureHandlerStateManager>

@end
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED

typedef void (^GestureHandlerOperation)(ABI50_0_0RNGestureHandlerManager *manager);

@implementation ABI50_0_0RNGestureHandlerModule {
  ABI50_0_0RNGestureHandlerManager *_manager;
...
- (void)invalidate
{
  ABI50_0_0RNGestureHandlerManager *handlerManager = _manager;
...
- (void)setBridge:(ABI50_0_0RCTBridge *)bridge
{
  ...
  _manager = [[ABI50_0_0RNGestureHandlerManager alloc] initWithUIManager:bridge.uiManager
...
{
  ABI50_0_0RCTCxxBridge *cxxBridge = (ABI50_0_0RCTCxxBridge *)self.bridge;
...
ABI50_0_0RCT_EXPORT_METHOD(createGestureHandler
                  : (nonnull NSString *)handlerName tag
                  : (nonnull NSNumber *)handlerTag config
                  : (NSDictionary *)config)
{
  [self addOperationBlock:^(ABI50_0_0RNGestureHandlerManager *manager) {
    [manager createGestureHandler:handlerName tag:handlerTag config:config];
  }];
}

ABI50_0_0RCT_EXPORT_METHOD(attachGestureHandler
                  ...
                  : (nonnull NSNumber *)actionType)
{
  [self addOperationBlock:^(ABI50_0_0RNGestureHandlerManager *manager) {
    [manager attachGestureHandler:handlerTag
                   ...
                   withActionType:(ABI50_0_0RNGestureHandlerActionType)[actionType integerValue]];
  }];
}

ABI50_0_0RCT_EXPORT_METHOD(updateGestureHandler : (nonnull NSNumber *)handlerTag config : (NSDictionary *)config)
{
  [self addOperationBlock:^(ABI50_0_0RNGestureHandlerManager *manager) {
...
ABI50_0_0RCT_EXPORT_METHOD(dropGestureHandler : (nonnull NSNumber *)handlerTag)
{
  [self addOperationBlock:^(ABI50_0_0RNGestureHandlerManager *manager) {
...
ABI50_0_0RCT_EXPORT_METHOD(handleSetJSResponder
...
ABI50_0_0RCT_EXPORT_METHOD(handleClearJSResponder)
{
  [self addOperationBlock:^(ABI50_0_0RNGestureHandlerManager *manager) {
...
ABI50_0_0RCT_EXPORT_METHOD(flushOperations)
{
  ...
  [self.bridge.uiManager
      addUIBlock:^(__unused ABI50_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
...
{
  ABI50_0_0RNGestureHandler *handler = [_manager handlerWithTag:@(handlerTag)];
...
- (void)uiManagerWillFlushUIBlocks:(ABI50_0_0RCTUIManager *)uiManager
{
...
- (NSDictionary *)constantsToExport
{
  return @{
    @"State" : @{
      @"UNDETERMINED" : @(ABI50_0_0RNGestureHandlerStateUndetermined),
      @"BEGAN" : @(ABI50_0_0RNGestureHandlerStateBegan),
      @"ACTIVE" : @(ABI50_0_0RNGestureHandlerStateActive),
      @"CANCELLED" : @(ABI50_0_0RNGestureHandlerStateCancelled),
      @"FAILED" : @(ABI50_0_0RNGestureHandlerStateFailed),
      @"END" : @(ABI50_0_0RNGestureHandlerStateEnd)
    },
    @"Direction" : @{
      @"RIGHT" : @(ABI50_0_0RNGestureHandlerDirectionRight),
      @"LEFT" : @(ABI50_0_0RNGestureHandlerDirectionLeft),
      @"UP" : @(ABI50_0_0RNGestureHandlerDirectionUp),
      @"DOWN" : @(ABI50_0_0RNGestureHandlerDirectionDown)
    }
  };
}
