...
@interface ABI50_0_0EXNotificationsEmitter ()
...
@implementation ABI50_0_0EXNotificationsEmitter

ABI50_0_0EX_EXPORT_MODULE(ExpoNotificationsEmitter);

ABI50_0_0EX_EXPORT_METHOD_AS(getLastNotificationResponseAsync,
                    getLastNotificationResponseAsyncWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
...
{
  // Silence ABI50_0_0React Native warning: "Sending ... with no listeners registered."
...
{
  return [ABI50_0_0EXNotificationSerializer serializedNotification:notification];
}

- (NSDictionary *)serializedNotificationResponse:(UNNotificationResponse *)notificationResponse
{
  return [ABI50_0_0EXNotificationSerializer serializedNotificationResponse:notificationResponse];
}
