...
class CodegenUtils
    ...
    def generate_react_codegen_podspec!(spec, codegen_output_dir, file_manager: File)
        ...
        if @@REACT_CODEGEN_PODSPEC_GENERATED
          Pod::UI.puts "[Codegen] Skipping ABI50_0_0React-Codegen podspec generation."
          return
        end
        ...
        podspec_path = file_manager.join(output_dir, 'ABI50_0_0React-Codegen.podspec.json')
    ...
    # It generates the podspec object that represents the `ABI50_0_0React-Codegen.podspec` file
    #
    # Parameters
    ...
    def get_react_codegen_spec(package_json_file, folly_version: '2022.05.16.00', fabric_enabled: false, hermes_enabled: true, script_phases: nil, file_manager: File)
        ...
        header_search_paths = [
          ...
          "\"${PODS_ROOT}/Headers/Public/ABI50_0_0React-Codegen/react/renderer/components\"",
          "\"$(PODS_ROOT)/Headers/Private/ABI50_0_0React-Fabric\"",
          "\"$(PODS_ROOT)/Headers/Private/ABI50_0_0React-RCTFabric\"",
        ...
        spec = {
          ...
          'dependencies': {
            "ABI50_0_0React-jsiexecutor": [],
            "RCT-Folly": [],
            "ABI50_0_0RCTRequired": [],
            "ABI50_0_0RCTTypeSafety": [],
            "ABI50_0_0React-Core": [],
            "ABI50_0_0React-jsi": [],
            "ABI50_0_0ReactCommon/turbomodule/bridging": [],
            "ABI50_0_0ReactCommon/turbomodule/core": [],
            "ABI50_0_0React-NativeModulesApple": [],
            "glog": [],
            "DoubleConversion": [],
          }
        }
        ...
        if new_arch_disabled
          spec[:dependencies].merge!({
            "ABI50_0_0React-rncore": [],
            "ABI50_0_0FBReactNativeSpec": [],
          })
        end

        if script_phases
          Pod::UI.puts "[Codegen] Adding script_phases to ABI50_0_0React-Codegen."
    ...
    def use_react_native_codegen_discovery!(
      ...
      # Generate ABI50_0_0React-Codegen podspec here to add the script phases.
