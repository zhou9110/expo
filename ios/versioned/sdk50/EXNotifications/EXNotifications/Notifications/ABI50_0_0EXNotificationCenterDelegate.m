...
@interface ABI50_0_0EXNotificationCenterDelegate ()
...
@implementation ABI50_0_0EXNotificationCenterDelegate

ABI50_0_0EX_REGISTER_SINGLETON_MODULE(NotificationCenterDelegate);
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey,id> *)launchOptions
{
  if ([UNUserNotificationCenter currentNotificationCenter].delegate) {
    ABI50_0_0EXLogWarn(@"[expo-notifications] ABI50_0_0EXNotificationCenterDelegate encountered already present delegate of UNUserNotificationCenter: %@. "
              "ABI50_0_0EXNotificationCenterDelegate will not overwrite the value not to break other features of your app. "
              "In return, expo-notifications may not work properly. "
              "To fix this problem either remove setting of the second delegate "
              "or set the delegate to an instance of ABI50_0_0EXNotificationCenterDelegate manually afterwards.",
...
# pragma mark - ABI50_0_0EXNotificationCenterDelegate
