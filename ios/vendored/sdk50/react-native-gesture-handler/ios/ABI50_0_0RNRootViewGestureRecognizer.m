//
//  ABI50_0_0RNRootViewGestureRecognizer.m
...
@implementation ABI50_0_0RNRootViewGestureRecognizer {
  BOOL _active;
}
...
- (BOOL)shouldBeRequiredToFailByGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
  ...
  ABI50_0_0RNGestureHandler *otherHandler = [ABI50_0_0RNGestureHandler findGestureHandlerByRecognizer:otherGestureRecognizer];
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
        ABI50_0_0RCTSurfaceTouchHandler
#else
        ABI50_0_0RCTTouchHandler
#endif
        class]];
}
...
- (BOOL)canBePreventedByGestureRecognizer:(UIGestureRecognizer *)preventingGestureRecognizer
{
  ...
  ABI50_0_0RNGestureHandler *handler = [ABI50_0_0RNGestureHandler findGestureHandlerByRecognizer:preventingGestureRecognizer];
  if (handler != nil) {
