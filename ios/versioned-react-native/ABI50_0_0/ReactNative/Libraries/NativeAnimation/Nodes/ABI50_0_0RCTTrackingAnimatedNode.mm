...
@implementation ABI50_0_0RCTTrackingAnimatedNode {
...
- (void)performUpdate
{
  ...
  ABI50_0_0RCTValueAnimatedNode *node = (ABI50_0_0RCTValueAnimatedNode *)[self.parentNodes objectForKey:_toValueNodeTag];
