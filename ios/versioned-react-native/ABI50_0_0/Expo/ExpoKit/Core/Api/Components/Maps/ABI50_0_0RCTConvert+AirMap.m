...
@implementation ABI50_0_0RCTConvert (AirMap)
...
{
    json = [self NSDictionary:json];
    return [ABI50_0_0RCTConvert MKMapCameraWithDefaults:json existingCamera:nil];
}
...
ABI50_0_0RCT_ENUM_CONVERTER(MKMapType, (@{
...
+ (ABI50_0_0AIRMapCoordinate *)ABI50_0_0AIRMapCoordinate:(id)json
{
    ABI50_0_0AIRMapCoordinate *coord = [ABI50_0_0AIRMapCoordinate new];
    coord.coordinate = [self CLLocationCoordinate2D:json];
    return coord;
}

ABI50_0_0RCT_ARRAY_CONVERTER(ABI50_0_0AIRMapCoordinate)

+ (NSArray<NSArray<ABI50_0_0AIRMapCoordinate *> *> *)ABI50_0_0AIRMapCoordinateArrayArray:(id)json
{
    return ABI50_0_0RCTConvertArrayValue(@selector(ABI50_0_0AIRMapCoordinateArray:), json);
}
