  ...
  public func definition() -> ModuleDefinition {
    ...
    AsyncFunction("getPermissionsAsync") { (promise: Promise) in
      ...
      ABI50_0_0EXPermissionsMethodsDelegate.getPermissionWithPermissionsManager(
        permissionsManager,
        withRequester: ABI50_0_0EXMotionPermissionRequester.self,
    ...
    OnCreate {
      ...
      ABI50_0_0EXPermissionsMethodsDelegate.register([ABI50_0_0EXMotionPermissionRequester()], withPermissionsManager: permissionsManager)
    }
