...
static const float ABI50_0_0RNSSlideOpenTransitionDurationProportion = 1;
static const float ABI50_0_0RNSFadeOpenTransitionDurationProportion = 0.2 / 0.35;
static const float ABI50_0_0RNSSlideCloseTransitionDurationProportion = 0.25 / 0.35;
static const float ABI50_0_0RNSFadeCloseTransitionDurationProportion = 0.15 / 0.35;
static const float ABI50_0_0RNSFadeCloseDelayTransitionDurationProportion = 0.1 / 0.35;

@implementation ABI50_0_0RNSScreenStackAnimator {
...
- (NSTimeInterval)transitionDuration:(id<UIViewControllerContextTransitioning>)transitionContext
{
  ...
  if (_operation == UINavigationControllerOperationPush) {
    ...
    screen = ((ABI50_0_0RNSScreen *)toViewController).screenView;
  } else if (_operation == UINavigationControllerOperationPop) {
    UIViewController *fromViewController =
        [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    screen = ((ABI50_0_0RNSScreen *)fromViewController).screenView;
  }

  if (screen != nil && screen.stackAnimation == ABI50_0_0RNSScreenStackAnimationNone) {
    return 0;
  }
                                            ...
                                            fromVC:(UIViewController *)fromViewController
{
  ...
  if (_operation == UINavigationControllerOperationPush) {
    ...
    [UIView animateWithDuration:transitionDuration * ABI50_0_0RNSSlideOpenTransitionDurationProportion // defaults to 0.35 s
        delay:0
    ...
    [UIView animateWithDuration:transitionDuration * ABI50_0_0RNSFadeOpenTransitionDurationProportion // defaults to 0.2 s
                          delay:0
                        options:UIViewAnimationOptionCurveEaseOut
                     animations:^{
                       toViewController.view.alpha = 1.0;
    ...
    [UIView animateWithDuration:transitionDuration * ABI50_0_0RNSSlideCloseTransitionDurationProportion // defaults to 0.25 s
        delay:0
    ...
    [UIView animateWithDuration:transitionDuration * ABI50_0_0RNSFadeCloseTransitionDurationProportion // defaults to 0.15 s
                          delay:transitionDuration * ABI50_0_0RNSFadeCloseDelayTransitionDurationProportion // defaults to 0.1 s
                        options:UIViewAnimationOptionCurveLinear
                     animations:^{
                       fromViewController.view.alpha = 0.0;
                     }
...
{
  return (animation != ABI50_0_0RNSScreenStackAnimationFlip && animation != ABI50_0_0RNSScreenStackAnimationDefault);
}

- (void)animateTransitionWithStackAnimation:(ABI50_0_0RNSScreenStackAnimation)animation
                          transitionContext:(id<UIViewControllerContextTransitioning>)transitionContext
                                       toVC:(UIViewController *)toVC
                                     fromVC:(UIViewController *)fromVC
{
  if (animation == ABI50_0_0RNSScreenStackAnimationSimplePush) {
    [self animateSimplePushWithTransitionContext:transitionContext toVC:toVC fromVC:fromVC];
    return;
  } else if (animation == ABI50_0_0RNSScreenStackAnimationFade || animation == ABI50_0_0RNSScreenStackAnimationNone) {
    [self animateFadeWithTransitionContext:transitionContext toVC:toVC fromVC:fromVC];
    return;
  } else if (animation == ABI50_0_0RNSScreenStackAnimationSlideFromBottom) {
    [self animateSlideFromBottomWithTransitionContext:transitionContext toVC:toVC fromVC:fromVC];
    return;
  } else if (animation == ABI50_0_0RNSScreenStackAnimationFadeFromBottom) {
