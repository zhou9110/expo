...
#import "ABI50_0_0RCTWrapperViewControllerHostingView.h"
...
@implementation ABI50_0_0RCTWrapperViewControllerHostingView {
...
- (void)attachContentViewControllerIfNeeded
{
  ...
  [self.ABI50_0_0ReactViewController attachChildViewController:self.contentViewController toContainerView:self];
}
...
- (void)detachContentViewControllerIfNeeded
{
  ...
  [self.ABI50_0_0ReactViewController detachChildViewController:self.contentViewController];
}
