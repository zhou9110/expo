...
#include "ABI50_0_0JavaInteropTurboModule.h"
...
std::vector<ABI50_0_0facebook::jsi::PropNameID> JavaInteropTurboModule::getPropertyNames(
    ABI50_0_0facebook::jsi::Runtime& runtime) {
  std::vector<ABI50_0_0facebook::jsi::PropNameID> propNames =
