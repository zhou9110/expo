...
@implementation ABI50_0_0RNSVGView {
  NSColor *_tintColor;
}
...
- (NSColor *)tintColor
{
  ...
  // (b) we reach a view that isn't an ABI50_0_0RNSVGView
  NSView *parentView = [self superview];
  if ([parentView isKindOfClass:[ABI50_0_0RNSVGView class]]) {
    return [(ABI50_0_0RNSVGView *)parentView tintColor];
  } else {
...
@implementation NSImage (ABI50_0_0RNSVGMacOSExtensions)
...
@implementation NSValue (ABI50_0_0RNSVGMacOSExtensions)
