...
@interface ABI50_0_0RCTFrameAnimation ()
...
@implementation ABI50_0_0RCTFrameAnimation {
...
{
  NSNumber *toValue = [ABI50_0_0RCTConvert NSNumber:config[@"toValue"]] ?: @1;
  NSArray<NSNumber *> *frames = [ABI50_0_0RCTConvert NSNumberArray:config[@"frames"]];
...
- (void)stepAnimationWithTime:(NSTimeInterval)currentTime
{
  ...
  NSTimeInterval currentDuration = (_animationCurrentTime - _animationStartTime) / ABI50_0_0RCTAnimationDragCoefficient();

  // Determine how many frames have passed since last update.
  // Get index of frames that surround the current interval
  NSUInteger startIndex = floor(currentDuration / ABI50_0_0RCTSingleFrameInterval);
  ...
  NSTimeInterval fromInterval = (double)startIndex * ABI50_0_0RCTSingleFrameInterval;
  NSTimeInterval toInterval = (double)nextIndex * ABI50_0_0RCTSingleFrameInterval;
  ...
  CGFloat frameOutput = ABI50_0_0RCTInterpolateValue(
      currentDuration,
      fromInterval,
      toInterval,
      fromFrameValue.doubleValue,
      toFrameValue.doubleValue,
      ABI50_0_0EXTRAPOLATE_TYPE_EXTEND,
      ABI50_0_0EXTRAPOLATE_TYPE_EXTEND);
...
{
  CGFloat outputValue =
      ABI50_0_0RCTInterpolateValue(frameOutput, 0, 1, _fromValue, _toValue, ABI50_0_0EXTRAPOLATE_TYPE_EXTEND, ABI50_0_0EXTRAPOLATE_TYPE_EXTEND);
