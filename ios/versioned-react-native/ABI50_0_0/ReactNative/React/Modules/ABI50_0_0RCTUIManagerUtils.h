 ...
 *  1. `ABI50_0_0RCTAssertUIManagerQueue` is okay with execution on both actual UIManager and
 *     Pseudo UIManager queues.
 *  2. Both `ABI50_0_0RCTExecuteOnUIManagerQueue` and `ABI50_0_0RCTUnsafeExecuteOnUIManagerQueueSync`
 *     execute given block *synchronously* if they were called on actual UIManager
 *     or Pseudo UIManager queues.
 *  3. `ABI50_0_0RCTExecuteOnMainQueue` executes given block *synchronously* if we already on
 *     the Main queue.
 *  4. `ABI50_0_0RCTUnsafeExecuteOnUIManagerQueueSync` is smart enough to do the trick:
 ...
 * *explicitly* block the Main queue via calling `ABI50_0_0RCTUnsafeExecuteOnMainQueueSync`.
 ...
 */
ABI50_0_0RCT_EXTERN dispatch_queue_t ABI50_0_0RCTGetUIManagerQueue(void);

/**
 * Default name for the UIManager queue.
 */
ABI50_0_0RCT_EXTERN char *const ABI50_0_0RCTUIManagerQueueName;

/**
 * Check if we are currently on UIManager queue.
 * Please do not use this unless you really know what you're doing.
 */
ABI50_0_0RCT_EXTERN BOOL ABI50_0_0RCTIsUIManagerQueue(void);

/**
 * Check if we are currently on Pseudo UIManager queue.
 * Please do not use this unless you really know what you're doing.
 */
ABI50_0_0RCT_EXTERN BOOL ABI50_0_0RCTIsPseudoUIManagerQueue(void);
 ...
 */
ABI50_0_0RCT_EXTERN void ABI50_0_0RCTExecuteOnUIManagerQueue(dispatch_block_t block);
 ...
 * Please do not use this unless you really know what you're doing.
 */
ABI50_0_0RCT_EXTERN void ABI50_0_0RCTUnsafeExecuteOnUIManagerQueueSync(dispatch_block_t block);

/**
 * Convenience macro for asserting that we're running on UIManager queue.
 */
#define ABI50_0_0RCTAssertUIManagerQueue() \
  ABI50_0_0RCTAssert(                      \
      ABI50_0_0RCTIsUIManagerQueue() || ABI50_0_0RCTIsPseudoUIManagerQueue(), @"This function must be called on the UIManager queue")

/**
 * Returns new unique root view tag.
 */
ABI50_0_0RCT_EXTERN NSNumber *ABI50_0_0RCTAllocateRootViewTag(void);
