...
#include "ABI50_0_0RNSkDispatchQueue.h"
...
class ABI50_0_0RNSkPlatformContext {
public:
  /**
   * Constructor
   */
  ABI50_0_0RNSkPlatformContext(jsi::Runtime *runtime,
                      std::shared_ptr<ABI50_0_0React::CallInvoker> callInvoker,
                      float pixelDensity)
      : _pixelDensity(pixelDensity), _jsRuntime(runtime),
        _callInvoker(callInvoker),
        _dispatchQueue(
            std::make_unique<ABI50_0_0RNSkDispatchQueue>("skia-render-thread")) {
   ...
   * Destructor
   */
  virtual ~ABI50_0_0RNSkPlatformContext() { invalidate(); }
   ...
   * @param tag ABI50_0_0React view tag
   */
   ...
   * children.
   * @param viewTag ABI50_0_0React viewtag
...
private:
  ...
  std::shared_ptr<ABI50_0_0React::CallInvoker> _callInvoker;
  std::unique_ptr<ABI50_0_0RNSkDispatchQueue> _dispatchQueue;
