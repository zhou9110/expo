...
#import <ABI50_0_0React/ABI50_0_0RCTNativeAnimatedModule.h>
...
@interface ABI50_0_0RCTNativeAnimatedModule () <ABI50_0_0RCTInitializing>
@end

@implementation ABI50_0_0RCTNativeAnimatedModule {
...
- (void)setBridge:(ABI50_0_0RCTBridge *)bridge
{
  ...
  _nodesManager = [[ABI50_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:self.bridge
...
{
  ABI50_0_0RCTLogWarn(@"setSurfacePresenter should only be invoked in ABI50_0_0RCTNativeAnimatedTurboModule");
}
...
{
  NSString *viewName = [self.bridge.uiManager viewNameForABI50_0_0ReactTag:[NSNumber numberWithDouble:viewTag]];
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
- (void)uiManagerWillPerformMounting:(ABI50_0_0RCTUIManager *)uiManager
{
  ...
  [uiManager
      prependUIBlock:^(__unused ABI50_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
        for (AnimatedOperation operation in preOperations) {
          operation(self->_nodesManager);
        }
      }];
  [uiManager addUIBlock:^(__unused ABI50_0_0RCTUIManager *manager, __unused NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    for (AnimatedOperation operation in operations) {
      operation(self->_nodesManager);
    }
...
Class ABI50_0_0RCTNativeAnimatedModuleCls(void)
{
  return ABI50_0_0RCTNativeAnimatedModule.class;
}
