...
/**
 A component representing the native view to export to ABI50_0_0React.
...
public final class ViewDefinition<ViewType: UIView>: ViewManagerDefinition {
  ...
  override func createView(appContext: AppContext) -> UIView? {
    ...
    if let legacyViewType = ViewType.self as? ABI50_0_0EXLegacyExpoViewProtocol.Type {
...
/**
 Creates a view definition describing the native view exported to ABI50_0_0React.
 */
