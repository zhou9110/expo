...
#import "ABI50_0_0RNTapHandler.h"

#import <UIKit/UIGestureRecognizerSubclass.h>

#import <ABI50_0_0React/ABI50_0_0RCTConvert.h>

// ABI50_0_0RNBetterTapGestureRecognizer extends UIGestureRecognizer instead of UITapGestureRecognizer
...
@interface ABI50_0_0RNBetterTapGestureRecognizer : UIGestureRecognizer
...
@implementation ABI50_0_0RNBetterTapGestureRecognizer {
...
@implementation ABI50_0_0RNTapGestureHandler {
  ABI50_0_0RNGestureHandlerEventExtraData *_lastData;
}

- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI50_0_0RNBetterTapGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
{
  [super resetConfig];
  ABI50_0_0RNBetterTapGestureRecognizer *recognizer = (ABI50_0_0RNBetterTapGestureRecognizer *)_recognizer;
...
- (void)configure:(NSDictionary *)config
{
  ...
  if (prop != nil) {
    recognizer.maxDelay = [ABI50_0_0RCTConvert CGFloat:prop] / 1000.0;
  }

  prop = config[@"maxDurationMs"];
  if (prop != nil) {
    recognizer.maxDuration = [ABI50_0_0RCTConvert CGFloat:prop] / 1000.0;
  }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  // in ABI50_0_0RNGestureHandler it resets _lastSatate variable, making is seem like handler
