...
#import <ABI50_0_0cxxreact/ABI50_0_0CxxNativeModule.h>
#import <ABI50_0_0cxxreact/ABI50_0_0Instance.h>
#import <ABI50_0_0cxxreact/ABI50_0_0JSBundleType.h>
#import <ABI50_0_0cxxreact/ABI50_0_0JSIndexedRAMBundle.h>
#import <ABI50_0_0cxxreact/ABI50_0_0ModuleRegistry.h>
#import <ABI50_0_0cxxreact/ABI50_0_0RAMBundleRegistry.h>
...
#else
#import "ABI50_0_0JSCExecutorFactory.h"
#endif
#import "ABI50_0_0RCTJSIExecutorRuntimeInstaller.h"

#import "ABI50_0_0NSDataBigString.h"
#import "ABI50_0_0RCTMessageThread.h"
#import "ABI50_0_0RCTObjcExecutor.h"

#ifdef WITH_FBSYSTRACE
#import <ABI50_0_0React/ABI50_0_0RCTFBSystrace.h>
#endif
...
static NSString *const ABI50_0_0RCTJSThreadName = @"com.facebook.ABI50_0_0React.JavaScript";

typedef void (^ABI50_0_0RCTPendingCall)();
 ...
 */
typedef NS_ENUM(NSInteger, ABI50_0_0RCTBridgeFields) {
  ABI50_0_0RCTBridgeFieldRequestModuleIDs = 0,
  ABI50_0_0RCTBridgeFieldMethodIDs,
  ABI50_0_0RCTBridgeFieldParams,
  ABI50_0_0RCTBridgeFieldCallID,
};
...
class GetDescAdapter : public JSExecutorFactory {
 public:
  GetDescAdapter(ABI50_0_0RCTCxxBridge *bridge, std::shared_ptr<JSExecutorFactory> factory) : bridge_(bridge), factory_(factory)
  {
  }
...
static void registerPerformanceLoggerHooks(ABI50_0_0RCTPerformanceLogger *performanceLogger)
{
  __weak ABI50_0_0RCTPerformanceLogger *weakPerformanceLogger = performanceLogger;
  ABI50_0_0ReactMarker::logTaggedMarkerImpl = [weakPerformanceLogger](
                                         const ABI50_0_0ReactMarker::ABI50_0_0ReactMarkerId markerId, const char *tag) {
    mapABI50_0_0ReactMarkerToPerformanceLogger(markerId, weakPerformanceLogger, tag);
  };
}

@interface ABI50_0_0RCTCxxBridge ()

@property (nonatomic, weak, readonly) ABI50_0_0RCTBridge *parentBridge;
@property (nonatomic, assign, readonly) BOOL moduleSetupComplete;

- (instancetype)initWithParentBridge:(ABI50_0_0RCTBridge *)bridge;
- (void)partialBatchDidFlush;
- (void)batchDidComplete;

@end

struct ABI50_0_0RCTInstanceCallback : public InstanceCallback {
  __weak ABI50_0_0RCTCxxBridge *bridge_;
  ABI50_0_0RCTInstanceCallback(ABI50_0_0RCTCxxBridge *bridge) : bridge_(bridge){};
...
@implementation ABI50_0_0RCTCxxBridge {
  BOOL _didInvalidate;
  BOOL _moduleRegistryCreated;

  NSMutableArray<ABI50_0_0RCTPendingCall> *_pendingCalls;
  std::atomic<NSInteger> _pendingCount;

  // Native modules
  NSMutableDictionary<NSString *, ABI50_0_0RCTModuleData *> *_moduleDataByName;
  NSMutableArray<ABI50_0_0RCTModuleData *> *_moduleDataByID;
  ...
  NSThread *_jsThread;
  std::shared_ptr<ABI50_0_0RCTMessageThread> _jsMessageThread;
  std::mutex _moduleRegistryLock;

  // This is uniquely owned, but weak_ptr is used.
  std::shared_ptr<Instance> _ABI50_0_0ReactInstance;

  // Necessary for searching in TurboModules in TurboModuleManager
  id<ABI50_0_0RCTTurboModuleRegistry> _turboModuleRegistry;

  ABI50_0_0RCTModuleRegistry *_objCModuleRegistry;
  ABI50_0_0RCTViewRegistry *_viewRegistry_DEPRECATED;
...
{
  return [[ABI50_0_0RCTBridgeModuleDecorator alloc] initWithViewRegistry:_viewRegistry_DEPRECATED
...
- (BOOL)isInspectable
{
  return _ABI50_0_0ReactInstance ? _ABI50_0_0ReactInstance->isInspectable() : NO;
}

- (instancetype)initWithParentBridge:(ABI50_0_0RCTBridge *)bridge
{
  ABI50_0_0RCTAssertParam(bridge);
  ...
  if ((self = [super initWithDelegate:bridge.delegate
    ...
    _objCModuleRegistry = [ABI50_0_0RCTModuleRegistry new];
    [_objCModuleRegistry setBridge:self];
    _bundleManager = [ABI50_0_0RCTBundleManager new];
    [_bundleManager setBridge:self];
    _viewRegistry_DEPRECATED = [ABI50_0_0RCTViewRegistry new];
    [_viewRegistry_DEPRECATED setBridge:self];
    _callableJSModules = [ABI50_0_0RCTCallableJSModules new];
    [_callableJSModules setBridge:self];

    [ABI50_0_0RCTBridge setCurrentBridge:self];
    ...
    ABI50_0_0RCTLogSetBridgeModuleRegistry(_objCModuleRegistry);
    ABI50_0_0RCTLogSetBridgeCallableJSModules(_callableJSModules);
  }
  return self;
}
...
{
  @autoreleasepool {
    ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge runJSRunLoop] setup", nil);
...
- (void)handleMemoryWarning
{
  ...
  // We need to hold a local retaining pointer to ABI50_0_0React instance
  // in case if some other tread resets it.
  auto ABI50_0_0ReactInstance = _ABI50_0_0ReactInstance;
  if (ABI50_0_0ReactInstance) {
    int unloadLevel = ABI50_0_0RCTGetMemoryPressureUnloadLevel();
    ABI50_0_0ReactInstance->handleMemoryPressure(unloadLevel);
  }
}
...
- (void)start
{
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge start]", nil);

  [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTJavaScriptWillStartLoadingNotification
  ...
  [_performanceLogger markStartForTag:ABI50_0_0RCTPLNativeModuleInit];

  [self registerExtraModules];
  // Initialize all native modules that cannot be loaded lazily
  (void)[self _initializeModules:ABI50_0_0RCTGetModuleClasses() withDispatchGroup:prepareBridge lazilyDiscovered:NO];
  [self registerExtraLazyModules];

  [_performanceLogger markStopForTag:ABI50_0_0RCTPLNativeModuleInit];

  // This doesn't really do anything.  The real work happens in initializeBridge.
  _ABI50_0_0ReactInstance.reset(new Instance);

  __weak ABI50_0_0RCTCxxBridge *weakSelf = self;
  ...
  if (!self.executorClass) {
    ...
    if ([self.delegate respondsToSelector:jsExecutorFactoryForBridgeSEL]) {
      // Normally, `ABI50_0_0RCTCxxBridgeDelegate` protocol uses `std::unique_ptr` to return the js executor object.
      ...
      // but if someone is using our fork in the bare app, crashes may occur (`ABI50_0_0EXC_BAD_ACCESS`).
      ...
      if(strcmp(returnType, @encode(void *)) == 0) {
        ...
        id<ABI50_0_0RCTCxxBridgeDelegate> cxxDelegate = (id<ABI50_0_0RCTCxxBridgeDelegate>)self.delegate;
        ...
        id<ABI50_0_0RCTCxxBridgeTurboModuleDelegate> cxxDelegate = (id<ABI50_0_0RCTCxxBridgeTurboModuleDelegate>)self.delegate;
        executorFactory = [cxxDelegate jsExecutorFactoryForBridge:self];
      }
    }
    if (!executorFactory) {
      auto installBindings = ABI50_0_0RCTJSIExecutorRuntimeInstaller(nullptr);
#if ABI50_0_0RCT_USE_HERMES
    ...
    id<ABI50_0_0RCTJavaScriptExecutor> objcExecutor = [self moduleForClass:self.executorClass];
    executorFactory.reset(new ABI50_0_0RCTObjcExecutorFactory(objcExecutor, ^(NSError *error) {
      if (error) {
...
#if ABI50_0_0RCT_DEV_MENU && __has_include(<ABI50_0_0React/ABI50_0_0RCTDevLoadingViewProtocol.h>)
  {
    id<ABI50_0_0RCTDevLoadingViewProtocol> loadingView = [self moduleForName:@"DevLoadingView" lazilyLoadIfNecessary:YES];
    [loadingView showWithURL:self.bundleURL];
  }
#endif

  [self
      loadSource:^(NSError *error, ABI50_0_0RCTSource *source) {
        if (error) {
          [weakSelf handleError:error];
        }
...
#if ABI50_0_0RCT_DEV_MENU && __has_include(<ABI50_0_0React/ABI50_0_0RCTDevLoadingViewProtocol.h>)
        id<ABI50_0_0RCTDevLoadingViewProtocol> loadingView = [weakSelf moduleForName:@"DevLoadingView"
  ...
  dispatch_group_notify(prepareBridge, dispatch_get_global_queue(QOS_CLASS_USER_INTERACTIVE, 0), ^{
    ABI50_0_0RCTCxxBridge *strongSelf = weakSelf;
...
- (void)loadSource:(ABI50_0_0RCTSourceLoadBlock)_onSourceLoad onProgress:(ABI50_0_0RCTSourceLoadProgressBlock)onProgress
{
  NSNotificationCenter *center = [NSNotificationCenter defaultCenter];
  [center postNotificationName:ABI50_0_0RCTBridgeWillDownloadScriptNotification object:_parentBridge];
  [_performanceLogger markStartForTag:ABI50_0_0RCTPLScriptDownload];
  NSUInteger cookie = ABI50_0_0RCTProfileBeginAsyncEvent(0, @"JavaScript download", nil);

  // Suppress a warning if ABI50_0_0RCTProfileBeginAsyncEvent gets compiled out
  (void)cookie;

  ABI50_0_0RCTPerformanceLogger *performanceLogger = _performanceLogger;
  ABI50_0_0RCTSourceLoadBlock onSourceLoad = ^(NSError *error, ABI50_0_0RCTSource *source) {
    ABI50_0_0RCTProfileEndAsyncEvent(0, @"native", cookie, @"JavaScript download", @"JS async");
    [performanceLogger markStopForTag:ABI50_0_0RCTPLScriptDownload];
    [performanceLogger setValue:source.length forTag:ABI50_0_0RCTPLBundleSize];

    NSDictionary *userInfo = @{
      ABI50_0_0RCTBridgeDidDownloadScriptNotificationSourceKey : source ?: [NSNull null],
      ABI50_0_0RCTBridgeDidDownloadScriptNotificationBridgeDescriptionKey : self->_bridgeDescription ?: [NSNull null],
    };

    [center postNotificationName:ABI50_0_0RCTBridgeDidDownloadScriptNotification object:self->_parentBridge userInfo:userInfo];
  ...
  if ([self.delegate respondsToSelector:@selector(loadSourceForBridge:onProgress:onComplete:)]) {
    ...
    NSError *error = ABI50_0_0RCTErrorWithMessage(
    ...
    __weak ABI50_0_0RCTCxxBridge *weakSelf = self;
    [ABI50_0_0RCTJavaScriptLoader loadBundleAtURL:self.bundleURL
...
{
  if (ABI50_0_0RCT_DEBUG && _valid && _moduleClassesByID == nil) {
...
{
  if (ABI50_0_0RCTTurboModuleEnabled() && _turboModuleRegistry) {
    const char *moduleNameCStr = [moduleName UTF8String];
    if (lazilyLoad || [_turboModuleRegistry moduleIsInitialized:moduleNameCStr]) {
      id<ABI50_0_0RCTTurboModule> module = [_turboModuleRegistry moduleForName:moduleNameCStr warnOnLookupFailure:NO];
      if (module != nil) {
        return module;
      }
    }
  ...
  ABI50_0_0RCTModuleData *moduleData = _moduleDataByName[moduleName];
  if (moduleData) {
    if (![moduleData isKindOfClass:[ABI50_0_0RCTModuleData class]]) {
  ...
  if (result) {
    ...
    ABI50_0_0RCTLogError(@"Unable to find module for %@", moduleName);
  }
#else
  } else {
    ABI50_0_0RCTLogError(@"Unable to find module for %@", moduleName);
...
{
  return [self moduleForName:ABI50_0_0RCTBridgeModuleNameForClass(moduleClass) lazilyLoadIfNecessary:YES];
}
...
- (std::shared_ptr<ModuleRegistry>)_buildModuleRegistryUnlocked
{
  ...
  [_performanceLogger markStartForTag:ABI50_0_0RCTPLNativeModulePrepareConfig];
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge buildModuleRegistry]", nil);
  ...
  auto registry = std::make_shared<ModuleRegistry>(
      createNativeModules(_moduleDataByID, self, _ABI50_0_0ReactInstance), moduleNotFoundCallback);

  [_performanceLogger markStopForTag:ABI50_0_0RCTPLNativeModulePrepareConfig];
  ABI50_0_0RCT_PROFILE_END_EVENT(ABI50_0_0RCTProfileTagAlways, @"");
...
- (void)_initializeBridge:(std::shared_ptr<JSExecutorFactory>)executorFactory
{
  ...
  __weak ABI50_0_0RCTCxxBridge *weakSelf = self;
  _jsMessageThread = std::make_shared<ABI50_0_0RCTMessageThread>([NSRunLoop currentRunLoop], ^(NSError *error) {
    if (error) {
      [weakSelf handleError:error];
    }
  });

  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge initializeBridge:]", nil);
  // This can only be false if the bridge was invalidated before startup completed
  if (_ABI50_0_0ReactInstance) {
#if ABI50_0_0RCT_DEV
    ...
    if (ABI50_0_0RCTProfileIsProfiling()) {
      _ABI50_0_0ReactInstance->setGlobalVariable("__ABI50_0_0RCTProfileIsProfiling", std::make_unique<JSBigStdString>("true"));
    }
#endif
  }
...
- (void)_initializeBridgeLocked:(std::shared_ptr<JSExecutorFactory>)executorFactory
{
  ...
  _ABI50_0_0ReactInstance->initializeBridge(
      std::make_unique<ABI50_0_0RCTInstanceCallback>(self),
      executorFactory,
      _jsMessageThread,
...
{
  NSString *const moduleName = ABI50_0_0RCTBridgeModuleNameForClass([instance class]);
  if (moduleName) {
    ABI50_0_0RCTModuleData *const moduleData = _moduleDataByName[moduleName];
    if (moduleData) {
...
- (NSArray<ABI50_0_0RCTModuleData *> *)registerModulesForClasses:(NSArray<Class> *)moduleClasses
{
  return [self _registerModulesForClasses:moduleClasses lazilyDiscovered:NO];
}

- (NSArray<ABI50_0_0RCTModuleData *> *)_registerModulesForClasses:(NSArray<Class> *)moduleClasses
                                        lazilyDiscovered:(BOOL)lazilyDiscovered
{
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(
      ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge initModulesWithDispatchGroup:] autoexported moduleData", nil);

  NSArray *moduleClassesCopy = [moduleClasses copy];
  NSMutableArray<ABI50_0_0RCTModuleData *> *moduleDataByID = [NSMutableArray arrayWithCapacity:moduleClassesCopy.count];
  for (Class moduleClass in moduleClassesCopy) {
    if (ABI50_0_0RCTTurboModuleEnabled() && [moduleClass conformsToProtocol:@protocol(ABI50_0_0RCTTurboModule)]) {
      continue;
    }
    NSString *moduleName = ABI50_0_0RCTBridgeModuleNameForClass(moduleClass);
    ...
    if (moduleData) {
      if (moduleData.hasInstance || lazilyDiscovered) {
        ...
        ABI50_0_0RCTLogWarn(
            @"Attempted to register ABI50_0_0RCTBridgeModule class %@ for the "
    ...
    moduleData = [[ABI50_0_0RCTModuleData alloc] initWithModuleClass:moduleClass
                                                     bridge:self
                                             moduleRegistry:_objCModuleRegistry
...
{
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge initModulesWithDispatchGroup:] extraModules", nil);

  NSArray<id<ABI50_0_0RCTBridgeModule>> *appExtraModules = nil;
  ...
  NSMutableArray<id<ABI50_0_0RCTBridgeModule>> *extraModules = [NSMutableArray new];

  // Prevent TurboModules from appearing the NativeModule system
  for (id<ABI50_0_0RCTBridgeModule> module in appExtraModules) {
    if (!(ABI50_0_0RCTTurboModuleEnabled() && [module conformsToProtocol:@protocol(ABI50_0_0RCTTurboModule)])) {
  ...
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(
      ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge initModulesWithDispatchGroup:] preinitialized moduleData", nil);
  // Set up moduleData for pre-initialized module instances
  for (id<ABI50_0_0RCTBridgeModule> module in extraModules) {
    ...
    int32_t moduleDataId = getUniqueId();
    BridgeNativeModulePerfLogger::moduleDataCreateStart([moduleName UTF8String], moduleDataId);
    ABI50_0_0RCTModuleData *moduleData = [[ABI50_0_0RCTModuleData alloc] initWithModuleInstance:module
                                                                       bridge:self
                                                               moduleRegistry:_objCModuleRegistry
                                                      viewRegistry_DEPRECATED:_viewRegistry_DEPRECATED
                                                                bundleManager:_bundleManager
...
- (void)registerExtraLazyModules
{
  ...
  if (executorClass && [NSStringFromClass(executorClass) isEqualToString:@"ABI50_0_0RCTWebSocketExecutor"]) {
...
- (NSArray<ABI50_0_0RCTModuleData *> *)_initializeModules:(NSArray<Class> *)modules
                               withDispatchGroup:(dispatch_group_t)dispatchGroup
                                lazilyDiscovered:(BOOL)lazilyDiscovered
{
  // Set up moduleData for automatically-exported modules
  NSArray<ABI50_0_0RCTModuleData *> *moduleDataById = [self _registerModulesForClasses:modules
  ...
  if (lazilyDiscovered) {
    ...
    for (ABI50_0_0RCTModuleData *moduleData in moduleDataById) {
      ABI50_0_0RCTAssert(
    ...
    ABI50_0_0RCT_PROFILE_BEGIN_EVENT(
        ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge initModulesWithDispatchGroup:] moduleData.hasInstance", nil);
    ...
    for (ABI50_0_0RCTModuleData *moduleData in _moduleDataByID) {
      if (moduleData.hasInstance && (!moduleData.requiresMainQueueSetup || ABI50_0_0RCTIsMainQueue())) {
    ...
    // From this point on, ABI50_0_0RCTDidInitializeModuleNotification notifications will
  ...
  if (ABI50_0_0RCTProfileIsProfiling()) {
    ...
    ABI50_0_0RCTProfileHookModules(self);
  }
#endif
  return moduleDataById;
}
...
- (void)registerAdditionalModuleClasses:(NSArray<Class> *)modules
{
  ...
  if (_moduleRegistryCreated) {
    NSArray<ABI50_0_0RCTModuleData *> *newModules = [self _initializeModules:modules
                                                  withDispatchGroup:NULL
                                                   lazilyDiscovered:YES];
    assert(_ABI50_0_0ReactInstance); // at this point you must have ABI50_0_0ReactInstance as you already called
                            // ABI50_0_0ReactInstance->initializeBridge
    _ABI50_0_0ReactInstance->getModuleRegistry().registerModules(createNativeModules(newModules, self, _ABI50_0_0ReactInstance));
  } else {
...
{
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(0, @"-[ABI50_0_0RCTCxxBridge _prepareModulesWithDispatchGroup]", nil);
  ...
  [_performanceLogger setValue:0 forTag:ABI50_0_0RCTPLNativeModuleMainThread];
  ...
  for (ABI50_0_0RCTModuleData *moduleData in _moduleDataByID) {
    if (moduleData.requiresMainQueueSetup) {
      ...
      dispatch_block_t block = ^{
        if (self.valid && ![moduleData.moduleClass isSubclassOfClass:[ABI50_0_0RCTCxxModule class]]) {
          [self->_performanceLogger appendStartForTag:ABI50_0_0RCTPLNativeModuleMainThread];
          (void)[moduleData instance];
          [moduleData gatherConstants];
          [self->_performanceLogger appendStopForTag:ABI50_0_0RCTPLNativeModuleMainThread];
        }
      };

      if (initializeImmediately && ABI50_0_0RCTIsMainQueue()) {
        block();
      } else {
  ...
  [_performanceLogger setValue:_modulesInitializedOnMainQueue forTag:ABI50_0_0RCTPLNativeModuleMainThreadUsesCount];
  ABI50_0_0RCT_PROFILE_END_EVENT(ABI50_0_0RCTProfileTagAlways, @"");
}
...
- (void)executeSourceCode:(NSData *)sourceCode withSourceURL:(NSURL *)url sync:(BOOL)sync
{
  ...
  dispatch_block_t completion = ^{
    ...
    // timing issues with ABI50_0_0RCTRootView
    dispatch_async(dispatch_get_main_queue(), ^{
      [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTJavaScriptDidLoadNotification
...
- (void)handleError:(NSError *)error
{
  ...
  // through this method, but through ABI50_0_0RCTExceptionManager.
  ...
  // In state 1: on main queue, move to state 2, reset the bridge, and ABI50_0_0RCTFatal.
  // In state 2: go directly to ABI50_0_0RCTFatal.  Do not enqueue, do not collect $200.
  // In state 3: do nothing.

  if (self->_valid && !self->_loading) {
    if ([error userInfo][ABI50_0_0RCTJSRawStackTraceKey]) {
      [self.redBox showErrorMessage:[error localizedDescription] withRawStack:[error userInfo][ABI50_0_0RCTJSRawStackTraceKey]];
    }

    ABI50_0_0RCTFatal(error);

    // ABI50_0_0RN will stop, but let the rest of the app keep going.
    return;
  }
  ...
  ABI50_0_0RCTRedBox *redBox = [self redBox];
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    self->_ABI50_0_0ReactInstance.reset();
    self->_jsMessageThread.reset();

    [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTJavaScriptDidFailToLoadNotification
                                                        object:self->_parentBridge
                                                      userInfo:@{@"bridge" : self, @"error" : error}];

    if ([error userInfo][ABI50_0_0RCTJSRawStackTraceKey]) {
      [redBox showErrorMessage:[error localizedDescription] withRawStack:[error userInfo][ABI50_0_0RCTJSRawStackTraceKey]];
    }
...
ABI50_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithDelegate
                    : (__unused id<ABI50_0_0RCTBridgeDelegate>)delegate bundleURL
                    : (__unused NSURL *)bundleURL moduleProvider
                    : (__unused ABI50_0_0RCTBridgeModuleListProvider)block launchOptions
                    : (__unused NSDictionary *)launchOptions)

ABI50_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithBundleURL
                    : (__unused NSURL *)bundleURL moduleProvider
                    : (__unused ABI50_0_0RCTBridgeModuleListProvider)block launchOptions
                    : (__unused NSDictionary *)launchOptions)
...
#pragma mark - ABI50_0_0RCTInvalidating
...
- (void)invalidate
{
  ...
  ABI50_0_0RCTAssertMainQueue();
  ABI50_0_0RCTLogInfo(@"Invalidating %@ (parent: %@, executor: %@)", self, _parentBridge, [self executorClass]);
  ...
  if ([ABI50_0_0RCTBridge currentBridge] == self) {
    [ABI50_0_0RCTBridge setCurrentBridge:nil];
  }
  ...
  [self ensureOnJavaScriptThread:^{
    ...
    if (ABI50_0_0RCTProfileIsProfiling()) {
      ABI50_0_0RCTProfileUnhookModules(self);
    }

    // Invalidate modules

    [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTBridgeWillInvalidateModulesNotification
                                                        object:self->_parentBridge
                                                      userInfo:@{@"bridge" : self}];
    ...
    for (ABI50_0_0RCTModuleData *moduleData in self->_moduleDataByID) {
      ...
      if ([moduleData.instance respondsToSelector:@selector(invalidate)]) {
        ...
        [self
            dispatchBlock:^{
              [(id<ABI50_0_0RCTInvalidating>)moduleData.instance invalidate];
    ...
    if (dispatch_group_wait(moduleInvalidation, dispatch_time(DISPATCH_TIME_NOW, 10 * NSEC_PER_SEC))) {
      ABI50_0_0RCTLogError(@"Timed out waiting for modules to be invalidated");
    }

    [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTBridgeDidInvalidateModulesNotification
                                                        object:self->_parentBridge
                                                      userInfo:@{@"bridge" : self}];
...
{
  if (ABI50_0_0RCT_DEBUG && _valid) {
    [self enqueueJSCall:@"ABI50_0_0RCTLog" method:@"logIfNoNativeHook" args:@[ level, message ] completion:NULL];
  }
}

#pragma mark - ABI50_0_0RCTBridge methods

- (void)_runAfterLoad:(ABI50_0_0RCTPendingCall)block
{
...
- (void)logStartupFinish
{
  ...
  uint64_t nativeRequiresCount = [_performanceLogger valueForTag:ABI50_0_0RCTPLRAMNativeRequiresCount];
  [_performanceLogger setValue:nativeRequiresCount forTag:ABI50_0_0RCTPLRAMStartupNativeRequiresCount];
  uint64_t nativeRequires = [_performanceLogger valueForTag:ABI50_0_0RCTPLRAMNativeRequires];
  [_performanceLogger setValue:nativeRequires forTag:ABI50_0_0RCTPLRAMStartupNativeRequires];

  [_performanceLogger markStopForTag:ABI50_0_0RCTPLBridgeStartup];
}

- (void)_flushPendingCalls
{
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(0, @"Processing pendingCalls", @{@"count" : [@(_pendingCalls.count) stringValue]});
  ...
  NSArray<ABI50_0_0RCTPendingCall> *pendingCalls = _pendingCalls;
  _pendingCalls = nil;
  for (ABI50_0_0RCTPendingCall call in pendingCalls) {
    call();
    _pendingCount--;
  }
  _loading = NO;
           ...
           completion:(dispatch_block_t)completion
{
   ...
   * AnyThread
   */
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge enqueueJSCall:]", nil);
  ...
  [self _runAfterLoad:^() {
    ...
    if (strongSelf->_ABI50_0_0ReactInstance) {
      strongSelf->_ABI50_0_0ReactInstance->callJSFunction(
          [ABI50_0_0EX_REMOVE_VERSION(module) UTF8String], [method UTF8String], convertIdToFollyDynamic(args ?: @[]));
      ...
      if (completion) {
        if (strongSelf->_jsMessageThread) {
          ...
          ABI50_0_0RCTLogWarn(@"Can't invoke completion without messageThread");
        }
      }
    }
  }];
...
/**
 * Called by ABI50_0_0RCTModuleMethod from any thread.
 */
- (void)enqueueCallback:(NSNumber *)cbID args:(NSArray *)args
{
  ...
  [self _runAfterLoad:^() {
    ...
    if (strongSelf->_ABI50_0_0ReactInstance) {
      strongSelf->_ABI50_0_0ReactInstance->callJSCallback([cbID unsignedLongLongValue], convertIdToFollyDynamic(args ?: @[]));
    }
  }];
}
...
{
  if (_ABI50_0_0ReactInstance) {
    _ABI50_0_0ReactInstance->callJSFunction(
...
{
  ABI50_0_0RCT_PROFILE_BEGIN_EVENT(ABI50_0_0RCTProfileTagAlways, @"-[ABI50_0_0RCTCxxBridge enqueueApplicationScript]", nil);
  ...
  if (onComplete) {
    ABI50_0_0RCTAssert(_jsMessageThread != nullptr, @"Cannot invoke completion without jsMessageThread");
...
- (void)executeApplicationScript:(NSData *)script url:(NSURL *)url async:(BOOL)async
{
  [self _tryAndHandleError:^{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ABI50_0_0RCTJavaScriptWillStartExecutingNotification
                                                        object:self->_parentBridge
                                                      userInfo:@{@"bridge" : self}];
    ...
    // hold a local reference to ABI50_0_0ReactInstance in case a parallel thread
    // resets it between null check and usage
    auto ABI50_0_0ReactInstance = self->_ABI50_0_0ReactInstance;
    if (scriptType == ScriptTag::RAMBundle) {
      [self->_performanceLogger markStartForTag:ABI50_0_0RCTPLRAMBundleLoad];
      auto ramBundle = std::make_unique<JSIndexedRAMBundle>(sourceUrlStr.UTF8String);
      std::unique_ptr<const JSBigString> scriptStr = ramBundle->getStartupCode();
      [self->_performanceLogger markStopForTag:ABI50_0_0RCTPLRAMBundleLoad];
      [self->_performanceLogger setValue:scriptStr->size() forTag:ABI50_0_0RCTPLRAMStartupCodeSize];
      if (ABI50_0_0ReactInstance) {
        auto registry =
            RAMBundleRegistry::multipleBundlesRegistry(std::move(ramBundle), JSIndexedRAMBundle::buildFactory());
        ABI50_0_0ReactInstance->loadRAMBundle(std::move(registry), std::move(scriptStr), sourceUrlStr.UTF8String, !async);
      }
    } else if (ABI50_0_0ReactInstance) {
      ABI50_0_0ReactInstance->loadScriptFromString(std::make_unique<NSDataBigString>(script), sourceUrlStr.UTF8String, !async);
    } else {
...
{
  if (_ABI50_0_0ReactInstance) {
    _ABI50_0_0ReactInstance->registerBundle(static_cast<uint32_t>(segmentId), path.UTF8String);
  }
}
...
- (void)batchDidComplete
{
  // TODO #12592471: batchDidComplete is only used by ABI50_0_0RCTUIManager,
...
- (void)startProfiling
{
  ...
  [self ensureOnJavaScriptThread:^{
#if WITH_FBSYSTRACE
    [ABI50_0_0RCTFBSystrace registerCallbacks];
#endif
    ABI50_0_0RCTProfileInit(self);
...
- (void)stopProfiling:(void (^)(NSData *))callback
{
  ...
  [self ensureOnJavaScriptThread:^{
    ...
    ABI50_0_0RCTProfileEnd(self, ^(NSString *log) {
      NSData *logData = [log dataUsingEncoding:NSUTF8StringEncoding];
      callback(logData);
#if WITH_FBSYSTRACE
      if (![ABI50_0_0RCTFBSystrace verifyTraceSize:logData.length]) {
        ABI50_0_0RCTLogWarn(
            @"Your FBSystrace trace might be truncated, try to bump up the buffer size"
             " in ABI50_0_0RCTFBSystrace.m or capture a shorter trace");
      }
      [ABI50_0_0RCTFBSystrace unregisterCallbacks];
#endif
    });
  }];
}
...
- (BOOL)isBatchActive
{
  return _ABI50_0_0ReactInstance ? _ABI50_0_0ReactInstance->isBatchActive() : NO;
}
...
- (void *)runtime
{
  ...
  return _ABI50_0_0ReactInstance->getJavaScriptContext();
}
...
#pragma mark - ABI50_0_0RCTBridge (ABI50_0_0RCTTurboModule)

- (std::shared_ptr<CallInvoker>)jsCallInvoker
{
  return _ABI50_0_0ReactInstance ? _ABI50_0_0ReactInstance->getJSCallInvoker() : nullptr;
}
...
{
  return _ABI50_0_0ReactInstance ? _ABI50_0_0ReactInstance->getDecoratedNativeMethodCallInvoker(nativeInvoker) : nullptr;
}
