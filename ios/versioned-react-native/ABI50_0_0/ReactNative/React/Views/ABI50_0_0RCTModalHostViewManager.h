...
@interface ABI50_0_0RCTConvert (ABI50_0_0RCTModalHostView)

+ (UIModalPresentationStyle)UIModalPresentationStyle:(id)json;

@end

typedef void (^ABI50_0_0RCTModalViewInteractionBlock)(
    UIViewController *ABI50_0_0ReactViewController,
    UIViewController *viewController,
    BOOL animated,
    dispatch_block_t completionBlock);

@interface ABI50_0_0RCTModalHostViewManager : ABI50_0_0RCTViewManager <ABI50_0_0RCTInvalidating>
 ...
 */
@property (nonatomic, strong) ABI50_0_0RCTModalViewInteractionBlock presentationBlock;
@property (nonatomic, strong) ABI50_0_0RCTModalViewInteractionBlock dismissalBlock;
