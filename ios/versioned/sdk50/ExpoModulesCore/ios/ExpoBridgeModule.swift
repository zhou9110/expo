...
/**
 ...
 - Creating and owning the `AppContext` when the Expo modules architecture is automatically initialized
   by ABI50_0_0React Native (as opposed to native unit tests, where ABI50_0_0React Native is not used at all).
 - Installing the host object to the runtime.
 */
@objc(ABI50_0_0ExpoBridgeModule)
public final class ABI50_0_0ExpoBridgeModule: NSObject, ABI50_0_0RCTBridgeModule {
  @objc
  public let appContext: AppContext

  /**
   The initializer that is used by ABI50_0_0React Native when it loads bridge modules.
  ...
  public var bridge: ABI50_0_0RCTBridge! {
    didSet {
      ...
      let attachRuntime = { [weak self] in
        ...
        self.appContext._runtime = ABI50_0_0EXJavaScriptRuntimeManager.runtime(fromBridge: bridge)
      }
      ...
      if bridge.responds(to: Selector(("runtime"))) {
        ...
        if result == nil {
          ...
          bridge.dispatchBlock({ [weak self] in
            ...
            bridge.dispatchBlock(attachRuntime, queue: ABI50_0_0RCTJSThread)
  ...
  /**
   This should be called inside ABI50_0_0EXNativeModulesProxy.setBridge()
   */
  @objc
  public func legacyProxyDidSetBridge(legacyModulesProxy: LegacyNativeModulesProxy,
                                      legacyModuleRegistry: ABI50_0_0EXModuleRegistry) {
    ...
    appContext.useModulesProvider("ABI50_0_0ExpoModulesProvider")
  ...
  public func installModules() {
    ...
    if appContext._runtime == nil {
      appContext._runtime = ABI50_0_0EXJavaScriptRuntimeManager.runtime(fromBridge: bridge)
    }
  }
}
