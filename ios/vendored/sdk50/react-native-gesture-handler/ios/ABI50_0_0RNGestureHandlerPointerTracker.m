...
@implementation ABI50_0_0RNGestureHandlerPointerTracker {
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
  ...
  _eventType = ABI50_0_0RNGHTouchEventTypePointerDown;
...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
  ...
  _eventType = ABI50_0_0RNGHTouchEventTypePointerMove;
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
  ...
  _eventType = ABI50_0_0RNGHTouchEventTypePointerUp;
...
- (void)reset
{
  ...
  if (_trackedPointersCount == 0) {
    ...
    _eventType = ABI50_0_0RNGHTouchEventTypeUndetermined;
  } else {
...
- (void)cancelPointers
{
  ...
  if (registeredTouches > 0) {
    ...
    _eventType = ABI50_0_0RNGHTouchEventTypeCancelled;
...
- (void)sendEvent
{
  ...
  // would be nil.
  if (!_gestureHandler.needsPointerData || _gestureHandler.recognizer.view.ABI50_0_0ReactTag == nil) {
    return;
  }

  [_gestureHandler sendTouchEventInState:[_gestureHandler state]
                          forViewWithTag:_gestureHandler.recognizer.view.ABI50_0_0ReactTag];
}
