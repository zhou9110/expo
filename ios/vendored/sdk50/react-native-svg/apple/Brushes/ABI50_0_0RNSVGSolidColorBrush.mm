...
@implementation ABI50_0_0RNSVGSolidColorBrush {
  ABI50_0_0RNSVGColor *_color;
}

- (instancetype)initWithArray:(NSArray<ABI50_0_0RNSVGLength *> *)array
{
  if ((self = [super initWithArray:array])) {
    _color = [ABI50_0_0RCTConvert ABI50_0_0RNSVGColor:array offset:1];
  }
  return self;
}
...
{
  if ((self = [super init])) {
    _color = [ABI50_0_0RCTConvert ABI50_0_0RNSVGColor:number];
  }
  return self;
}

- (instancetype)initWithColor:(ABI50_0_0RNSVGColor *)color
{
  if ((self = [super init])) {
    _color = color;
  }
