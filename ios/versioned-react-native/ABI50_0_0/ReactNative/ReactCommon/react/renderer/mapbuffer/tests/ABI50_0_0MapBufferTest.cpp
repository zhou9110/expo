...
TEST(MapBufferTest, testSimpleIntMap) {
  ...
  ABI50_0_0EXPECT_EQ(map.count(), 2);
  ABI50_0_0EXPECT_EQ(map.getInt(0), 1234);
  ABI50_0_0EXPECT_EQ(map.getInt(1), 4321);
}
...
TEST(MapBufferTest, testMapBufferExtension) {
  ...
  ABI50_0_0EXPECT_EQ(map.count(), 4);

  ABI50_0_0EXPECT_EQ(map.getInt(0), 1234);
  ABI50_0_0EXPECT_EQ(map.getInt(1), 4321);
  ABI50_0_0EXPECT_EQ(map.getInt(2), 2121);
  ABI50_0_0EXPECT_EQ(map.getInt(3), 1212);
}
...
TEST(MapBufferTest, testBoolEntries) {
  ...
  ABI50_0_0EXPECT_EQ(map.count(), 2);
  ABI50_0_0EXPECT_EQ(map.getBool(0), true);
  ABI50_0_0EXPECT_EQ(map.getBool(1), false);
}
...
TEST(MapBufferTest, testDoubleEntries) {
  ...
  ABI50_0_0EXPECT_EQ(map.getDouble(0), 123.4);
  ABI50_0_0EXPECT_EQ(map.getDouble(1), 432.1);
}
...
TEST(MapBufferTest, testStringEntries) {
  ...
  ABI50_0_0EXPECT_EQ(map.getString(0), "This is a test");
}
...
TEST(MapBufferTest, testUTFStringEntry) {
  ...
  ABI50_0_0EXPECT_EQ(map.getString(0), "Let's count: 的, 一, 是");
}
...
TEST(MapBufferTest, testUTFStringEntries) {
  ...
  ABI50_0_0EXPECT_EQ(map.getString(0), "Let's count: 的, 一, 是");
  ABI50_0_0EXPECT_EQ(map.getString(1), "This is a test");
}

TEST(MapBufferTest, testEmptyMap) {
  auto builder = MapBufferBuilder();
  auto map = builder.build();
  ABI50_0_0EXPECT_EQ(map.count(), 0);
}
...
TEST(MapBufferTest, testMapEntries) {
  ...
  ABI50_0_0EXPECT_EQ(map.count(), 2);
  ABI50_0_0EXPECT_EQ(map.getString(0), "This is a test");
  ABI50_0_0EXPECT_EQ(map.getInt(1), 1234);
  ...
  ABI50_0_0EXPECT_EQ(map2.count(), 2);
  ABI50_0_0EXPECT_EQ(map2.getInt(0), 4321);

  MapBuffer readMap2 = map2.getMapBuffer(1);

  ABI50_0_0EXPECT_EQ(readMap2.count(), 2);
  ABI50_0_0EXPECT_EQ(readMap2.getString(0), "This is a test");
  ABI50_0_0EXPECT_EQ(readMap2.getInt(1), 1234);
}
...
TEST(MapBufferTest, testMapListEntries) {
  ...
  ABI50_0_0EXPECT_EQ(mapBufferList2.size(), 2);
  ABI50_0_0EXPECT_EQ(mapBufferList2[0].getString(0), "This is a test");
  ABI50_0_0EXPECT_EQ(mapBufferList2[0].getInt(1), 1234);
  ABI50_0_0EXPECT_EQ(mapBufferList2[1].getDouble(3), 908.1);
}
...
TEST(MapBufferTest, testMapRandomAccess) {
  ...
  ABI50_0_0EXPECT_EQ(map.count(), 4);
  ABI50_0_0EXPECT_EQ(map.getString(0), "This is a test");
  ABI50_0_0EXPECT_EQ(map.getDouble(8), 908.1);
  ABI50_0_0EXPECT_EQ(map.getInt(1234), 4321);
  ABI50_0_0EXPECT_EQ(map.getString(65535), "Let's count: 的, 一, 是");
}
