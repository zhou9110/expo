...
#include "ABI50_0_0EXPlatformUtils.h"
...
void ABI50_0_0EXGLContext::prepareContext(jsi::Runtime &runtime, std::function<void(void)> flushMethod) {
  ...
  try {
    ...
    ABI50_0_0EXGLSysLog("Failed to setup ABI50_0_0EXGLContext [%s]", err.what());
  }
}

void ABI50_0_0EXGLContext::maybeResolveWorkletContext(jsi::Runtime &runtime) {
...
void ABI50_0_0EXGLContext::prepareWorkletContext() {
...
void ABI50_0_0EXGLContext::endNextBatch() noexcept {
...
void ABI50_0_0EXGLContext::addToNextBatch(Op &&op) noexcept {
...
void ABI50_0_0EXGLContext::addBlockingToNextBatch(Op &&op) {
...
// [JS thread] Enqueue a function and return an ABI50_0_0EXGL object that will get mapped
// to the function's return value when it is called on the GL thread.
jsi::Value ABI50_0_0EXGLContext::addFutureToNextBatch(
    jsi::Runtime &runtime,
...
void ABI50_0_0EXGLContext::flush(void) {
...
ABI50_0_0EXGLObjectId ABI50_0_0EXGLContext::createObject(void) noexcept {
  return nextObjectId++;
}

void ABI50_0_0EXGLContext::destroyObject(ABI50_0_0EXGLObjectId exglObjId) noexcept {
  objects.erase(exglObjId);
}

void ABI50_0_0EXGLContext::mapObject(ABI50_0_0EXGLObjectId exglObjId, GLuint glObj) noexcept {
  objects[exglObjId] = glObj;
}

GLuint ABI50_0_0EXGLContext::lookupObject(ABI50_0_0EXGLObjectId exglObjId) noexcept {
  auto iter = objects.find(exglObjId);
  return iter == objects.end() ? 0 : iter->second;
}

void ABI50_0_0EXGLContext::tryRegisterOnJSRuntimeDestroy(jsi::Runtime &runtime) {
...
glesContext ABI50_0_0EXGLContext::prepareOpenGLESContext() {
  glesContext result;
...
void ABI50_0_0EXGLContext::maybeReadAndCacheSupportedExtensions() {
