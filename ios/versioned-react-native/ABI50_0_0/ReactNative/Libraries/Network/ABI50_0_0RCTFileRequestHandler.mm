...
@interface ABI50_0_0RCTFileRequestHandler () <ABI50_0_0RCTTurboModule>
@end

@implementation ABI50_0_0RCTFileRequestHandler {
...
{
  return [request.URL.scheme caseInsensitiveCompare:@"file"] == NSOrderedSame && !ABI50_0_0RCTIsBundleAssetURL(request.URL);
}

- (NSOperation *)sendRequest:(NSURLRequest *)request withDelegate:(id<ABI50_0_0RCTURLRequestDelegate>)delegate
{
  // Lazy setup
  if (!_fileQueue) {
...
Class ABI50_0_0RCTFileRequestHandlerCls(void)
{
  return ABI50_0_0RCTFileRequestHandler.class;
}
