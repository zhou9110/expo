...
#import <ABI50_0_0cxxreact/ABI50_0_0JSBigString.h>
...
class ABI50_0_0RCTObjcExecutor : public JSExecutor {
 public:
  ABI50_0_0RCTObjcExecutor(
  ...
  {
    ABI50_0_0RCTAssert(NO, @"RAM bundles are not supported in ABI50_0_0RCTObjcExecutor");
  }
 ...
 private:
  ...
  ABI50_0_0RCTJavaScriptCallback m_jsCallback;
};

}

ABI50_0_0RCTObjcExecutorFactory::ABI50_0_0RCTObjcExecutorFactory(id<ABI50_0_0RCTJavaScriptExecutor> jse, ABI50_0_0RCTJavaScriptCompleteBlock errorBlock)
    : m_jse(jse), m_errorBlock(errorBlock)
{
}

std::unique_ptr<JSExecutor> ABI50_0_0RCTObjcExecutorFactory::createJSExecutor(
    std::shared_ptr<ExecutorDelegate> delegate,
    std::shared_ptr<MessageQueueThread> jsQueue)
{
  return std::unique_ptr<JSExecutor>(new ABI50_0_0RCTObjcExecutor(m_jse, m_errorBlock, jsQueue, delegate));
}
