...
/* There are Two Views being implemented here:
 1- The ABI50_0_0RCTView for ABI50_0_0React Native that has all of the normal props, and
 2- a LottieAnimationView that is a child of the ABI50_0_0RCTView and is bound to the same coordinates, just on top of it
 */
@objc(ABI50_0_0LottieContainerView)
class ContainerView: ABI50_0_0RCTView {
    ...
    @objc var onAnimationFinish: ABI50_0_0RCTBubblingEventBlock?
    @objc var onAnimationFailure: ABI50_0_0RCTBubblingEventBlock?
    @objc var onAnimationLoaded: ABI50_0_0RCTBubblingEventBlock?
    ...
    // The animation view is a child of the ABI50_0_0RCTView, so if the bounds ever change, add those changes to the animation view as well
    ...
    func replaceAnimationView(next: LottieAnimationView) {
        super.removeABI50_0_0ReactSubview(animationView)
