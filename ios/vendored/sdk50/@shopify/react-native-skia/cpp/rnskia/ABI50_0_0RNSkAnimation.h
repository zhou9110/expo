...
#include "ABI50_0_0RNSkClockValue.h"
 ...
 */
class ABI50_0_0RNSkAnimation : public ABI50_0_0RNSkClockValue {

public:
  ABI50_0_0RNSkAnimation(std::shared_ptr<ABI50_0_0RNSkPlatformContext> platformContext,
                size_t identifier, jsi::Runtime &runtime,
                const jsi::Value *arguments, size_t count)
      : ABI50_0_0RNSkClockValue(platformContext, identifier, runtime, arguments, count) {
  ...
  JSI_EXPORT_FUNCTIONS(JSI_EXPORT_FUNC(ABI50_0_0RNSkAnimation, cancel))
