...
- (id)_convertValue:(id)value
{
  if ([value isKindOfClass:[NSDictionary class]]) {
    ...
    if (nodeTag && [nodeTag isKindOfClass:[NSNumber class]]) {
      ABI50_0_0RCTAnimatedNode *node = [self.parentNodes objectForKey:(NSNumber *)nodeTag];
