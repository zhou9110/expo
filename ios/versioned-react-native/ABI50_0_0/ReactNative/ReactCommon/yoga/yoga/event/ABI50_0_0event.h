...
struct ABI50_0_0YG_EXPORT Event {
  enum Type {
    NodeAllocation,
    NodeDeallocation,
    NodeLayout,
  ...
  class Data;
  using Subscriber = void(ABI50_0_0YGNodeConstRef, Type, Data);
  ...
  template <Type E>
  static void publish(ABI50_0_0YGNodeConstRef node, const TypedData<E>& eventData = {}) {
    publish(node, E, Data{eventData});
  }

 private:
  static void publish(ABI50_0_0YGNodeConstRef, Type, const Data&);
};
...
struct Event::TypedData<Event::MeasureCallbackEnd> {
  float width;
  ABI50_0_0YGMeasureMode widthMeasureMode;
  float height;
  ABI50_0_0YGMeasureMode heightMeasureMode;
  float measuredWidth;
