...
#import "ABI50_0_0RCTFontUtils.h"
...
static ABI50_0_0RCTFontProperties ABI50_0_0RCTDefaultFontProperties()
{
  static ABI50_0_0RCTFontProperties defaultFontProperties;
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultFontProperties.style = ABI50_0_0RCTFontStyleNormal;
    defaultFontProperties.variant = ABI50_0_0RCTFontVariantDefault;
...
static ABI50_0_0RCTFontProperties ABI50_0_0RCTResolveFontProperties(
    ABI50_0_0RCTFontProperties fontProperties,
    ABI50_0_0RCTFontProperties baseFontProperties)
{
  ...
  fontProperties.style =
      fontProperties.style != ABI50_0_0RCTFontStyleUndefined ? fontProperties.style : baseFontProperties.style;
  fontProperties.variant =
      fontProperties.variant != ABI50_0_0RCTFontVariantUndefined ? fontProperties.variant : baseFontProperties.variant;
  return fontProperties;
}

static UIFontWeight ABI50_0_0RCTGetFontWeight(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
  return [traits[UIFontWeightTrait] doubleValue];
}

static ABI50_0_0RCTFontStyle ABI50_0_0RCTGetFontStyle(UIFont *font)
{
  NSDictionary *traits = [font.fontDescriptor objectForKey:UIFontDescriptorTraitsAttribute];
...
static NSArray *ABI50_0_0RCTFontFeatures(ABI50_0_0RCTFontVariant fontVariant)
{
  // FIXME:
  return @[];
}

static UIFont *ABI50_0_0RCTDefaultFontWithFontProperties(ABI50_0_0RCTFontProperties fontProperties)
{
  ...
  if (!font) {
    ...
    if (fontProperties.variant == ABI50_0_0RCTFontStyleItalic) {
...
UIFont *ABI50_0_0RCTFontWithFontProperties(ABI50_0_0RCTFontProperties fontProperties)
{
  ABI50_0_0RCTFontProperties defaultFontProperties = ABI50_0_0RCTDefaultFontProperties();
  fontProperties = ABI50_0_0RCTResolveFontProperties(fontProperties, defaultFontProperties);
  ...
  if ([fontProperties.family isEqualToString:defaultFontProperties.family]) {
    ...
    font = ABI50_0_0RCTDefaultFontWithFontProperties(fontProperties);
  } else {
    ...
    if (fontNames.count == 0) {
      ...
      for (NSString *name in fontNames) {
        ...
        if (ABI50_0_0RCTGetFontStyle(fontMatch) != fontProperties.style) {
          continue;
        }

        CGFloat testWeight = ABI50_0_0RCTGetFontWeight(fontMatch);
  ...
  if (fontProperties.variant != ABI50_0_0RCTFontVariantDefault) {
    NSArray *fontFeatures = ABI50_0_0RCTFontFeatures(fontProperties.variant);
    UIFontDescriptor *fontDescriptor = [font.fontDescriptor
