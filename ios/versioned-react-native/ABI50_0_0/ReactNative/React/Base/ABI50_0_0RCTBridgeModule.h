...
@protocol ABI50_0_0RCTBridgeMethod;
@protocol ABI50_0_0RCTTurboModule;
@protocol ABI50_0_0RCTTurboModuleRegistry;
 ...
 */
typedef void (^ABI50_0_0RCTResponseSenderBlock)(NSArray *response);
 ...
 */
typedef void (^ABI50_0_0RCTResponseErrorBlock)(NSError *error);

/**
 * Block that bridge modules use to resolve the JS promise waiting for a result.
 * Nil results are supported and are converted to JS's undefined value.
 */
typedef void (^ABI50_0_0RCTPromiseResolveBlock)(id result);
 ...
 */
typedef void (^ABI50_0_0RCTPromiseRejectBlock)(NSString *code, NSString *message, NSError *error);

ABI50_0_0RCT_EXTERN_C_BEGIN

typedef struct ABI50_0_0RCTMethodInfo {
  const char *const jsName;
  const char *const objcName;
  const BOOL isSync;
} ABI50_0_0RCTMethodInfo;
 ...
 */
@protocol ABI50_0_0RCTBridgeModule <NSObject>
 ...
 */
#define ABI50_0_0RCT_EXPORT_MODULE(js_name)          \
...
/**
 * Same as ABI50_0_0RCT_EXPORT_MODULE, but uses __attribute__((constructor)) for module
 * registration. Useful for registering swift classes that forbids use of load
 * Used in ABI50_0_0RCT_EXTERN_REMAP_MODULE
 */
#define ABI50_0_0RCT_EXPORT_MODULE_NO_LOAD(js_name, objc_name)                           \
  ABI50_0_0RCT_EXTERN void ABI50_0_0RCTRegisterModule(Class);                                     \
  +(NSString *)moduleName                                                       \
  {                                                                             \
    return @ #js_name;                                                          \
  }                                                                             \
  __attribute__((constructor)) static void ABI50_0_0RCT_CONCAT(initialize_, objc_name)() \
  {                                                                             \
    ABI50_0_0RCTRegisterModule([objc_name class]);                                       \
  }

// Implemented by ABI50_0_0RCT_EXPORT_MODULE
+ (NSString *)moduleName;

@optional

/**
 * A reference to the ABI50_0_0RCTModuleRegistry. Useful for modules that require access
 ...
 * `@objc var moduleRegistry: ABI50_0_0RCTModuleRegistry!` to your module.
 */
@property (nonatomic, weak, readwrite) ABI50_0_0RCTModuleRegistry *moduleRegistry;

/**
 * A reference to the ABI50_0_0RCTViewRegistry. Useful for modules that query UIViews,
 * given a ABI50_0_0React tag. This API is deprecated, and only exists to help migrate
 ...
 * `@objc var viewRegistry_DEPRECATED: ABI50_0_0RCTViewRegistry!` to your module.
 */
@property (nonatomic, weak, readwrite) ABI50_0_0RCTViewRegistry *viewRegistry_DEPRECATED;

/**
 * A reference to the ABI50_0_0RCTBundleManager. Useful for modules that need to read
 ...
 * ABI50_0_0RCTBundleManager!` to your module.
 */
@property (nonatomic, weak, readwrite) ABI50_0_0RCTBundleManager *bundleManager;

/**
 * A reference to an ABI50_0_0RCTCallableJSModules. Useful for modules that need to
 * call into methods on JavaScript modules registered as callable with
 * ABI50_0_0React Native.
 *
 ...
 * ABI50_0_0RCTCallableJSModules!` to your module.
 */
@property (nonatomic, weak, readwrite) ABI50_0_0RCTCallableJSModules *callableJSModules;

/**
 * A reference to the ABI50_0_0RCTBridge. Useful for modules that require access
 * to bridge features, such as sending events or making JS calls. This
 * will be set automatically by the bridge when it initializes the module.
 * To implement this in your module, just add `@synthesize bridge = _bridge;`
 * If using Swift, add `@objc var bridge: ABI50_0_0RCTBridge!` to your module.
 */
@property (nonatomic, weak, readonly) ABI50_0_0RCTBridge *bridge;
 ...
 * thread-only. You can tell ABI50_0_0React Native to call your module methods on the
 ...
 * ABI50_0_0RCT_REMAP_METHOD to specify the JS name of the method.
 *
 ...
 * becomes
 *
 * ABI50_0_0RCT_EXPORT_METHOD(doSomething:(NSString *)aString
 *                   withA:(NSInteger)a
 *                   andB:(NSInteger)b)
 * { ... }
 *
 ...
 * For example:
 *
 * ABI50_0_0RCT_EXPORT_METHOD(doSomethingAsync:(NSString *)aString
 ...
 *
 */
#define ABI50_0_0RCT_EXPORT_METHOD(method) ABI50_0_0RCT_REMAP_METHOD(, method)

/**
 * Same as ABI50_0_0RCT_EXPORT_METHOD but the method is called from JS
 * synchronously **on the JS thread**, possibly returning a result.
 *
 * WARNING: in the vast majority of cases, you should use ABI50_0_0RCT_EXPORT_METHOD which
 ...
 */
#define ABI50_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(method) ABI50_0_0RCT_EXPORT_SYNCHRONOUS_TYPED_METHOD(id, method)

#define ABI50_0_0RCT_EXPORT_SYNCHRONOUS_TYPED_METHOD(returnType, method) \
  ABI50_0_0RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(, returnType, method)

/**
 * Similar to ABI50_0_0RCT_EXPORT_METHOD but lets you set the JS name of the exported
 * method. Example usage:
 *
 * ABI50_0_0RCT_REMAP_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI50_0_0RCT_REMAP_METHOD(js_name, method)       \
  _ABI50_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, NO) \
  -(void)method ABI50_0_0RCT_DYNAMIC;

/**
 * Similar to ABI50_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD but lets you set
 * the JS name of the exported method. Example usage:
 *
 * ABI50_0_0RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(executeQueryWithParameters,
 *   executeQuery:(NSString *)query parameters:(NSDictionary *)parameters)
 * { ... }
 */
#define ABI50_0_0RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(js_name, returnType, method) \
  _ABI50_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, YES)                           \
  -(returnType)method ABI50_0_0RCT_DYNAMIC;
 ...
 *
 *   @interface ABI50_0_0RCT_EXTERN_MODULE(MyModule, NSObject)
 *
 *   ABI50_0_0RCT_EXTERN_METHOD(doSomething:(NSString *)string withFoo:(NSInteger)a bar:(NSInteger)b)
 *
 *   @end
 *
 ...
 */
#define ABI50_0_0RCT_EXTERN_MODULE(objc_name, objc_supername) ABI50_0_0RCT_EXTERN_REMAP_MODULE(, objc_name, objc_supername)

/**
 * Like ABI50_0_0RCT_EXTERN_MODULE, but allows setting a custom JavaScript name.
 */
#define ABI50_0_0RCT_EXTERN_REMAP_MODULE(js_name, objc_name, objc_supername) \
  objc_name:                                                        \
  objc_supername @                                                  \
  end @interface objc_name(ABI50_0_0RCTExternModule)<ABI50_0_0RCTBridgeModule>        \
  @end                                                              \
  @implementation objc_name (ABI50_0_0RCTExternModule)                       \
  ABI50_0_0RCT_EXPORT_MODULE_NO_LOAD(js_name, objc_name)

/**
 * Use this macro in accordance with ABI50_0_0RCT_EXTERN_MODULE to export methods
 * of an external module.
 */
#define ABI50_0_0RCT_EXTERN_METHOD(method) _ABI50_0_0RCT_EXTERN_REMAP_METHOD(, method, NO)

/**
 * Use this macro in accordance with ABI50_0_0RCT_EXTERN_MODULE to export methods
 * of an external module that should be invoked synchronously.
 */
#define ABI50_0_0RCT_EXTERN__BLOCKING_SYNCHRONOUS_METHOD(method) _ABI50_0_0RCT_EXTERN_REMAP_METHOD(, method, YES)

/**
 * Like ABI50_0_0RCT_EXTERN_REMAP_METHOD, but allows setting a custom JavaScript name
 * and also whether this method is synchronous.
 */
#define _ABI50_0_0RCT_EXTERN_REMAP_METHOD(js_name, method, is_blocking_synchronous_method)                            \
  +(const ABI50_0_0RCTMethodInfo *)ABI50_0_0RCT_CONCAT(__rct_export__, ABI50_0_0RCT_CONCAT(js_name, ABI50_0_0RCT_CONCAT(__LINE__, __COUNTER__))) \
  {                                                                                                          \
    static ABI50_0_0RCTMethodInfo config = {#js_name, #method, is_blocking_synchronous_method};                       \
    return &config;                                                                                          \
  }
 ...
 * before registration.
 */
- (NSArray<id<ABI50_0_0RCTBridgeMethod>> *)methodsToExport;
 ...
 * values such as session keys, that are regenerated only as part of a reload of the entire ABI50_0_0React application.
 *
 ...
 */
@interface ABI50_0_0RCTModuleRegistry : NSObject
- (void)setBridge:(ABI50_0_0RCTBridge *)bridge;
- (void)setTurboModuleRegistry:(id<ABI50_0_0RCTTurboModuleRegistry>)turboModuleRegistry;
...
typedef UIView * (^ABI50_0_0RCTBridgelessComponentViewProvider)(NSNumber *);

typedef void (^ABI50_0_0RCTViewRegistryUIBlock)(ABI50_0_0RCTViewRegistry *viewRegistry);

/**
 * A class that allows NativeModules to query for views, given ABI50_0_0React Tags.
 */
@interface ABI50_0_0RCTViewRegistry : NSObject
- (void)setBridge:(ABI50_0_0RCTBridge *)bridge;
...
typedef void (^ABI50_0_0RCTBridgelessJSModuleMethodInvoker)(
    NSString *moduleName,
    NSString *methodName,
    NSArray *args,
 ...
 * as callable with ABI50_0_0React Native.
 */
@interface ABI50_0_0RCTCallableJSModules : NSObject
- (void)setBridge:(ABI50_0_0RCTBridge *)bridge;
- (void)setBridgelessJSModuleMethodInvoker:(ABI50_0_0RCTBridgelessJSModuleMethodInvoker)bridgelessJSModuleMethodInvoker;
