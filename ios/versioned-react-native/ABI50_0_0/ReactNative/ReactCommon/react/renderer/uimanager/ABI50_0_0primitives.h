...
#include <ABI50_0_0React/renderer/core/ABI50_0_0EventHandler.h>
...
inline static InstanceHandle::Shared instanceHandleFromValue(
  ...
  ABI50_0_0React_native_assert(!instanceHandleValue.isNull());
...
inline static int displayModeToInt(const DisplayMode value) {
  ...
  // Libraries/ABI50_0_0ReactNative/DisplayMode.js
  switch (value) {
