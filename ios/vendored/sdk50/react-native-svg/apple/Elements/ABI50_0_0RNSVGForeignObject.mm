...
@implementation ABI50_0_0RNSVGForeignObject
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNSVGForeignObjectProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNSVGForeignObjectComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = static_cast<const ABI50_0_0RNSVGForeignObjectProps &>(*props);

  self.x = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.x)
      ? [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.x)]
      : nil;
  self.y = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.y)
      ? [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.y)]
      : nil;
  if (ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.height)) {
    self.foreignObjectheight = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.height)];
  }
  if (ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.width)) {
    self.foreignObjectwidth = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.width)];
  }

  setCommonGroupProps(newProps, self);
  _props = std::static_pointer_cast<ABI50_0_0RNSVGForeignObjectProps const>(props);
}
...
- (void)setForeignObjectwidth:(ABI50_0_0RNSVGLength *)foreignObjectwidth
{
...
- (void)setForeignObjectheight:(ABI50_0_0RNSVGLength *)foreignObjectheight
{
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNSVGForeignObjectCls(void)
{
  return ABI50_0_0RNSVGForeignObject.class;
}
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
