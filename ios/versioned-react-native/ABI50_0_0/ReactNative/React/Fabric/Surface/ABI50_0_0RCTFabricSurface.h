...
/**
 * (This is Fabric-compatible ABI50_0_0RCTSurface implementation.)
 *
 ...
 */
@interface ABI50_0_0RCTFabricSurface : NSObject <ABI50_0_0RCTSurfaceProtocol>
 ...
 * ABI50_0_0RCTSurface does not control (or influence in any way) the size or origin
...
@interface ABI50_0_0RCTFabricSurface (Internal)

- (const ABI50_0_0facebook::ABI50_0_0React::SurfaceHandler &)surfaceHandler;

@end

@interface ABI50_0_0RCTFabricSurface (Deprecated)
