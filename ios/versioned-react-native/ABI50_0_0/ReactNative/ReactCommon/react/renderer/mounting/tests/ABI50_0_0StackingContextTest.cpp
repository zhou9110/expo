...
TEST_F(StackingContextTest, defaultPropsMakeEverythingFlattened) {
  testViewTree_([](const StubViewTree& viewTree) {
    // 1 view in total.
    ABI50_0_0EXPECT_EQ(viewTree.size(), 1);

    // The root view has no subviews.
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.size(), 0);
  });
}
...
TEST_F(StackingContextTest, mostPropsDoNotForceViewsToMaterialize) {
  ...
  mutateViewShadowNodeProps_(nodeAA_, [](ViewProps& props) {
    ...
    yogaStyle.padding()[ABI50_0_0YGEdgeAll] = ABI50_0_0YGValue{42, ABI50_0_0YGUnitPoint};
    yogaStyle.margin()[ABI50_0_0YGEdgeAll] = ABI50_0_0YGValue{42, ABI50_0_0YGUnitPoint};
...
TEST_F(StackingContextTest, somePropsForceViewsToMaterialize1) {
  ...
  testViewTree_([](const StubViewTree& viewTree) {
    // 4 views in total.
    ABI50_0_0EXPECT_EQ(viewTree.size(), 4);

    // The root view has all 3 subviews.
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.size(), 3);

    // The root view subviews are [3, 5, 7].
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(0)->tag, 3);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(1)->tag, 5);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(2)->tag, 7);
  });
}
...
TEST_F(StackingContextTest, somePropsForceViewsToMaterialize2) {
  ...
  testViewTree_([](const StubViewTree& viewTree) {
    // 10 views in total.
    ABI50_0_0EXPECT_EQ(viewTree.size(), 10);

    // The root view has all 9 subviews.
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.size(), 9);
  });
}
...
TEST_F(StackingContextTest, zIndexAndFlattenedNodes) {
  ...
  testViewTree_([](const StubViewTree& viewTree) {
    // 7 views in total.
    ABI50_0_0EXPECT_EQ(viewTree.size(), 7);

    // The root view has all 6 subviews.
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.size(), 6);

    // The root view subviews are [10, 9, 8, 7, 5, 3].
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(0)->tag, 10);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(1)->tag, 9);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(2)->tag, 8);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(3)->tag, 7);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(4)->tag, 5);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(5)->tag, 3);
  });
  ...
  testViewTree_([](const StubViewTree& viewTree) {
    // 8 views in total.
    ABI50_0_0EXPECT_EQ(viewTree.size(), 8);

    // The root view has 5 subviews.
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.size(), 5);

    // The root view subviews are [6, 10, 9, 5, 3].
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(0)->tag, 6);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(1)->tag, 10);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(2)->tag, 9);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(3)->tag, 5);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(4)->tag, 3);

    auto& view6 = viewTree.getStubView(6);
    ABI50_0_0EXPECT_EQ(view6.children.size(), 2);
    ABI50_0_0EXPECT_EQ(view6.children.at(0)->tag, 8);
    ABI50_0_0EXPECT_EQ(view6.children.at(1)->tag, 7);
  });
  ...
  testViewTree_([](const StubViewTree& viewTree) {
    ...
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(4)->tag, 3);
#else
    ABI50_0_0EXPECT_EQ(viewTree.size(), 5);

    // The root view has all 4 subviews.
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.size(), 4);

    // The root view subviews are [6, 10, 9, 5].
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(0)->tag, 10);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(1)->tag, 9);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(2)->tag, 5);
    ABI50_0_0EXPECT_EQ(viewTree.getRootStubView().children.at(3)->tag, 3);
#endif
  });
}
