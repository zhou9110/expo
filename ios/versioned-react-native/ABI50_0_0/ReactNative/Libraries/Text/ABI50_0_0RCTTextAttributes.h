...
extern NSString *const ABI50_0_0RCTTextAttributesIsHighlightedAttributeName;
extern NSString *const ABI50_0_0RCTTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface ABI50_0_0RCTTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) ABI50_0_0RCTDynamicTypeRamp dynamicTypeRamp;
...
@property (nonatomic, assign) ABI50_0_0RCTTextDecorationLineType textDecorationLine;
// Shadow
...
@property (nonatomic, assign) ABI50_0_0RCTTextTransform textTransform;
