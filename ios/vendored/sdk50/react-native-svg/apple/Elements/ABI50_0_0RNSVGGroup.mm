...
@implementation ABI50_0_0RNSVGGroup {
  ABI50_0_0RNSVGGlyphContext *_glyphContext;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNSVGGroupProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNSVGGroupComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = static_cast<const ABI50_0_0RNSVGGroupProps &>(*props);

  setCommonGroupProps(newProps, self);
  _props = std::static_pointer_cast<ABI50_0_0RNSVGGroupProps const>(props);
}
...
- (void)renderGroupTo:(CGContextRef)context rect:(CGRect)rect
{
  ...
  [self traverseSubviews:^(ABI50_0_0RNSVGView *node) {
    if ([node isKindOfClass:[ABI50_0_0RNSVGMask class]] || [node isKindOfClass:[ABI50_0_0RNSVGClipPath class]]) {
      // no-op
    } else if ([node isKindOfClass:[ABI50_0_0RNSVGNode class]]) {
      ABI50_0_0RNSVGNode *svgNode = (ABI50_0_0RNSVGNode *)node;
      ...
      if ([node isKindOfClass:[ABI50_0_0RNSVGRenderable class]]) {
        [(ABI50_0_0RNSVGRenderable *)node mergeProperties:self];
      }
      ...
      if ([node isKindOfClass:[ABI50_0_0RNSVGRenderable class]]) {
        [(ABI50_0_0RNSVGRenderable *)node resetProperties];
      }
    } else if ([node isKindOfClass:[ABI50_0_0RNSVGSvgView class]]) {
      ABI50_0_0RNSVGSvgView *svgView = (ABI50_0_0RNSVGSvgView *)node;
...
- (void)setupGlyphContext:(CGContextRef)context
{
  ...
  _glyphContext = [[ABI50_0_0RNSVGGlyphContext alloc] initWithWidth:width height:height];
}
...
- (CGPathRef)getPath:(CGContextRef)context
{
  ...
  [self traverseSubviews:^(ABI50_0_0RNSVGNode *node) {
    if ([node isKindOfClass:[ABI50_0_0RNSVGNode class]] && ![node isKindOfClass:[ABI50_0_0RNSVGMask class]]) {
...
- (ABI50_0_0RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
  ...
  if (!event) {
    NSPredicate *const anyActive =
        [NSPredicate predicateWithFormat:@"self isKindOfClass: %@ AND active == TRUE", [ABI50_0_0RNSVGNode class]];
  ...
  for (ABI50_0_0RNSVGView *node in [self.subviews reverseObjectEnumerator]) {
    if ([node isKindOfClass:[ABI50_0_0RNSVGNode class]]) {
      if ([node isKindOfClass:[ABI50_0_0RNSVGMask class]]) {
        continue;
      }
      ABI50_0_0RNSVGNode *svgNode = (ABI50_0_0RNSVGNode *)node;
      if (event) {
      ...
      ABI50_0_0RNSVGPlatformView *hitChild = [svgNode hitTest:transformed withEvent:event];
      if (hitChild) {
        svgNode.active = YES;
      ...
      ABI50_0_0RNSVGSvgView *svgView = (ABI50_0_0RNSVGSvgView *)node;
      ABI50_0_0RNSVGPlatformView *hitChild = [svgView hitTest:transformed withEvent:event];
      if (hitChild) {
        return hitChild;
      }
    }
  ...
  ABI50_0_0RNSVGPlatformView *hitSelf = [super hitTest:transformed withEvent:event];
  if (hitSelf) {
    return hitSelf;
  }
...
{
  [self traverseSubviews:^(__kindof ABI50_0_0RNSVGNode *node) {
    if ([node isKindOfClass:[ABI50_0_0RNSVGRenderable class]]) {
      [(ABI50_0_0RNSVGRenderable *)node resetProperties];
    }
    return YES;
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNSVGGroupCls(void)
{
  return ABI50_0_0RNSVGGroup.class;
}
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
