...
#import "ABI50_0_0RCTWrapperViewController.h"
...
@implementation ABI50_0_0RCTWrapperViewController {
  UIView *_wrapperView;
  UIView *_contentView;
...
{
  ABI50_0_0RCTAssertParam(contentView);
...
ABI50_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithNibName : (NSString *)nn bundle : (NSBundle *)nb)
...
static BOOL ABI50_0_0RCTFindScrollViewAndRefreshContentInsetInView(UIView *view)
{
  if ([view conformsToProtocol:@protocol(ABI50_0_0RCTAutoInsetsProtocol)]) {
    [(id<ABI50_0_0RCTAutoInsetsProtocol>)view refreshContentInset];
    return YES;
  }
  for (UIView *subview in view.subviews) {
    if (ABI50_0_0RCTFindScrollViewAndRefreshContentInsetInView(subview)) {
      return YES;
    }
  }
  return NO;
...
- (void)viewDidLayoutSubviews
{
  ...
  if (_previousTopInset != _currentTopInset || _previousBottomInset != _currentBottomInset) {
    ABI50_0_0RCTFindScrollViewAndRefreshContentInsetInView(_contentView);
...
- (void)loadView
{
  ...
  //`contentView` which is a ABI50_0_0React-managed view.
