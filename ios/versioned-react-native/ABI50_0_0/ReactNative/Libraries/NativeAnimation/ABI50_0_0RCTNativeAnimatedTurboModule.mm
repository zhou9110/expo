...
#import <ABI50_0_0React/ABI50_0_0RCTNativeAnimatedTurboModule.h>

#import "ABI50_0_0RCTAnimationPlugins.h"

typedef void (^AnimatedOperation)(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager);

@interface ABI50_0_0RCTNativeAnimatedTurboModule () <ABI50_0_0NativeAnimatedModuleSpec, ABI50_0_0RCTInitializing>
@end

@implementation ABI50_0_0RCTNativeAnimatedTurboModule {
  ABI50_0_0RCTNativeAnimatedNodesManager *_nodesManager;
...
- (void)initialize
{
  ...
  _nodesManager = [[ABI50_0_0RCTNativeAnimatedNodesManager alloc] initWithBridge:nil surfacePresenter:_surfacePresenter];
...
ABI50_0_0RCT_EXPORT_METHOD(startOperationBatch)
{
  // TODO T71377585
}

ABI50_0_0RCT_EXPORT_METHOD(finishOperationBatch)
{
  // TODO T71377585
}

ABI50_0_0RCT_EXPORT_METHOD(createAnimatedNode : (double)tag config : (NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager createAnimatedNode:[NSNumber numberWithDouble:tag] config:config];
  }];
}

ABI50_0_0RCT_EXPORT_METHOD(updateAnimatedNodeConfig : (double)tag config : (NSDictionary<NSString *, id> *)config)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(connectAnimatedNodes : (double)parentTag childTag : (double)childTag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodes : (double)parentTag childTag : (double)childTag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(startAnimatingNode
...
ABI50_0_0RCT_EXPORT_METHOD(stopAnimation : (double)animationId)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(setAnimatedNodeValue : (double)nodeTag value : (double)value)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager setAnimatedNodeValue:[NSNumber numberWithDouble:nodeTag] value:[NSNumber numberWithDouble:value]];
  }];
  // In Bridge, flushing of native animations is done from ABI50_0_0RCTCxxBridge batchDidComplete().
  // Since ABI50_0_0RCTCxxBridge doesn't exist in Bridgeless, and components are not remounted in Fabric for native animations,
  // flush here for changes in Animated.Value for Animated.event.
  [self flushOperationQueues];
}

ABI50_0_0RCT_EXPORT_METHOD(setAnimatedNodeOffset : (double)nodeTag offset : (double)offset)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(flattenAnimatedNodeOffset : (double)nodeTag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(extractAnimatedNodeOffset : (double)nodeTag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(connectAnimatedNodeToView : (double)nodeTag viewTag : (double)viewTag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(disconnectAnimatedNodeFromView : (double)nodeTag viewTag : (double)viewTag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(restoreDefaultValues : (double)nodeTag)
{
  [self addPreOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager restoreDefaultValues:[NSNumber numberWithDouble:nodeTag]];
  }];
}

ABI50_0_0RCT_EXPORT_METHOD(dropAnimatedNode : (double)tag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(startListeningToAnimatedNodeValue : (double)tag)
{
  __weak id<ABI50_0_0RCTValueAnimatedNodeObserver> valueObserver = self;
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
    [nodesManager startListeningToAnimatedNodeValue:[NSNumber numberWithDouble:tag] valueObserver:valueObserver];
  }];
}

ABI50_0_0RCT_EXPORT_METHOD(stopListeningToAnimatedNodeValue : (double)tag)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(addAnimatedEventToView
                  : (double)viewTag eventName
                  : (nonnull NSString *)eventName eventMapping
                  : (ABI50_0_0JS::NativeAnimatedModule::EventMapping &)eventMapping)
{
  NSMutableDictionary *eventMappingDict = [NSMutableDictionary new];
  eventMappingDict[@"nativeEventPath"] = ABI50_0_0RCTConvertVecToArray(eventMapping.nativeEventPath());
...
ABI50_0_0RCT_EXPORT_METHOD(removeAnimatedEventFromView
                  : (double)viewTag eventName
...
ABI50_0_0RCT_EXPORT_METHOD(getValue : (double)nodeTag saveValueCallback : (ABI50_0_0RCTResponseSenderBlock)saveValueCallback)
{
  [self addOperationBlock:^(ABI50_0_0RCTNativeAnimatedNodesManager *nodesManager) {
...
ABI50_0_0RCT_EXPORT_METHOD(queueAndExecuteBatchedOperations : (NSArray *)operationsAndArgs)
{
...
#pragma mark - ABI50_0_0RCTSurfacePresenterObserver
...
{
  return std::make_shared<ABI50_0_0facebook::ABI50_0_0React::NativeAnimatedModuleSpecJSI>(params);
}

@end

Class ABI50_0_0RCTNativeAnimatedTurboModuleCls(void)
{
  return ABI50_0_0RCTNativeAnimatedTurboModule.class;
}
