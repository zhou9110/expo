...
class CodegenUtilsTests < Test::Unit::TestCase
    ...
    def testGenerateReactCodegenPodspec_whenItHasBeenAlreadyGenerated_doesNothing
        ...
        # Assert
        assert_equal(Pod::UI.collected_messages, ["[Codegen] Skipping ABI50_0_0React-Codegen podspec generation."])
    ...
    def testGenerateReactCodegenPodspec_whenItHasNotBeenAlreadyGenerated_generatesIt
        ...
        assert_equal(Pod::UI.collected_messages, ["[Codegen] Generating ~/app/ios/build/ABI50_0_0React-Codegen.podspec.json"])
        assert_equal(FileMock.open_files_with_mode["~/app/ios/build/ABI50_0_0React-Codegen.podspec.json"], 'w')
    ...
    def testGetReactCodegenSpec_whenFabricEnabledAndScriptPhases_generatesAPodspec
        ...
        assert_equal(Pod::UI.collected_messages, ["[Codegen] Adding script_phases to ABI50_0_0React-Codegen."])
    end
    ...
    def testUseReactCodegenDiscovery_whenParametersAreGood_executeCodegen
        ...
        codegen_spec = {"name" => "ABI50_0_0React-Codegen"}
        ...
        assert_equal(codegen_utils_mock.generate_react_codegen_spec_params,  [{
            ...
            :react_codegen_spec=>{"name"=>"ABI50_0_0React-Codegen"}
        }])
        assert_equal(Pod::Executable.executed_commands, [
            {
                "command" => "node",
