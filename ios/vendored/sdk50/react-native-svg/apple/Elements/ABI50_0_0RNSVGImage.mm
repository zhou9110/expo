...
#if __has_include(<ABI50_0_0React/ABI50_0_0RCTImageLoader.h>)
...
#import <ABI50_0_0React/ABI50_0_0RCTImageResponseObserverProxy.h>
#import <ABI50_0_0React/ABI50_0_0RCTImageSource.h>
#import <react/renderer/components/rnsvg/ComponentDescriptors.h>
#import <react/renderer/components/view/conversions.h>
#import <react/renderer/imagemanager/ABI50_0_0RCTImagePrimitivesConversions.h>
#import <rnsvg/ABI50_0_0RNSVGImageComponentDescriptor.h>
#import "ABI50_0_0RNSVGFabricConversions.h"

using namespace ABI50_0_0facebook::ABI50_0_0React;
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED

@implementation ABI50_0_0RNSVGImage {
  CGImageRef _image;
  CGSize _imageSize;
  ABI50_0_0RCTImageLoaderCancellationBlock _reloadImageCancellationBlock;

#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
  ABI50_0_0RNSVGImageShadowNode::ConcreteState::Shared _state;
  ABI50_0_0RCTImageResponseObserverProxy _imageResponseObserverProxy;
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
}
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNSVGImageProps>();
    _props = defaultProps;

    _imageResponseObserverProxy = ABI50_0_0RCTImageResponseObserverProxy(self);
  }
  return self;
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNSVGImageComponentDescriptor>();
}

- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  const auto &newProps = static_cast<const ABI50_0_0RNSVGImageProps &>(*props);
  ...
  if (ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.height)) {
    self.imageheight = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.height)];
  }
  if (ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.width)) {
    self.imagewidth = [ABI50_0_0RNSVGLength lengthWithString:ABI50_0_0RCTNSStringFromString(newProps.width)];
  }
  self.align = ABI50_0_0RCTNSStringFromStringNilIfEmpty(newProps.align);
  self.meetOrSlice = intToRNSVGVBMOS(newProps.meetOrSlice);

  setCommonRenderableProps(newProps, self);
  _props = std::static_pointer_cast<ABI50_0_0RNSVGImageProps const>(props);
}

- (void)updateState:(State::Shared const &)state oldState:(State::Shared const &)oldState
{
  ABI50_0_0RCTAssert(state, @"`state` must not be null.");
  ABI50_0_0RCTAssert(
      std::dynamic_pointer_cast<ABI50_0_0RNSVGImageShadowNode::ConcreteState const>(state),
      @"`state` must be a pointer to `ABI50_0_0RNSVGImageShadowNode::ConcreteState`.");

  auto oldImageState = std::static_pointer_cast<ABI50_0_0RNSVGImageShadowNode::ConcreteState const>(_state);
  auto newImageState = std::static_pointer_cast<ABI50_0_0RNSVGImageShadowNode::ConcreteState const>(state);

  [self _setStateAndResubscribeImageResponseObserver:newImageState];
}

- (void)_setStateAndResubscribeImageResponseObserver:(ABI50_0_0RNSVGImageShadowNode::ConcreteState::Shared const &)state
{
  if (_state) {
...
#pragma mark - ABI50_0_0RCTImageResponseDelegate
...
- (void)setSrc:(ABI50_0_0RCTImageSource *)src
{
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
#else
  if (src == _src) {
  ...
  ABI50_0_0RCTImageLoaderCancellationBlock previousCancellationBlock = _reloadImageCancellationBlock;
...
- (void)setImagewidth:(ABI50_0_0RNSVGLength *)width
{
...
- (void)setImageheight:(ABI50_0_0RNSVGLength *)height
{
...
- (void)renderLayerTo:(CGContextRef)context rect:(CGRect)rect
{
  ...
  CGAffineTransform viewbox = [ABI50_0_0RNSVGViewBox getTransform:imageBounds
                                                   eRect:hitArea
                                                   align:self.align
...
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNSVGImageCls(void)
{
  return ABI50_0_0RNSVGImage.class;
}
#endif // ABI50_0_0RCT_NEW_ARCH_ENABLED
