...
typedef dispatch_block_t ABI50_0_0RCTUIManagerMountingBlock;
 ...
 */
@protocol ABI50_0_0RCTUIManagerObserver <NSObject>
 ...
 * some components which have own ABI50_0_0React-independent state can compute and cache
...
/**
 * Simple helper which take care of ABI50_0_0RCTUIManager's observers.
 */
@interface ABI50_0_0RCTUIManagerObserverCoordinator : NSObject <ABI50_0_0RCTUIManagerObserver>

/**
 * Add a UIManagerObserver. See the `ABI50_0_0RCTUIManagerObserver` protocol for more info.
