...
typedef id<ABI50_0_0RCTBridgeModule> (^ABI50_0_0RCTBridgeModuleProvider)(void);

@interface ABI50_0_0RCTModuleData : NSObject <ABI50_0_0RCTInvalidating>
...
- (instancetype)initWithModuleClass:(Class)moduleClass
            ...
            viewRegistry_DEPRECATED:(ABI50_0_0RCTViewRegistry *)viewRegistry_DEPRECATED
                      bundleManager:(ABI50_0_0RCTBundleManager *)bundleManager
                  callableJSModules:(ABI50_0_0RCTCallableJSModules *)callableJSModules NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, readonly) NSArray<id<ABI50_0_0RCTBridgeMethod>> *methods;

/**
 * Returns a map of the module methods. Note that this will gather the methods the first
 * time it is called and then memoize the results.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, id<ABI50_0_0RCTBridgeMethod>> *methodsByName;
 ...
 */
@property (nonatomic, strong, readwrite) id<ABI50_0_0RCTBridgeModule> instance;
