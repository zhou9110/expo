...
#import <ABI50_0_0Expo/ABI50_0_0EXAppDefinesLoader.h>
...
@implementation ABI50_0_0EXAppDefinesLoader

+ (void)load
{
  BOOL APP_DEBUG;
  [ABI50_0_0EXAppDefines load:@{
#if DEBUG
    @"APP_DEBUG": @(YES),
#else
    @"APP_DEBUG": @(NO),
#endif
    @"APP_RCT_DEBUG": @(ABI50_0_0RCT_DEBUG),
    @"APP_RCT_DEV": @(ABI50_0_0RCT_DEV),
