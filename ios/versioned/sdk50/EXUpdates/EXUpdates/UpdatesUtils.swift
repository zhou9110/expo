...
@objc(ABI50_0_0EXUpdatesUtils)
@objcMembers
public final class UpdatesUtils: NSObject {
  private static let ABI50_0_0EXUpdatesUtilsErrorDomain = "ABI50_0_0EXUpdatesUtils"
  ...
  public static func initializeUpdatesDirectory() throws -> URL {
    ...
    if exists {
      if !isDir.boolValue {
        throw NSError(
          domain: ABI50_0_0EXUpdatesUtilsErrorDomain,
          code: 1005,
          userInfo: [
...
#if ABI50_0_0EX_UPDATES_NATIVE_DEBUG
    return true
#else
    return false
#endif
