...
class ABI50_0_0RNSkInfoObject : public ABI50_0_0RNJsi::JsiHostObject {
public:
  ...
  JSI_EXPORT_PROPERTY_GETTERS(JSI_EXPORT_PROP_GET(ABI50_0_0RNSkInfoObject, width),
                              JSI_EXPORT_PROP_GET(ABI50_0_0RNSkInfoObject, height),
                              JSI_EXPORT_PROP_GET(ABI50_0_0RNSkInfoObject, timestamp),
                              JSI_EXPORT_PROP_GET(ABI50_0_0RNSkInfoObject, touches))
  ...
  ABI50_0_0RNSkInfoObject() : JsiHostObject() {}
