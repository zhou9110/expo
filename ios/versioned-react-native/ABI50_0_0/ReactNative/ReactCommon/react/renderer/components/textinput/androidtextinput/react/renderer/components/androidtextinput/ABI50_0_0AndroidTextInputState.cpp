...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(mostRecentEventCount),
      ...
      ABI50_0_0ReactTreeAttributedString(std::move(ABI50_0_0ReactTreeAttributedString)),
...
AndroidTextInputState::AndroidTextInputState(
    ...
    : mostRecentEventCount(data.getDefault(
      ...
      ABI50_0_0ReactTreeAttributedString(previousState.ABI50_0_0ReactTreeAttributedString),
