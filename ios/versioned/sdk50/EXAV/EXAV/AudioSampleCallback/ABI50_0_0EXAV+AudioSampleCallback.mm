...
#import <ABI50_0_0EXAV/AudioSampleCallbackWrapper.h>

namespace jsi = ABI50_0_0facebook::jsi;
using CallInvoker = ABI50_0_0facebook::ABI50_0_0React::CallInvoker;
using namespace ABI50_0_0expo::av;
...
@implementation ABI50_0_0EXAV (AudioSampleCallback)

- (void)installJSIBindingsForRuntime:(void *)jsRuntimePtr
                 withSoundDictionary:(NSMutableDictionary <NSNumber *, ABI50_0_0EXAVPlayerData *> *)soundDictionary
{
  ...
  auto setAudioSampleCallback = [weakCallInvoker, weakSoundDictionary](jsi::Runtime &runtime,
    ...
    if (argsCount > 1 && args[1].isObject()) {
      ...
      ABI50_0_0EXAudioSampleCallback* objcWrapper = [[ABI50_0_0EXAudioSampleCallback alloc] initWithCallbackWrapper:(std::move(wrapper))];
