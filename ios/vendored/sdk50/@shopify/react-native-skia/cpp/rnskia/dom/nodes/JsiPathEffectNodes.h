...
public:
  JsiBasePathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
                        const char *type)
...
public:
  explicit JsiDashPathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiCornerPathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiPath1DPathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiPath2DPathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiLine2DPathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiSumPathEffectNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
