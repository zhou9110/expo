...
@interface NSString (ABI50_0_0RNSStringUtil)

+ (BOOL)ABI50_0_0RNSisBlank:(NSString *)string;

@end

@interface ABI50_0_0RNSScreenStackHeaderConfig :
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
...
@property (nonatomic, weak) ABI50_0_0RNSScreenView *screenView;
...
@interface ABI50_0_0RNSScreenStackHeaderConfigManager : ABI50_0_0RCTViewManager

@end

@interface ABI50_0_0RCTConvert (ABI50_0_0RNSScreenStackHeader)
