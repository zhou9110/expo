...
@implementation ABI50_0_0EXNotificationCategoriesModule

ABI50_0_0EX_EXPORT_MODULE(ExpoNotificationCategoriesModule);

# pragma mark - Exported methods

ABI50_0_0EX_EXPORT_METHOD_AS(getNotificationCategoriesAsync,
                 getNotificationCategoriesAsyncWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
...
ABI50_0_0EX_EXPORT_METHOD_AS(setNotificationCategoryAsync,
                 setNotificationCategoryWithCategoryId:(NSString *)categoryId
                 actions:(NSArray *)actions
                 options:(NSDictionary *)options
                 resolve:(ABI50_0_0EXPromiseResolveBlock)resolve reject:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  UNNotificationCategory *newCategory = [ABI50_0_0EXNotificationCategoriesModule createCategoryWithId:categoryId
                                                                                     actions:actions
                                                                                     options:options];
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteNotificationCategoryAsync,
