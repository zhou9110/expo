...
@interface ABI50_0_0EXScopedNotificationBuilder ()
...
@implementation ABI50_0_0EXScopedNotificationBuilder
...
- (UNNotificationContent *)notificationContentFromRequest:(NSDictionary *)request
{
  ...
  if (content.categoryIdentifier && _isInExpoGo) {
    NSString *scopedCategoryIdentifier = [ABI50_0_0EXScopedNotificationsUtils scopedIdentifierFromId:content.categoryIdentifier
