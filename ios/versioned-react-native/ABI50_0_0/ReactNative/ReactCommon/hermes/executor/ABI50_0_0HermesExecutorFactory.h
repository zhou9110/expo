...
class HermesExecutorFactory : public JSExecutorFactory {
 public:
  explicit HermesExecutorFactory(
      ...
      ::ABI50_0_0hermes::vm::RuntimeConfig runtimeConfig = defaultRuntimeConfig())
 ...
 private:
  static ::ABI50_0_0hermes::vm::RuntimeConfig defaultRuntimeConfig();

  JSIExecutor::RuntimeInstaller runtimeInstaller_;
  JSIScopedTimeoutInvoker timeoutInvoker_;
  ::ABI50_0_0hermes::vm::RuntimeConfig runtimeConfig_;
  bool enableDebugger_ = true;
  std::string debuggerName_ = "Hermes ABI50_0_0React Native";
};
