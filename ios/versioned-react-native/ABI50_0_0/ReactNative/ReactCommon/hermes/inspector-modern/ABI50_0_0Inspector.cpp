...
#include "ABI50_0_0Inspector.h"
#include "ABI50_0_0Exceptions.h"
#include "ABI50_0_0InspectorState.h"
...
// likely specific to the version of folly ABI50_0_0RN uses, so may need to be
// changed.  Even better, perhaps folly can be refactored to simplify
// this.  Providing a ABI50_0_0RN-specific Timekeeper impl may also help.
