...
#include "ABI50_0_0ErrorUtils.h"
#include "ABI50_0_0JSBigString.h"
#include "ABI50_0_0JSBundleType.h"
#include "ABI50_0_0JSExecutor.h"
#include "ABI50_0_0MessageQueueThread.h"
#include "ABI50_0_0MethodCall.h"
#include "ABI50_0_0NativeToJsBridge.h"
#include "ABI50_0_0RAMBundleRegistry.h"
#include "ABI50_0_0RecoverableError.h"
#include "ABI50_0_0SystraceSection.h"

#include <ABI50_0_0cxxreact/ABI50_0_0JSIndexedRAMBundle.h>
    ...
    if (auto strongNativeToJsBridge = weakNativeToJsBridge.lock()) {
      strongNativeToJsBridge->runOnExecutorQueue(
          [callback = std::move(callback)](JSExecutor* executor) {
            ...
            try {
              ABI50_0_0React_native_assert(runtime != nullptr);
              callback(*runtime);
              executor->flush();
...
void Instance::JSCallInvoker::invokeAsync(std::function<void()>&& work) {
   ...
   *    is initialized. ABI50_0_0RCTDevLoadingView shows bundle download progress.
