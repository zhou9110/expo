...
#import "ABI50_0_0RNSVGGroupManager.h"
#import "ABI50_0_0RNSVGCGFCRule.h"
#import "ABI50_0_0RNSVGGroup.h"

@implementation ABI50_0_0RNSVGGroupManager

ABI50_0_0RCT_EXPORT_MODULE()

- (ABI50_0_0RNSVGNode *)node
{
  return [ABI50_0_0RNSVGGroup new];
}

ABI50_0_0RCT_EXPORT_VIEW_PROPERTY(font, NSDictionary)

ABI50_0_0RCT_CUSTOM_VIEW_PROPERTY(fontSize, id, ABI50_0_0RNSVGGroup)
{
...
ABI50_0_0RCT_CUSTOM_VIEW_PROPERTY(fontWeight, id, ABI50_0_0RNSVGGroup)
{
  if ([json isKindOfClass:[NSString class]]) {
    NSString *stringValue = (NSString *)json;
