...
#import <ABI50_0_0React/ABI50_0_0RCTGenericDelegateSplitter.h>
 ...
 */
@interface ABI50_0_0RCTScrollViewComponentView : ABI50_0_0RCTViewComponentView <ABI50_0_0RCTMountingTransactionObserving>

/*
 * Finds and returns the closet ABI50_0_0RCTScrollViewComponentView component to the given view
 */
+ (nullable ABI50_0_0RCTScrollViewComponentView *)findScrollViewComponentViewForView:(UIView *)view;
...
/*
 * ABI50_0_0RCTScrollableProtocol is a protocol which ABI50_0_0RCTScrollViewManager uses to communicate with all kinds of `UIScrollView`s.
 ...
 */
@interface ABI50_0_0RCTScrollViewComponentView (ScrollableProtocol) <ABI50_0_0RCTScrollableProtocol>
