 ...
 * This is most useful for registering a lambda as a ABI50_0_0RN method.  There
...
class CxxModule {
 ...
 public:
   ...
   */
  void setInstance(std::weak_ptr<ABI50_0_0React::Instance> instance) {
    instance_ = instance;
  }
   ...
   */
  std::weak_ptr<ABI50_0_0React::Instance> getInstance() {
    return instance_;
  }

 private:
  std::weak_ptr<ABI50_0_0React::Instance> instance_;
};
