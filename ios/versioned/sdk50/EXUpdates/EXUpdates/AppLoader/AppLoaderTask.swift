...
@objc(ABI50_0_0EXUpdatesAppLoaderTaskDelegate)
...
@objc(ABI50_0_0EXUpdatesBackgroundUpdateStatus)
 ...
 *   be sent to JS.
 */
@objc(ABI50_0_0EXUpdatesAppLoaderTask)
@objcMembers
public final class AppLoaderTask: NSObject {
  private static let ErrorDomain = "ABI50_0_0EXUpdatesAppLoaderTask"
