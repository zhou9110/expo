...
@implementation ABI50_0_0RNSVGContextBrush {
  BOOL _isStroke;
}
...
{
  ABI50_0_0RNSVGRenderable *element = ABI50_0_0RNSVGRenderable.contextElement;
  if (!element) {
    return NO;
  }

  ABI50_0_0RNSVGBrush *brush = _isStroke ? element.stroke : element.fill;

  BOOL fillColor;

  if (brush.class == ABI50_0_0RNSVGBrush.class) {
