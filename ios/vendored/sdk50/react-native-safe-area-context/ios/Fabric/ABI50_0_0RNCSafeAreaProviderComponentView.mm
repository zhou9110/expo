...
@interface ABI50_0_0RNCSafeAreaProviderComponentView () <ABI50_0_0RCTRNCSafeAreaProviderViewProtocol>
@end

@implementation ABI50_0_0RNCSafeAreaProviderComponentView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const ABI50_0_0RNCSafeAreaProviderProps>();
    _props = defaultProps;
...
- (void)invalidateSafeAreaInsets
{
  ...
  if (_eventEmitter) {
    ABI50_0_0RNCSafeAreaProviderEventEmitter::OnInsetsChange event = {
        .insets =
            {
    ...
    std::static_pointer_cast<ABI50_0_0RNCSafeAreaProviderEventEmitter const>(_eventEmitter)->onInsetsChange(event);
  }
}
...
{
  return concreteComponentDescriptorProvider<ABI50_0_0RNCSafeAreaProviderComponentDescriptor>();
}
...
Class<ABI50_0_0RCTComponentViewProtocol> ABI50_0_0RNCSafeAreaProviderCls(void)
{
  return ABI50_0_0RNCSafeAreaProviderComponentView.class;
}
