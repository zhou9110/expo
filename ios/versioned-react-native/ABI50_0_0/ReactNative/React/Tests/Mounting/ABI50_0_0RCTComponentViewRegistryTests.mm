...
@interface ABI50_0_0RCTComponentViewRegistryTests : XCTestCase
@end

using namespace ABI50_0_0facebook::ABI50_0_0React;

@implementation ABI50_0_0RCTComponentViewRegistryTests {
  ABI50_0_0RCTComponentViewRegistry *_componentViewRegistry;
}
...
- (void)setUp
{
  ...
  [_componentViewRegistry.componentViewFactory registerComponentViewClass:[ABI50_0_0RCTViewComponentView class]];
}
...
- (void)testComponentViewDescriptorWithTag
{
  ...
  auto newViewDescriptor = [_componentViewRegistry
      dequeueComponentViewWithComponentHandle:[ABI50_0_0RCTViewComponentView componentDescriptorProvider].handle
                                          tag:existingTag];
...
- (void)testDequeueAndEnqueue
{
  ...
  XCTAssertThrows(
      ^{
        Tag nonExistingTag = 12;
        [self->_componentViewRegistry
            enqueueComponentViewWithComponentHandle:[ABI50_0_0RCTViewComponentView componentDescriptorProvider].handle
                                                tag:nonExistingTag
