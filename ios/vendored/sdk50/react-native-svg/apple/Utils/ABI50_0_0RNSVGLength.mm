...
@implementation ABI50_0_0RNSVGLength
...
{
  ABI50_0_0RNSVGLength *length = [[self alloc] init];
...
+ (instancetype)lengthWithString:(NSString *)lengthString
{
  ...
  ABI50_0_0RNSVGLength *output = [ABI50_0_0RNSVGLength alloc];
  if (stringLength == 0) {
    ...
    ABI50_0_0RNSVGLengthUnitType unit = SVG_LENGTHTYPE_NUMBER;
