 ...
 */
class ABI50_0_0RNSkComputedValue : public ABI50_0_0RNSkReadonlyValue {
public:
  ABI50_0_0RNSkComputedValue(std::shared_ptr<ABI50_0_0RNSkPlatformContext> platformContext,
  ...
  void invalidate() override {
    ABI50_0_0RNSkReadonlyValue::invalidate();
  ...
  void initializeDependencies(jsi::Runtime &runtime,
    ...
    // Save dependencies
    std::vector<std::shared_ptr<ABI50_0_0RNSkReadonlyValue>> dependencies;
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      auto value =
          dep.asObject(runtime).asHostObject<ABI50_0_0RNSkReadonlyValue>(runtime);
      if (value == nullptr) {
        continue;
      }
    ...
    for (const auto &dep : dependencies) {
      _unsubscribers.push_back(dep->addListener([weakSelf = weak_from_this()](
        ...
        if (self) {
          auto selfAsThis = std::dynamic_pointer_cast<ABI50_0_0RNSkComputedValue>(self);
