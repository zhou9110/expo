...
// Interface for ABI50_0_0EXTaskManager module.

@protocol ABI50_0_0EXTaskManagerInterface
 ...
 *  or given consumer class doesn't conform to ABI50_0_0EXTaskConsumerInterface protocol.
 */
