    ...
    data: [
      {
        ...
        uri: 'https://www.svgrepo.com/show/4733/samples.svg',
      },
      require('../../../assets/images/expo.svg'),
      require('../../../assets/images/code.svg'),
      require('../../../assets/images/sdk.svg'),
      {
        uri: 'https://raw.githubusercontent.com/ide/expo-image-gallery/main/assets/images/sdk.svg',
      },
      {
        uri: 'https://d4rgq65mqvxhk.cloudfront.net/public/gift_icons/officialGift%2378548ed1-9c95-4634-b355-ca8c2a53da4f.svg',
      },
      {
        uri: 'https://s3-symbol-logo.tradingview.com/apple--big.svg',
      },
    ],
  },
  {
...
function renderItem({ item }: SectionListRenderItemInfo<ImageSource>) {
  ...
  return (
    <Image
      ...
      onLoadEnd={() => {
        console.log('load', performance.now() - timeStart);
      }}
      // tintColor="blue"
    />
  );
