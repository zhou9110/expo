 ...
 *
 * # Usecases
 * ABI50_0_0React Native platform-specific mounting layer has limitations when it comes to notifying view components about
 ...
 * required.
 * - Alternatively, an observer can be registered explicitly via `ABI50_0_0RCTSurface`.
 *
 ...
 */
@protocol ABI50_0_0RCTMountingTransactionObserving <NSObject>
 ...
 */
- (void)mountingTransactionDidMount:(const ABI50_0_0facebook::ABI50_0_0React::MountingTransaction &)transaction
               withSurfaceTelemetry:(const ABI50_0_0facebook::ABI50_0_0React::SurfaceTelemetry &)surfaceTelemetry;
