...
#import <ABI50_0_0React/ABI50_0_0RCTBackedTextInputDelegateAdapter.h>
#import <ABI50_0_0React/ABI50_0_0RCTTextAttributes.h>

@implementation ABI50_0_0RCTUITextView {
  UILabel *_placeholderView;
  UITextView *_detachedTextView;
  ABI50_0_0RCTBackedTextViewDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI50_0_0RCTBackedTextViewDelegateAdapter alloc] initWithTextView:self];
...
{
  // Delegate is set inside `[ABI50_0_0RCTBackedTextViewDelegateAdapter initWithTextView]` and
...
- (CGSize)placeholderSize
{
  ...
  CGSize placeholderSize = [placeholder boundingRectWithSize:maxPlaceholderSize
                                                  ...
                                                  attributes:[self _placeholderTextAttributes]
                                                     context:nil]
                               .size;
  placeholderSize = CGSizeMake(ABI50_0_0RCTCeilPixelValue(placeholderSize.width), ABI50_0_0RCTCeilPixelValue(placeholderSize.height));
