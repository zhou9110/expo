...
#import "ABI50_0_0RCTMultipartStreamReader.h"
#import <QuartzCore/QuartzCore.h>

#define CRLF @"\r\n"

@implementation ABI50_0_0RCTMultipartStreamReader {
...
- (void)emitChunk:(NSData *)data headers:(NSDictionary *)headers callback:(ABI50_0_0RCTMultipartCallback)callback done:(BOOL)done
{
...
- (void)emitProgress:(NSDictionary *)headers
       contentLength:(NSUInteger)contentLength
               final:(BOOL)final
            callback:(ABI50_0_0RCTMultipartProgressCallback)callback
{
  if (headers == nil) {
    return;
  }
