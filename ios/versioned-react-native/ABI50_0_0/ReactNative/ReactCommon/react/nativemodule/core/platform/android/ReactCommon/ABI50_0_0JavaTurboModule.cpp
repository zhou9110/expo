...
#include <ABI50_0_0ReactCommon/ABI50_0_0TurboModulePerfLogger.h>
#include <ABI50_0_0ReactCommon/ABI50_0_0TurboModuleUtils.h>
#include <ABI50_0_0jsi/ABI50_0_0JSIDynamic.h>
#include <ABI50_0_0React/debug/ABI50_0_0React_native_assert.h>
#include <ABI50_0_0React/jni/ABI50_0_0NativeMap.h>
#include <ABI50_0_0React/jni/ABI50_0_0ReadableNativeMap.h>
#include <ABI50_0_0React/jni/ABI50_0_0WritableNativeMap.h>
...
std::string stringifyJSIValue(const jsi::Value& v, jsi::Runtime* rt = nullptr) {
  ...
  ABI50_0_0React_native_assert(v.isObject() && "Expecting object.");
...
JNIArgs convertJSIArgsToJNIArgs(
  ...
  for (unsigned int argIndex = 0; argIndex < count; argIndex += 1) {
    ...
    if (arg->isNull() || arg->isUndefined()) {
    ...
    } else if (type == "Lcom/facebook/ABI50_0_0React/bridge/Callback;") {
      ...
      jarg->l = makeGlobalIfNecessary(
          createJavaCallbackFromJSIFunction(std::move(fn), rt, jsInvoker)
              .release());
    } else if (type == "Lcom/facebook/ABI50_0_0React/bridge/ReadableArray;") {
    ...
    } else if (type == "Lcom/facebook/ABI50_0_0React/bridge/ReadableMap;") {
      if (!(arg->isObject())) {
        throw JavaTurboModuleArgumentConversionException(
...
jsi::Value convertFromJMapToValue(JNIEnv* env, jsi::Runtime& rt, jobject arg) {
  ...
  jclass jArguments = env->FindClass("com/facebook/ABI50_0_0React/bridge/Arguments");
  static jmethodID jMakeNativeMap = env->GetStaticMethodID(
      jArguments,
      "makeNativeMap",
      "(Ljava/util/Map;)Lcom/facebook/ABI50_0_0React/bridge/WritableNativeMap;");
      ...
      jsi::Function promiseConstructorArg = jsi::Function::createFromHostFunction(
          ...
          [this,
           ...
           env](
            ...
            jclass jPromiseImpl =
                env->FindClass("com/facebook/ABI50_0_0React/bridge/PromiseImpl");
            jmethodID jPromiseImplConstructor = env->GetMethodID(
                jPromiseImpl,
                "<init>",
                "(Lcom/facebook/ABI50_0_0React/bridge/Callback;Lcom/facebook/ABI50_0_0React/bridge/Callback;)V");
