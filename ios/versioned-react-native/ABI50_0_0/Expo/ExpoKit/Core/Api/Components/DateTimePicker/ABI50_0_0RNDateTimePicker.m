...
@interface ABI50_0_0RNDateTimePicker ()

@property (nonatomic, copy) ABI50_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, copy) ABI50_0_0RCTBubblingEventBlock onPickerDismiss;
@property (nonatomic, assign) NSInteger ABI50_0_0ReactMinuteInterval;

@end

@implementation ABI50_0_0RNDateTimePicker

- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    #ifndef ABI50_0_0RCT_NEW_ARCH_ENABLED
      // somehow, with Fabric, the callbacks are executed here as well as in ABI50_0_0RNDateTimePickerComponentView
    ...
    _ABI50_0_0ReactMinuteInterval = 1;
  }
  return self;
}
...
- (void)onDismiss:(ABI50_0_0RNDateTimePicker *)sender
{
  if (_onPickerDismiss) {
    _onPickerDismiss(@{});
  }
...
- (void)setDatePickerMode:(UIDatePickerMode)datePickerMode
{
  ...
  self.minuteInterval = _ABI50_0_0ReactMinuteInterval;
}

- (void)setMinuteInterval:(NSInteger)minuteInterval
{
  [super setMinuteInterval:minuteInterval];
  _ABI50_0_0ReactMinuteInterval = minuteInterval;
}
