...
#include "ABI50_0_0EventTarget.h"
...
void EventTarget::retain(jsi::Runtime& runtime) const {
  ...
  // TODO: Replace with mustfix once mustfix is ready in ABI50_0_0React Native.
  // ABI50_0_0React_native_assert(!strongInstanceHandle_.isNull());
  // ABI50_0_0React_native_assert(!strongInstanceHandle_.isUndefined());
}
...
void EventTarget::release(jsi::Runtime& /*runtime*/) const {
  ...
  ABI50_0_0React_native_assert(retainCount_ >= 0);
}
