...
#import "ABI50_0_0AIRMapPolylineRenderer.h"
#import <ABI50_0_0React/ABI50_0_0UIView+React.h>


@implementation ABI50_0_0AIRMapPolyline {
...
- (void)setStrokeColors:(NSArray<UIColor *> *)strokeColors {
    ...
    if ((self.renderer != nil) && ![_renderer isKindOfClass:[ABI50_0_0AIRMapPolylineRenderer class]]) {
...
- (void)setCoordinates:(NSArray<ABI50_0_0AIRMapCoordinate *> *)coordinates {
...
- (MKOverlayPathRenderer*)createRenderer {
    ...
    if (self.strokeColors == nil) {
        ...
        return [[ABI50_0_0AIRMapPolylineRenderer alloc] initWithOverlay:self polyline:self.polyline];
    }
}
...
- (void) updateRenderer:(MKOverlayPathRenderer*)renderer {
    ...
    if ([renderer isKindOfClass:[ABI50_0_0AIRMapPolylineRenderer class]]) {
        ((ABI50_0_0AIRMapPolylineRenderer*)renderer).strokeColors = _strokeColors;
    }
}
...
#pragma mark ABI50_0_0AIRMapSnapshot implementation

- (void) drawToSnapshot:(MKMapSnapshot *) snapshot context:(CGContextRef) context
{
    ABI50_0_0AIRMapPolylineRenderer* renderer = [[ABI50_0_0AIRMapPolylineRenderer alloc] initWithSnapshot:snapshot overlay:self polyline:self.polyline];
