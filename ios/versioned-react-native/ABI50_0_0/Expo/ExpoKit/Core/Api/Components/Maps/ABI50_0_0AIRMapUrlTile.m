...
@implementation ABI50_0_0AIRMapUrlTile 
...
- (void)createTileOverlayAndRendererIfPossible
{
    ...
    if (_tileCachePathSet || _maximumNativeZSet) {
        ...
        self.tileOverlay = [[ABI50_0_0AIRMapUrlTileCachedOverlay alloc] initWithURLTemplate:self.urlTemplate];
...
- (void)update
{
    ...
    for (id<MKOverlay> overlay in _map.overlays) {
        if ([overlay isKindOfClass:[ABI50_0_0AIRMapUrlTile class]]) {
            continue;
        }
