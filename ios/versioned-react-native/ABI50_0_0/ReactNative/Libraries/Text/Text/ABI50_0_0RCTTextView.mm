...
@implementation ABI50_0_0RCTTextView {
...
{
  NSString *stringToAppend = [NSString stringWithFormat:@" ABI50_0_0ReactTag: %@; text: %@", self.ABI50_0_0ReactTag, _textStorage.string];
...
- (void)drawRect:(CGRect)rect
{
  ...
  [_textStorage
      enumerateAttribute:ABI50_0_0RCTTextAttributesIsHighlightedAttributeName
...
- (NSNumber *)ABI50_0_0ReactTagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    ABI50_0_0ReactTag = [_textStorage attribute:ABI50_0_0RCTTextAttributesTagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }

  return ABI50_0_0ReactTag;
}
