...
@implementation ABI50_0_0EXAppDefines
...
+ (void)load:(NSDictionary *)defines
{
  ...
  NSAssert(!_loaded, @"ABI50_0_0EXAppDefines is already loaded");
  if (!_loaded) {
    _storage = defines;
    _loaded = YES;
  }
...
// Private function for ABI50_0_0EXAppDefinesTest to unload the current state.
+ (void)_unload
{
  _storage = nil;
  _loaded = NO;
...
+ (void)throwIfNotLoaded
{
  if (!_loaded) {
    @throw [NSException exceptionWithName:NSInternalInconsistencyException
                                   reason:@"ABI50_0_0EXAppDefines is not loaded."
                                 userInfo:nil];
  }
}
