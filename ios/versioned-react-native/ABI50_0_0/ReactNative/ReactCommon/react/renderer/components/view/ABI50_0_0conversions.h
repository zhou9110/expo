...
#include <ABI50_0_0React/renderer/graphics/ABI50_0_0ValueUnit.h>
#include <stdlib.h>
...
/*
 * Yoga's `float` <-> ABI50_0_0React Native's `Float` (can be `double` or `float`)
 *
 * Regular Yoga `float` values represent some onscreen-position-related values.
 * They can be real numbers or special value `ABI50_0_0YGUndefined` (which actually is
 * `NaN`). Conceptually, layout computation process inside Yoga should never
 * produce `NaN` values from non-`NaN` values. At the same time, ` ABI50_0_0YGUndefined`
 * values have special "no limit" meaning in Yoga, therefore ` ABI50_0_0YGUndefined`
 * usually corresponds to `Infinity` value.
 */
inline Float floatFromYogaFloat(float value) {
  static_assert(
      ABI50_0_0YGUndefined != ABI50_0_0YGUndefined,
      "The code of this function assumes that ABI50_0_0YGUndefined is NaN.");
  if (std::isnan(value) /* means: `value == ABI50_0_0YGUndefined` */) {
...
/*
 * `yoga::FloatOptional` <-> ABI50_0_0React Native's `Float`
 *
...
inline LayoutMetrics layoutMetricsFromYogaNode(yoga::Node& yogaNode) {
  ...
  layoutMetrics.frame = Rect{
      Point{
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetLeft(&yogaNode)),
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetTop(&yogaNode))},
      Size{
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetWidth(&yogaNode)),
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetHeight(&yogaNode))}};

  layoutMetrics.borderWidth = EdgeInsets{
      floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetBorder(&yogaNode, ABI50_0_0YGEdgeLeft)),
      floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetBorder(&yogaNode, ABI50_0_0YGEdgeTop)),
      floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetBorder(&yogaNode, ABI50_0_0YGEdgeRight)),
      floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetBorder(&yogaNode, ABI50_0_0YGEdgeBottom))};

  layoutMetrics.contentInsets = EdgeInsets{
      layoutMetrics.borderWidth.left +
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetPadding(&yogaNode, ABI50_0_0YGEdgeLeft)),
      layoutMetrics.borderWidth.top +
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetPadding(&yogaNode, ABI50_0_0YGEdgeTop)),
      layoutMetrics.borderWidth.right +
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetPadding(&yogaNode, ABI50_0_0YGEdgeRight)),
      layoutMetrics.borderWidth.bottom +
          floatFromYogaFloat(ABI50_0_0YGNodeLayoutGetPadding(&yogaNode, ABI50_0_0YGEdgeBottom))};
  ...
  layoutMetrics.layoutDirection =
      ABI50_0_0YGNodeLayoutGetDirection(&yogaNode) == ABI50_0_0YGDirectionRTL
...
inline ABI50_0_0YGDirection yogaDirectionFromLayoutDirection(LayoutDirection direction) {
  switch (direction) {
    case LayoutDirection::Undefined:
      return ABI50_0_0YGDirectionInherit;
...
inline void fromRawValue(
  ...
  ABI50_0_0React_native_expect(value.hasType<std::string>());
...
inline void fromRawValue(
  ...
  if (value.hasType<Float>()) {
    result = yoga::CompactValue::ofMaybe<ABI50_0_0YGUnitPoint>((float)value);
    return;
  } else if (value.hasType<std::string>()) {
    const auto stringValue = (std::string)value;
    if (stringValue == "auto") {
      result = context.treatAutoAsABI50_0_0YGValueUndefined() ? ABI50_0_0YGValueUndefined
                                                     : ABI50_0_0YGValueAuto;
      return;
    } else {
      if (stringValue.back() == '%') {
        ...
        if (tryValue.hasValue()) {
          result = ABI50_0_0YGValue{tryValue.value(), ABI50_0_0YGUnitPercent};
          return;
        }
      } else {
        auto tryValue = folly::tryTo<float>(stringValue);
        if (tryValue.hasValue()) {
          result = ABI50_0_0YGValue{tryValue.value(), ABI50_0_0YGUnitPoint};
          return;
        }
      }
    }
  }
  result = ABI50_0_0YGValueUndefined;
}

inline void fromRawValue(
    const PropsParserContext& context,
    const RawValue& value,
    ABI50_0_0YGValue& result) {
...
inline void fromRawValue(
  ...
  ABI50_0_0React_native_expect(value.hasType<std::vector<RawValue>>());
  ...
  for (const auto& configuration : configurations) {
    ...
    if (operation == "matrix") {
      ABI50_0_0React_native_expect(parameters.hasType<std::vector<Float>>());
      auto numbers = (std::vector<Float>)parameters;
      ABI50_0_0React_native_expect(numbers.size() == transformMatrix.matrix.size());
      auto i = 0;
...
inline std::string toString(const ABI50_0_0YGValue& value) {
  switch (value.unit) {
    case ABI50_0_0YGUnitUndefined:
      return "undefined";
    case ABI50_0_0YGUnitPoint:
...
inline std::string toString(const yoga::Style::Edges& value) {
  ...
  for (auto i = 0; i < names.size(); i++) {
    ABI50_0_0YGValue v = value[i];
    if (v.unit == ABI50_0_0YGUnitUndefined) {
      continue;
    }
