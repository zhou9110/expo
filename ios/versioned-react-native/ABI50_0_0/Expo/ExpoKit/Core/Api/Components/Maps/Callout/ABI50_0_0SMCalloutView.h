...
typedef NS_OPTIONS(NSUInteger, ABI50_0_0SMCalloutArrowDirection) {
    ABI50_0_0SMCalloutArrowDirectionUp = 1 << 0,
    ABI50_0_0SMCalloutArrowDirectionDown = 1 << 1,
    ABI50_0_0SMCalloutArrowDirectionAny = ABI50_0_0SMCalloutArrowDirectionUp | ABI50_0_0SMCalloutArrowDirectionDown
};

/// options for the callout present/dismiss animation
typedef NS_ENUM(NSInteger, ABI50_0_0SMCalloutAnimation) {
    /// the "bounce" animation we all know and love from @c UIAlertView
            ABI50_0_0SMCalloutAnimationBounce,
    /// a simple fade in or out
            ABI50_0_0SMCalloutAnimationFade,
    /// grow or shrink linearly, like in the iPad Calendar app
            ABI50_0_0SMCalloutAnimationStretch
};
...
@protocol ABI50_0_0SMCalloutViewDelegate;
@class ABI50_0_0SMCalloutBackgroundView;
...
@interface ABI50_0_0SMCalloutView : UIView
#else
@interface ABI50_0_0SMCalloutView : UIView <CAAnimationDelegate>
#endif

@property (nonatomic, weak, nullable) id<ABI50_0_0SMCalloutViewDelegate> delegate;
...
/// Default @c ABI50_0_0SMCalloutArrowDirectionDown
@property (nonatomic, assign) ABI50_0_0SMCalloutArrowDirection permittedArrowDirection;
/// The current arrow direction
@property (nonatomic, readonly) ABI50_0_0SMCalloutArrowDirection currentArrowDirection;
...
/// default is @c ABI50_0_0SMCalloutMaskedBackgroundView, or @c ABI50_0_0SMCalloutDrawnBackgroundView when using @c ABI50_0_0SMClassicCalloutView
@property (nonatomic, strong) ABI50_0_0SMCalloutBackgroundView *backgroundView;

/**
 @brief Custom title view.
 
 @disucssion Keep in mind that @c ABI50_0_0SMCalloutView calls @c -sizeThatFits on titleView/subtitleView if defined, so your view
...
/**
 ...
 @discussion Keep in mind that @c ABI50_0_0SMCalloutView calls @c -sizeThatFits on subtitleView if defined, so your view
 may be resized as a result of that (especially if you're using @c UILabel/UITextField). You may want to subclass and override @c -sizeThatFits, or just wrap your view in a "generic" @c UIView if you do not want it to be auto-sized.
...
/// default ABI50_0_0SMCalloutAnimationBounce, ABI50_0_0SMCalloutAnimationFade respectively
@property (nonatomic, assign) ABI50_0_0SMCalloutAnimation presentAnimation, dismissAnimation;

/// Returns a new instance of ABI50_0_0SMCalloutView if running on iOS 7 or better, otherwise a new instance of ABI50_0_0SMClassicCalloutView if available.
+ (ABI50_0_0SMCalloutView *)platformCalloutView;
...
- (CAAnimation *)animationWithType:(ABI50_0_0SMCalloutAnimation)type presenting:(BOOL)presenting;
...
/// Abstract base class
@interface ABI50_0_0SMCalloutBackgroundView : UIView
...
/// returns an optional layer whose contents should mask the callout view's contents (not honored by @c ABI50_0_0SMClassicCalloutView )
...
@interface ABI50_0_0SMCalloutMaskedBackgroundView : ABI50_0_0SMCalloutBackgroundView
@end
...
@protocol ABI50_0_0SMCalloutViewDelegate <NSObject>
@optional

/// Controls whether the callout "highlights" when pressed. default YES. You must also respond to @c -calloutViewClicked below.
/// Not honored by @c ABI50_0_0SMClassicCalloutView.
- (BOOL)calloutViewShouldHighlight:(ABI50_0_0SMCalloutView *)calloutView;

/// Called when the callout view is clicked. Not honored by @c ABI50_0_0SMClassicCalloutView.
- (void)calloutViewClicked:(ABI50_0_0SMCalloutView *)calloutView;
