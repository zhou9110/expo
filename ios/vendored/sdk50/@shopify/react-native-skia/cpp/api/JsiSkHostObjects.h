 ...
 */
class JsiSkHostObject : public ABI50_0_0RNJsi::JsiHostObject {
public:
  /**
   * Default constructor
   * @param context Platform context
   */
  explicit JsiSkHostObject(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
      : _context(context) {}
...
protected:
   ...
   */
  std::shared_ptr<ABI50_0_0RNSkPlatformContext> getContext() { return _context; }

private:
  std::shared_ptr<ABI50_0_0RNSkPlatformContext> _context;
};
...
public:
   ...
   * @param context Platform context
   */
  JsiSkWrappingHostObject(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
                          T object)
...
public:
  JsiSkWrappingSharedPtrHostObject(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
...
public:
  JsiSkWrappingSkPtrHostObject(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
                               sk_sp<T> object)
