    ...
    auto element =
        Element<RootShadowNode>()
          ...
          .props([] {
            ...
            yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(200));
            yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(200));
            return sharedProps;
          })
          .children({
            Element<ViewShadowNode>()
              ...
              .props([] {
                ...
                yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(50));
                yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(50));
                return sharedProps;
              })
              .children({
                Element<ViewShadowNode>()
                  ...
                  .props([=] {
                    ...
                    auto &yogaStyle = props.yogaStyle;
                    yogaStyle.positionType() = yoga::PositionType::Absolute;
                    yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{10, ABI50_0_0YGUnitPoint};
                    yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{10, ABI50_0_0YGUnitPoint};
                    yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(30));
                    yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(90));
                  ...
                  .children({
                    Element<ViewShadowNode>()
                      ...
                      .props([=] {
                        ...
                        yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{10, ABI50_0_0YGUnitPoint};
                        yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{10, ABI50_0_0YGUnitPoint};
                        yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(110));
                        yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(20));
                        return sharedProps;
                      })
                      .children({
                        Element<ViewShadowNode>()
                          ...
                          .props([] {
                            ...
                            auto &yogaStyle = props.yogaStyle;
                            yogaStyle.positionType() = yoga::PositionType::Absolute;
                            yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{70, ABI50_0_0YGUnitPoint};
                            yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{-50, ABI50_0_0YGUnitPoint};
                            yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(30));
                            yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(60));
                            return sharedProps;
                          })
                      }),
                    Element<ViewShadowNode>()
                      ...
                      .props([] {
                        ...
                        auto &yogaStyle = props.yogaStyle;
                        yogaStyle.positionType() = yoga::PositionType::Absolute;
                        yogaStyle.position()[ABI50_0_0YGEdgeLeft] = ABI50_0_0YGValue{-60, ABI50_0_0YGUnitPoint};
                        yogaStyle.position()[ABI50_0_0YGEdgeTop] = ABI50_0_0YGValue{50, ABI50_0_0YGUnitPoint};
                        yogaStyle.setDimension(ABI50_0_0YGDimensionWidth, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(70));
                        yogaStyle.setDimension(ABI50_0_0YGDimensionHeight, yoga::CompactValue::of<ABI50_0_0YGUnitPoint>(20));
                        return sharedProps;
                      })
                  })
...
TEST_F(LayoutTest, overflowInsetTest) {
  ...
  ABI50_0_0EXPECT_EQ(layoutMetricsA.frame.size.width, 50);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.frame.size.height, 50);

  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -30);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -80);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -50);

  auto layoutMetricsABC = viewShadowNodeABC_->getLayoutMetrics();

  ABI50_0_0EXPECT_EQ(layoutMetricsABC.frame.size.width, 110);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.frame.size.height, 20);

  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.left, 0);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.top, -50);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.right, 0);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.bottom, 0);
}
...
TEST_F(LayoutTest, overflowInsetWithClippingTest) {
  ...
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, 0);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -80);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -50);
  ...
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.left, 0);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.top, 0);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.right, 0);
  ABI50_0_0EXPECT_EQ(layoutMetricsABC.overflowInset.bottom, 0);
}
...
TEST_F(LayoutTest, overflowInsetTransformTranslateTest) {
  ...
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -30);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -90);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -60);

  auto layoutMetricsAB = viewShadowNodeAB_->getLayoutMetrics();

  ABI50_0_0EXPECT_EQ(layoutMetricsAB.frame.size.width, 30);
  ABI50_0_0EXPECT_EQ(layoutMetricsAB.frame.size.height, 90);

  // No change on self node with translate transform
  ABI50_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.left, -60);
  ABI50_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.top, -40);
  ABI50_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.right, -90);
  ABI50_0_0EXPECT_EQ(layoutMetricsAB.overflowInset.bottom, 0);
...
TEST_F(LayoutTest, overflowInsetTransformScaleTest) {
  ...
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -125);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -115);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -185);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -95);
...
TEST_F(LayoutTest, overflowInsetHitSlopTest) {
  ...
  // Change on parent node
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.left, -50);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -40);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -80);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -100);
...
TEST_F(LayoutTest, overflowInsetHitSlopTransformTranslateTest) {
  ...
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.top, -40);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.right, -90);
  ABI50_0_0EXPECT_EQ(layoutMetricsA.overflowInset.bottom, -110);
