...
@protocol ABI50_0_0RCTScrollViewProtocol <NSObject>
...
ABI50_0_0RCT_EXTERN inline void
ABI50_0_0RCTScrollViewHandleCommand(id<ABI50_0_0RCTScrollViewProtocol> componentView, const NSString *commandName, const NSArray *args)
{
...
#if ABI50_0_0RCT_DEBUG
    if (!ABI50_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"float", @"ScrollView", commandName, @"1st")) {
      return;
    }
#endif
    NSObject *arg1 = args[1];
#if ABI50_0_0RCT_DEBUG
    if (!ABI50_0_0RCTValidateTypeOfViewCommandArgument(arg1, [NSNumber class], @"float", @"ScrollView", commandName, @"2nd")) {
      return;
    }
#endif
    NSObject *arg2 = args[2];
#if ABI50_0_0RCT_DEBUG
    if (!ABI50_0_0RCTValidateTypeOfViewCommandArgument(arg2, [NSNumber class], @"boolean", @"ScrollView", commandName, @"3rd")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"scrollToEnd"]) {
    ...
    NSObject *arg0 = args[0];
#if ABI50_0_0RCT_DEBUG
    if (!ABI50_0_0RCTValidateTypeOfViewCommandArgument(arg0, [NSNumber class], @"boolean", @"ScrollView", commandName, @"1st")) {
      return;
    }
#endif
  ...
  if ([commandName isEqualToString:@"zoomToRect"]) {
...
#if ABI50_0_0RCT_DEBUG
    if (!ABI50_0_0RCTValidateTypeOfViewCommandArgument(
    ...
    NSObject *arg1 = args[1];
#if ABI50_0_0RCT_DEBUG
    if (!ABI50_0_0RCTValidateTypeOfViewCommandArgument(arg1, [NSNumber class], @"boolean", @"ScrollView", commandName, @"2nd")) {
      return;
    }
#endif
