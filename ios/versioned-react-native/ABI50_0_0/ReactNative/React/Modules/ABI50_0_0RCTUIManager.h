 ...
 */
ABI50_0_0RCT_EXTERN NSString *const ABI50_0_0RCTUIManagerWillUpdateViewsDueToContentSizeMultiplierChangeNotification;

@class ABI50_0_0RCTLayoutAnimationGroup;
@class ABI50_0_0RCTUIManagerObserverCoordinator;

/**
 * The ABI50_0_0RCTUIManager is the module responsible for updating the view hierarchy.
 */
@interface ABI50_0_0RCTUIManager : NSObject <ABI50_0_0RCTBridgeModule, ABI50_0_0RCTInvalidating>
...
/**
 * Register a root view with the ABI50_0_0RCTUIManager.
 */
- (void)registerRootView:(UIView *)rootView;

/**
 * Gets the view name associated with a ABI50_0_0ReactTag.
 */
- (NSString *)viewNameForABI50_0_0ReactTag:(NSNumber *)ABI50_0_0ReactTag;

/**
 * Gets the view associated with a ABI50_0_0ReactTag.
 */
- (UIView *)viewForABI50_0_0ReactTag:(NSNumber *)ABI50_0_0ReactTag;

/**
 * Gets the shadow view associated with a ABI50_0_0ReactTag.
 */
 ...
 * or some other layout event outside of the ABI50_0_0React-managed view hierarchy.
 */
 ...
 */
- (void)synchronouslyUpdateViewOnUIThread:(NSNumber *)ABI50_0_0ReactTag
                                 viewName:(NSString *)viewName
                                    props:(NSDictionary *)props;

/**
 * Given a ABI50_0_0ReactTag from a component, find its root view, if possible.
 * Otherwise, this will give back nil.
 *
 * @param ABI50_0_0ReactTag the component tag
 ...
 * @param rootTag the ABI50_0_0React tag of root view hierarchy from which to find the view.
 */
 ...
 * ABI50_0_0React won't be aware of this, so we need to make sure it happens.
 */
- (void)setNeedsLayout;

/**
 * Dedicated object for subscribing for UIManager events.
 * See `ABI50_0_0RCTUIManagerObserver` protocol for more details.
 */
@property (atomic, retain, readonly) ABI50_0_0RCTUIManagerObserverCoordinator *observerCoordinator;

@end

/**
 * This category makes the current ABI50_0_0RCTUIManager instance available via the
 * ABI50_0_0RCTBridge, which is useful for ABI50_0_0RCTBridgeModules or ABI50_0_0RCTViewManagers that
 * need to access the ABI50_0_0RCTUIManager.
 */
@interface ABI50_0_0RCTBridge (ABI50_0_0RCTUIManager)

@property (nonatomic, readonly) ABI50_0_0RCTUIManager *uiManager;

@end

@interface ABI50_0_0RCTBridgeProxy (ABI50_0_0RCTUIManager)

@property (nonatomic, readonly) ABI50_0_0RCTUIManager *uiManager;

@end

ABI50_0_0RCT_EXTERN NSMutableDictionary<NSString *, id> *ABI50_0_0RCTModuleConstantsForDestructuredComponent(
