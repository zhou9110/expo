...
/**
 * ABI50_0_0RCTBlockGuard is designed to be used with obj-c blocks to assist with manual deallocation of C++ resources
 ...
 * the block.
 */
@interface ABI50_0_0RCTBlockGuard : NSObject
