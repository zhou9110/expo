...
@class ABI50_0_0RCTEventDispatcher;

@interface ABI50_0_0RNGestureHandlerManager : NSObject

- (nonnull instancetype)initWithUIManager:(nonnull ABI50_0_0RCTUIManager *)uiManager
                          eventDispatcher:(nonnull ABI50_0_0RCTEventDispatcher *)eventDispatcher;
