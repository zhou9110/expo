...
#include "ABI50_0_0TimerManager.h"
...
std::shared_ptr<TimerHandle> TimerManager::createABI50_0_0ReactNativeMicrotask(
  ...
  ABI50_0_0ReactNativeMicrotasksQueue_.push_back(timerID);
  return std::make_shared<TimerHandle>(timerID);
}

void TimerManager::callABI50_0_0ReactNativeMicrotasks(jsi::Runtime& runtime) {
  std::vector<uint32_t> ABI50_0_0ReactNativeMicrotasksQueue;
  while (!ABI50_0_0ReactNativeMicrotasksQueue_.empty()) {
    ABI50_0_0ReactNativeMicrotasksQueue.clear();
    ABI50_0_0ReactNativeMicrotasksQueue.swap(ABI50_0_0ReactNativeMicrotasksQueue_);

    for (auto ABI50_0_0ReactNativeMicrotaskID : ABI50_0_0ReactNativeMicrotasksQueue) {
      // ABI50_0_0ReactNativeMicrotasks can clear other scheduled ABI50_0_0ReactNativeMicrotasks.
      if (timers_.count(ABI50_0_0ReactNativeMicrotaskID) > 0) {
        timers_[ABI50_0_0ReactNativeMicrotaskID]->invoke(runtime);
        timers_.erase(ABI50_0_0ReactNativeMicrotaskID);
      }
    }
  }
}
...
void TimerManager::deleteABI50_0_0ReactNativeMicrotask(
    jsi::Runtime& runtime,
    std::shared_ptr<TimerHandle> timerHandle) {
  if (timerHandle == nullptr) {
    throw jsi::JSError(
        runtime, "clearABI50_0_0ReactNativeMicrotask was called with an invalid handle");
  }

  for (auto it = ABI50_0_0ReactNativeMicrotasksQueue_.begin();
       it != ABI50_0_0ReactNativeMicrotasksQueue_.end();
       it++) {
    if ((*it) == timerHandle->index()) {
      ABI50_0_0ReactNativeMicrotasksQueue_.erase(it);
      break;
    }
  }
  ...
  runtime.global().setProperty(
      ...
      jsi::Function::createFromHostFunction(
          ...
          [this](
            ...
            auto handle = createABI50_0_0ReactNativeMicrotask(
  ...
  runtime.global().setProperty(
      ...
      jsi::Function::createFromHostFunction(
          ...
          [this](
            ...
            deleteABI50_0_0ReactNativeMicrotask(rt, handle);
            return jsi::Value::undefined();
          }));
      ...
      jsi::Function::createFromHostFunction(
          ...
          [this](
            ...
            auto callback = jsi::Function::createFromHostFunction(
                rt,
                jsi::PropNameID::forAscii(rt, "ABI50_0_0RN$rafFn"),
                0,
