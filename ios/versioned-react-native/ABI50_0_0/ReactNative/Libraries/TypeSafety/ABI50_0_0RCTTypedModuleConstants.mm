...
#import "ABI50_0_0RCTTypedModuleConstants.h"

#import <ABI50_0_0React/ABI50_0_0RCTDefines.h>

@implementation _ABI50_0_0RCTTypedModuleConstants {
  NSDictionary *_dictionary;
}

+ (instancetype)newWithUnsafeDictionary:(NSDictionary<NSString *, id> *)dictionary
{
  _ABI50_0_0RCTTypedModuleConstants *constants = [self new];
  if (constants) {
...
ABI50_0_0RCT_NOT_IMPLEMENTED(-(instancetype)initWithObjects
