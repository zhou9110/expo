...
- (void)ABI50_0_0ReactUpdateResponderOffsetForScrollView:(ABI50_0_0RCTScrollView *)scrollView
{
...
- (UIView<ABI50_0_0RCTBackedTextInputViewProtocol> *)backedTextInputView
{
  ABI50_0_0RCTAssert(NO, @"-[ABI50_0_0RCTBaseTextInputView backedTextInputView] must be implemented in subclass.");
  return nil;
}

#pragma mark - ABI50_0_0RCTComponent
...
- (void)setTextAttributes:(ABI50_0_0RCTTextAttributes *)textAttributes
{
...
{
  id<ABI50_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
...
- (void)setABI50_0_0ReactPaddingInsets:(UIEdgeInsets)ABI50_0_0ReactPaddingInsets
{
  _ABI50_0_0ReactPaddingInsets = ABI50_0_0ReactPaddingInsets;
  // We apply `paddingInsets` as `backedTextInputView`'s `textContainerInset`.
  self.backedTextInputView.textContainerInset = ABI50_0_0ReactPaddingInsets;
  [self setNeedsLayout];
}

- (void)setABI50_0_0ReactBorderInsets:(UIEdgeInsets)ABI50_0_0ReactBorderInsets
{
  _ABI50_0_0ReactBorderInsets = ABI50_0_0ReactBorderInsets;
  // We apply `borderInsets` as `backedTextInputView` layout offset.
  self.backedTextInputView.frame = UIEdgeInsetsInsetRect(self.bounds, ABI50_0_0ReactBorderInsets);
  [self setNeedsLayout];
}
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
  ...
  [backedTextInputViewTextCopy removeAttribute:ABI50_0_0RCTTextAttributesTagAttributeName
                                         range:NSMakeRange(0, backedTextInputViewTextCopy.length)];

  [attributedTextCopy removeAttribute:ABI50_0_0RCTTextAttributesTagAttributeName
  ...
  } else if (eventLag > ABI50_0_0RCTTextUpdateLagWarningThreshold) {
    ABI50_0_0RCTLog(
...
- (ABI50_0_0RCTTextSelection *)selection
{
  id<ABI50_0_0RCTBackedTextInputViewProtocol> backedTextInputView = self.backedTextInputView;
  UITextRange *selectedTextRange = backedTextInputView.selectedTextRange;
  return [[ABI50_0_0RCTTextSelection new]
...
- (void)setSelection:(ABI50_0_0RCTTextSelection *)selection
{
  if (!selection) {
    return;
  }
...
{
  UIView<ABI50_0_0RCTBackedTextInputViewProtocol> *textInputView = self.backedTextInputView;
...
- (void)textInputDidBeginEditing
{
  ...
  [_eventDispatcher sendTextEventWithType:ABI50_0_0RCTTextEventTypeFocus
...
{
  [_eventDispatcher sendTextEventWithType:ABI50_0_0RCTTextEventTypeEnd
                                 ABI50_0_0ReactTag:self.ABI50_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];

  [_eventDispatcher sendTextEventWithType:ABI50_0_0RCTTextEventTypeBlur
                                 ABI50_0_0ReactTag:self.ABI50_0_0ReactTag
                                     text:[self.backedTextInputView.attributedText.string copy]
                                      key:nil
                               eventCount:_nativeEventCount];
...
- (BOOL)textInputShouldSubmitOnReturn
{
  ...
  if (shouldSubmit) {
    ...
    [_eventDispatcher sendTextEventWithType:ABI50_0_0RCTTextEventTypeSubmit
                                   ABI50_0_0ReactTag:self.ABI50_0_0ReactTag
                                       text:[self.backedTextInputView.attributedText.string copy]
                                        key:nil
                                 eventCount:_nativeEventCount];
...
- (NSString *)textInputShouldChangeText:(NSString *)text inRange:(NSRange)range
{
  ...
  if (!backedTextInputView.textWasPasted) {
    [_eventDispatcher sendTextEventWithType:ABI50_0_0RCTTextEventTypeKeyPress
                                   ABI50_0_0ReactTag:self.ABI50_0_0ReactTag
                                       text:nil
                                        key:text
                                 eventCount:_nativeEventCount];
...
- (void)textInputDidChangeSelection
{
  ...
  ABI50_0_0RCTTextSelection *selection = self.selection;
...
- (CGSize)intrinsicContentSize
{
  ...
  size.width += _ABI50_0_0ReactBorderInsets.left + _ABI50_0_0ReactBorderInsets.right;
  size.height += _ABI50_0_0ReactBorderInsets.top + _ABI50_0_0ReactBorderInsets.bottom;
...
{
  CGFloat compoundHorizontalBorderInset = _ABI50_0_0ReactBorderInsets.left + _ABI50_0_0ReactBorderInsets.right;
  CGFloat compoundVerticalBorderInset = _ABI50_0_0ReactBorderInsets.top + _ABI50_0_0ReactBorderInsets.bottom;
...
{
  [self.backedTextInputView ABI50_0_0ReactFocus];
}

- (void)ABI50_0_0ReactBlur
{
  [self.backedTextInputView ABI50_0_0ReactBlur];
}
...
- (void)didMoveToWindow
{
  if (self.autoFocus && !_didMoveToWindow) {
    ...
    [self.backedTextInputView ABI50_0_0ReactFocusIfNeeded];
  }
...
{
  __weak ABI50_0_0RCTBaseTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForABI50_0_0ReactTag:self.ABI50_0_0ReactTag
                          withCompletion:^(UIView *rootView) {
                            ABI50_0_0RCTBaseTextInputView *strongSelf = weakSelf;
                            if (rootView) {
                              UIView *accessoryView = [strongSelf->_bridge.uiManager viewForNativeID:nativeID
                                                                                         withRootTag:rootView.ABI50_0_0ReactTag];
                              if (accessoryView && [accessoryView isKindOfClass:[ABI50_0_0RCTInputAccessoryView class]]) {
                                strongSelf.backedTextInputView.inputAccessoryView =
                                    ((ABI50_0_0RCTInputAccessoryView *)accessoryView).inputAccessoryView;
