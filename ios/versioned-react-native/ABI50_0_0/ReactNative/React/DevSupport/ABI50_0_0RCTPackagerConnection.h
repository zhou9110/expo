...
@class ABI50_0_0RCTPackagerClientResponder;

typedef uint32_t ABI50_0_0RCTHandlerToken;
typedef void (^ABI50_0_0RCTNotificationHandler)(NSDictionary<NSString *, id> *);
typedef void (^ABI50_0_0RCTRequestHandler)(NSDictionary<NSString *, id> *, ABI50_0_0RCTPackagerClientResponder *);
typedef void (^ABI50_0_0RCTConnectedHandler)(void);

/** Encapsulates singleton connection to ABI50_0_0React Native packager. */
@interface ABI50_0_0RCTPackagerConnection : NSObject
