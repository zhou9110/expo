...
@implementation ABI50_0_0RNGestureHandlerEventExtraData
...
{
  return [[ABI50_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{
    @"x" : @(position.x),
    @"y" : @(position.y),
                             ...
                             withNumberOfTouches:(NSUInteger)numberOfTouches
{
  if (changedPointers == nil || allPointers == nil) {
    changedPointers = @[];
    allPointers = @[];
    eventType = ABI50_0_0RNGHTouchEventTypeUndetermined;
  }
...
{
  return [[ABI50_0_0RNGestureHandlerEventExtraData alloc] initWithData:@{@"pointerInside" : @(pointerInside)}];
}

@end

@implementation ABI50_0_0RNGestureHandlerEvent {
  NSNumber *_handlerTag;
  ABI50_0_0RNGestureHandlerState _state;
  ABI50_0_0RNGestureHandlerEventExtraData *_extraData;
}
...
@implementation ABI50_0_0RNGestureHandlerStateChange {
  NSNumber *_handlerTag;
  ABI50_0_0RNGestureHandlerState _state;
  ABI50_0_0RNGestureHandlerState _prevState;
  ABI50_0_0RNGestureHandlerEventExtraData *_extraData;
}
