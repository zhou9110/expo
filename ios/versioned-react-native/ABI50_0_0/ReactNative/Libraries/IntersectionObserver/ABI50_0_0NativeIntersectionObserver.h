...
#include <ABI50_0_0React/renderer/observers/intersection/ABI50_0_0IntersectionObserverManager.h>
#include <optional>
#include <string>
#include <tuple>
#include <vector>
...
class NativeIntersectionObserver
    : public ABI50_0_0NativeIntersectionObserverCxxSpec<NativeIntersectionObserver>,
