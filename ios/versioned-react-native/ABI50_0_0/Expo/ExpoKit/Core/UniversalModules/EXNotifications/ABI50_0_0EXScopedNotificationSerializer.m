...
@implementation ABI50_0_0EXScopedNotificationSerializer
...
+ (NSDictionary *)serializedNotificationContent:(UNNotificationRequest *)request
{
  ...
  serializedContentMutable[@"categoryIdentifier"] = request.content.categoryIdentifier ? [ABI50_0_0EXScopedNotificationsUtils getScopeAndIdentifierFromScopedIdentifier:request.content.categoryIdentifier].identifier : [NSNull null];
...
+ (NSDictionary *)serializedNotificationRequest:(UNNotificationRequest *)request
{
  ...
  serializedRequestMutable[@"identifier"] = [ABI50_0_0EXScopedNotificationsUtils getScopeAndIdentifierFromScopedIdentifier:request.identifier].identifier;
