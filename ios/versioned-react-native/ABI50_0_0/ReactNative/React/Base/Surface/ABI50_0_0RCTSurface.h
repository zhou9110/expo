...
@class ABI50_0_0RCTSurfaceView;
@protocol ABI50_0_0RCTSurfaceDelegate;

/**
 * ABI50_0_0RCTSurface instance represents ABI50_0_0React Native-powered piece of a user interface
 * which can be a full-screen app, separate modal view controller,
 * or even small widget.
 * It is called "Surface".
 *
 * The ABI50_0_0RCTSurface instance is completely thread-safe by design;
 ...
 *
 * The primary goals of the ABI50_0_0RCTSurface are:
 ...
 */
@interface ABI50_0_0RCTSurface : NSObject <ABI50_0_0RCTSurfaceProtocol>
...
/**
 * Simple shortcut to `-[ABI50_0_0RCTSurface setMinimumSize:size maximumSize:size]`.
 */
 ...
 *  - Calling on the main queue with `ABI50_0_0RCTSurfaceStageSurfaceDidInitialMounting`
 *    stage temporary is not supported; in this case the stage will be
 *    downgraded to `ABI50_0_0RCTSurfaceStageSurfaceDidInitialLayout`.
 */
...
/**
 * Mount the ABI50_0_0React component specified by the given moduleName. This is typically
...
/**
 * Unmount the ABI50_0_0React component specified by the given rootViewTag, called from native.
 */
