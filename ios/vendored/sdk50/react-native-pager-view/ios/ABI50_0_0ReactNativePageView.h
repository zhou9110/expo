...
@interface ABI50_0_0ReactNativePageView: UIView
...
@property(nonatomic, copy) ABI50_0_0RCTDirectEventBlock onPageSelected;
@property(nonatomic, copy) ABI50_0_0RCTDirectEventBlock onPageScroll;
@property(nonatomic, copy) ABI50_0_0RCTDirectEventBlock onPageScrollStateChanged;
