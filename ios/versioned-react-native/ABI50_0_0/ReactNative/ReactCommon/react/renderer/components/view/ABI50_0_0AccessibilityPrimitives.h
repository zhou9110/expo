...
namespace std {
template <>
struct hash<ABI50_0_0facebook::ABI50_0_0React::AccessibilityRole> {
  size_t operator()(const ABI50_0_0facebook::ABI50_0_0React::AccessibilityRole& v) const {
    return hash<int>()(static_cast<int>(v));
  }
};

template <>
struct hash<ABI50_0_0facebook::ABI50_0_0React::Role> {
  size_t operator()(const ABI50_0_0facebook::ABI50_0_0React::Role& v) const {
    return hash<int>()(static_cast<int>(v));
  }
};
} // namespace std
