...
#if !TARGET_OS_TV
@implementation ABI50_0_0RCTConvert (ABI50_0_0EXStatusBar)

ABI50_0_0RCT_ENUM_CONVERTER(UIStatusBarStyle, (@{
  @"default": @(UIStatusBarStyleDefault),
  @"light-content": @(UIStatusBarStyleLightContent),
  @"dark-content": @(UIStatusBarStyleDefault),
}), UIStatusBarStyleDefault, integerValue);

ABI50_0_0RCT_ENUM_CONVERTER(UIStatusBarAnimation, (@{
...
@interface ABI50_0_0EXStatusBarManager ()

@property (nonatomic, strong) NSMutableDictionary *capturedStatusBarProperties;

@end

@implementation ABI50_0_0EXStatusBarManager

+ (NSString *)moduleName { return @"ABI50_0_0RCTStatusBarManager"; }
...
ABI50_0_0RCT_EXPORT_METHOD(setStyle:(UIStatusBarStyle)statusBarStyle
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI50_0_0RCTSharedApplication() setStatusBarStyle:statusBarStyle
                                     animated:animated];
...
ABI50_0_0RCT_EXPORT_METHOD(setHidden:(BOOL)hidden
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ABI50_0_0RCTSharedApplication() setStatusBarHidden:hidden
 ...
 */
ABI50_0_0RCT_REMAP_METHOD(_captureProperties,
                 _capturePropertiesWithResolver:(ABI50_0_0RCTPromiseResolveBlock)resolve
 ...
 *  Normally nobody should use this method because it bypasses the JS state used by the StatusBar component.
 */
ABI50_0_0RCT_EXPORT_METHOD(_applyPropertiesAndForget:(NSDictionary *)properties)
{
...
{
  UIApplication *currentApplication = ABI50_0_0RCTSharedApplication();
  return @{
