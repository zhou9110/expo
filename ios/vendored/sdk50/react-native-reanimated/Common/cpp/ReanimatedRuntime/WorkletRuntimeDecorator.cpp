...
void WorkletRuntimeDecorator::decorate(
  ...
  jsi_utils::installJsiFunction(
      ...
      [jsScheduler](
        ...
        auto shareableRemoteFun = extractShareableOrThrow<
            ...
            rt,
            remoteFun,
            "[Reanimated] Incompatible object passed to scheduleOnJS. It is only allowed to schedule worklets or functions defined on the ABI50_0_0React Native JS runtime this way.");
  ...
  jsi_utils::installJsiFunction(
      ...
      [](jsi::Runtime &rt,
        ...
        ABI50_0_0reanimated::scheduleOnRuntime(
  ...
  jsi_utils::installJsiFunction(
      ...
      [](jsi::Runtime &rt,
        ...
        return ABI50_0_0reanimated::updateDataSynchronously(
