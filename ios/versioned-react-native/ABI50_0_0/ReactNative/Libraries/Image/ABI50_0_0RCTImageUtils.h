 ...
 */
ABI50_0_0RCT_EXTERN CGRect ABI50_0_0RCTTargetRect(CGSize sourceSize, CGSize destSize, CGFloat destScale, ABI50_0_0RCTResizeMode resizeMode);
 ...
 */
ABI50_0_0RCT_EXTERN CGAffineTransform ABI50_0_0RCTTransformFromTargetRect(CGSize sourceSize, CGRect targetRect);
 ...
 */
ABI50_0_0RCT_EXTERN CGSize ABI50_0_0RCTTargetSize(
    CGSize sourceSize,
    CGFloat sourceScale,
    CGSize destSize,
    CGFloat destScale,
 ...
 */
ABI50_0_0RCT_EXTERN BOOL ABI50_0_0RCTUpscalingRequired(
    CGSize sourceSize,
    CGFloat sourceScale,
    CGSize destSize,
    CGFloat destScale,
 ...
 */
ABI50_0_0RCT_EXTERN UIImage *__nullable
ABI50_0_0RCTDecodeImageWithData(NSData *data, CGSize destSize, CGFloat destScale, ABI50_0_0RCTResizeMode resizeMode);

/**
 * This function takes the source data for an image and decodes just the
 * metadata, without decompressing the image itself.
 */
ABI50_0_0RCT_EXTERN NSDictionary<NSString *, id> *__nullable ABI50_0_0RCTGetImageMetadata(NSData *data);
 ...
 */
ABI50_0_0RCT_EXTERN NSData *__nullable ABI50_0_0RCTGetImageData(UIImage *image, float quality);
 ...
 */
ABI50_0_0RCT_EXTERN UIImage *__nullable
ABI50_0_0RCTTransformImage(UIImage *image, CGSize destSize, CGFloat destScale, CGAffineTransform transform);

/*
 * Return YES if image has an alpha component
 */
ABI50_0_0RCT_EXTERN BOOL ABI50_0_0RCTImageHasAlpha(CGImageRef image);
