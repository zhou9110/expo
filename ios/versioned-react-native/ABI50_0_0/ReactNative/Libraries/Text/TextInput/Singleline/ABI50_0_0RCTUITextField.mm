...
@implementation ABI50_0_0RCTUITextField {
  ABI50_0_0RCTBackedTextFieldDelegateAdapter *_textInputDelegateAdapter;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _textInputDelegateAdapter = [[ABI50_0_0RCTBackedTextFieldDelegateAdapter alloc] initWithTextField:self];
    _scrollEnabled = YES;
  }
...
- (CGSize)intrinsicContentSize
{
  ...
  size = CGSizeMake(ABI50_0_0RCTCeilPixelValue(size.width), ABI50_0_0RCTCeilPixelValue(size.height));
