...
public:
  ...
  JSI_HOST_FUNCTION(MakeImageFromViewTag) {
    ...
    return ABI50_0_0RNJsi::JsiPromises::createPromiseAsJSIValue(
        runtime,
        [context = std::move(context), viewTag](
            jsi::Runtime &runtime,
            std::shared_ptr<ABI50_0_0RNJsi::JsiPromises::Promise> promise) -> void {
  ...
  explicit JsiSkImageFactory(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
