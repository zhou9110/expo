...
- (NSArray<UIAccessibilityElement *> *)accessibilityElements
{
  ...
  if (accessibilityLabel.length == 0) {
    accessibilityLabel = ABI50_0_0RCTNSStringFromString(_attributedString.getString());
  }
  // add first element has the text for the whole textview in order to read out the whole text
  ABI50_0_0RCTAccessibilityElement *firstElement =
      [[ABI50_0_0RCTAccessibilityElement alloc] initWithAccessibilityContainer:_view.superview];
  ...
  [_layoutManager getRectWithAttributedString:_attributedString
                          paragraphAttributes:_paragraphAttributes
                           enumerateAttribute:ABI50_0_0RCTTextAttributesAccessibilityRoleAttributeName
                                        frame:_frame
                                   usingBlock:^(CGRect fragmentRect, NSString *_Nonnull fragmentText, NSString *value) {
                                     ...
                                     ABI50_0_0RCTAccessibilityElement *element =
                                         [[ABI50_0_0RCTAccessibilityElement alloc] initWithAccessibilityContainer:self->_view];
  ...
  if (numberOfLinks > 0 || numberOfButtons > 0) {
    ...
    [elements enumerateObjectsUsingBlock:^(UIAccessibilityElement *element, NSUInteger idx, BOOL *_Nonnull stop) {
      ...
      if (element.accessibilityTraits & UIAccessibilityTraitLink) {
        NSString *test = [ABI50_0_0RCTLocalizationProvider ABI50_0_0RCTLocalizedString:@"Link %ld of %ld."
        ...
        element.accessibilityHint =
            [NSString stringWithFormat:[ABI50_0_0RCTLocalizationProvider ABI50_0_0RCTLocalizedString:@"Button %ld of %ld."
  ...
  if (numberOfLinks > 0 && numberOfButtons > 0) {
    firstElement.accessibilityHint =
        [ABI50_0_0RCTLocalizationProvider ABI50_0_0RCTLocalizedString:@"Links and buttons are found, swipe to move to them."
    ...
    NSString *firstElementHint = (numberOfLinks == 1)
        ? [ABI50_0_0RCTLocalizationProvider ABI50_0_0RCTLocalizedString:@"One link found, swipe to move to the link."
                                      withDescription:@"accessibility hint for one link inside text"]
        : [NSString stringWithFormat:[ABI50_0_0RCTLocalizationProvider
                                         ABI50_0_0RCTLocalizedString:@"%ld links found, swipe to move to the first link."
    ...
    NSString *firstElementHint = (numberOfButtons == 1)
        ? [ABI50_0_0RCTLocalizationProvider ABI50_0_0RCTLocalizedString:@"One button found, swipe to move to the button."
                                      withDescription:@"accessibility hint for one button inside text"]
        : [NSString stringWithFormat:[ABI50_0_0RCTLocalizationProvider
                                         ABI50_0_0RCTLocalizedString:@"%ld buttons found, swipe to move to the first button."
  ...
  if (truncatedText && truncatedText.length > 0) {
    firstElement.accessibilityHint = (numberOfLinks > 0 || numberOfButtons > 0)
        ? [NSString
              stringWithFormat:@"%@ %@",
                               firstElement.accessibilityHint,
                               [ABI50_0_0RCTLocalizationProvider
                                   ABI50_0_0RCTLocalizedString:[NSString stringWithFormat:@"Double tap to %@.", truncatedText]
                                      withDescription:@"accessibility hint for truncated text with links or buttons"]]
        : [ABI50_0_0RCTLocalizationProvider ABI50_0_0RCTLocalizedString:[NSString stringWithFormat:@"Double tap to %@.", truncatedText]
