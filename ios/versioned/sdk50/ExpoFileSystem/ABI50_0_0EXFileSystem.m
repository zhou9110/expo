...
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXFileSystemLocalFileHandler.h>
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXFileSystemAssetLibraryHandler.h>
...
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXSessionTaskDispatcher.h>
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXSessionDownloadTaskDelegate.h>
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXSessionResumableDownloadTaskDelegate.h>
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXSessionUploadTaskDelegate.h>
#import <ABI50_0_0ExpoFileSystem/ABI50_0_0EXSessionCancelableUploadTaskDelegate.h>

NSString * const ABI50_0_0EXDownloadProgressEventName = @"expo-file-system.downloadProgress";
NSString * const ABI50_0_0EXUploadProgressEventName = @"expo-file-system.uploadProgress";

typedef NS_ENUM(NSInteger, ABI50_0_0EXFileSystemSessionType) {
  ABI50_0_0EXFileSystemBackgroundSession = 0,
  ABI50_0_0EXFileSystemForegroundSession = 1,
};

typedef NS_ENUM(NSInteger, ABI50_0_0EXFileSystemUploadType) {
  ABI50_0_0EXFileSystemInvalidType = -1,
  ABI50_0_0EXFileSystemBinaryContent = 0,
  ABI50_0_0EXFileSystemMultipart = 1,
};

@interface ABI50_0_0EXFileSystem ()

@property (nonatomic, strong) NSURLSession *backgroundSession;
@property (nonatomic, strong) NSURLSession *foregroundSession;
@property (nonatomic, strong) ABI50_0_0EXSessionTaskDispatcher *sessionTaskDispatcher;
@property (nonatomic, strong) ABI50_0_0EXTaskHandlersManager *taskHandlersManager;
...
@implementation ABI50_0_0EXFileSystem
...
{
  return @[@protocol(ABI50_0_0EXFileSystemInterface)];
}
...
- (instancetype)initWithDocumentDirectory:(NSString *)documentDirectory cachesDirectory:(NSString *)cachesDirectory
{
  if (self = [super init]) {
    ...
    _taskHandlersManager = [ABI50_0_0EXTaskHandlersManager new];

    [ABI50_0_0EXFileSystem ensureDirExistsWithPath:_documentDirectory];
    [ABI50_0_0EXFileSystem ensureDirExistsWithPath:_cachesDirectory];
  }
  return self;
}
...
- (void)setModuleRegistry:(ABI50_0_0EXModuleRegistry *)moduleRegistry
{
  ...
  _eventEmitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXEventEmitterService)];

  _sessionTaskDispatcher = [[ABI50_0_0EXSessionTaskDispatcher alloc] initWithSessionHandler:[moduleRegistry getSingletonModuleForName:@"SessionHandler"]];
  _backgroundSession = [self _createSession:ABI50_0_0EXFileSystemBackgroundSession delegate:_sessionTaskDispatcher];
  _foregroundSession = [self _createSession:ABI50_0_0EXFileSystemForegroundSession delegate:_sessionTaskDispatcher];
}
...
{
  return @[ABI50_0_0EXDownloadProgressEventName, ABI50_0_0EXUploadProgressEventName];
}
...
ABI50_0_0EX_EXPORT_METHOD_AS(getInfoAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:uri] & ABI50_0_0EXFileSystemPermissionRead)) {
  ...
  if ([uri.scheme isEqualToString:@"file"]) {
    [ABI50_0_0EXFileSystemLocalFileHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else if ([uri.scheme isEqualToString:@"assets-library"] || [uri.scheme isEqualToString:@"ph"]) {
    [ABI50_0_0EXFileSystemAssetLibraryHandler getInfoForFile:uri withOptions:options resolver:resolve rejecter:reject];
  } else {
...
ABI50_0_0EX_EXPORT_METHOD_AS(readAsStringAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(writeAsStringAsync,
...
{
  NSURL *uri = [self percentEncodedURLFromURIString:uriString];
  if (!([self permissionsForURI:uri] & ABI50_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI50_0_0EX_EXPORT_METHOD_AS(deleteAsync,
...
{
  NSURL *uri = [self percentEncodedURLFromURIString:uriString];
  if (!([self permissionsForURI:[uri URLByAppendingPathComponent:@".."]] & ABI50_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI50_0_0EX_EXPORT_METHOD_AS(moveAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:[from URLByAppendingPathComponent:@".."]] & ABI50_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  if (!([self permissionsForURI:to] & ABI50_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI50_0_0EX_EXPORT_METHOD_AS(copyAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:from] & ABI50_0_0EXFileSystemPermissionRead)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  if ([from.scheme isEqualToString:@"file"]) {
    [ABI50_0_0EXFileSystemLocalFileHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else if ([from.scheme isEqualToString:@"assets-library"] || [from.scheme isEqualToString:@"ph"]) {
    [ABI50_0_0EXFileSystemAssetLibraryHandler copyFrom:from to:to resolver:resolve rejecter:reject];
  } else {
    reject(@"ERR_FILESYSTEM_INVALID_URI",
           [NSString stringWithFormat:@"Unsupported URI scheme for '%@'", from],
           nil);
...
ABI50_0_0EX_EXPORT_METHOD_AS(makeDirectoryAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(readDirectoryAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(downloadAsync,
                                ...
                                rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self permissionsForURI:localUri] & ABI50_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
  ...
  ABI50_0_0EXSessionTaskDelegate *taskDelegate = [[ABI50_0_0EXSessionDownloadTaskDelegate alloc] initWithResolve:resolve
                                                                                        reject:reject
                                                                                      localUrl:localUri
...
ABI50_0_0EX_EXPORT_METHOD_AS(uploadAsync,
                       ...
                       rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI50_0_0EXSessionTaskDelegate *taskDelegate = [[ABI50_0_0EXSessionUploadTaskDelegate alloc] initWithResolve:resolve reject:reject];
  [_sessionTaskDispatcher registerTaskDelegate:taskDelegate forTask:task];
  [task resume];
}

ABI50_0_0EX_EXPORT_METHOD_AS(uploadTaskStartAsync,
                                ...
                                rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  ABI50_0_0EXUploadDelegateOnSendCallback onSend = ^(NSURLSessionUploadTask *task, int64_t bytesSent, int64_t totalBytesSent, int64_t totalBytesExpectedToSend) {
    ABI50_0_0EX_ENSURE_STRONGIFY(self);
    [self sendEventWithName:ABI50_0_0EXUploadProgressEventName
                       body:@{
                             @"uuid": uuid,
                             @"data": @{
  ...
  ABI50_0_0EXSessionTaskDelegate *taskDelegate = [[ABI50_0_0EXSessionCancelableUploadTaskDelegate alloc] initWithResolve:resolve
                                                                                          reject:reject
                                              ...
                                              rejecter:(ABI50_0_0EXPromiseRejectBlock)reject
{
  ...
  ABI50_0_0EXFileSystemUploadType type = [self _getUploadTypeFrom:options[@"uploadType"]];
  ...
  if (type == ABI50_0_0EXFileSystemBinaryContent) {
    task = [session uploadTaskWithRequest:request fromFile:fileUri];
  } else if (type == ABI50_0_0EXFileSystemMultipart) {
...
ABI50_0_0EX_EXPORT_METHOD_AS(downloadResumableStartAsync,
                                              ...
                                              rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  if (!([self _permissionsForPath:path] & ABI50_0_0EXFileSystemPermissionWrite)) {
    reject(@"ERR_FILESYSTEM_NO_PERMISSIONS",
...
ABI50_0_0EX_EXPORT_METHOD_AS(downloadResumablePauseAsync,
                    ...
                    rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  ...
  [task cancelByProducingResumeData:^(NSData * _Nullable resumeData) {
    ABI50_0_0EX_ENSURE_STRONGIFY(self);
    resolve(@{ @"resumeData": ABI50_0_0EXNullIfNil([resumeData base64EncodedStringWithOptions:0]) });
  }];
}

ABI50_0_0EX_EXPORT_METHOD_AS(networkTaskCancelAsync,
...
ABI50_0_0EX_EXPORT_METHOD_AS(getFreeDiskStorageAsync, getFreeDiskStorageAsyncWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  NSError *error = nil;
...
ABI50_0_0EX_EXPORT_METHOD_AS(getTotalDiskCapacityAsync, getTotalDiskCapacityAsyncWithResolver:(ABI50_0_0EXPromiseResolveBlock)resolve rejecter:(ABI50_0_0EXPromiseRejectBlock)reject)
{
  NSError *error = nil;
...
- (ABI50_0_0EXFileSystemUploadType)_getUploadTypeFrom:(NSNumber * _Nullable)type
{
  switch ([type intValue]) {
    case ABI50_0_0EXFileSystemBinaryContent:
    case ABI50_0_0EXFileSystemMultipart:
      return [type intValue];
  }

  return ABI50_0_0EXFileSystemInvalidType;
}
...
- (NSURLSession *)_sessionForType:(ABI50_0_0EXFileSystemSessionType)type
{
  switch (type) {
    case ABI50_0_0EXFileSystemBackgroundSession:
      return _backgroundSession;
    case ABI50_0_0EXFileSystemForegroundSession:
...
- (NSURLSession *)_createSession:(ABI50_0_0EXFileSystemSessionType)type delegate:(id<NSURLSessionDelegate>)delegate
{
  NSURLSessionConfiguration *sessionConfiguration;
  if (type == ABI50_0_0EXFileSystemForegroundSession) {
...
{
  ABI50_0_0EX_WEAKIFY(self);
  ABI50_0_0EXDownloadDelegateOnWriteCallback onWrite = ^(NSURLSessionDownloadTask *task, int64_t bytesWritten, int64_t totalBytesWritten, int64_t totalBytesExpectedToWrite) {
    ABI50_0_0EX_ENSURE_STRONGIFY(self);
    [self sendEventWithName:ABI50_0_0EXDownloadProgressEventName
                       body:@{
                             @"uuid": uuid,
                             @"data": @{
  ...
  ABI50_0_0EXSessionTaskDelegate *taskDelegate = [[ABI50_0_0EXSessionResumableDownloadTaskDelegate alloc] initWithResolve:resolve
                                                                                                 reject:reject
                                                                                               localUrl:fileUrl
                                                                                     shouldCalculateMd5:[options[@"md5"] boolValue]
...
- (ABI50_0_0EXFileSystemPermissionFlags)_permissionsForPath:(NSString *)path
{
  return [[_moduleRegistry getModuleImplementingProtocol:@protocol(ABI50_0_0EXFilePermissionModuleInterface)] getPathPermissions:(NSString *)path];
}
...
- (ABI50_0_0EXFileSystemPermissionFlags)permissionsForURI:(NSURL *)uri
{
  ...
  if ([validSchemas containsObject:uri.scheme]) {
    return ABI50_0_0EXFileSystemPermissionRead;
  }
  if ([uri.scheme isEqualToString:@"file"]) {
...
{
  return [ABI50_0_0EXFileSystem ensureDirExistsWithPath:path];
}
...
{
  return [ABI50_0_0EXFileSystem generatePathInDirectory:directory withExtension:extension];
}

+ (NSString *)generatePathInDirectory:(NSString *)directory withExtension:(NSString *)extension
{
  NSString *fileName = [[[NSUUID UUID] UUIDString] stringByAppendingString:extension];
  [ABI50_0_0EXFileSystem ensureDirExistsWithPath:directory];
