...
#include <hermes/inspector-modern/ABI50_0_0AsyncPauseState.h>
#include <hermes/inspector-modern/ABI50_0_0Exceptions.h>
...
class InspectorObserver {
 public:
  ...
  virtual void onBreakpointResolved(
      Inspector &inspector,
      const ABI50_0_0facebook::ABI50_0_0hermes::debugger::BreakpointInfo &info) = 0;
  ...
  virtual void onPause(
      Inspector &inspector,
      const ABI50_0_0facebook::ABI50_0_0hermes::debugger::ProgramState &state) = 0;
 ...
 * debugging API.
 */
class Inspector : public ABI50_0_0facebook::ABI50_0_0hermes::debugger::EventObserver,
 ...
 public:
  ...
  folly::Future<folly::Unit> executeIfEnabled(
      ...
      folly::Function<void(const ABI50_0_0facebook::ABI50_0_0hermes::debugger::ProgramState &)>
          func);
   ...
   * execution.
   */
  folly::Future<ABI50_0_0facebook::ABI50_0_0hermes::debugger::BreakpointInfo> setBreakpoint(
      ABI50_0_0facebook::ABI50_0_0hermes::debugger::SourceLocation loc,
      std::optional<std::string> condition = std::nullopt);

  folly::Future<folly::Unit> removeBreakpoint(
      ABI50_0_0facebook::ABI50_0_0hermes::debugger::BreakpointID loc);
   ...
   * otherwise.
   */
  folly::Future<ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult> evaluate(
      uint32_t frameIndex,
      const std::string &src,
      folly::Function<void(const ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult &)>
          resultTransformer);

  folly::Future<folly::Unit> setPauseOnExceptions(
      const ABI50_0_0facebook::ABI50_0_0hermes::debugger::PauseOnThrowMode &mode);
   ...
   * on the JS thread.
   */
  ABI50_0_0facebook::ABI50_0_0hermes::debugger::Command didPause(
      ABI50_0_0facebook::ABI50_0_0hermes::debugger::Debugger &debugger) override;

  /**
   * breakpointResolved implements the breakpointResolved callback from Hermes.
   */
  void breakpointResolved(
      ABI50_0_0facebook::ABI50_0_0hermes::debugger::Debugger &debugger,
      ABI50_0_0facebook::ABI50_0_0hermes::debugger::BreakpointID breakpointId) override;
 ...
 private:
  ...
  void setBreakpointOnExecutor(
      ...
      std::shared_ptr<
          folly::Promise<ABI50_0_0facebook::ABI50_0_0hermes::debugger::BreakpointInfo>> promise);
  ...
  void setPendingCommandOnExecutor(
      ABI50_0_0facebook::ABI50_0_0hermes::debugger::Command command,
      std::shared_ptr<folly::Promise<folly::Unit>> promise);
  ...
  void evaluateOnExecutor(
      uint32_t frameIndex,
      const std::string &src,
      std::shared_ptr<folly::Promise<ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult>>
          promise,
      folly::Function<void(const ABI50_0_0facebook::ABI50_0_0hermes::debugger::EvalResult &)>
          resultTransformer);
  ...
  ABI50_0_0facebook::ABI50_0_0hermes::debugger::Debugger &debugger_;
