...
@protocol ABI50_0_0RCTRootViewDelegate;
 ...
 * rootViewDidChangeIntrinsicSize method of the ABI50_0_0RCTRootViewDelegate will be called.
 */
typedef NS_ENUM(NSInteger, ABI50_0_0RCTRootViewSizeFlexibility) {
  ABI50_0_0RCTRootViewSizeFlexibilityNone = 0,
  ABI50_0_0RCTRootViewSizeFlexibilityWidth = 1 << 0,
  ABI50_0_0RCTRootViewSizeFlexibilityHeight = 1 << 1,
  ABI50_0_0RCTRootViewSizeFlexibilityWidthAndHeight = ABI50_0_0RCTRootViewSizeFlexibilityWidth | ABI50_0_0RCTRootViewSizeFlexibilityHeight,
};
...
extern
    ...
    NS_ASSUME_NONNULL_BEGIN
        ...
        NSString *const ABI50_0_0RCTContentDidAppearNotification;

/**
 * Native view used to host ABI50_0_0React-managed views within the app. Can be used just
 * like any ordinary UIView. You can have multiple ABI50_0_0RCTRootViews on screen at
 * once, all controlled by the same JavaScript application.
 */
@interface ABI50_0_0RCTRootView : UIView
 ...
 * This initializer is intended to be used when the app has a single ABI50_0_0RCTRootView,
 * otherwise create an `ABI50_0_0RCTBridge` and pass it in via `initWithBridge:moduleName:`
 ...
 * root views, so you can use this property to initialize another ABI50_0_0RCTRootView.
 */
 ...
 */
@property (nonatomic, weak, nullable) id<ABI50_0_0RCTRootViewDelegate> delegate;

/**
 * The backing view controller of the root view.
 */
@property (nonatomic, weak, nullable) UIViewController *ABI50_0_0ReactViewController;
...
/**
 * The ABI50_0_0React-managed contents view of the root view.
 */
...
/**
 * When set, any touches on the ABI50_0_0RCTRootView that are not matched up to any of the child
 * views will be passed to siblings of the ABI50_0_0RCTRootView. See -[UIView hitTest:withEvent:]
 * for details on iOS hit testing.
 *
 * Enable this to support a semi-transparent ABI50_0_0RN view that occupies the whole screen but
...
@interface ABI50_0_0RCTRootView (Deprecated)

/**
 * The intrinsic size of the root view's content. This is set right before the
 * `rootViewDidChangeIntrinsicSize` method of `ABI50_0_0RCTRootViewDelegate` is called.
 ...
 * To interrupt a ABI50_0_0React Native gesture recognizer, use the standard
