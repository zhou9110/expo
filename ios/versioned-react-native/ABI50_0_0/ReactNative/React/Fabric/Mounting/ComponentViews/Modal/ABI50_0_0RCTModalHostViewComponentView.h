 ...
 */
@interface ABI50_0_0RCTModalHostViewComponentView : ABI50_0_0RCTViewComponentView <ABI50_0_0RCTMountingTransactionObserving>

/**
 * Subclasses may override this method and present the modal on different view controller.
 * Default implementation presents the modal on `[self ABI50_0_0ReactViewController]`.
 */
