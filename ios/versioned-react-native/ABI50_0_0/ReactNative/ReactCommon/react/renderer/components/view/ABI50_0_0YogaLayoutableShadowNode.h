...
#pragma mark - Mutating Methods
   ...
   */
  void setPositionType(ABI50_0_0YGPositionType positionType) const;
...
#pragma mark - LayoutableShadowNode
 ...
 private:
   ...
   * the passed default
   */
  ABI50_0_0YGErrata resolveErrata(ABI50_0_0YGErrata defaultErrata) const;
  ...
  static yoga::Config& initializeYogaConfig(
      yoga::Config& config,
      ABI50_0_0YGConfigConstRef previousConfig = nullptr);
  static ABI50_0_0YGNodeRef yogaNodeCloneCallbackConnector(
      ABI50_0_0YGNodeConstRef oldYogaNode,
      ABI50_0_0YGNodeConstRef parentYogaNode,
      size_t childIndex);
  static ABI50_0_0YGSize yogaNodeMeasureCallbackConnector(
