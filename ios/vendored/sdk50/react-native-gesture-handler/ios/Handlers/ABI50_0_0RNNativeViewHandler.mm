//
//  ABI50_0_0RNNativeViewHandler.m
...
#import "ABI50_0_0RNNativeViewHandler.h"
...
#pragma mark ABI50_0_0RNDummyGestureRecognizer

@implementation ABI50_0_0RNDummyGestureRecognizer {
...
#pragma mark ABI50_0_0RNNativeViewgestureHandler

@implementation ABI50_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
  if ((self = [super initWithTag:tag])) {
    _recognizer = [[ABI50_0_0RNDummyGestureRecognizer alloc] initWithGestureHandler:self];
  }
  return self;
}
...
- (void)configure:(NSDictionary *)config
{
  ...
  _shouldActivateOnStart = [ABI50_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
  _disallowInterruption = [ABI50_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
  ...
  // is set
#ifdef ABI50_0_0RCT_NEW_ARCH_ENABLED
  if ([view isKindOfClass:[ABI50_0_0RCTScrollViewComponentView class]]) {
    UIScrollView *scrollView = ((ABI50_0_0RCTScrollViewComponentView *)view).scrollView;
  ...
  if ([view isKindOfClass:[ABI50_0_0RCTScrollView class]]) {
    ...
    // we expect for ABI50_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
    // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
  ...
  [self sendEventsInState:ABI50_0_0RNGestureHandlerStateActive
           forViewWithTag:sender.ABI50_0_0ReactTag
            withExtraData:[ABI50_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
  [self sendEventsInState:ABI50_0_0RNGestureHandlerStateEnd
           forViewWithTag:sender.ABI50_0_0ReactTag
            withExtraData:[ABI50_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
  [self sendEventsInState:ABI50_0_0RNGestureHandlerStateCancelled
           forViewWithTag:sender.ABI50_0_0ReactTag
            withExtraData:[ABI50_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
