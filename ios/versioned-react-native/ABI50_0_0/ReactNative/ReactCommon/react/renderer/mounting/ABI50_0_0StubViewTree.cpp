  ...
  for (const auto& mutation : mutations) {
    switch (mutation.type) {
      case ShadowViewMutation::Create: {
        ABI50_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI50_0_0React_native_assert(mutation.oldChildShadowView == ShadowView{});
        ABI50_0_0React_native_assert(mutation.newChildShadowView.props);
        ...
        ABI50_0_0React_native_assert(!hasTag(tag));
      ...
      case ShadowViewMutation::Delete: {
        ...
        ABI50_0_0React_native_assert(mutation.parentShadowView == ShadowView{});
        ABI50_0_0React_native_assert(mutation.newChildShadowView == ShadowView{});
      ...
      case ShadowViewMutation::Insert: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI50_0_0React_native_assert(hasTag(parentTag));
          auto parentStubView = registry_[parentTag];
          ABI50_0_0React_native_assert(hasTag(childTag));
          ...
          ABI50_0_0React_native_assert(childStubView->parentTag == NO_VIEW_TAG);
          ABI50_0_0React_native_assert(
              mutation.index >= 0 &&
      ...
      case ShadowViewMutation::Remove: {
        if (!mutation.mutatedViewIsVirtual()) {
          ...
          ABI50_0_0React_native_assert(childStubView->parentTag == parentTag);
          STUB_VIEW_LOG({
      ...
      case ShadowViewMutation::Update: {
        ...
        ABI50_0_0React_native_assert(hasTag(mutation.newChildShadowView.tag));
        auto oldStubView = registry_[mutation.newChildShadowView.tag];
        ABI50_0_0React_native_assert(oldStubView->tag != 0);
