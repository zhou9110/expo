...
@implementation ABI50_0_0RCTAnimatedNode {
  NSMapTable<NSNumber *, ABI50_0_0RCTAnimatedNode *> *_childNodes;
  NSMapTable<NSNumber *, ABI50_0_0RCTAnimatedNode *> *_parentNodes;
}
...
- (NSMapTable<NSNumber *, ABI50_0_0RCTAnimatedNode *> *)childNodes
{
  return _childNodes;
}

- (NSMapTable<NSNumber *, ABI50_0_0RCTAnimatedNode *> *)parentNodes
{
  return _parentNodes;
}

- (void)addChild:(ABI50_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
...
- (void)removeChild:(ABI50_0_0RCTAnimatedNode *)child
{
  if (!_childNodes) {
    return;
  }
...
- (void)detachNode
{
  for (ABI50_0_0RCTAnimatedNode *parent in _parentNodes.objectEnumerator) {
    [parent removeChild:self];
  }
  for (ABI50_0_0RCTAnimatedNode *child in _childNodes.objectEnumerator) {
