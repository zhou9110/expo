...
@implementation ABI50_0_0EXRawJavaScriptFunction {
  /**
                                   ...
                                   asConstructor:(BOOL)asConstructor
{
  ...
  std::vector<jsi::Value> vector = ABI50_0_0expo::convertNSArrayToStdVector(*runtime, arguments);
  ...
  return [[ABI50_0_0EXJavaScriptValue alloc] initWithRuntime:_runtime value:resultPtr];
}
