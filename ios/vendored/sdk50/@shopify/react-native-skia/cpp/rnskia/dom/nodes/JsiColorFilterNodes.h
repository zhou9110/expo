...
public:
  JsiBaseColorFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context,
                         const char *type)
...
public:
  explicit JsiBlendColorFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiLumaColorFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
...
public:
  explicit JsiLerpColorFilterNode(std::shared_ptr<ABI50_0_0RNSkPlatformContext> context)
