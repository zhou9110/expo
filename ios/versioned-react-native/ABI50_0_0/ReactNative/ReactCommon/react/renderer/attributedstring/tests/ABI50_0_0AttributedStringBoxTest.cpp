...
TEST(AttributedStringBoxTest, testDefaultConstructor) {
  ...
  ABI50_0_0EXPECT_EQ(attributedStringBox.getMode(), AttributedStringBox::Mode::Value);
  ABI50_0_0EXPECT_EQ(attributedStringBox.getValue(), AttributedString{});
}
...
TEST(AttributedStringBoxTest, testOpaquePointerConstructor) {
  ...
  ABI50_0_0EXPECT_EQ(attributedStringBox.getOpaquePointer(), string);
  ABI50_0_0EXPECT_EQ(string.use_count(), 2);
}
...
TEST(AttributedStringBoxTest, testMoveConstructor) {
  {
    ...
    ABI50_0_0EXPECT_EQ(moveToAttributedStringBox.getOpaquePointer(), string);
    ABI50_0_0EXPECT_EQ(string.use_count(), 2);
  }
  {
    auto attributedString = AttributedString{};
    ...
    ABI50_0_0EXPECT_EQ(moveToAttributedStringBox.getValue(), attributedString);
  }
}
...
TEST(AttributedStringBoxTest, testMoveAssignment) {
  {
    ...
    ABI50_0_0EXPECT_EQ(
        ...
        AttributedStringBox::Mode::OpaquePointer);
    ABI50_0_0EXPECT_EQ(movedToAttributedStringBox.getOpaquePointer(), string);
    ABI50_0_0EXPECT_EQ(string.use_count(), 2);
  }
  {
    auto attributedString = AttributedString{};
