...
@protocol ABI50_0_0RCTBackedTextInputDelegate;
@class ABI50_0_0RCTTextAttributes;

NS_ASSUME_NONNULL_BEGIN

@protocol ABI50_0_0RCTBackedTextInputViewProtocol <UITextInput>
...
@property (nonatomic, weak, nullable) id<ABI50_0_0RCTBackedTextInputDelegate> textInputDelegate;
