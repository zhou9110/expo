...
@interface ABI50_0_0EXLocationTaskConsumer ()
...
@implementation ABI50_0_0EXLocationTaskConsumer
...
- (void)setOptions:(NSDictionary *)options
{
  [ABI50_0_0EXUtilities performSynchronouslyOnMainThread:^{
    ...
    locationManager.desiredAccuracy = [ABI50_0_0EXLocation CLLocationAccuracyFromOption:accuracy];
    locationManager.distanceFilter = [options[@"distanceInterval"] doubleValue] ?: kCLDistanceFilterNone;
    locationManager.activityType = [ABI50_0_0EXLocation CLActivityTypeFromOption:[options[@"activityType"] integerValue]];
...
- (void)executeTaskWithDeferredLocations
{
  ...
  NSDictionary *data = @{ @"locations": [ABI50_0_0EXLocationTaskConsumer _exportLocations:_deferredLocations] };
...
+ (NSArray<NSDictionary *> *)_exportLocations:(NSArray<CLLocation *> *)locations
{
  ...
  for (CLLocation *location in locations) {
    [result addObject:[ABI50_0_0EXLocation exportLocation:location]];
  }
  return result;
}
