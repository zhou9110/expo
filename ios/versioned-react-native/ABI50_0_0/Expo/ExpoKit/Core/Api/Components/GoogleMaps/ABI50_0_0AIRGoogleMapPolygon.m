//
//  ABI50_0_0AIRGoogleMapPolygon.m
//
...
#import "ABI50_0_0AIRGMSPolygon.h"
#import <GoogleMaps/GoogleMaps.h>

@implementation ABI50_0_0AIRGoogleMapPolygon
{
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _polygon = [[ABI50_0_0AIRGMSPolygon alloc] init];
  }
...
- (void)setHoles:(NSArray<NSArray<ABI50_0_0AIRMapCoordinate *> *> *)holes
{
  _holes = holes;
